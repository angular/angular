...
""",
    ...
    "_rollup": attr.label(
        executable = True,
        cfg = "host",
        default = Label("//dev-infra/tools/ng_rollup_bundle:rollup_with_build_optimizer"),
    ),
    "_rollup_config_tmpl": attr.label(
        default = Label("//dev-infra/tools/ng_rollup_bundle:rollup.config.js"),
        allow_single_file = True,
    ),
}
...
def ng_rollup_bundle(name, **kwargs):
    ...
    common_terser_args = {
        ...
        "config_file": "//dev-infra/tools/ng_rollup_bundle:terser_config.json",
        "sourcemap": False,
    }
    ...
    npm_package_bin(
        ...
        tool = "//dev-infra/tools/brotli-cli",
        data = [name + ".min.js"],
        outs = [name + ".min.js.br"],
        args = [
