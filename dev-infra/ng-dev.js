...
var MergeStrategy = /** @class */ (function () {
    ...
    MergeStrategy.prototype.fetchTargetBranches = function (names) {
        ...
        this.git.run(tslib.__spread(['fetch', '-q', '-f', this.git.getRepoGitUrl()], fetchRefspecs, extraRefspecs));
    };
    ...
    MergeStrategy.prototype.pushTargetBranchesUpstream = function (names) {
        ...
        this.git.run(tslib.__spread(['push', this.git.getRepoGitUrl()], pushRefspecs));
    };
