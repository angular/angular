...
describe('generateNavItems', () => {
  it('should test the default case', async () => {
    spyOn(fs, 'createReadStream').and.returnValue({destroy: () => null});
    spyOn(readline, 'createInterface').and.returnValue(readlineInterfaceMock);
    const strategy = {
      pathPrefix: 'page',
...
//# sourceMappingURL=nav-items-gen.spec.mjs.map
