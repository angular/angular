...
export function shouldLinkSymbol(symbol) {
 ...
 */
export function extractFromSymbol(symbol) {
  let propName;
...
export function getSymbolUrl(symbol, apiEntries) {
...
function hasMoreThanOneDot(str) {
