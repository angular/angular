...
const entriesBuilder = (comment) => [{jsdocTags: [], rawComment: comment, description: ''}];
const getComment = (entries) => entries[0].rawComment;
describe('interpolate_code_examples', () => {
  beforeAll(() => {
    spyOn(fs, 'readFileSync').and.callFake(mockReadFileSync);
  });
...
//# sourceMappingURL=interpolate_code_examples.spec.mjs.map
