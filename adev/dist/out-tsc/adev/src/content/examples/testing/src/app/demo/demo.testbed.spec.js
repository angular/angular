...
describe('demo (with TestBed):', () => {
  ...
  describe('TestBed component overrides:', () => {
    ...
    it("injected provider should not be same as component's provider", () => {
      ...
      const tcProvider = fixture.debugElement.injector.get(ValueService);
      const tpcProvider = fixture.debugElement.children[0].injector.get(ValueService);
      ...
      expect(testBedProvider instanceof ValueService)
        ...
        .toBe(true);
      expect(tcProvider).withContext('tcProvider is {}').toEqual({});
...
let FakeGrandchildComponent = (() => {
  ...
  let _classExtraInitializers = [];
  let _classThis;
  var FakeGrandchildComponent = class {
    static {
      _classThis = this;
    }
    static {
...
let FakeChildWithGrandchildComponent = (() => {
  ...
  let _classExtraInitializers = [];
  let _classThis;
  var FakeChildWithGrandchildComponent = class {
    static {
      _classThis = this;
    }
    static {
...
let FakeValueService = (() => {
  ...
  let _classExtraInitializers = [];
  let _classThis;
  let _classSuper = ValueService;
  var FakeValueService = class extends _classSuper {
    static {
      _classThis = this;
    }
    static {
...
//# sourceMappingURL=demo.testbed.spec.js.map
