...
import {CdkDrag, CdkDragPreview, CdkDropList, moveItemInArray} from '@angular/cdk/drag-drop';
import {Component} from '@angular/core';
/**
 * @title Drag&Drop custom preview
 */
let CdkDragDropCustomPreviewExample = (() => {
  ...
  let _classThis;
  var CdkDragDropCustomPreviewExample = class {
    static {
      _classThis = this;
    }
    static {
      ...
      CdkDragDropCustomPreviewExample = _classThis = _classDescriptor.value;
      if (_metadata)
  ...
  return (CdkDragDropCustomPreviewExample = _classThis);
})();
