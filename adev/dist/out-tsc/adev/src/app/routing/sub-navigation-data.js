...
const DOCS_SUB_NAVIGATION_DATA = [
  {
    label: 'Introduction',
    children: [
      {
...
export const TUTORIALS_SUB_NAVIGATION_DATA = [
...
const REFERENCE_SUB_NAVIGATION_DATA = [
  {
    label: 'Roadmap',
    path: 'roadmap',
...
export const SUB_NAVIGATION_DATA = {
...
//# sourceMappingURL=sub-navigation-data.js.map
