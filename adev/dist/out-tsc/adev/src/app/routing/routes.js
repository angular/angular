...
// for content pages.
export const SUB_NAVIGATION_ROUTES = [...DOCS_ROUTES, ...REFERENCE_ROUTES, ...TUTORIALS_ROUTES];
const FOOTER_ROUTES = mapNavigationItemsToRoutes(flatNavigationData(SUB_NAVIGATION_DATA.footer), {
  loadComponent: () => import('../features/docs/docs.component'),
});
const API_REFERENCE_ROUTES = mapApiManifestToRoutes();
export const routes = [
  {
    path: '',
