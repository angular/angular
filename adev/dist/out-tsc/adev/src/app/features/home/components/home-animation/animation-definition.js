...
const METEOR_ID = (id) => `${METEOR_FIELD_LAYER_ID} >> .mt-${id}`;
...
const at = (at) => at * TIMING_MULTIPLIER;
const timeframe = (from, to) => [from * TIMING_MULTIPLIER, to * TIMING_MULTIPLIER];
/** Duration: 1 second */
...
export function generateHomeAnimationDefinition(isUwu, meteorCount) {
...
//# sourceMappingURL=animation-definition.js.map
