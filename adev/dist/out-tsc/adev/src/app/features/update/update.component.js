...
let UpdateComponent = (() => {
  ...
  var UpdateComponent = class {
    ...
    static {
      ...
      _copyCode_decorators = [HostListener('click', ['$event'])];
      __esDecorate(
        this,
        null,
        _copyCode_decorators,
        {
          kind: 'method',
          name: 'copyCode',
          static: false,
          private: false,
          access: {has: (obj) => 'copyCode' in obj, get: (obj) => obj.copyCode},
          metadata: _metadata,
        },
        null,
      ...
      UpdateComponent = _classThis = _classDescriptor.value;
      if (_metadata)
    ...
    snackBar = (__runInitializers(this, _instanceExtraInitializers), inject(MatSnackBar));
    title = signal('');
    level = 1;
    options = {
      ngUpgrade: false,
...
\`npm install typescript@2.4.2 --save-exact\``;
  ...
  return (UpdateComponent = _classThis);
})();
