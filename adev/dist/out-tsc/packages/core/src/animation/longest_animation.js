 ...
 */
export function determineLongestAnimation(el, animationsMap, areAnimationSupported) {
...
export const allLeavingAnimations = new Set();
//# sourceMappingURL=longest_animation.js.map
