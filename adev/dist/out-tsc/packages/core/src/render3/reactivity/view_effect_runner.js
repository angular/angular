 ...
 */
import {EFFECTS, FLAGS} from '../interfaces/view';
export function runEffectsInView(view) {
  ...
  while (tryFlushEffects) {
    ...
    // become dirty.
    tryFlushEffects =
      foundDirtyEffect && !!((view[FLAGS] & 8192) /* LViewFlags.HasChildViewsToRefresh */);
  }
}
//# sourceMappingURL=view_effect_runner.js.map
