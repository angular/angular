 ...
 * @publicApi
 */
export const LOCALE_ID = new InjectionToken(
 ...
 * @publicApi
 */
export const DEFAULT_CURRENCY_CODE = new InjectionToken(
 ...
 * @publicApi
 */
export const TRANSLATIONS = new InjectionToken(
 ...
 * @publicApi
 */
export const TRANSLATIONS_FORMAT = new InjectionToken(
