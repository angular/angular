...
export class R3Injector extends EnvironmentInjector {
  ...
  get(token, notFoundValue = THROW_IF_NOT_FOUND, options) {
    ...
    try {
      ...
      const nextInjector = !((flags & 2) /* InternalInjectFlags.Self */)
        ? this.parent
        : getNullInjector();
      ...
      if (
        errorCode === -200 /* RuntimeErrorCode.CYCLIC_DI_DEPENDENCY */ ||
    ...
    if (isValueProvider(provider)) {
      ...
      factory = (_, flags) =>
        ɵɵinject(
          ...
          flags !== undefined && flags & 8 /* InternalInjectFlags.Optional */
...
export function assertNotDestroyed(injector) {
