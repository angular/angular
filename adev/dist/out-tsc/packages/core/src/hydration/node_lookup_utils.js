...
export function isDisconnectedNode(tNode, lView) {
  return (
    !(tNode.type & (16 /* TNodeType.Projection */ | 128) /* TNodeType.LetDeclaration */) &&
    !!lView[tNode.index] &&
 ...
 */
export function gatherDeferBlocksCommentNodes(doc, node) {
...
//# sourceMappingURL=node_lookup_utils.js.map
