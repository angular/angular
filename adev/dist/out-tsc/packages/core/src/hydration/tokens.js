 ...
 */
export const IS_HYDRATION_DOM_REUSE_ENABLED = new InjectionToken(
 ...
 */
export const PRESERVE_HOST_CONTENT = new InjectionToken(
 ...
 * is enabled.
 */
export const IS_I18N_HYDRATION_ENABLED = new InjectionToken(
 ...
 * is enabled.
 */
export const IS_EVENT_REPLAY_ENABLED = new InjectionToken(
 ...
 * is enabled.
 */
export const IS_INCREMENTAL_HYDRATION_ENABLED = new InjectionToken(
 ...
 */
export const JSACTION_BLOCK_ELEMENT_MAP = new InjectionToken(
 ...
 */
export const IS_ENABLED_BLOCKING_INITIAL_NAVIGATION = new InjectionToken(
