...
import {InjectionToken, Injector, makeEnvironmentProviders, runInInjectionContext} from '../di';
...
export function createPlatform(injector) {
  if (getPlatform()) {
    throw new RuntimeError(
      400 /* RuntimeErrorCode.MULTIPLE_PLATFORMS */,
 ...
 * @publicApi
 */
export function providePlatformInitializer(initializerFn) {
