...
let ChangeDetectionSchedulerImpl = (() => {
  ...
  var ChangeDetectionSchedulerImpl = class {
    ...
    tick() {
      ...
      if (
        !this.zonelessEnabled &&
        this.appRef.dirtyFlags & 7 /* ApplicationRefDirtyFlags.ViewTreeAny */
      ) {
...
export {ChangeDetectionSchedulerImpl};
/**
...
export function provideZonelessChangeDetection() {
  ...
  if ((typeof ngDevMode === 'undefined' || ngDevMode) && typeof Zone !== 'undefined' && Zone) {
    const message = formatRuntimeError(
      914 /* RuntimeErrorCode.UNEXPECTED_ZONEJS_PRESENT_IN_ZONELESS_MODE */,
...
export function provideZonelessChangeDetectionInternal() {
  return [
...
//# sourceMappingURL=zoneless_scheduling_impl.js.map
