...
let NgIf = (() => {
  ...
  var NgIf = class {
    ...
    static {
      ...
      _set_ngIf_decorators = [Input()];
      _set_ngIfThen_decorators = [Input()];
      _set_ngIfElse_decorators = [Input()];
      __esDecorate(
        this,
        null,
        _set_ngIf_decorators,
        {
          kind: 'setter',
          name: 'ngIf',
          static: false,
