...
let FormGroupName = (() => {
  ...
  var FormGroupName = class extends _classSuper {
    static {
      _classThis = this;
    }
    static {
      const _metadata =
        typeof Symbol === 'function' && Symbol.metadata
          ...
          : void 0;
      _name_decorators = [Input('formGroupName')];
      __esDecorate(
        null,
        null,
        _name_decorators,
...
let FormArrayName = (() => {
  ...
  let _name_initializers = [];
  let _name_extraInitializers = [];
  var FormArrayName = class extends _classSuper {
    static {
      _classThis = this;
    }
    static {
      const _metadata =
        typeof Symbol === 'function' && Symbol.metadata
          ? Object.create(_classSuper[Symbol.metadata] ?? null)
          : void 0;
      _name_decorators = [Input('formArrayName')];
      __esDecorate(
        null,
        null,
        _name_decorators,
