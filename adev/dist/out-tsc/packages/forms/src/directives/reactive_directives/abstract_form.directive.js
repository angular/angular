...
import {Directive, computed, signal, untracked} from '@angular/core';
 ...
 * @publicApi
 */
let AbstractFormDirective = (() => {
  let _classDecorators = [Directive()];
  let _classDescriptor;
  let _classExtraInitializers = [];
  let _classThis;
  let _classSuper = ControlContainer;
  var AbstractFormDirective = class extends _classSuper {
    static {
      _classThis = this;
    }
    static {
      ...
      AbstractFormDirective = _classThis = _classDescriptor.value;
      if (_metadata)
  ...
  return (AbstractFormDirective = _classThis);
})();
