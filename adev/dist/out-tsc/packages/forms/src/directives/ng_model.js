...
import {booleanAttribute, Directive, EventEmitter, forwardRef, Input, Output} from '@angular/core';
...
let NgModel = (() => {
  ...
  var NgModel = class extends _classSuper {
    static {
      _classThis = this;
    }
    static {
      ...
      _isDisabled_decorators = [Input('disabled')];
      _model_decorators = [Input('ngModel')];
      _options_decorators = [Input('ngModelOptions')];
      ...
      __esDecorate(
        ...
        _isDisabled_initializers,
        _isDisabled_extraInitializers,
      );
      __esDecorate(
        null,
        null,
    ...
    isDisabled =
      ...
      __runInitializers(this, _isDisabled_initializers, void 0));
    /**
     * @description
    ...
    options =
      ...
      __runInitializers(this, _options_initializers, void 0));
    /**
     * @description
