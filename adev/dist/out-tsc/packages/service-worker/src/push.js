...
import {ERR_SW_NOT_SUPPORTED} from './low_level';
/**
      ...
      const doUnsubscribe = (sub) => {
        if (sub === null) {
          throw new RuntimeError(
            5602 /* RuntimeErrorCode.NOT_SUBSCRIBED_TO_PUSH_NOTIFICATIONS */,
        ...
        return sub.unsubscribe().then((success) => {
          if (!success) {
            throw new RuntimeError(
              5603 /* RuntimeErrorCode.PUSH_SUBSCRIPTION_UNSUBSCRIBE_FAILED */,
