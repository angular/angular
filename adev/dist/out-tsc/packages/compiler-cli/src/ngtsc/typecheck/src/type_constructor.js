...
export function generateTypeCtorDeclarationFn(env, meta, nodeTypeRef, typeParams) {
 ...
 */
export function generateInlineTypeCtor(env, node, meta) {
...
export function requiresInlineTypeCtor(node, host, env) {
