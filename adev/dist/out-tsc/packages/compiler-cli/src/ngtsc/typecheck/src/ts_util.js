 ...
 */
export function tsCreateElement(...tagNames) {
 ...
 * expression.
 */
export function tsCreateVariable(id, initializer, flags = null) {
  const decl = ts.factory.createVariableDeclaration(
    /* name */ id,
    /* exclamationToken */ undefined,
    /* type */ undefined,
 ...
 * - var _t1 /*T:D*\/ = _ctor1({});
 */
export function isDirectiveDeclaration(node) {
 ...
 * ```
 */
export function isSymbolAliasOf(firstSymbol, lastSymbol, typeChecker) {
