 ...
 */
export function loadIsReferencedAliasDeclarationPatch(context) {
 ...
 */
export function isAliasImportDeclaration(node) {
...
//# sourceMappingURL=patch_alias_reference_resolution.js.map
