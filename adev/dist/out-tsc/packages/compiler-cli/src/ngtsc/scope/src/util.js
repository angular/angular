...
export function getDiagnosticNode(ref, rawExpr) {
...
export function makeNotStandaloneDiagnostic(scopeReader, ref, rawExpr, kind) {
...
export function makeUnknownComponentImportDiagnostic(ref, rawExpr) {
  return makeDiagnostic(
...
export function makeUnknownComponentDeferredImportDiagnostic(ref, rawExpr) {
  return makeDiagnostic(
