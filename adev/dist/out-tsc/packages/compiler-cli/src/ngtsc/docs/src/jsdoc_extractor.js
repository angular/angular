...
export function extractJsDocTags(node) {
 ...
 */
export function extractJsDocDescription(node) {
  const escapedNode = getEscapedNode(node);
 ...
 */
export function extractRawJsDoc(node) {
...
//# sourceMappingURL=jsdoc_extractor.js.map
