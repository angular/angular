 ...
 */
export function isInitializerApiFunction(node, typeChecker) {
 ...
 */
export function extractInitializerApiFunction(node, typeChecker) {
...
//# sourceMappingURL=initializer_api_function_extractor.js.map
