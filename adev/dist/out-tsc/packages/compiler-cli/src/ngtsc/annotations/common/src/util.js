...
export function toR3Reference(origin, ref, context, refEmitter) {
 ...
 */
export function isAngularCoreReferenceWithPotentialAliasing(reference, symbolName, isCore) {
  return (
...
export function getAngularDecorators(decorators, names, isCore) {
 ...
 */
export function createForwardRefResolver(isCore) {
...
export function resolveImportedFile(moduleResolver, importedFile, expr, origin) {
 ...
 * used.
 */
export function getOriginNodeForDiagnostics(expr, container) {
...
export function isAbstractClassDeclaration(clazz) {
