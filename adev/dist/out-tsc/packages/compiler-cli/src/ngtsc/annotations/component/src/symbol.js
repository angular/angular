 ...
 */
import {isArrayEqual, isReferenceEqual} from '../../../incremental/semantic_graph';
...
export class ComponentSymbol extends DirectiveSymbol {
  ...
  isEmitAffected(previousSymbol, publicApiAffected) {
    ...
    // affected.
    const isSymbolUnaffected = (current, previous) =>
  ...
  isTypeCheckBlockAffected(previousSymbol, typeCheckApiAffected) {
    ...
    const isDirectiveUnaffected = (current, previous) =>
    ...
    // API affected.
    const isPipeUnaffected = (current, previous) =>
