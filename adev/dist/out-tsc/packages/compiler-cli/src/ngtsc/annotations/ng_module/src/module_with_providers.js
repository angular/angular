...
import {SyntheticValue} from '../../../partial_evaluator';
import {entityNameToValue, isNamedClassDeclaration, typeNodeToValueExpr} from '../../../reflection';
/**
 ...
 */
export function createModuleWithProvidersResolver(reflector, isCore) {
  /**
...
export function isResolvedModuleWithProviders(sv) {
  return (
...
//# sourceMappingURL=module_with_providers.js.map
