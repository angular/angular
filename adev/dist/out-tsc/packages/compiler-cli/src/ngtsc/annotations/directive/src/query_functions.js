...
import {ClassMemberAccessLevel, reflectObjectLiteral} from '../../../reflection';
...
const queryFunctionNames = ['viewChild', 'viewChildren', 'contentChild', 'contentChildren'];
 ...
 */
export function tryParseSignalQueryFromInitializer(member, reflector, importTracker) {
...
//# sourceMappingURL=query_functions.js.map
