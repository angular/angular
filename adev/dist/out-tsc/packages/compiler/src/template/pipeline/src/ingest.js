...
export function ingestDomProperty(job, property, bindingKind, securityContexts) {
  let expression;
...
function ingestDeferBlock(unit, deferBlock) {
  ...
  ingestDeferTriggers(
    'hydrate' /* ir.DeferOpModifierKind.HYDRATE */,
  ...
  ingestDeferTriggers(
    'none' /* ir.DeferOpModifierKind.NONE */,
    deferBlock.triggers,
    deferOnOps,
    deferWhenOps,
    unit,
  ...
  ingestDeferTriggers(
    'prefetch' /* ir.DeferOpModifierKind.PREFETCH */,
  ...
  const hasConcreteTrigger =
    deferOnOps.some((op) => op.modifier === 'none' /* ir.DeferOpModifierKind.NONE */) ||
...
function makeListenerHandlerOps(unit, handler, handlerSpan) {
  ...
  handlerOps.push(
    ...expressions.map((e) => ir.createStatementOp(new o.ExpressionStatement(e, e.sourceSpan))),
  );
