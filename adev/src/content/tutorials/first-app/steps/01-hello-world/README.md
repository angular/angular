...
NOTE: Если вы работаете со встроенным редактором, перейдите к [четвертому шагу](#create-hello-world).
...
1. Откройте `first-app/src/index.html`.
   NOTE: Этот и следующий шаги предназначены только для вашей локальной среды!
