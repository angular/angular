...
Now that you've learned [managing async signals with resources API](/tutorials/signals/5-managing-async-signals-with-resources-api), let's explore Angular's signal-based APIs for component inputs, outputs, and two-way binding, making component data flow more reactive and efficient.
