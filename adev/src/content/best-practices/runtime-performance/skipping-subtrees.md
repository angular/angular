# Пропуск поддеревьев компонентов {#skipping-component-subtrees}
...
## Распространенные сценарии обнаружения изменений {#common-change-detection-scenarios}

В этом разделе рассматриваются несколько распространенных сценариев обнаружения изменений для иллюстрации поведения
Angular.

### Событие обрабатывается компонентом со стратегией обнаружения изменений по умолчанию {#event-handled-by-component-with-default-change-detection}
...
## Событие обрабатывается компонентом с OnPush {#event-handled-by-component-with-onpush}
...
## Событие обрабатывается потомком компонента с OnPush {#event-handled-by-descendant-of-onpush-component}
...
## Новые входные данные для компонента с OnPush {#new-inputs-for-onpush-component}
