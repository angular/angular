...
### Событие обрабатывается компонентом со стратегией обнаружения изменений по умолчанию {#an-event-is-handled-by-a-component-with-default-change-detection}
...
## Новые входные данные для компонента с OnPush {#new-inputs-to-component-with-onpush}
