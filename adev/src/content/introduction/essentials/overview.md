...
Angular uses a small amount of TypeScript-specific syntax for defining metadata on classes. You do not need to understand the underlying language proposals in advance — this guide introduces everything you need as you go.
