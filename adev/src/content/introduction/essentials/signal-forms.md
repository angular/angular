...
### 1. Создайте модель формы с помощью `signal()`
...
### 3. Привяжите HTML-поля ввода с помощью директивы `[formField]`
...
### 4. Читайте значения полей с помощью `value()`
...
### 5. Обновляйте значения полей с помощью `set()`
