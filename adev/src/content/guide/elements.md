...
<docs-code-multifile>
    <docs-code header="popup.component.ts" example="elements" path="src/app/popup.component.ts"/>
    <docs-code header="popup.service.ts" example="elements" path="src/app/popup.service.ts"/>
    <docs-code header="app.component.ts" example="elements" path="src/app/app.component.ts"/>
</docs-code-multifile>
