...
<docs-code header="src/app/animations.ts" example="animations" path="src/app/animations.1.ts" visibleRegion="animation-const"/>
...
<docs-code header="src/app/animations.1.ts" example="animations" path="src/app/animations.1.ts" visibleRegion="trigger-const"/>
...
<docs-code header="src/app/open-close.component.ts" example="animations" path="src/app/open-close.component.3.ts" visibleRegion="reusable"/>
