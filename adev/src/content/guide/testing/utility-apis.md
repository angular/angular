...
<docs-code header="app/demo/demo.testbed.spec.ts" example="testing" path="src/app/demo/demo.testbed.spec.ts" visibleRegion="custom-predicate"/>
...
<docs-code header="app/hero/hero-list.component.spec.ts" example="testing" path="src/app/hero/hero-list.component.spec.ts" visibleRegion="by"/>
