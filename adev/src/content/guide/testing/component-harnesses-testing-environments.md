...
TIP: Это руководство предполагает, что вы уже ознакомились
...
### Когда имеет смысл добавлять поддержку среды тестирования? {#when-does-adding-support-for-a-test-environment-make-sense}
