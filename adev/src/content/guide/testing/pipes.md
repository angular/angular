...
<docs-code header="app/shared/title-case.pipe.ts" example="testing" path="src/app/shared/title-case.pipe.ts"/>

Anything that uses a regular expression is worth testing thoroughly.
Use simple Jasmine to explore the expected cases and the edge cases.

<docs-code header="app/shared/title-case.pipe.spec.ts" example="testing" path="src/app/shared/title-case.pipe.spec.ts" visibleRegion="excerpt"/>
