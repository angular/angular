...
## Тестирование `HighlightDirective` {#testing-the-highlight-directive}
...
HELPFUL: В случае с `<input>`, `HighlightDirective` привязывается к названию цвета в поле ввода.
