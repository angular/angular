...
Although developers generally avoid it, some visual effects and third-party tools require direct DOM access.
...
A class cannot be referenced directly until it has been defined.
...
The Angular `forwardRef()` function creates an _indirect_ reference that Angular resolves at runtime.
