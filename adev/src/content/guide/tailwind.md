...
## Автоматическая настройка с помощью `ng add` {#automated-setup-with-ng-add}
...
### 1. Создайте проект Angular {#1-create-an-angular-project}
...
### 2. Установите Tailwind CSS {#2-install-tailwind-css}
...
### 3. Настройте плагины PostCSS {#3-configure-postcss-plugins}
...
### 4. Импортируйте Tailwind CSS {#4-import-tailwind-css}
