# Безопасность `HttpClient` {#httpclient-security}
...
## Защита от XSSI {#xssi-protection}
...
## Защита от XSRF/CSRF {#xsrf-csrf-protection}
...
### Настройка пользовательских имён cookie/заголовков {#configuring-custom-cookie-and-header-names}
