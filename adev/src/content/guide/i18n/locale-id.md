...
HELPFUL: Чтобы точно перевести ваш Angular-проект, необходимо решить, на какие языки и локали вы ориентируетесь при
интернационализации.
...
## Установка ID исходной локали {#set-the-source-locale-id}
