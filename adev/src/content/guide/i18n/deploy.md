...
## Настройка сервера {#configure-a-server}
...
IMPORTANT: Если вы используете [Рендеринг на стороне сервера (SSR)](guide/ssr) с `outputMode`, установленным в `server`,
...
### Пример для Apache {#apache-example}
