...
### Пример включения всех локалей из сборки в `angular.json` {#angularjson-include-all-locales-from-build-example}
...
### Пример сборки для французского языка {#build-for-french-example}
