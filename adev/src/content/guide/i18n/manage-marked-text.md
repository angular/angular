...
<docs-code header="messages.fr.xlf.html" example="i18n" path="doc-files/messages.fr.xlf.html" visibleRegion="generated-id"/>
...
<docs-code header="app/app.component.html" example="i18n" path="doc-files/app.component.html" visibleRegion="i18n-attribute-solo-id"/>
...
<docs-code header="messages.fr.xlf.html" example="i18n" path="doc-files/messages.fr.xlf.html" visibleRegion="custom-id"/>
...
<docs-code header="app/app.component.html" example="i18n" path="doc-files/app.component.html" visibleRegion="i18n-attribute-id"/>
...
<docs-code header="app/app.component.html" example="i18n" path="doc-files/app.component.html" visibleRegion="i18n-attribute-meaning-and-id"/>
...
<docs-code header="app/app.component.html" example="i18n" path="doc-files/app.component.html" visibleRegion="i18n-duplicate-custom-id"/>

The following displays the translation in French.

<docs-code header="src/locale/messages.fr.xlf" example="i18n" path="doc-files/messages.fr.xlf.html" visibleRegion="i18n-duplicate-custom-id"/>

Both elements now use the same translation \(`Bonjour`\), because both were defined with the same custom ID.

<docs-code example="i18n" path="doc-files/rendered-output.html"/>
