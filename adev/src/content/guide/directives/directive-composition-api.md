# API композиции директив {#directive-composition-api}
...
Когда фреймворк рендерит компонент, Angular также создаёт экземпляр каждой хост-директивы. Хост-привязки директив
...
## Семантика хост-директив {#host-directive-semantics}
...
провайдеры, определённые классом с `hostDirectives`, имеют приоритет над провайдерами, определёнными хост-директивами.
