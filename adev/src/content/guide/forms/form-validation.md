...
<docs-code header="template/actor-form-template.component.html (name)" example="form-validation" path="src/app/template/actor-form-template.component.html" visibleRegion="name-with-error-msg"/>
...
<docs-code header="reactive/actor-form-reactive.component.ts (validator functions)" example="form-validation" path="src/app/reactive/actor-form-reactive.component.1.ts" visibleRegion="form-group"/>
...
<docs-code header="reactive/actor-form-reactive.component.html (name with error msg)" example="form-validation" path="src/app/reactive/actor-form-reactive.component.html" visibleRegion="name-with-error-msg"/>
...
<docs-code header="shared/forbidden-name.directive.ts (forbiddenNameValidator)" example="form-validation" path="src/app/shared/forbidden-name.directive.ts" visibleRegion="custom-validator"/>
...
<docs-code header="reactive/actor-form-reactive.component.ts (validator functions)" example="form-validation" path="src/app/reactive/actor-form-reactive.component.1.ts" visibleRegion="custom-validator"/>
...
<docs-code header="shared/forbidden-name.directive.ts (providers)" example="form-validation" path="src/app/shared/forbidden-name.directive.ts" visibleRegion="directive-providers"/>
...
<docs-code header="shared/forbidden-name.directive.ts (directive)" example="form-validation" path="src/app/shared/forbidden-name.directive.ts" visibleRegion="directive"/>
...
<docs-code header="template/actor-form-template.component.html (forbidden-name-input)" example="form-validation" path="src/app/template/actor-form-template.component.html" visibleRegion="name-input"/>
...
<docs-code header="forms.css (status classes)" example="form-validation" path="src/assets/forms.css"/>
...
<docs-code header="shared/unambiguous-role.directive.ts" example="form-validation" path="src/app/shared/unambiguous-role.directive.ts" visibleRegion="cross-validation-validator"/>
...
<docs-code header="reactive/actor-form-template.component.html" example="form-validation" path="src/app/reactive/actor-form-reactive.component.html" visibleRegion="cross-validation-error-message"/>
...
<docs-code header="shared/unambiguous-role.directive.ts" example="form-validation" path="src/app/shared/unambiguous-role.directive.ts" visibleRegion="cross-validation-directive"/>
...
<docs-code header="template/actor-form-template.component.html" example="form-validation" path="src/app/template/actor-form-template.component.html" visibleRegion="cross-validation-register-validator"/>

To provide better user experience, an appropriate error message appears when the form is invalid.

<docs-code header="template/actor-form-template.component.html" example="form-validation" path="src/app/template/actor-form-template.component.html" visibleRegion="cross-validation-error-message"/>
...
<docs-code example="form-validation" path="src/app/shared/role.directive.ts" visibleRegion="async-validator"/>
...
<docs-code example="form-validation" path="src/app/reactive/actor-form-reactive.component.2.ts" visibleRegion="async-validator-inject"/>
...
<docs-code example="form-validation" path="src/app/reactive/actor-form-reactive.component.2.ts" visibleRegion="async-validator-usage"/>
...
<docs-code example="form-validation" path="src/app/shared/role.directive.ts" visibleRegion="async-validator-directive"/>

Then, as with synchronous validators, add the directive's selector to an input to activate it.

<docs-code header="template/actor-form-template.component.html (unique-unambiguous-role-input)" example="form-validation" path="src/app/template/actor-form-template.component.html" visibleRegion="role-input"/>
