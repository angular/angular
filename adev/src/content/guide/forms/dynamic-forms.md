...
<docs-code-multifile>
    <docs-code header="dynamic-form.component.ts" example="dynamic-form" path="src/app/dynamic-form.component.ts"/>
    <docs-code header="dynamic-form-question.component.ts" example="dynamic-form" path="src/app/dynamic-form-question.component.ts"/>
</docs-code-multifile>
...
<docs-code header="src/app/question-base.ts" example="dynamic-form" path="src/app/question-base.ts"/>
...
<docs-code header="question-textbox.ts" example="dynamic-form" path="src/app/question-textbox.ts"/>

The `DropdownQuestion` control type presents a list of choices in a select box.

 <docs-code header="question-dropdown.ts" example="dynamic-form" path="src/app/question-dropdown.ts"/>
...
<docs-code header="src/app/question-control.service.ts" example="dynamic-form" path="src/app/question-control.service.ts"/>
...
<docs-code-multifile>
  <docs-code header="dynamic-form-question.component.html" example="dynamic-form" path="src/app/dynamic-form-question.component.html"/>
  <docs-code header="dynamic-form-question.component.ts" example="dynamic-form" path="src/app/dynamic-form-question.component.ts"/>
</docs-code-multifile>
...
<docs-code header="src/app/question.service.ts" example="dynamic-form" path="src/app/question.service.ts"/>
...
<docs-code-multifile>
    <docs-code header="dynamic-form.component.html" example="dynamic-form" path="src/app/dynamic-form.component.html"/>
    <docs-code header="dynamic-form.component.ts" example="dynamic-form" path="src/app/dynamic-form.component.ts"/>
</docs-code-multifile>
...
<docs-code header="app.component.ts" example="dynamic-form" path="src/app/app.component.ts"/>
