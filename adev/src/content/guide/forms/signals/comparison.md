...
NOTE: Signal Forms are [experimental](reference/releases#experimental) as of Angular v19. The API may change before stabilizing.

## Quick comparison

| Feature          | Signal Forms                      | Reactive Forms            | Template-driven Forms |
| ---------------- | --------------------------------- | ------------------------- | --------------------- |
| Source of truth  | Writable signal                   | FormControl/FormGroup     | Template with NgModel |
| Type safety      | Inferred from model               | Explicit with typed forms | Minimal               |
| Validation       | Schema with path-based validators | ValidatorFn on controls   | Directive-based       |
...
| Status           | Experimental (v19+)               | Stable                    | Stable                |
...
- You're building new signal-based applications (Angular v18+)
