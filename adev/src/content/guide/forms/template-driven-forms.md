# Создание формы на основе шаблона {#building-a-template-driven-form}
...
## Создание формы на основе шаблона {#building-the-form}
...
## Привязка элементов управления ввода к свойствам данных {#binding-input-controls-to-data-properties}
...
## Отслеживание состояний формы {#tracking-form-states}
...
## Отслеживание состояний элементов управления {#tracking-control-states}
...
### Наблюдение за состояниями элементов управления {#observing-control-states}
...
### Создание визуальной обратной связи для состояний {#creating-visual-feedback-for-states}
...
### Отображение и скрытие сообщений об ошибках валидации {#showing-and-hiding-validation-error-messages}
...
## Добавление нового актера {#adding-a-new-actor}
...
## Отправка формы с помощью `ngSubmit` {#submitting-the-form-with-ngsubmit}
...
### Реагирование на отправку формы {#responding-to-form-submission}
