...
## Создание формы на основе шаблона {#build-a-template-driven-form}
...
## Привязка элементов управления ввода к свойствам данных {#bind-input-controls-to-data-properties}
...
## Отслеживание состояний элементов управления {#track-control-states}
...
### Наблюдение за состояниями элементов управления {#observe-control-states}
...
### Создание визуальной обратной связи для состояний {#create-visual-feedback-for-states}
...
### Отображение и скрытие сообщений об ошибках валидации {#show-and-hide-validation-error-messages}
...
## Добавление нового актера {#add-a-new-actor}
...
## Отправка формы с помощью `ngSubmit` {#submit-the-form-with-ngsubmit}
...
### Реагирование на отправку формы {#respond-to-form-submission}
