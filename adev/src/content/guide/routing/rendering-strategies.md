...
### Особенности CSR {#csr-trade-offs}
...
### Особенности SSG {#ssg-trade-offs}
...
### Особенности SSR {#ssr-trade-offs}
...
## Обеспечение интерактивности SSR/SSG с помощью гидратации {#making-ssr-ssg-interactive-with-hydration}
