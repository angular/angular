...
## Доступ к полученным данным в компонентах {#accessing-resolved-data-in-components}
...
### Обеспечение обратной связи при навигации {#providing-navigation-feedback}
...
## Чтение данных родительского резолвера в дочерних резолверах {#reading-parent-resolved-data-in-child-resolvers}
