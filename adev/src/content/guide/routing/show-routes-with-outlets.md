...
## Вложенные маршруты и дочерние маршруты {#nesting-routes-with-child-routes}
...
## Передача контекстных данных в маршрутизируемые компоненты {#passing-contextual-data-to-routed-components}
...
NOTE: Если входное свойство `routerOutletData` не задано, внедряемое значение по умолчанию равно null.
