...
describe('authGuard', () => {
  ...
  it('allows navigation when user is authenticated', async () => {
    ...
    // Check that the harness rendered the protected component
    expect(harness.routeNativeElement).not.toBeNull();
    // Check that the final URL is the protected route
  ...
  it('redirects to login when user is not authenticated', async () => {
    await setup(false);
    await harness.navigateByUrl('/protected');
    // Check that the harness rendered the login component
    expect(harness.routeNativeElement).not.toBeNull();
    // Check that the final URL is the login route
