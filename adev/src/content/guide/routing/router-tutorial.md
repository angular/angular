...
## Определение маршрутов {#define-your-routes}
...
## Импорт `provideRouter` из `@angular/router` {#import-providerouter-from-angular-router}
...
## Обновление компонента с помощью `router-outlet` {#update-your-component-with-router-outlet}
...
## Управление навигацией с помощью элементов UI {#control-navigation-with-ui-elements}
...
## Идентификация активного маршрута {#identify-the-active-route}
...
## Добавление перенаправления (redirect) {#adding-a-redirect}
...
## Добавление страницы 404 {#adding-a-404-page}
...
IMPORTANT: Обратите внимание, что подстановочный маршрут помещен в конец массива.
