...
The `ActivatedRoute` can provide different information about the route including:
...
Check out the [`ActivatedRoute` API docs](/api/router/ActivatedRoute) for a complete list of what you can access with it.
...
Check out the [`ActivatedRouteSnapshot API docs`](/api/router/ActivatedRouteSnapshot) for a complete list of all properties you can access.
