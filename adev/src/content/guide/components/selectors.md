...
TIP: Это руководство предполагает, что вы уже прочитали [Руководство по основам](essentials). Сначала ознакомьтесь с
...
IMPORTANT: Angular использует префикс селектора `ng` для собственных API фреймворка. Никогда не используйте `ng` в качестве
