# Пользовательские события и outputs {#custom-events-with-outputs}
...
## Программная подписка на outputs {#programmatically-subscribing-to-outputs}
...
### Псевдонимы с декоратором `@Output` {#aliasing-with-the-output-decorator}
