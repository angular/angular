...
### Режим множественного раскрытия {#multi-expansion-mode}
...
### Отключенные элементы аккордеона {#disabled-accordion-items}
...
#### Input-свойства {#accordiongroup-inputs}
...
#### Input-свойства {#accordiontrigger-inputs}
...
#### Input-свойства {#accordionpanel-inputs}
...
#### Сигналы {#accordionpanel-signals}

| Свойство  | Тип               | Описание                             |
| --------- | ----------------- | ------------------------------------ |
| `visible` | `Signal<boolean>` | Развернута ли панель в данный момент |

#### Методы {#accordionpanel-methods}
