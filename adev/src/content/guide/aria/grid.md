...
### Сетка таблицы данных {#data-table-grid}
...
#### Входные свойства (Inputs) {#grid-inputs}
...
#### Входные свойства (Inputs) {#gridrow-inputs}
...
#### Входные свойства (Inputs) {#gridcell-inputs}
...
#### Сигналы (Signals) {#gridcell-signals}
