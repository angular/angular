...
NOTE: Хотя схематик может автоматически обновить большую часть кода, некоторые граничные случаи требуют
...
HELPFUL: На этом этапе схематик игнорирует NgModules, которые загружают (bootstrap) компонент, так как они, вероятно,
