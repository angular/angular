...
### `immediate` вместе с триггерами предзагрузки {#immediate-with-prefetch-triggers}
...
### Таймер предзагрузки установлен не раньше основного таймера {#prefetch-timer-not-earlier-than-main-timer}
...
### Идентичные триггеры предзагрузки и основные триггеры {#identical-prefetch-and-main-triggers}
