...
For complex applications with many modules, circular dependencies can be difficult to identify manually. Consider using tools like [madge](https://npmx.dev/package/madge) to visualize and detect circular imports:
