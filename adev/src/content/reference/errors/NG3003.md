...
<docs-code header="parent.component.ts" example="errors" path="cyclic-imports/parent.component.ts"/>

<docs-code header="child.component.ts" example="errors" path="cyclic-imports/child.component.ts"/>
