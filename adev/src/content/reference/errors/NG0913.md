...
- Switch to use Angular's built-in image directive ([`NgOptimizedImage`](/dev/api/common/NgOptimizedImage)), which allows for easily [prioritizing LCP images](/guide/image-optimization#mark-images-as-priority).
