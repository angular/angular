...
| [`@angular-devkit/build-angular`](https://npmx.dev/package/@angular-devkit/build-angular) | Contains default CLI builders for bundling, testing, and serving Angular applications and libraries.                                                                                                         |
| [`rxjs`](https://npmx.dev/package/rxjs)                                                   | A library for reactive programming using `Observables`.                                                                                                                                                      |
...
| [`typescript`](https://npmx.dev/package/typescript)                                       | The TypeScript compiler, language server, and built-in type definitions.                                                                                                                                     |
