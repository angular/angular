# Инспекция дерева компонентов {#inspecting-the-components-tree}
...
### Изучение структуры приложения {#explore-the-application-structure}
...
### Переход к хост-узлу {#navigate-to-the-host-node}
...
### Переход к исходному коду {#navigate-to-source}
...
### Обновление значения свойства {#update-property-value}
...
### Доступ к выбранному компоненту или директиве в консоли {#access-selected-component-or-directive-in-console}
...
### Выбор директивы или компонента {#select-a-directive-or-component}
...
### Инспекция откладываемых представлений (Deferrable views) {#inspect-deferrable-views}
