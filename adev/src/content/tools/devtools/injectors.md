## Инспектирование инжекторов {#inspect-your-injectors}

ПРИМЕЧАНИЕ: Дерево инжекторов (Injector Tree) доступно для приложений Angular, созданных с использованием версии 17 или
выше.

### Просмотр иерархии инжекторов приложения {#view-the-injector-hierarchy-of-your-application}
...
### Визуализация путей разрешения {#visualize-resolution-paths}
...
### Просмотр провайдеров инжектора {#view-injector-providers}
