# Генерация кода с использованием схематиков {#generating-code-using-schematics}
...
## Схематики для Angular CLI {#schematics-for-the-angular-cli}
...
### Настройка схематиков CLI {#configuring-cli-schematics}
...
## Разработка схематиков для библиотек {#developing-schematics-for-libraries}
...
### Схематики добавления (Add schematics) {#add-schematics}
...
### Схематики генерации (Generation schematics) {#generation-schematics}
...
### Схематики обновления (Update schematics) {#update-schematics}
