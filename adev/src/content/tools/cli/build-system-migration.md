# Система сборки приложений Angular {#angular-application-build-system}
...
#### Ручная миграция на новый билдер `application` {#manual-migration-to-the-application-builder}
...
## Выполнение сборки {#running-the-build}
...
## Запуск сервера разработки {#starting-the-dev-server}
...
### Vite в качестве сервера разработки {#vite-as-the-development-server}
...
### Условия импорта/экспорта {#importexport-conditions}
...
### Проверка типов кода Web Worker и обработка вложенных Web Workers {#web-worker-code-type-checking-and-processing-of-nested-web-workers}
...
### Изменения расположения выходных файлов {#output-file-location-changes}
...
## Сообщения об ошибках {#reporting-errors}
