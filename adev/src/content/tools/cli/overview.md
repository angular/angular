...
## Синтаксис командного языка CLI {#cli-command-language-syntax}

Angular CLI в целом следует соглашениям Unix/POSIX в отношении синтаксиса опций.

### Логические (Boolean) опции {#boolean-options}
