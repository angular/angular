...
<docs-code header="src/my-builder.ts (builder skeleton)" example="cli-builder" path="src/my-builder.ts" visibleRegion="builder-skeleton"/>
...
<docs-code header="src/my-builder.ts (builder)" example="cli-builder" path="src/my-builder.ts" visibleRegion="builder"/>
...
<docs-code header="src/my-builder.ts (handling output)" example="cli-builder" path="src/my-builder.ts" visibleRegion="handling-output"/>
...
<docs-code header="src/my-builder.ts (progress reporting)" example="cli-builder" path="src/my-builder.ts" visibleRegion="progress-reporting"/>
...
<docs-code header="src/my-builder.ts (report status)" example="cli-builder" path="src/my-builder.ts" visibleRegion="report-status"/>
...
<docs-code header="src/my-builder.spec.ts" example="cli-builder" path="src/my-builder.spec.ts"/>
