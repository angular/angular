# Разработка Schematics {#authoring-schematics}
...
### Подсказки (Prompts) в Schematics {#schematics-prompts}
...
#### Сокращенный синтаксис подсказок {#prompt-short-syntax}
...
#### Полный синтаксис подсказок {#prompt-long-syntax}
