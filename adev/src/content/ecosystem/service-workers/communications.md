...
<docs-code header="log-update.service.ts" example="service-worker-getting-started" path="src/app/log-update.service.ts" visibleRegion="sw-update"/>
...
<docs-code header="check-for-update.service.ts" example="service-worker-getting-started" path="src/app/check-for-update.service.ts"/>
...
<docs-code header="prompt-update.service.ts" example="service-worker-getting-started" path="src/app/prompt-update.service.ts" visibleRegion="sw-version-ready"/>
...
<docs-code header="handle-unrecoverable-state.service.ts" example="service-worker-getting-started" path="src/app/handle-unrecoverable-state.service.ts" visibleRegion="sw-unrecoverable-state"/>
