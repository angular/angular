# Взаимодействие с Service Worker {#service-worker-communication}

Включение поддержки Service Workerа не просто регистрирует его; это также предоставляет сервисы, которые вы можете
использовать для взаимодействия с Service Workerом и управления кэшированием вашего приложения.
...
- Запрос к Service Workerу на проверку наличия новых обновлений на сервере.
- Запрос к Service Workerу на активацию последней версии приложения для текущей вкладки.
...
В некоторых случаях версия приложения, используемая Service Workerом для обслуживания клиента, может находиться в
