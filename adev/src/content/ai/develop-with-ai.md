...
| :------------------- | :--------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Antigravity          | <a download href="/assets/context/antigravity.md" target="_blank">antigravity.md</a>                                   | <a href="https://antigravity.google/docs/rules">Configure `antigravity.md`</a>                                                                                  |
