    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            label: 'Приём данных через входные свойства',
            path: 'guide/components/inputs',
            contentPath: 'guide/components/inputs',
          },
          {
            label: 'Пользовательские события через выходные свойства',
          ...
          {
            label: 'Ссылки на дочерние компоненты через запросы',
      ...
      },
      {
        ...
        children: [
          ...
          {
            label: 'Контроль доступа к маршрутам с гардами',
          ...
          {
            label: 'Создание пользовательских совпадений маршрутов',
...
export const REFERENCE_SUB_NAVIGATION_DATA: NavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        label: 'Синтаксис управления потоком',
