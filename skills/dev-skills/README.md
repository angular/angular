...
- **`angular-library`**: Guides the creation, build, and publishing of Angular libraries. Covers ng-packagr, secondary entry points, public API surface, schematics (`ng add`, `ng generate`), and publishing to npm.
