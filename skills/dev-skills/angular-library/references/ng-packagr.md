...
The `ng-package.json` file at the root of your library configures the ng-packagr build. This is the file `ng generate library my-lib` creates:
...
| `dest`           | Output directory, relative to `ng-package.json` (schema default: `dist`, `ng generate library` sets it) |
