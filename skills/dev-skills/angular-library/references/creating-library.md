...
>
> Fortunately, the Angular CLI automatically configures the correct path mappings pointing to the `dist/` folder in the root `tsconfig.json` when generating a library.
