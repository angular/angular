...
import {inject, InjectFlags, InjectionToken, Injector, Token, ɵsetCurrentInjector as setCurrentInjector} from '@angular/core';

class MockRootScopeInjector implements Injector {
  constructor(readonly parent: Injector) {}

  get<T>(token: Token<T>, defaultValue?: any, flags: InjectFlags = InjectFlags.Default): T {
