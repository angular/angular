...
/**
 * Collects a set of CSS styles for use in an animation style.
 */
 ...
 * When a transition is defined that matches the state criteria, the associated animation is triggered.
 *
