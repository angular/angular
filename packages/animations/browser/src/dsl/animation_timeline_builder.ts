 ...
 */
import {AnimateChildOptions, AnimateTimings, AnimationOptions, AnimationQueryOptions, AUTO_STYLE, ɵPRE_STYLE as PRE_STYLE, ɵStyleData} from '@angular/animations';
  ...
  private _copyOptions() {
    ...
    if (this.options) {
      ...
      if (oldParams) {
        ...
        Object.keys(this.options.params).forEach(name => {
