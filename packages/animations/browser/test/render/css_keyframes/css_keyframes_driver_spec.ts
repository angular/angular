...
describe('CssKeyframesDriver tests', () => {
  ...
  describe('when animating', () => {
    ...
    it('should animate until the `animationend` method is emitted, but stil retain the <style> method and the element animation details', fakeAsync(() => {
    ...
    it('should animate until finish() is called, but stil retain the <style> method and the element animation details', fakeAsync(() => {
      const elm = createElement();
      const animator = new CssKeyframesDriver();
    ...
    it('should animate until the destroy method is called and cleanup the element animation details', fakeAsync(() => {
      const elm = createElement();
      const animator = new CssKeyframesDriver();
    ...
    it('should cleanup the associated <style> object when the animation is destroyed', fakeAsync(() => {
      const elm = createElement();
      const animator = new CssKeyframesDriver();
...
function parseElementAnimationStyle(
  element: any
