    ...
    return {
      ...
      link: (scope: IScope, element: IAugmentedJQuery, attrs: IAttributes, required: any[]) => {
        ...
        const doDowngrade = (injector: Injector, moduleInjector: Injector) => {
          ...
          const componentFactoryResolver: ComponentFactoryResolver = moduleInjector.get(
            ComponentFactoryResolver
          );
          const componentFactory: ComponentFactory<any> = componentFactoryResolver.resolveComponentFactory(
            info.component
          )!;
