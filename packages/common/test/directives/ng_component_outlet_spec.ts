...
describe('insert/remove', () => {
  ...
  it('should use the injector, if one supplied', async(() => {
    ...
    fixture.componentInstance.injector = Injector.create(
      [{provide: TEST_TOKEN, useValue: uniqueValue}],
...
const TEST_CMP_TEMPLATE = `<ng-template *ngComponentOutlet="currentComponent; injector: injector; content: projectables; ngModuleFactory: module;"></ng-template>`;
