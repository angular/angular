    ...
    describe('corner cases', () => {
      ...
      it('should throw error when ngSwitchCase is used outside of ngSwitch', waitForAsync(() => {
           ...
           expect(() => createTestComponent(template))
               .toThrowError(
                   'NG2100: An element with the "ngSwitchCase" attribute (matching the "NgSwitchCase" directive) must be located inside an element with the "ngSwitch" attribute (matching "NgSwitch" directive)');
         }));
      ...
      it('should throw error when ngSwitchDefault is used outside of ngSwitch', waitForAsync(() => {
           ...
           expect(() => createTestComponent(template))
               .toThrowError(
                   'NG2100: An element with the "ngSwitchDefault" attribute (matching the "NgSwitchDefault" directive) must be located inside an element with the "ngSwitch" attribute (matching "NgSwitch" directive)');
         }));
