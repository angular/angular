...
/** @experimental */
export const NgLocaleTi: NgLocale = {
  localeId: 'ti',
  dateTimeTranslations: {
    ...
    eras: {abbreviated: ['ዓ/ዓ', 'ዓ/ም'], narrow: ['ዓ/ዓ', 'ዓ/ም'], wide: ['ዓ/ዓ', 'ዓመተ ምህረት']}
  },
  dateTimeSettings: {
    firstDayOfWeek: 0,
    weekendRange: [6, 0],
  ...
  currencySettings: {symbol: 'Br', name: 'የኢትዮጵያ ብር'},
