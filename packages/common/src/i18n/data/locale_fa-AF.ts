...
/** @experimental */
export const NgLocaleFaAF: NgLocale = {
  localeId: 'fa-AF',
  dateTimeTranslations: {
    ...
    months: {
      format: {
        narrow: ['ج', 'ف', 'م', 'ا', 'م', 'ج', 'ج', 'ا', 'س', 'ا', 'ن', 'د'],
        abbreviated: [
      ...
      standalone: {
        ...
        wide: [
          'جنوری', 'فبروری', 'ما��چ', 'اپریل', 'می', 'جون', 'جولای', 'اگست', 'سپتمبر', 'اکتوبر',
          'نومبر', 'دسمبر'
        ]
      }
    },
  ...
  currencySettings: {symbol: '؋', name: 'افغانی افغانستان'},
