...
/** @experimental */
export const NgLocaleZhHant: NgLocale = {
  localeId: 'zh-Hant',
  dateTimeTranslations: {
    ...
    eras: {abbreviated: ['西元前', '西元'], narrow: ['西元前', '西元'], wide: ['西元前', '西元']}
  },
  dateTimeSettings: {
    firstDayOfWeek: 0,
    weekendRange: [6, 0],
    formats: {
      date: {full: 'y年M月d日 EEEE', long: 'y年M月d日', medium: 'y年M月d日', short: 'y/M/d'},
  ...
  currencySettings: {symbol: '$', name: '新台幣'},
