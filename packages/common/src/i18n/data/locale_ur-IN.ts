...
/** @experimental */
export const NgLocaleUrIN: NgLocale = {
  localeId: 'ur-IN',
  dateTimeTranslations: {
    ...
    days: {
      format: {
        ...
        abbreviated: ['اتوار', 'پیر', 'منگل', 'بدھ', 'جمعرات', 'جمعہ', 'ہفتہ'],
        wide: ['اتوار', 'پیر', 'منگل', 'بدھ', 'جمعرات', 'جمعہ', 'ہفتہ']
      },
      standalone: {
        narrow: ['S', 'M', 'T', 'W', 'T', 'F', 'S'],
        short: ['اتوار', 'پیر', 'منگل', 'بدھ', 'جمعرات', 'جمعہ', 'ہفتہ'],
  ...
  currencySettings: {symbol: '₹', name: 'بھارتی روپیہ'},
