...
/** @experimental */
export const NgLocaleSrCyrlBA: NgLocale = {
  localeId: 'sr-Cyrl-BA',
  dateTimeTranslations: {
    ...
    days: {
      format: {
        ...
        wide: ['недјеља', 'понедељак', 'уторак', 'сриједа', 'четвртак', 'петак', 'субота']
      },
      standalone: {
        narrow: ['н', 'п', 'у', 'с', 'ч', 'п', 'с'],
        short: ['не', 'по', 'ут', 'ср', 'че', 'пе', 'су'],
  ...
  currencySettings: {symbol: 'КМ', name: 'Босанско-херцеговачка конвертибилна марка'},
