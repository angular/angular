...
/** @experimental */
export const NgLocaleHaw: NgLocale = {
  localeId: 'haw',
  dateTimeTranslations: {
    ...
    days: {
      format: {
        ...
        short: ['LP', 'P1', 'P2', 'P3', 'P4', 'P5', 'P6'],
        abbreviated: ['LP', 'P1', 'P2', 'P3', 'P4', 'P5', 'P6'],
        wide: ['Lāpule', 'Poʻakahi', 'Poʻalua', 'Poʻakolu', 'Poʻahā', 'Poʻalima', 'Poʻaono']
      },
      standalone: {
        narrow: ['S', 'M', 'T', 'W', 'T', 'F', 'S'],
        short: ['LP', 'P1', 'P2', 'P3', 'P4', 'P5', 'P6'],
  ...
  currencySettings: {symbol: '$', name: 'USD'},
