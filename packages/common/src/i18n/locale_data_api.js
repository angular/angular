...
function checkFullData(data) {
  if (!data[ɵLocaleDataIndex.ExtraData]) {
    throw new RuntimeError(
      2303 /* RuntimeErrorCode.MISSING_EXTRA_LOCALE_DATA_FOR_LOCALE */,
      ngDevMode &&
...
export function getLocaleExtraDayPeriodRules(locale) {
  ...
  checkFullData(data);
  const rules =
    data[ɵLocaleDataIndex.ExtraData][2 /* ɵExtraLocaleDataIndex.ExtraDayPeriodsRules */] || [];
...
function getLastDefinedValue(data, index) {
  ...
  throw new RuntimeError(
    2304 /* RuntimeErrorCode.LOCALE_DATA_UNDEFINED */,
