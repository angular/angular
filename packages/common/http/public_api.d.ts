 ...
 */
export { HttpBackend, HttpHandler, HttpInterceptorHandler as ɵHttpInterceptingHandler, } from './src/backend';
export { HttpClient } from './src/client';
export { HttpContext, HttpContextToken } from './src/context';
export { FetchBackend } from './src/fetch';
export { HttpHeaders } from './src/headers';
export { HTTP_INTERCEPTORS, HttpHandlerFn, HttpInterceptor, HttpInterceptorFn, } from './src/interceptor';
...
export { HttpTransferCacheOptions, withHttpTransferCache as ɵwithHttpTransferCache, HTTP_TRANSFER_CACHE_ORIGIN_MAP, } from './src/transfer_cache';
