...
import {ACCEPT_HEADER, ACCEPT_HEADER_VALUE, CONTENT_TYPE_HEADER} from './request';
import {
  ...
  handle(req) {
    ...
    if (req.method === 'JSONP') {
      throw new RuntimeError(
        -2800 /* RuntimeErrorCode.MISSING_JSONP_MODULE */,
...
HttpXhrBackend = __decorate([Injectable({providedIn: 'root'})], HttpXhrBackend);
