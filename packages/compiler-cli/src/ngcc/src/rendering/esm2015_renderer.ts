...
import {DecorationAnalyses, DecorationAnalysis} from '../analysis/decoration_analyzer';
...
export class Esm2015Renderer extends Fesm2015Renderer {
  constructor(
      protected host: NgccReflectionHost, protected sourcePath: string,
      protected targetPath: string, protected dtsMapper: DtsMapper) {
    super(host, sourcePath, targetPath);
  }
