...
describe('getEntryPointInfo()', () => {
  ...
  it('should work with Angular Material style package.json', () => {
    ...
    expect(entryPoint).toEqual({
      ...
      esm2015: `/some_package/material_style/esm2015/material_style.js`,
      esm5: `/some_package/material_style/esm5/material_style.es5.js`,
...
function createPackageJson(
    packageName: string, {exclude}: {exclude?: string} = {},
