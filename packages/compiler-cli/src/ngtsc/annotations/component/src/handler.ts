...
import {Cycle, CycleAnalyzer, CycleHandlingStrategy} from '../../../cycles/index.js';
import {ErrorCode, FatalDiagnosticError, makeDiagnostic} from '../../../diagnostics/index.js';
import {absoluteFrom, relative} from '../../../file_system/index.js';
import {assertSuccessfulReferenceEmit, ImportedFile, ModuleResolver, Reference, ReferenceEmitter} from '../../../imports/index.js';
...
import {DirectiveMeta, extractDirectiveTypeCheckMeta, InjectableClassRegistry, MetadataReader, MetadataRegistry, MetaKind, PipeMeta, ResourceRegistry} from '../../../metadata/index.js';
import {PartialEvaluator} from '../../../partial_evaluator/index.js';
import {PerfEvent, PerfRecorder} from '../../../perf/index.js';
import {ClassDeclaration, DeclarationNode, Decorator, ReflectionHost, reflectObjectLiteral} from '../../../reflection/index.js';
import {ComponentScopeKind, ComponentScopeReader, DtsModuleScopeResolver, LocalModuleScopeRegistry, makeNotStandaloneDiagnostic, makeUnknownComponentImportDiagnostic, TypeCheckScopeRegistry} from '../../../scope/index.js';
...
import {extractDirectiveMetadata, parseFieldArrayValue} from '../../directive/index.js';
import {NgModuleSymbol} from '../../ng_module/index.js';

import {checkCustomElementSelectorForErrors, makeCyclicImportInfo} from './diagnostics.js';
import {ComponentAnalysisData, ComponentResolutionData} from './metadata.js';
import {_extractTemplateStyleUrls, extractComponentStyleUrls, extractStyleResources, extractTemplate, makeResourceNotFoundError, ParsedTemplateWithSource, parseTemplateDeclaration, preloadAndParseTemplate, ResourceTypeForDiagnostics, StyleUrlMeta, transformDecoratorToInlineResources} from './resources.js';
import {ComponentSymbol} from './symbol.js';
import {animationTriggerResolver, collectAnimationNames, validateAndFlattenComponentImports} from './util.js';
