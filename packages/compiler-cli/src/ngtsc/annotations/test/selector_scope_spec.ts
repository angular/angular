...
import {LocalIdentifierStrategy, NodeModulesReferenceEmitStrategy, Reference, ReferenceEmitter, RelativeReferenceEmitStrategy} from '../../imports';
...
function makeReferenceEmitter(
  ...
  return new ReferenceEmitter([
    ...
    new NodeModulesReferenceEmitStrategy(program, checker, options, host),
    new RelativeReferenceEmitStrategy(checker, new LogicalFileSystem(rootDirs)),
  ]);
}
