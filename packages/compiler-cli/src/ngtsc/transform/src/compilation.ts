...
export class IvyCompilation {
  ...
  private typeCheckMap = new Map<ts.Declaration, IvyClass>();
  ...
  private detectHandlersForClass(node: ts.Declaration): IvyClass|null {
    ...
    for (const handler of this.handlers) {
      ...
      const isSharedHandler = handler.precedence === HandlerPrecedence.SHARED;
      ...
      if (ivyClass === null) {
        ...
        ivyClass = {
          ...
          hasSharedHandlers: isSharedHandler,
        ...
        ivyClass.hasSharedHandlers = isSharedHandler;
        ivyClass.hasPrimaryHandler = isPrimaryHandler;
      }
    }
