...
import {Import, ImportManager, NamespaceImport, SideEffectImport} from '../../translator';
...
export function addImports(
  ...
  const addedImports = importManager.getAllImports(sf.fileName).map(i => {
    return i.qualifier !== null ? createNamespaceImportDecl(i) : createSideEffectImportDecl(i);
  });
...
function createNamespaceImportDecl(i: NamespaceImport): ts.ImportDeclaration {
...
function createSideEffectImportDecl(i: SideEffectImport): ts.ImportDeclaration {
