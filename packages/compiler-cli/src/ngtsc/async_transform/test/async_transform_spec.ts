  ...
  describe('async transform', () => {
    ...
    it('should transform reads and writes of `super` properties within async methods', () => {
      ...
      expect(emittedContent.split(/\r?\n/g)).toEqual([
        ...
        '        return Zone.__awaiter(this, [a, b], function* (a, b) {',
    ...
    it('should transform accesses of `super` within async arrows', () => {
      ...
      expect(emittedContent.split(/\r?\n/g)).toEqual([
        ...
        '            foo: { get: () => super.foo }',
        '        });',
        '        const callSuperFoo = () => Zone.__awaiter(this, [], function* () { return (yield ɵsuper.foo.call(this, a, b)) + (yield ɵsuperIndex("foo").call(this, a, b)); });',
        '        callSuperFoo();',
        '        return 20;',
        '    }',
        '    bar(a, b) {',
        ...
        '        });',
        '        return Zone.__awaiter(this, [a, b], function* (a, b) {',
        '            const callSuperFoo = () => Zone.__awaiter(this, [], function* () { return (yield ɵsuper_1.foo.call(this, a, b)) + (yield ɵsuperIndex_1("foo").call(this, a, b)); });',
        '            yield callSuperFoo();',
        '        });',
        '    }',
        '    moo(a, b) {',
