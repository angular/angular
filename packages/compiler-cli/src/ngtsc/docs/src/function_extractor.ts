...
export class FunctionExtractor {
  ...
  extract(): FunctionEntry {
    ...
    let signature = this.typeChecker.getSignatureFromDeclaration(this.exportDeclaration);
    let returnType = signature ? extractReturnType(signature, this.typeChecker) : 'unknown';
