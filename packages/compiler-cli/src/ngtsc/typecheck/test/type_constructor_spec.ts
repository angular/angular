...
import {LocalIdentifierStrategy, NodeModulesReferenceEmitStrategy, ReferenceEmitter, RelativeReferenceEmitStrategy} from '../../imports';
...
TestClass.ngTypeCtor({value: 'test'});
      ...
      const emitter = new ReferenceEmitter([
        ...
        new RelativeReferenceEmitStrategy(checker, logicalFs),
      ]);
