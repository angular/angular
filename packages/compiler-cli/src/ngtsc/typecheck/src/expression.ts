...
import {AST, AstVisitor, ASTWithSource, Binary, BindingPipe, Chain, Conditional, EmptyExpr, FunctionCall, ImplicitReceiver, Interpolation, KeyedRead, KeyedWrite, LiteralArray, LiteralMap, LiteralPrimitive, MethodCall, NonNullAssert, PrefixNot, PropertyRead, PropertyWrite, Quote, SafeMethodCall, SafePropertyRead, ThisImplicitReceiver, Unary} from '@angular/compiler';
...
class AstTranslator implements AstVisitor {
  ...
  visitThisImplicitReceiver(ast: ThisImplicitReceiver): never {
    throw new Error('Method not implemented.');
  }
...
class VeSafeLhsInferenceBugDetector implements AstVisitor {
  ...
  visitThisImplicitReceiver(ast: ThisImplicitReceiver): boolean {
    return false;
  }
