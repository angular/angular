...
import {AST, EmptyExpr, PropertyRead, PropertyWrite, SafePropertyRead, TmplAstNode} from '@angular/compiler/src/compiler';
...
export class CompletionEngine {
  ...
  private expressionCompletionCache = new Map<PropertyRead|SafePropertyRead, ShimLocation>();
