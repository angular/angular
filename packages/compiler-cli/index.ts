...
export {CompilerHost} from './src/compiler_host';
...
// TODO(vicb): clean exports
export {createModuleFilenameResolver} from './src/transformers/module_filename_resolver';
export {ModuleFilenameResolver} from './src/transformers/api';
