  ...
  computeDependencies(
    ...
    sf.statements
        ...
        .forEach(importPath => {
          ...
          if (resolvedModule) {
            if (resolvedModule.isRelative) {
              const internalDependency = resolvedModule.resolvedPath;
              ...
              const entryPointPath = resolvedModule.resolvedPath;
              if (!resolvedModule.isDeepImport) {
                dependencies.add(entryPointPath);
              } else {
                deepImports.add(entryPointPath);
              }
            }
          } else {
