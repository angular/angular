...
export class ParallelTaskQueue extends BaseTaskQueue {
  ...
  constructor(tasks: Task[], graph: DepGraph<EntryPoint>) {
 ...
 */
function computeBlockedTasks(tasks: Task[], graph: DepGraph<EntryPoint>): Map<Task, Set<Task>> {
 ...
 */
function sortTasksByPriority(tasks: Task[], blockedTasks: Map<Task, Set<Task>>): Task[] {
