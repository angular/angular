...
import {DefinePropertyReexportStatement, ExportDeclaration, ExportStatement, extractGetterFnExpression, findNamespaceOfIdentifier, findRequireCallReference, isDefinePropertyReexportStatement, isExportStatement, isRequireCall, isWildcardReexportStatement, WildcardReexportStatement} from './commonjs_umd_utils';
...
export class UmdReflectionHost extends Esm5ReflectionHost {
  ...
  private getUmdModuleDeclaration(id: ts.Identifier): Declaration|null {
    ...
    const viaModule = !importPath.startsWith('./') ? importPath : null;
