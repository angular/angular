  ...
  describe('NgccConfiguration', () => {
    describe('constructor', () => {
      it('should error if a project level config file is badly formatted', () => {
        ...
        expect(() => new NgccConfiguration(fs, _Abs('/project-1'))).toThrowError(
          `Invalid project configuration file at "${_Abs(
            '/project-1/ngcc.config.js'
    ...
    describe('hash', () => {
      it('should compute a hash from the loaded and processed project configuration', () => {
        ...
        const expectedProject1Config = `{"packages":{"${project1Package1}":[{"entryPoints":{"${project1Package1EntryPoint1}":{}},"versionRange":"*"}]}}`;
        expect(project1Conf.hash).toEqual(
          createHash('md5').update(expectedProject1Config).digest('hex')
        );
        ...
        const expectedProject2Config = `{"packages":{"${project2Package1}":[{"entryPoints":{"${project2Package1EntryPoint1}":{"ignore":true}},"versionRange":"*"}]}}`;
        expect(project2Conf.hash).toEqual(
          createHash('md5').update(expectedProject2Config).digest('hex')
        );
      });
    ...
    describe('getConfig()', () => {
      describe('at the package level', () => {
        it('should return configuration for a package found in a package level file, with a matching version', () => {
          ...
          expect(readFileSpy).toHaveBeenCalledWith(
            _Abs('/project-1/node_modules/package-1/ngcc.config.js')
          );
        });

        it('should read extra package config from package level file', () => {
          loadTestFiles(
            packageWithConfigFiles(
              'package-1',
              'entry-point-1',
              '1.0.0',
        ...
        it('should error if a package level config file is badly formatted', () => {
          ...
          expect(() =>
            ...
            `Invalid package configuration file at "${_Abs(
              '/project-1/node_modules/package-1/ngcc.config.js'
            )}": Unexpected identifier`
          );
        });
      });
      ...
      describe('at the project level', () => {
        ...
        it('should return configuration for the correct version of a package found in a project level file', () => {
          ...
          expect(
            configuration.getConfig(_Abs('/project-1/node_modules/package-1'), '2.5.0')
          ).toEqual({
            versionRange: '2.*',
            entryPoints: {[_Abs('/project-1/node_modules/package-1/entry-point-2')]: {}},
          });
          expect(
            configuration.getConfig(_Abs('/project-1/node_modules/package-1'), '3.2.5')
          ).toEqual({
            versionRange: '^3.2.0',
            entryPoints: {[_Abs('/project-1/node_modules/package-1/entry-point-3')]: {}},
          });
          expect(
            configuration.getConfig(_Abs('/project-1/node_modules/package-1'), '4.0.0')
        ...
        it('should correctly handle pre-release versions and version ranges', () => {
          ...
          expect(getConfig('package-1', '1.0.0-beta.2')).toEqual(
            {
              versionRange: '*',
              entryPoints: {[_Abs('/project-1/node_modules/package-1/entry-point-1')]: {}},
            },
          ...
          expect(getConfig('package-2', '1.0.0-beta.2')).toEqual(
            {
          ...
          expect(getConfig('package-2', '1.0.0')).toEqual(
            {
              versionRange: '*',
              entryPoints: {},
            },
          ...
          expect(getConfig('package-2', null)).toEqual(
            {
              versionRange: '1.0.0-beta.2',
              entryPoints: {[_Abs('/project-1/node_modules/package-2/entry-point-2')]: {}},
            },
          ...
          // Version range: >=1.0.0-beta.2
          expect(getConfig('package-3', '1.0.0-beta.2')).toEqual(
            {
              versionRange: '>=1.0.0-beta.2',
          ...
          expect(getConfig('package-3', '1.0.0')).toEqual(
            {
              versionRange: '>=1.0.0-beta.2',
              entryPoints: {[_Abs('/project-1/node_modules/package-3/entry-point-3')]: {}},
            },
          ...
          expect(getConfig('package-3', '2.0.0')).toEqual(
            {
              versionRange: '>=1.0.0-beta.2',
              entryPoints: {[_Abs('/project-1/node_modules/package-3/entry-point-3')]: {}},
            },
          ...
          expect(getConfig('package-3', '1.0.0-beta.1')).toEqual(
            {
              versionRange: '*',
              entryPoints: {},
            },
          ...
          expect(getConfig('package-3', '0.9.99')).toEqual(
            {
              versionRange: '*',
              entryPoints: {},
            },
        ...
        it('should not get confused by the @ in namespaced packages', () => {
          ...
          expect(
            configuration.getConfig(_Abs('/project-1/node_modules/@angular/common'), '1.0.0')
          ).toEqual({
            versionRange: '*',
        ...
        it('should override package level config with project level config per package', () => {
          ...
          const package1Config = configuration.getConfig(
            _Abs('/project-1/node_modules/package-1'),
            '1.0.0'
          );
          ...
          // merge entry-points.
          const package2Config = configuration.getConfig(
            _Abs('/project-1/node_modules/package-2'),
            '1.0.0'
          );
          ...
          expect(readFileSpy).not.toHaveBeenCalledWith(
            _Abs('/project-1/node_modules/package-2/ngcc.config.js')
          );
        });
      });
