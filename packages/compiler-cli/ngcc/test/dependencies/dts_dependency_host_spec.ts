  ...
  describe('DtsDependencyHost', () => {
    ...
    describe('collectDependencies()', () => {
      it('should not generate a TS AST if the source does not contain any imports or re-exports', () => {
        ...
        host.collectDependencies(_('/no/imports/or/re-exports/index.d.ts'), createDependencyInfo());
      ...
      it('should resolve all the external imports of the source file', () => {
        ...
        host.collectDependencies(_('/external/imports/index.d.ts'), {
          dependencies,
          missing,
          deepImports,
        });
      ...
      it('should resolve all the external re-exports of the source file', () => {
        const {dependencies, missing, deepImports} = createDependencyInfo();
        host.collectDependencies(_('/external/re-exports/index.d.ts'), {
          dependencies,
          missing,
          deepImports,
        });
      ...
      it('should capture missing external imports', () => {
        const {dependencies, missing, deepImports} = createDependencyInfo();
        host.collectDependencies(_('/external/imports-missing/index.d.ts'), {
          dependencies,
          missing,
          deepImports,
        });
      ...
      it('should not register deep imports as missing', () => {
        ...
        const {dependencies, missing, deepImports} = createDependencyInfo();
        host.collectDependencies(_('/external/deep-import/index.d.ts'), {
          dependencies,
          missing,
          deepImports,
        });
      ...
      it('should not register deep imports as missing, if available in `@types/...`', () => {
        ...
        const {dependencies, missing, deepImports} = createDependencyInfo();
        host.collectDependencies(_('/external/deep-import-2/index.d.ts'), {
          dependencies,
          missing,
          deepImports,
        });
      ...
      it('should recurse into internal dependencies', () => {
        const {dependencies, missing, deepImports} = createDependencyInfo();
        host.collectDependencies(_('/internal/outer/index.d.ts'), {
          dependencies,
          missing,
          deepImports,
        });
      ...
      it('should handle circular internal dependencies', () => {
        const {dependencies, missing, deepImports} = createDependencyInfo();
        host.collectDependencies(_('/internal/circular-a/index.d.ts'), {
          dependencies,
          missing,
          deepImports,
        });
