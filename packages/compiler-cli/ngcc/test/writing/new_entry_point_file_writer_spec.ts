...
runInEachFileSystem(() => {
  describe('NewEntryPointFileWriter', () => {
    ...
    beforeEach(() => {
      ...
      loadTestFiles([
        ...
        {name: _('/node_modules/test/a/es2015/foo.js'), contents: 'export class FooA {}'},
        {
          ...
          contents: `{"module": "../lib/esm5.js", "es2015": "../lib/es2015/index.js", "typings": "../typings/index.d.ts"}`,
        },
    ...
    describe('writeBundle() [primary entry-point]', () => {
      beforeEach(() => {
        fileWriter = new NewEntryPointFileWriter(
          ...
          new DirectPackageJsonUpdater(fs)
        );
      ...
      it('should write the modified files to a new folder', () => {
        ...
        expect(fs.readFile(_('/node_modules/test/__ivy_ngcc__/esm5.js'))).toEqual(
          'export function FooTop() {} // MODIFIED'
        );
        expect(fs.readFile(_('/node_modules/test/esm5.js'))).toEqual('export function FooTop() {}');
        expect(fs.readFile(_('/node_modules/test/__ivy_ngcc__/esm5.js.map'))).toEqual(
          'MODIFIED MAPPING DATA'
        );
      ...
      it('should also copy unmodified files in the program', () => {
        ...
        expect(fs.readFile(_('/node_modules/test/__ivy_ngcc__/es2015/foo.js'))).toEqual(
          'export class FooTop {} // MODIFIED'
        );
        expect(fs.readFile(_('/node_modules/test/es2015/foo.js'))).toEqual(
          'export class FooTop {}'
        );
        expect(fs.readFile(_('/node_modules/test/__ivy_ngcc__/es2015/index.js'))).toEqual(
          'export {FooTop} from "./foo";'
        );
        expect(fs.readFile(_('/node_modules/test/es2015/index.js'))).toEqual(
          'export {FooTop} from "./foo";'
        );
      });
      ...
      it('should update the package.json properties', () => {
        ...
        expect(loadPackageJson(fs, '/node_modules/test')).toEqual(
      ...
      it('should overwrite and backup typings files', () => {
        ...
        expect(fs.readFile(_('/node_modules/test/index.d.ts'))).toEqual(
          'export declare class FooTop {} // MODIFIED'
        );
        expect(fs.readFile(_('/node_modules/test/index.d.ts.__ivy_ngcc_bak'))).toEqual(
          'export declare class FooTop {}'
        );
        expect(fs.exists(_('/node_modules/test/__ivy_ngcc__/index.d.ts'))).toBe(false);

        expect(fs.readFile(_('/node_modules/test/index.d.ts.map'))).toEqual(
          'MODIFIED MAPPING DATA'
        );
        expect(fs.readFile(_('/node_modules/test/index.d.ts.map.__ivy_ngcc_bak'))).toEqual(
    ...
    describe('writeBundle() [secondary entry-point]', () => {
      ...
      it('should write the modified file to a new folder', () => {
        ...
        expect(fs.readFile(_('/node_modules/test/__ivy_ngcc__/a/esm5.js'))).toEqual(
          'export function FooA() {} // MODIFIED'
        );
      ...
      it('should also copy unmodified files in the program', () => {
        ...
        expect(fs.readFile(_('/node_modules/test/__ivy_ngcc__/a/es2015/foo.js'))).toEqual(
          'export class FooA {} // MODIFIED'
        );
        expect(fs.readFile(_('/node_modules/test/a/es2015/foo.js'))).toEqual(
          'export class FooA {}'
        );
        expect(fs.readFile(_('/node_modules/test/__ivy_ngcc__/a/es2015/index.js'))).toEqual(
          'export {FooA} from "./foo";'
        );
        expect(fs.readFile(_('/node_modules/test/a/es2015/index.js'))).toEqual(
          'export {FooA} from "./foo";'
        );
      });
      ...
      it('should update the package.json properties', () => {
        ...
        expect(loadPackageJson(fs, '/node_modules/test/a')).toEqual(
          jasmine.objectContaining({
      ...
      it('should overwrite and backup typings files', () => {
        ...
        expect(fs.readFile(_('/node_modules/test/a/index.d.ts'))).toEqual(
          'export declare class FooA {} // MODIFIED'
        );
        expect(fs.readFile(_('/node_modules/test/a/index.d.ts.__ivy_ngcc_bak'))).toEqual(
          'export declare class FooA {}'
        );
    ...
    describe('writeBundle() [entry-point (with files placed outside entry-point folder)]', () => {
      ...
      it('should write the modified file to a new folder', () => {
        ...
        expect(fs.readFile(_('/node_modules/test/__ivy_ngcc__/lib/esm5.js'))).toEqual(
          'export function FooB() {} // MODIFIED'
        );
        expect(fs.readFile(_('/node_modules/test/lib/esm5.js'))).toEqual(
      ...
      it('should also copy unmodified files in the program', () => {
        ...
        expect(fs.readFile(_('/node_modules/test/__ivy_ngcc__/lib/es2015/foo.js'))).toEqual(
          'export class FooB {} // MODIFIED'
        );
        expect(fs.readFile(_('/node_modules/test/lib/es2015/foo.js'))).toEqual(
          'import {FooA} from "test/a"; import "events"; export class FooB {}'
        );
        expect(fs.readFile(_('/node_modules/test/__ivy_ngcc__/lib/es2015/index.js'))).toEqual(
          'export {FooB} from "./foo"; import * from "other";'
        );
        expect(fs.readFile(_('/node_modules/test/lib/es2015/index.js'))).toEqual(
          'export {FooB} from "./foo"; import * from "other";'
        );
      });
      ...
      it('should update the package.json properties', () => {
        ...
        expect(loadPackageJson(fs, '/node_modules/test/b')).toEqual(
          jasmine.objectContaining({
      ...
      it('should overwrite and backup typings files', () => {
        ...
        expect(fs.readFile(_('/node_modules/test/typings/index.d.ts'))).toEqual(
          'export declare class FooB {} // MODIFIED'
        );
        expect(fs.readFile(_('/node_modules/test/typings/index.d.ts.__ivy_ngcc_bak'))).toEqual(
          'export declare class FooB {}'
        );
  ...
  function makeTestBundle(
    ...
    return makeEntryPointBundle(
      fs,
      entryPoint,
      entryPoint.packageJson[formatProperty]!,
      false,
      format,
      true
    );
