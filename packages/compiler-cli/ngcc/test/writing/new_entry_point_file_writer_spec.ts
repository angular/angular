...
describe('NewEntryPointFileWriter', () => {
  ...
  describe('writeBundle() [primary entry-point]', () => {
    beforeEach(() => {
      ...
      entryPoint = getEntryPointInfo(
          fs, new MockLogger(), _Abs('/node_modules/test'), _Abs('/node_modules/test')) !;
    ...
    it('should write the modified files to a new folder', () => {
      fileWriter.writeBundle(entryPoint, esm5bundle, [
        {
          path: _Abs('/node_modules/test/esm5.js'),
          contents: 'export function FooTop() {} // MODIFIED'
        },
        {path: _Abs('/node_modules/test/esm5.js.map'), contents: 'MODIFIED MAPPING DATA'},
      ]);
      expect(fs.readFile(_Abs('/node_modules/test/__ivy_ngcc__/esm5.js')))
          .toEqual('export function FooTop() {} // MODIFIED');
      expect(fs.readFile(_Abs('/node_modules/test/esm5.js')))
          .toEqual('export function FooTop() {}');
      expect(fs.readFile(_Abs('/node_modules/test/__ivy_ngcc__/esm5.js.map')))
          .toEqual('MODIFIED MAPPING DATA');
      expect(fs.readFile(_Abs('/node_modules/test/esm5.js.map'))).toEqual('ORIGINAL MAPPING DATA');
    });

    it('should also copy unmodified files in the program', () => {
      fileWriter.writeBundle(entryPoint, esm2015bundle, [
        {
          path: _Abs('/node_modules/test/es2015/foo.js'),
          contents: 'export class FooTop {} // MODIFIED'
        },
      ]);
      expect(fs.readFile(_Abs('/node_modules/test/__ivy_ngcc__/es2015/foo.js')))
          .toEqual('export class FooTop {} // MODIFIED');
      expect(fs.readFile(_Abs('/node_modules/test/es2015/foo.js')))
          .toEqual('export class FooTop {}');
      expect(fs.readFile(_Abs('/node_modules/test/__ivy_ngcc__/es2015/index.js')))
          .toEqual('export {FooTop} from "./foo";');
      expect(fs.readFile(_Abs('/node_modules/test/es2015/index.js')))
          .toEqual('export {FooTop} from "./foo";');
    });
    ...
    it('should overwrite and backup typings files', () => {
      fileWriter.writeBundle(entryPoint, esm2015bundle, [
        {
          path: _Abs('/node_modules/test/index.d.ts'),
          contents: 'export declare class FooTop {} // MODIFIED'
        },
        {path: _Abs('/node_modules/test/index.d.ts.map'), contents: 'MODIFIED MAPPING DATA'},
      ]);
      expect(fs.readFile(_Abs('/node_modules/test/index.d.ts')))
          .toEqual('export declare class FooTop {} // MODIFIED');
      expect(fs.readFile(_Abs('/node_modules/test/index.d.ts.__ivy_ngcc_bak')))
          .toEqual('export declare class FooTop {}');
      expect(fs.exists(_Abs('/node_modules/test/__ivy_ngcc__/index.d.ts'))).toBe(false);

      expect(fs.readFile(_Abs('/node_modules/test/index.d.ts.map')))
          .toEqual('MODIFIED MAPPING DATA');
      expect(fs.readFile(_Abs('/node_modules/test/index.d.ts.map.__ivy_ngcc_bak')))
          .toEqual('ORIGINAL MAPPING DATA');
      expect(fs.exists(_Abs('/node_modules/test/__ivy_ngcc__/index.d.ts.map'))).toBe(false);
    });
  });
  ...
  describe('writeBundle() [secondary entry-point]', () => {
    beforeEach(() => {
      ...
      fileWriter = new NewEntryPointFileWriter(fs);
      entryPoint = getEntryPointInfo(
          fs, new MockLogger(), _Abs('/node_modules/test'), _Abs('/node_modules/test/a')) !;
      esm5bundle = makeTestBundle(fs, entryPoint, 'module', 'esm5');
      esm2015bundle = makeTestBundle(fs, entryPoint, 'es2015', 'esm2015');
    });
    ...
    it('should write the modified file to a new folder', () => {
      fileWriter.writeBundle(entryPoint, esm5bundle, [
        {
          path: _Abs('/node_modules/test/a/esm5.js'),
          contents: 'export function FooA() {} // MODIFIED'
        },
      ]);
      expect(fs.readFile(_Abs('/node_modules/test/__ivy_ngcc__/a/esm5.js')))
          .toEqual('export function FooA() {} // MODIFIED');
      expect(fs.readFile(_Abs('/node_modules/test/a/esm5.js')))
    ...
    it('should also copy unmodified files in the program', () => {
      fileWriter.writeBundle(entryPoint, esm2015bundle, [
        {
          path: _Abs('/node_modules/test/a/es2015/foo.js'),
          contents: 'export class FooA {} // MODIFIED'
        },
      ]);
      expect(fs.readFile(_Abs('/node_modules/test/__ivy_ngcc__/a/es2015/foo.js')))
          .toEqual('export class FooA {} // MODIFIED');
      expect(fs.readFile(_Abs('/node_modules/test/a/es2015/foo.js')))
          .toEqual('export class FooA {}');
      expect(fs.readFile(_Abs('/node_modules/test/__ivy_ngcc__/a/es2015/index.js')))
          .toEqual('export {FooA} from "./foo";');
      expect(fs.readFile(_Abs('/node_modules/test/a/es2015/index.js')))
          .toEqual('export {FooA} from "./foo";');
    });
    ...
    it('should overwrite and backup typings files', () => {
      fileWriter.writeBundle(entryPoint, esm2015bundle, [
        {
          path: _Abs('/node_modules/test/a/index.d.ts'),
          contents: 'export declare class FooA {} // MODIFIED'
        },
      ]);
      expect(fs.readFile(_Abs('/node_modules/test/a/index.d.ts')))
          .toEqual('export declare class FooA {} // MODIFIED');
      expect(fs.readFile(_Abs('/node_modules/test/a/index.d.ts.__ivy_ngcc_bak')))
          .toEqual('export declare class FooA {}');
      expect(fs.exists(_Abs('/node_modules/test/__ivy_ngcc__/a/index.d.ts'))).toBe(false);
    });
  });
  ...
  describe('writeBundle() [entry-point (with files placed outside entry-point folder)]', () => {
    beforeEach(() => {
      ...
      fileWriter = new NewEntryPointFileWriter(fs);
      entryPoint = getEntryPointInfo(
          fs, new MockLogger(), _Abs('/node_modules/test'), _Abs('/node_modules/test/b')) !;
      esm5bundle = makeTestBundle(fs, entryPoint, 'module', 'esm5');
      esm2015bundle = makeTestBundle(fs, entryPoint, 'es2015', 'esm2015');
    });
    ...
    it('should write the modified file to a new folder', () => {
      fileWriter.writeBundle(entryPoint, esm5bundle, [
        {
          path: _Abs('/node_modules/test/lib/esm5.js'),
          contents: 'export function FooB() {} // MODIFIED'
        },
      ]);
      expect(fs.readFile(_Abs('/node_modules/test/__ivy_ngcc__/lib/esm5.js')))
          .toEqual('export function FooB() {} // MODIFIED');
      expect(fs.readFile(_Abs('/node_modules/test/lib/esm5.js')))
    ...
    it('should also copy unmodified files in the program', () => {
      fileWriter.writeBundle(entryPoint, esm2015bundle, [
        {
          path: _Abs('/node_modules/test/lib/es2015/foo.js'),
          contents: 'export class FooB {} // MODIFIED'
        },
      ]);
      expect(fs.readFile(_Abs('/node_modules/test/__ivy_ngcc__/lib/es2015/foo.js')))
          .toEqual('export class FooB {} // MODIFIED');
      expect(fs.readFile(_Abs('/node_modules/test/lib/es2015/foo.js')))
          .toEqual('import {FooA} from "test/a"; import "events"; export class FooB {}');
      expect(fs.readFile(_Abs('/node_modules/test/__ivy_ngcc__/lib/es2015/index.js')))
          .toEqual('export {FooB} from "./foo"; import * from "other";');
      expect(fs.readFile(_Abs('/node_modules/test/lib/es2015/index.js')))
          .toEqual('export {FooB} from "./foo"; import * from "other";');
    });
    ...
    it('should not copy typings files within the package (i.e. from a different entry-point)',
       () => {
         ...
         expect(fs.exists(_Abs('/node_modules/test/__ivy_ngcc__/a/index.d.ts'))).toEqual(false);
       });
    ...
    it('should not copy files outside of the package', () => {
      ...
      expect(fs.exists(_Abs('/node_modules/test/other/index.d.ts'))).toEqual(false);
      expect(fs.exists(_Abs('/node_modules/test/events/events.js'))).toEqual(false);
    });
    ...
    it('should overwrite and backup typings files', () => {
      fileWriter.writeBundle(entryPoint, esm2015bundle, [
        {
          path: _Abs('/node_modules/test/typings/index.d.ts'),
          contents: 'export declare class FooB {} // MODIFIED'
        },
      ]);
      expect(fs.readFile(_Abs('/node_modules/test/typings/index.d.ts')))
          .toEqual('export declare class FooB {} // MODIFIED');
      expect(fs.readFile(_Abs('/node_modules/test/typings/index.d.ts.__ivy_ngcc_bak')))
          .toEqual('export declare class FooB {}');
      expect(fs.exists(_Abs('/node_modules/test/__ivy_ngcc__/typings/index.d.ts'))).toBe(false);
    });
  });
});
...
function makeTestBundle(
  ...
  return makeEntryPointBundle(
      ...
      entryPoint.typings, false, formatProperty, format, true) !;
}
