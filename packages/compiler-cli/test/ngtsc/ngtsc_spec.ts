  ...
  describe('ngtsc behavioral tests', () => {
    ...
    describe('animate.enter', () => {
      it('should compile animate.enter event bindings with a function call', () => {
        ...
        const jsContents = env.getContents('test.js');
        expect(jsContents).toContain(
          'i0.ɵɵanimateEnterListener(function TestComponent_Conditional_1_Template_p_enteranimate_enter_0_listener($event) { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.animateFn($event)); });',
        );
      ...
      it('should compile animate.enter bindings with a class string', () => {
        ...
        const jsContents = env.getContents('test.js');
        expect(jsContents).toContain('i0.ɵɵanimateEnter(ctx_r0.fade());');
        const instances = jsContents.match(/ɵɵanimateEnter/g);
        expect(instances?.length).toBe(1);
      });
      ...
      it('should compile animate.enter bindings with a string array', () => {
        ...
        const jsContents = env.getContents('test.js');
        expect(jsContents).toContain('i0.ɵɵanimateEnter(ctx_r0.classList);');
        const instances = jsContents.match(/ɵɵanimateEnter/g);
        expect(instances?.length).toBe(1);
      });
    ...
    describe('animate.leave', () => {
      it('should compile animate.leave event bindings with a function call', () => {
        ...
        const jsContents = env.getContents('test.js');
        expect(jsContents).toContain(
          'i0.ɵɵanimateLeaveListener(function TestComponent_Conditional_1_Template_p_leaveanimate_leave_0_listener($event) { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.animateFn($event)); });',
        );
      ...
      it('should compile animate.leave bindings with a class string', () => {
        ...
        const jsContents = env.getContents('test.js');
        expect(jsContents).toContain('i0.ɵɵanimateLeave(ctx_r0.fade());');
        const instances = jsContents.match(/ɵɵanimateLeave/g);
        expect(instances?.length).toBe(1);
      });
      ...
      it('should compile animate.leave bindings with a string array', () => {
        ...
        const jsContents = env.getContents('test.js');
        expect(jsContents).toContain('i0.ɵɵanimateLeave(ctx_r0.classList);');
        const instances = jsContents.match(/ɵɵanimateLeave/g);
        expect(instances?.length).toBe(1);
      });
