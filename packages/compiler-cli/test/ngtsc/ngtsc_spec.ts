...
runInEachFileSystem
    ...
    `);
                  ...
                  expect(jsContents)
                      .toContain('Service_Factory(t) { return new (t || Service)(); }');
                  expect(jsContents).toContain(', providedIn: \'root\' });');
                  expect(jsContents).not.toContain('__decorate');
                  const dtsContents = env.getContents('test.d.ts');
                  expect(dtsContents).toContain('static ɵprov: i0.ɵɵInjectableDef<Service>;');
    ...
    `);
      ...
      `);
                ...
                fit('should compile Components (inline template) without errors', () => {
                  env.tsconfig({tracePerformance: 'true'});
                  env.write('test.ts', `
    ...
    `);
      ...
      `);
                     ...
                     const jsContents = trim(env.getContents('test.js'));
                     expect(jsContents)
                         .toContain('directives: [DirectiveA, DirectiveB, ComponentA, ComponentB]');
                   });
    ...
    `);
                  ...
                  const jsContents = env.getContents('test.js');
                  expect(jsContents)
                      .toContain(`i0.ɵɵdefineNgModule({ type: TestModule, id: 'test' })`);
                });
    ...
    `);
                  ...
                  expect(dtsContents)
                      .toContain('static ɵpipe: i0.ɵɵPipeDefWithMeta<TestPipe, "test-pipe">;');
    ...
    `);
                  ...
                  expect(dtsContents)
                      .toContain('static ɵfac: i0.ɵɵFactoryDef<TestPipe<any>, never>;');
                });
    ...
    `);
      ...
      `);
        ...
        `);
                  ...
                  ['ViewChild', 'ViewChildren', 'ContentChild', 'ContentChildren'].forEach(
                      decorator => {
                        it(`should throw if @Input and @${
                               decorator} decorators are applied to the same property`,
                           () => {
                             env.tsconfig({});
                             env.write('test.ts', `
          ...
          `);
                             verifyThrownError(
                                 ErrorCode.VALUE_HAS_WRONG_TYPE,
                                 `Failed to resolve @${
                                     decorator} predicate at position 1 to a string`);
                           });
                      });
            ...
            `);
                  ...
                  ['Input', 'Output'].forEach(decorator => {
                    it(`should throw error if @${
                           decorator} decorator argument has unsupported type`,
                       () => {
                         env.tsconfig({});
                         env.write('test.ts', `
            import {Component, ${decorator}} from '@angular/core';
      ...
      `);
                       ...
                       expect(errors[0].messageText)
                           .toContain('Two incompatible decorators on class');
                     });
  ...
  `);
    ...
    `);
                     ...
                     expect(dtsContents)
                         .toContain(`static ɵfac: i0.ɵɵFactoryDef<EmptyCtor, never>`);
                     expect(dtsContents)
                         .toContain(`static ɵfac: i0.ɵɵFactoryDef<WithoutDecorators, never>`);
                     expect(dtsContents)
                         .toContain(`static ɵfac: i0.ɵɵFactoryDef<MyCmp, [{ host: true; }]>`);
                     expect(dtsContents)
                         .toContain(`static ɵfac: i0.ɵɵFactoryDef<MyPipe, [{ host: true; }]>`);
                   });
    ...
    `);
                  ...
                  const dtsContents = env.getContents('test.d.ts');
                  expect(dtsContents)
                      .toContain(`static ɵfac: i0.ɵɵFactoryDef<Inj, [{ self: true; }]>`);
                  expect(dtsContents)
                      .toContain(`static ɵfac: i0.ɵɵFactoryDef<InjUseExisting, [{ self: true; }]>`);
                  expect(dtsContents)
                      .toContain(`static ɵfac: i0.ɵɵFactoryDef<InjUseClass, [{ self: true; }]>`);
                  expect(dtsContents)
                      .toContain(
                  ...
                  expect(dtsContents)
                      .toContain(`static ɵfac: i0.ɵɵFactoryDef<InjUseValue, [{ self: true; }]>`);
                });
    ...
    `);
                  ...
                  expect(factoryContents)
                      .toContain(`import { NotAModule, TestModule } from './test';`);
                  expect(factoryContents)
                      .toContain(
      ...
      `);
                    ...
                    const summaryContents = env.getContents('test.ngsummary.js');
                    expect(summaryContents)
                        .toEqual(`export var NotDirectlyExportedNgSummary = null;\n`);
                  });
      ...
      `);
         ...
         `);
           ...
           `);
                       ...
                       expect(jsContents)
                           .toMatch(setClassMetadataRegExp('type: i1.ns.one.two.Two'));
                     });
    ...
    `);
      ...
      `);
          ...
          `);
                    ...
                    it('should throw if `styleUrls` is defined incorrectly in @Component',
                       async () => {
                         env.write('test.ts', `
            import {Component} from '@angular/core';
          ...
          `);
                ...
                describe('flat module indices', () => {
                  ...
                  it('should generate a proper flat module index file when nested', () => {
                    ...
                    expect(env.getContents('./public-api/index.js'))
                        .toContain(`export * from '../test';`);
                  });
      ...
      `);
        ...
        `);
                       ...
                       expect(jsContents)
                           .toContain('export { Dir as ɵngExportɵModuleɵDir } from "./dir";');
        ...
        `);
                       ...
                       expect(diag[0]!.code)
                           .toEqual(ngErrorCode(ErrorCode.NGMODULE_REEXPORT_NAME_COLLISION));
                     });
        ...
        `);
                    ...
                    expect(jsContents)
                        .toContain('directives: [i1.ɵngExportɵExternalModuleɵExternalDir]');
                  });
      ...
      `);
        ...
        `);
                      ...
                      expect(routes).toEqual([
                        lazyRouteMatching(
                            './lazy-3#Lazy3Module', /\/lazy\/lazy-2\.ts$/, 'Lazy2Module',
                            /\/lazy\/lazy-3\.ts$/, 'Lazy3Module'),
                        lazyRouteMatching(
                            './lazy/lazy-1#Lazy1Module', /\/test\.ts$/, 'TestModule',
                            /\/lazy\/lazy-1\.ts$/, 'Lazy1Module'),
                        lazyRouteMatching(
                            './lazy/lazy-2#Lazy2Module', /\/test\.ts$/, 'TestModule',
                            /\/lazy\/lazy-2\.ts$/, 'Lazy2Module'),
                      ]);
                    });
        ...
        `);
                      ...
                      expect(routes).toEqual([
                        lazyRouteMatching(
                            './lazy#LazyModule', /\/test\.ts$/, 'TestModule', /\/lazy\.ts$/,
                            'LazyModule'),
                      ]);
                    });
        ...
        `);
                      ...
                      expect(routes).toEqual([
                        ...
                        lazyRouteMatching(
                            ...
                            'LazyFooModule', /\/bar\/other-root-dir\/src\/lazy-bar\.ts$/,
                            'LazyBarModule'),
                        lazyRouteMatching(
                            './lazier-bar#LazierBarModule',
                            /\/bar\/other-root-dir\/src\/lazy-bar\.ts$/, 'LazyBarModule',
                            /\/bar\/other-root-dir\/src\/lazier-bar\.ts$/, 'LazierBarModule'),
                      ]);
                    });
                  });
        ...
        `);
                      ...
                      expect(routes).toEqual([
                        lazyRouteMatching(
                            './lazy/lazy#LazyModule', /\/test\.ts$/, 'TestModule',
                            /\/lazy\/lazy\.ts$/, 'LazyModule'),
                        lazyRouteMatching(
        ...
        `);
                      ...
                      expect(routes).toEqual([
                        lazyRouteMatching(
                            './lazy-1/lazy-1#Lazy1Module', /\/test\.ts$/, 'TestModule',
                            /\/lazy-1\/lazy-1\.ts$/, 'Lazy1Module'),
                        lazyRouteMatching(
        ...
        `);
                      ...
                      expect(routes).toEqual([
                        lazyRouteMatching(
                            ...
                            /\/lazy\/lazy\.ts$/, 'LazyModule'),
                        lazyRouteMatching(
                            './lazy/lazy#LazyModule', /\/test\.ts$/, 'SharedModule',
                            /\/lazy\/lazy\.ts$/, 'LazyModule'),
                        lazyRouteMatching(
        ...
        `);
                         ...
                         expect(routes).toEqual([
                           lazyRouteMatching(
                               './lazy/lazy#Lazy1Module', /\/test\.ts$/, 'Test1Module',
                               /\/lazy\/lazy\.ts$/, 'Lazy1Module'),
                         ]);
                       });
...
`;
                       ...
                       const sourceTestOutsideAngularCore =
                           env.getContents('test_outside_angular_core.js');
                       const sourceTestInsideAngularCore =
                           env.getContents('test_inside_angular_core.js');
      ...
      `);
                    ...
                    expect(jsContents)
                        .toContain('directives: [i1.\u0275ng$root$alpha$$ExternalDir]');
                  });
      ...
      `);
                    ...
                    const jsContents = env.getContents('test.js');
                    expect(jsContents)
                        .toContain('styles: ["h1[_ngcontent-%COMP%] {font-size: larger}"]');
                  });
                });
        ...
        `);
          ...
          `);
                       ...
                       expect(diags.length).toBe(1);
                       expect(diags[0].messageText)
                           .toContain('cannot be created via dependency injection');
                     });
