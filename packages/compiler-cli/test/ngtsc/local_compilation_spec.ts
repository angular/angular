  ...
  describe('local compilation', () => {
    ...
    describe('constructor injection', () => {
      it('should include injector types with all possible import/injection styles into component factory', () => {
        ...
        expect(jsContents).toContain(
          `MainComponent.ɵfac = function MainComponent_Factory(ɵt) { return new (ɵt || MainComponent)(i0.ɵɵdirectiveInject(i1.SomeService1), i0.ɵɵdirectiveInject(SomeService2), i0.ɵɵdirectiveInject(i2.SomeService3), i0.ɵɵdirectiveInject(i3.nested.SomeService4), i0.ɵɵinjectAttribute('title'), i0.ɵɵdirectiveInject(MESSAGE_TOKEN)); };`,
        );
      });
      ...
      it('should include injector types with all possible import/injection styles into directive factory', () => {
        ...
        expect(jsContents).toContain(
          `MainDirective.ɵfac = function MainDirective_Factory(ɵt) { return new (ɵt || MainDirective)(i0.ɵɵdirectiveInject(i1.SomeService1), i0.ɵɵdirectiveInject(SomeService2), i0.ɵɵdirectiveInject(i2.SomeService3), i0.ɵɵdirectiveInject(i3.nested.SomeService4), i0.ɵɵinjectAttribute('title'), i0.ɵɵdirectiveInject(MESSAGE_TOKEN)); };`,
        );
      });
      ...
      it('should include injector types with all possible import/injection styles into pipe factory', () => {
        ...
        expect(jsContents).toContain(
          `MainPipe.ɵfac = function MainPipe_Factory(ɵt) { return new (ɵt || MainPipe)(i0.ɵɵdirectiveInject(i1.SomeService1, 16), i0.ɵɵdirectiveInject(SomeService2, 16), i0.ɵɵdirectiveInject(i2.SomeService3, 16), i0.ɵɵdirectiveInject(i3.nested.SomeService4, 16), i0.ɵɵinjectAttribute('title'), i0.ɵɵdirectiveInject(MESSAGE_TOKEN, 16)); };`,
        );
      });
      ...
      it('should include injector types with all possible import/injection styles into injectable factory', () => {
        ...
        expect(jsContents).toContain(
          `MainService.ɵfac = function MainService_Factory(ɵt) { return new (ɵt || MainService)(i0.ɵɵinject(i1.SomeService1), i0.ɵɵinject(SomeService2), i0.ɵɵinject(i2.SomeService3), i0.ɵɵinject(i3.nested.SomeService4), i0.ɵɵinjectAttribute('title'), i0.ɵɵinject(MESSAGE_TOKEN)); };`,
        );
      });
      ...
      it('should include injector types with all possible import/injection styles into ng module factory', () => {
        ...
        expect(jsContents).toContain(
          `MainModule.ɵfac = function MainModule_Factory(ɵt) { return new (ɵt || MainModule)(i0.ɵɵinject(i1.SomeService1), i0.ɵɵinject(SomeService2), i0.ɵɵinject(i2.SomeService3), i0.ɵɵinject(i3.nested.SomeService4), i0.ɵɵinjectAttribute('title'), i0.ɵɵinject(MESSAGE_TOKEN)); };`,
        );
      });
      ...
      it('should generate invalid factory for injectable when type parameter types are used as token', () => {
        ...
        expect(jsContents).toContain(
          `MainService.ɵfac = function MainService_Factory(ɵt) { i0.ɵɵinvalidFactory(); };`,
        );
      });
      ...
      it('should generate invalid factory for directive without selector type parameter types are used as token', () => {
        ...
        expect(jsContents).toContain(
          `MyDirective.ɵfac = function MyDirective_Factory(ɵt) { i0.ɵɵinvalidFactory(); };`,
        );
      });
