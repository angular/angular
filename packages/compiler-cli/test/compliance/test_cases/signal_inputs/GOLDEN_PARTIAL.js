...
export class TestDir {
    constructor() {
        this.name = input.required(...(ngDevMode ? [{ debugName: "name", transform: convertToBoolean }] : [{ transform: convertToBoolean, }]));
    }
}
TestDir.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "0.0.0-PLACEHOLDER", ngImport: i0, type: TestDir, deps: [], target: i0.ɵɵFactoryTarget.Directive });
...
export class TestDir {
    constructor() {
        this.name = input.required(...(ngDevMode ? [{ debugName: "name", transform: (v) => v === true || v !== '' }] : [{ transform: (v) => v === true || v !== '', }]));
