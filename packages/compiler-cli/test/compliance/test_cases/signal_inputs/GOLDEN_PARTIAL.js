...
export class TestDir {
    constructor() {
        this.counter = input(...(ngDevMode ? [0, { debugName: "counter" }] : [0]));
...
export class TestDir {
    constructor() {
        this.counter = input(...(ngDevMode ? [0, { debugName: "counter" }] : [0]));
        this.signalWithTransform = input(...(ngDevMode ? [false, { debugName: "signalWithTransform", transform: convertToBoolean }] : [false, { transform: convertToBoolean }]));
        this.signalWithTransformAndAlias = input(...(ngDevMode ? [false, { debugName: "signalWithTransformAndAlias", alias: 'publicNameSignal', transform: convertToBoolean }] : [false, { alias: 'publicNameSignal', transform: convertToBoolean }]));
