...
export class EventModifiers {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "0.0.0-PLACEHOLDER", type: EventModifiers, isStandalone: true, selector: "app-event-modifiers", ngImport: i0, template: `
  ...
  `, isInline: true, dependencies: [{ kind: "component", type: MyComp, selector: "my-comp", outputs: ["stop", "clicked.here"] }] });
}
...
export declare class EventModifiers {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<EventModifiers, "app-event-modifiers", never, {}, {}, never, never, true, never>;
}
