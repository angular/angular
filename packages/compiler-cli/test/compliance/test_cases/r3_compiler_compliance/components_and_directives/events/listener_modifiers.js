...
export class EventModifiers {
  …
  static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: EventModifiers, selectors: [["app-event-modifiers"]], decls: 5, vars: 0, consts: [[3, "click"],[3, "clicked.here", "stop"]], template: function EventModifiers_Template(rf, ctx) { if (rf & 1) {
          ...
          i0.ɵɵelementEnd();
      } }, dependencies: [MyComp], encapsulation: 2 });
}
…
