...
export declare class MyComp {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MyComp, "my-comp", never, { "names": { "publicName": "names"; "required": false; }; }, {}, never, never, false, never>;
}
...
export declare class ObjectComp {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ObjectComp, "object-comp", never, { "config": { "publicName": "config"; "required": false; }; }, {}, never, never, false, never>;
}
export declare class MyApp {
    name: string;
    static ɵfac: i0.ɵɵFactoryDeclaration<MyApp, never>;
...
export declare class NestedComp {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NestedComp, "nested-comp", never, { "config": { "publicName": "config"; "required": false; }; }, {}, never, never, false, never>;
}
export declare class MyApp {
    name: string;
    duration: number;
