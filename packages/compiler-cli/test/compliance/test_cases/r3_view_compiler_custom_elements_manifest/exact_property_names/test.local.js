function ManifestDomPropertyShapes_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    $r3$.ɵɵproperty("readonly", $ctx_r0$.readonly, null, true)("innerHTML", $ctx_r0$.html, $r3$.ɵɵsanitizeHtml, true);
  }
}
...
function ManifestDomProperties_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    $r3$.ɵɵproperty("innerHTML", ctx.html, $r3$.ɵɵsanitizeHtml, true)("tabindex", ctx.tabindex);
  }
}
...
function ManifestDomPropertyShapes_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    $r3$.ɵɵadvance();
    $r3$.ɵɵproperty("innerHTML", $r3$.ɵɵinterpolate(ctx.html), $r3$.ɵɵsanitizeHtml, true);
  }
}
