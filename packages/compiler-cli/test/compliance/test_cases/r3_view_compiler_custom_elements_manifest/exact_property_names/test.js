...
function ManifestPropertyShapes_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    $r3$.ɵɵelement(0, "my-button", 3);
    $r3$.ɵɵelementStart(1, "my-button", 4);
    $r3$.ɵɵi18nAttributes(2, 0, ["for"]);
    $r3$.ɵɵelementEnd();
  }
  if (rf & 2) {
    const $ctx_r0$ = $r3$.ɵɵnextContext();
    $r3$.ɵɵproperty("innerHTML", $r3$.ɵɵinterpolate($ctx_r0$.html), $r3$.ɵɵsanitizeHtml);
    $r3$.ɵɵadvance();
    $r3$.ɵɵi18nExp($ctx_r0$.html);
    $r3$.ɵɵi18nApply(2);
  }
}
...
function ManifestDomPropertyShapes_Template(rf, ctx) {
  if (rf & 1) {
    $r3$.ɵɵdomElement(0, "my-button", 1)(1, "input", 1);
    $r3$.ɵɵconditionalCreate(2, ManifestDomPropertyShapes_Conditional_2_Template, 1, 2, "my-button", 2);
    $r3$.ɵɵdomElement(3, "my-button", 3);
    $r3$.ɵɵdomElementStart(4, "my-button", 4);
    $r3$.ɵɵi18nAttributes(5, 0, ["for"]);
    $r3$.ɵɵdomElementEnd();
  }
  if (rf & 2) {
    $r3$.ɵɵdomProperty("readonly", ctx.readonly);
...
function ManifestPropertyShapes_Template(rf, ctx) {
  if (rf & 1) {
    $r3$.ɵɵelement(0, "my-button", 1)(1, "input", 2);
    $r3$.ɵɵconditionalCreate(2, ManifestPropertyShapes_Conditional_2_Template, 3, 3);
  }
  if (rf & 2) {
