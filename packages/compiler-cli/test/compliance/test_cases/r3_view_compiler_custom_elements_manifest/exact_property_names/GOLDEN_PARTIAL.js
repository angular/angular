...
export class ManifestDomPropertyShapes {
  ...
  `, isInline: true, customElementPropertyNames: { "my-button": ["readonly"] } });
}
...
export class ManifestPropertyShapes {
  ...
  `, isInline: true, customElementPropertyNames: { "my-button": ["readonly"] }, dependencies: [{ kind: "directive", type: ForceFull, selector: "[forceFull]" }] });
}
