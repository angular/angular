...
export class ManifestDomProperties {
    ...
    <my-button
      ...
      [tabindex]="tabindex"
    ></my-button>
  `, isInline: true, customElementPropertyNames: { "my-button": ["readonly", "formaction"] } });
}
...
export class ManifestProperties {
    ...
    <my-button
      ...
      [innerHTML]="html"
    ></my-button>
  `, isInline: true, customElementPropertyNames: { "my-button": ["readonly", "formaction"] }, dependencies: [{ kind: "directive", type: ForceFull, selector: "[forceFull]" }] });
}
...
export class ManifestDomPropertyShapes {
  ...
  `, isInline: true, customElementPropertyNames: { "my-button": ["readonly", "for"] } });
}
...
export class ManifestPropertyShapes {
  ...
  `, isInline: true, customElementPropertyNames: { "my-button": ["readonly", "for"] }, dependencies: [{ kind: "directive", type: ForceFull, selector: "[forceFull]" }] });
}
