...
export class TestDir {
    constructor() {
        this.query1 = viewChild('locatorA', ngDevMode ? { debugName: "query1" } : undefined);
        this.query2 = viewChildren('locatorB', ngDevMode ? { debugName: "query2" } : undefined);
        this.query3 = contentChild('locatorC', ngDevMode ? { debugName: "query3" } : undefined);
        this.query4 = contentChildren('locatorD', ngDevMode ? { debugName: "query4" } : undefined);
        this.query5 = viewChild(forwardRef(() => SomeToken), ngDevMode ? { debugName: "query5" } : undefined);
        this.query6 = viewChildren(SomeToken, ngDevMode ? { debugName: "query6" } : undefined);
        this.query7 = viewChild('locatorE', ngDevMode ? { read: SomeToken, debugName: "query7" } : { read: SomeToken });
        this.query8 = contentChildren('locatorF, locatorG', ngDevMode ? { descendants: true, debugName: "query8" } : { descendants: true });
        this.query9 = contentChildren(nonAnalyzableRefersToString, ngDevMode ? { descendants: true, debugName: "query9" } : { descendants: true });
    }
}
...
export class TestDir {
    constructor() {
        this.signalViewChild = viewChild('locator1', ngDevMode ? { debugName: "signalViewChild" } : undefined);
        this.signalContentChild = contentChild('locator2', ngDevMode ? { debugName: "signalContentChild" } : undefined);
    }
}
TestDir.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "0.0.0-PLACEHOLDER", ngImport: i0, type: TestDir, deps: [], target: i0.ɵɵFactoryTarget.Directive });
