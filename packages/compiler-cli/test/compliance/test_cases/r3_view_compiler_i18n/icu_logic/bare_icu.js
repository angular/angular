...
consts: function() {
  ...
  __i18nIcuMsg__('{VAR_SELECT, select, 0 {no emails} 1 {one email} other {{$interpolation} emails}}', [['interpolation', '{INTERPOLATION}']], {original_code: {'interpolation': '{{count}}'}}, [['VAR_SELECT', String.raw`\uFFFD0\uFFFD`], ['INTERPOLATION', String.raw`\uFFFD1\uFFFD`]])
  return [
    $i18n_0$,
