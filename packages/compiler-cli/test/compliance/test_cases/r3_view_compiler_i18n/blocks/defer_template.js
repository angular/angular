...
MyApp.ɵcmp = /*@__PURE__*/ $r3$.ɵɵdefineComponent({
  ...
  consts: () => {
    ...
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
       ...
       */
      const MSG_EXTERNAL_7863738818382242773$$DEFER_TS__1 = goog.getMsg(" Content: {$startBlockDefer} before{$startTagSpan}middle{$closeTagSpan}after {$closeBlockDefer}{$startBlockPlaceholder} before{$startTagDiv}placeholder{$closeTagDiv}after {$closeBlockPlaceholder}{$startBlockLoading} before{$startTagButton}loading{$closeTagButton}after {$closeBlockLoading}{$startBlockError} before{$startHeadingLevel1}error{$closeHeadingLevel1}after {$closeBlockError}", {
        "closeBlockDefer": "\uFFFD/*2:1\uFFFD",
        "closeBlockError": "\uFFFD/*5:4\uFFFD",
      ...
      i18n_0 = MSG_EXTERNAL_7863738818382242773$$DEFER_TS__1;
    } else {
