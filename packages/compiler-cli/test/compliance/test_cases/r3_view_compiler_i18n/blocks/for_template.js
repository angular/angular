...
MyApp.ɵcmp = /*@__PURE__*/ $r3$.ɵɵdefineComponent({
  ...
  consts: () => {
    ...
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
       ...
       */
      const $MSG1$ = goog.getMsg(" Content: {$startBlockFor} before{$startTagSpan}middle{$closeTagSpan}after {$closeBlockFor}{$startBlockEmpty} before{$startTagDiv}empty{$closeTagDiv}after {$closeBlockEmpty}! ", {
        "closeBlockEmpty": "\uFFFD/*4:2\uFFFD",
        "closeBlockFor": "\uFFFD/*3:1\uFFFD",
        "closeTagDiv": "\uFFFD/#1:2\uFFFD",
        "closeTagSpan": "\uFFFD/#1:1\uFFFD",
