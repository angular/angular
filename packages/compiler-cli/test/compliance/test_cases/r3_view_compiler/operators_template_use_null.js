template: function MyApp_Template(rf, $ctx$) {
	if (rf & 1) {
		...
		…
		$r3$.ɵɵdomListener("click", function MyApp_Template_button_click_11_listener() { return $ctx$.number++; });
		…
		$r3$.ɵɵdomListener("click", function MyApp_Template_button_click_12_listener() { return $ctx$.number--; });
		…
		$r3$.ɵɵdomListener("click", function MyApp_Template_button_click_13_listener() { return ++$ctx$.number; });
		…
		$r3$.ɵɵdomListener("click", function MyApp_Template_button_click_14_listener() { return --$ctx$.number; });
		…
	} 
	if (rf & 2) {
