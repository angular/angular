export class ChildComponent {
  ...
  static ɵcmp = /*@__PURE__*/ $r3$.ɵɵdefineComponent({
    ...
    hostBindings: function ChildComponent_HostBindings(rf, ctx) {
      if (rf & 1) {
        $r3$.ɵɵanimateEnterListener(function ChildComponent_animateenter_HostBindingHandler($event) { return ctx.fadeFn($event); });
      }
    },
    decls: 2,
    vars: 0,
