    ...
    it('should support complex expressions in interpolation', () => {
      ...
      const output = String.raw`
        ...
        template: function MyComponent_Template(rf, ctx) {
          ...
          if (rf & 2) {
              var $tmp_0_0$ = null;
              const $currVal_0$ = ($tmp_0_0$ = ctx.valueA.getRawValue()) == null ? undefined : $tmp_0_0$.getTitle();
    ...
    it('should support interpolations with complex expressions', () => {
      ...
      const output = String.raw`
        ...
        template: function MyComponent_Template(rf, ctx) {
          ...
          if (rf & 2) {
            var $tmp_2_0$ = null;
            const $currVal_2$ = ($tmp_2_0$ = ctx.valueA.getRawValue()) == null ? undefined : $tmp_2_0$.getTitle();
            $r3$.ɵɵadvance(2);
            $r3$.ɵɵi18nExp($r3$.ɵɵpipeBind1(2, 3, ctx.valueA))(ctx.valueA == null ? undefined : ctx.valueA.a == null ? undefined : ctx.valueA.a.b)($currVal_2$);
            $r3$.ɵɵi18nApply(1);
          }
        }
      `;
