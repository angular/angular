        ...
        MyComponent.ngComponentDef = $r3$.ɵdefineComponent({
          ...
          template: function MyComponent_Template(rf, ctx) {
            if (rf & 1) {
              ...
              $r3$.ɵlistener("@myAnimation.start", function MyComponent_Template_animation_myAnimation_start_0_listener($event) { return ctx.onStart($event); });
              $r3$.ɵlistener("@myAnimation.done", function MyComponent_Template_animation_myAnimation_done_0_listener($event) { return ctx.onDone($event); });
              $r3$.ɵelementEnd();
            } if (rf & 2) {
