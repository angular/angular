...
describe('compiler compliance', () => {
        ...
        MyComponent.ngComponentDef = i0.ΔdefineComponent({type:MyComponent,selectors:[["my-component"]],
            ...
            template: function MyComponent_Template(rf,ctx){
              if (rf & 1) {
                ...
                $r3$.Δstyling($e0_classBindings$, $e0_styleBindings$);
                $r3$.ΔelementEnd();
              }
              if (rf & 2) {
                $r3$.Δselect(0);
                $r3$.ΔstyleProp(0, ctx.color);
                $r3$.ΔclassProp(0, ctx.error);
                $r3$.ΔstylingApply();
              }
            },
            encapsulation: 2
        ...
        const MyAppDeclaration = `
          ...
          MyApp.ngComponentDef = $r3$.ΔdefineComponent({
            ...
            template:  function MyApp_Template(rf, ctx) {
              ...
              if (rf & 2) {
                $r3$.Δselect(0);
                $r3$.Δproperty("names", $r3$.ΔpureFunction1(1, $e0_ff$, ctx.customName));
              }
            },
           directives: [MyComp],
           encapsulation: 2
          ...
          MyApp.ngComponentDef = $r3$.ΔdefineComponent({
            ...
            template:  function MyApp_Template(rf, ctx) {
              ...
              if (rf & 2) {
                $r3$.Δselect(0);
                $r3$.Δproperty("names",
                    $r3$.ΔpureFunctionV(1, $e0_ff$, [ctx.n0, ctx.n1, ctx.n2, ctx.n3, ctx.n4, ctx.n5, ctx.n6, ctx.n7, ctx.n8]));
              }
            },
            directives: [MyComp],
            encapsulation: 2
        ...
        const MyAppDefinition = `
          ...
          MyApp.ngComponentDef = $r3$.ΔdefineComponent({
            ...
            template:  function MyApp_Template(rf, ctx) {
              ...
              if (rf & 2) {
                $r3$.Δselect(0);
                $r3$.Δproperty("config", $r3$.ΔpureFunction1(1, $e0_ff$, ctx.name));
              }
            },
          ...
          MyApp.ngComponentDef = $r3$.ΔdefineComponent({
            ...
            template:  function MyApp_Template(rf, ctx) {
              ...
              if (rf & 2) {
                ...
                $r3$.Δproperty(
                    "config",
                    $r3$.ΔpureFunction2(5, $e0_ff_2$, ctx.name, $r3$.ΔpureFunction1(3, $e0_ff_1$, $r3$.ΔpureFunction1(1, $e0_ff$, ctx.duration))));
              }
            },
        ...
        const SimpleLayoutDefinition = `
          SimpleLayout.ngComponentDef = $r3$.ΔdefineComponent({
            ...
            template:  function SimpleLayout_Template(rf, ctx) {
              ...
              if (rf & 2) {
                $r3$.Δselect(0);
                $r3$.Δproperty("name", ctx.name1);
                $r3$.Δselect(1);
                $r3$.Δproperty("name", ctx.name2);
              }
            },
        ...
        const MyComponentDefinition = `
          ...
          function MyComponent_li_1_Template(rf, ctx) {
            ...
            if (rf & 2) {
              ...
              $r3$.Δselect(4);
              $r3$.Δproperty("forOf", IDENT.infos);
            }
          }
  ...
  describe('inherited base classes', () => {
    ...
    it('should add ngBaseDef if a host binding is present', () => {
      ...
      const expectedOutput = `
      // ...
      BaseClass.ngBaseDef = $r3$.ΔdefineBase({
        hostBindings: function (rf, ctx, elIndex) {
          if (rf & 1) {
            $r3$.ΔallocHostVars(1);
          }
          if (rf & 2) {
            $r3$.ΔelementAttribute(elIndex, "tabindex", $r3$.Δbind(ctx.tabindex));
          }
        }
      });
      // ...
    ...
    it('should add ngBaseDef if a host listener is present', () => {
      ...
      BaseClass.ngBaseDef = $r3$.ΔdefineBase({
        hostBindings: function (rf, ctx, elIndex) {
          if (rf & 1) {
            $r3$.Δlistener("mousedown", function ($event) {
