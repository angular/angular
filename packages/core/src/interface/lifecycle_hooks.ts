 ...
 * A Content is fully initialized when all the lifecycle hooks required before first change detection cycle are executed.
 * This lifecycle hook is called before first change detection cycle on any content.
