...
export function injectInjectorOnly<T>(token: Token<T>): T;
export function injectInjectorOnly<T>(token: Token<T>, flags?: InjectFlags): T|null;
export function injectInjectorOnly<T>(token: Token<T>, flags = InjectFlags.Default): T|null {
 ...
 */
export function ɵɵinject<T>(token: Token<T>): T;
export function ɵɵinject<T>(token: Token<T>, flags?: InjectFlags): T|null;
export function ɵɵinject<T>(token: Token<T>, flags = InjectFlags.Default): T|null {
...
export function injectArgs(types: (Token<any>|any[])[]): any[] {
  const args: any[] = [];
