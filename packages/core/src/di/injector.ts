...
export abstract class Injector {
   ...
   * @returns The instance from the injector if defined.
   * @throws When `token` does not resolve to an instance.
   */
  abstract get<T>(
   ...
   * @throws When `token` does not resolve to an instance and the `notFoundValue`
   *    is `undefined` or `Injector.THROW_IF_NOT_FOUND`.
   */
  abstract get<T, U>(
