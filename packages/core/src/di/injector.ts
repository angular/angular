...
import {ɵɵinject, INJECTOR, THROW_IF_NOT_FOUND, NG_TEMP_TOKEN_PATH, NullInjector, USE_VALUE, formatError, catchInjectorError} from './injector_compatibility';
...
export function INJECTOR_IMPL__POST_R3__(providers: StaticProvider[], parent: Injector|undefined, name: string) {
