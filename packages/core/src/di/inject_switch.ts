 ...
 */
let _injectImplementation: (<T>(token: ProviderToken<T>, flags?: InternalInjectFlags) => T | null)|
    undefined;
...
export function setInjectImplementation(
    impl: (<T>(token: ProviderToken<T>, flags?: InternalInjectFlags) => T | null)|
    undefined): (<T>(token: ProviderToken<T>, flags?: InternalInjectFlags) => T | null)|undefined {
...
export function injectRootLimpMode<T>(
    token: ProviderToken<T>, notFoundValue: T|undefined, flags: InternalInjectFlags): T|null {
