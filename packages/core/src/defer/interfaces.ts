...
/**
 * Basic interface for a DeferBlock
 */
...
export interface TDeferBlockDetails {
   ...
   */
  hydrateTriggers: (DeferBlockTrigger | HydrateTriggerDetails)[] | null;

  /**
   * List of prefetch triggers for a given block
   */
  prefetchTriggers: DeferBlockTrigger[] | null;
}
