...
export * from './version';
export * from './di';
export {ApplicationRef, APP_BOOTSTRAP_LISTENER} from './application/application_ref';
...
export {afterEveryRender, afterNextRender} from './render3/after_render/hooks';
...
export {MAX_ANIMATION_TIMEOUT} from './animation/interfaces';
