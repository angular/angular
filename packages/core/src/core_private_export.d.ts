...
export { TracingAction as ɵTracingAction, TracingService as ɵTracingService, TracingSnapshot as ɵTracingSnapshot, } from './application/tracing';
...
export { withDomHydration as ɵwithDomHydration, withI18nSupport as ɵwithI18nSupport, withIncrementalHydration as ɵwithIncrementalHydration, CLIENT_RENDER_MODE_FLAG as ɵCLIENT_RENDER_MODE_FLAG, } from './hydration/api';
...
export { IS_HYDRATION_DOM_REUSE_ENABLED as ɵIS_HYDRATION_DOM_REUSE_ENABLED, IS_INCREMENTAL_HYDRATION_ENABLED as ɵIS_INCREMENTAL_HYDRATION_ENABLED, JSACTION_BLOCK_ELEMENT_MAP as ɵJSACTION_BLOCK_ELEMENT_MAP, IS_ENABLED_BLOCKING_INITIAL_NAVIGATION as ɵIS_ENABLED_BLOCKING_INITIAL_NAVIGATION, } from './hydration/tokens';
export { HydrationStatus as ɵHydrationStatus, HydratedNode as ɵHydratedNode, HydrationInfo as ɵHydrationInfo, readHydrationInfo as ɵreadHydrationInfo, SSR_CONTENT_INTEGRITY_MARKER as ɵSSR_CONTENT_INTEGRITY_MARKER, } from './hydration/utils';
...
export { startMeasuring as ɵstartMeasuring, stopMeasuring as ɵstopMeasuring, PERFORMANCE_MARK_PREFIX as ɵPERFORMANCE_MARK_PREFIX, enableProfiling as ɵenableProfiling, disableProfiling as ɵdisableProfiling, } from './profiler';
export { ResourceImpl as ɵResourceImpl, encapsulateResourceError as ɵencapsulateResourceError, } from './resource/resource';
