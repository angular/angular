 ...
 */
import { InputOptions, InputOptionsWithoutTransform, InputOptionsWithTransform, InputSignal, InputSignalWithTransform } from './input_signal';
export declare function inputFunction<ReadT, WriteT>(initialValue?: ReadT, opts?: InputOptions<ReadT, WriteT>): InputSignalWithTransform<ReadT | undefined, WriteT>;
export declare function inputRequiredFunction<ReadT, WriteT = ReadT>(opts?: InputOptions<ReadT, WriteT>): InputSignalWithTransform<ReadT, WriteT>;
/**
