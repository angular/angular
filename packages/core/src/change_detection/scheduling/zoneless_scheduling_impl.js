...
let ChangeDetectionSchedulerImpl = class ChangeDetectionSchedulerImpl {
  constructor() {
    ...
    this.tracing = inject(TracingService, {optional: true});
...
ChangeDetectionSchedulerImpl = __decorate(
