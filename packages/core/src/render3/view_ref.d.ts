...
export declare class ViewRef<T> implements EmbeddedViewRef<T>, ChangeDetectorRefInterface {
    /**
 ...
 */
export declare function isViewDirty(view: ViewRef<unknown>): boolean;
export declare function markForRefresh(view: ViewRef<unknown>): void;
export {};
