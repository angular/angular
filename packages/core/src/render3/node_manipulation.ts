...
const unusedValueToPlacateAjd = unused1 + unused2 + unused3 + unused5;
...
function applyToElementOrContainer(
    action: WalkTNodeTreeAction, renderer: Renderer2, parent: RElement|null,
...
export function createTextNode(renderer: Renderer2, value: string): RText {
  ngDevMode && ngDevMode.rendererCreateTextNode++;
  ngDevMode && ngDevMode.rendererSetText++;
  return renderer.createText(value);
}

export function updateTextNode(renderer: Renderer2, rNode: RText, value: string): void {
  ngDevMode && ngDevMode.rendererSetText++;
  renderer.setValue(rNode, value);
}

export function createCommentNode(renderer: Renderer2, value: string): RComment {
...
export function createElementNode(
    renderer: Renderer2, name: string, namespace: string|null): RElement {
...
export function addViewToContainer(
    tView: TView, parentTNode: TNode, renderer: Renderer2, lView: LView, parentNativeNode: RElement,
...
export function nativeInsertBefore(
    renderer: Renderer2, parent: RElement, child: RNode, beforeNode: RNode|null,
    isMove: boolean): void {
  ngDevMode && ngDevMode.rendererInsertBefore++;
  renderer.insertBefore(parent, child, beforeNode, isMove);
}

function nativeAppendChild(renderer: Renderer2, parent: RElement, child: RNode): void {
...
function nativeAppendOrInsertBefore(
    renderer: Renderer2, parent: RElement, child: RNode, beforeNode: RNode|null, isMove: boolean) {
  if (beforeNode !== null) {
...
function nativeRemoveChild(
    renderer: Renderer2, parent: RElement, child: RNode, isHostElement?: boolean): void {
...
let _processI18nInsertBefore: (
    renderer: Renderer2, childTNode: TNode, lView: LView, childRNode: RNode|RNode[],
 ...
 */
export function nativeRemoveNode(renderer: Renderer2, rNode: RNode, isHostElement?: boolean): void {
 ...
 */
function applyNodes(
    renderer: Renderer2, action: WalkTNodeTreeAction, tNode: TNode|null, lView: LView,
 ...
 */
function applyView(
    tView: TView, lView: LView, renderer: Renderer2, action: WalkTNodeTreeAction.Destroy,
    parentRElement: null, beforeNode: null): void;
function applyView(
    tView: TView, lView: LView, renderer: Renderer2, action: WalkTNodeTreeAction,
...
function applyProjectionRecursive(
    renderer: Renderer2, action: WalkTNodeTreeAction, lView: LView,
...
function applyContainer(
    renderer: Renderer2, action: WalkTNodeTreeAction, lContainer: LContainer,
...
export function applyStyling(
    renderer: Renderer2, isClassBased: boolean, rNode: RElement, prop: string, value: any) {
  if (isClassBased) {
 ...
 */
export function writeDirectStyle(renderer: Renderer2, element: RElement, newValue: string) {
 ...
 * @param newValue The new class list to write.
 */
export function writeDirectClass(renderer: Renderer2, element: RElement, newValue: string) {
  ngDevMode && assertString(newValue, '\'newValue\' should be a string');
  if (newValue === '') {
