...
import {decrementActiveDirectiveSuperClassDepthPosition, incrementActiveDirectiveSuperClassDepthPosition} from '../state';
    ...
    if (superDef) {
      ...
      if (superHostBindings) {
        if (prevHostBindings) {
          ...
          // relying on the directive uniqueId exclusively is not enoguh is because the
          ...
          definition.hostBindings = (rf: RenderFlags, ctx: any, elementIndex: number) => {
            ...
            incrementActiveDirectiveSuperClassDepthPosition();
            try {
              superHostBindings(rf, ctx, elementIndex);
            } finally {
              decrementActiveDirectiveSuperClassDepthPosition();
            }
