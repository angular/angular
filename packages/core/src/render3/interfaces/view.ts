...
export interface LViewDebug<T = unknown> {
   ...
   */
  readonly parent: LViewDebug<T>|LContainerDebug|null;

  /**
   * Next sibling to the `LView`.
   */
  readonly next: LViewDebug<T>|LContainerDebug|null;
   ...
   * Child `LView`s
   */
  readonly childViews: Array<LViewDebug<T>|LContainerDebug>;
