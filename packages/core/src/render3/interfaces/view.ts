...
import {AfterRenderSequence} from '../after_render/manager';
...
export const AFTER_RENDER_SEQUENCES_TO_REGISTER = 25;
...
export interface LView<T = unknown> extends Array<any> {
  ...
  [AFTER_RENDER_SEQUENCES_TO_REGISTER]: AfterRenderSequence[] | null;
}
