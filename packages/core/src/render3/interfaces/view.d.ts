...
export declare const EFFECTS_TO_SCHEDULE = 22;
export declare const EFFECTS = 23;
export declare const REACTIVE_TEMPLATE_CONSUMER = 24;
export declare const AFTER_RENDER_SEQUENCES_TO_ADD = 25;
export declare const ANIMATIONS = 26;
/**
 ...
 */
export type TData = (TNode | PipeDef<any> | DirectiveDef<any> | ComponentDef<any> | number | TStylingRange | TStylingKey | ProviderToken<any> | TI18n | I18nUpdateOpCodes | TIcu | null | string | TDeferBlockDetails)[];
