...
/**
 * A definition of a Pipe as generated by the Angular compiler.
 *
 * see: `ɵɵdefinePipe`
 */
export interface ProtoPipeDef<T> {
...
export class PipeDef<T> {
  ...
  constructor(protoPipeDef: ProtoPipeDef<T>) {
    this.type = protoPipeDef.type;
    this.name = protoPipeDef.name;
    this.factory = null;
    this.pure = protoPipeDef.pure !== false;
    this.onDestroy = protoPipeDef.type.prototype.ngOnDestroy ?? null;
  }
}
