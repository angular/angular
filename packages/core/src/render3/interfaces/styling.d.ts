 ...
 */
export declare const enum StylingRange {
    PREV_SHIFT = 17,
...
export declare function toTStylingRange(prev: number, next: number): TStylingRange;
export declare function getTStylingRangePrev(tStylingRange: TStylingRange): number;
export declare function getTStylingRangePrevDuplicate(tStylingRange: TStylingRange): boolean;
export declare function setTStylingRangePrev(tStylingRange: TStylingRange, previous: number): TStylingRange;
export declare function setTStylingRangePrevDuplicate(tStylingRange: TStylingRange): TStylingRange;
export declare function getTStylingRangeNext(tStylingRange: TStylingRange): number;
export declare function setTStylingRangeNext(tStylingRange: TStylingRange, next: number): TStylingRange;
export declare function getTStylingRangeNextDuplicate(tStylingRange: TStylingRange): boolean;
export declare function setTStylingRangeNextDuplicate(tStylingRange: TStylingRange): TStylingRange;
export declare function getTStylingRangeTail(tStylingRange: TStylingRange): number;
