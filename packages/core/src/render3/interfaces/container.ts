...
export const enum ActiveIndexFlag {
  ...
  /**
   * Flag to signify that this `LContainer` may have transplanted views which need to be change detected.
  ...
  /**
   * When incrementing the active index for inline embedded views, the amount to increment to leave space for other
   * flags.
   */
  INCREMENT = 1 << SHIFT,
}
...
export interface LContainer extends Array<any> {
   ...
   * unused.
   *
   * The lowest bit signals that this `LContainer` has transplanted views which need to be change detected
