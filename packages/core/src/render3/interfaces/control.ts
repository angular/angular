...
/** A unique symbol used to identify {@link ɵFieldDirective} implementations. */
export const ɵCONTROL: unique symbol = Symbol('CONTROL');

/**
 * Instructions for dynamically binding a {@link ɵFieldDirective} to a form control.
 */
 ...
 */
export interface ɵFieldDirective<T> {
  /**
   * The presence of this property is used to identify {@link ɵFieldDirective} implementations, while the
