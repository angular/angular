 ...
 */
export declare const enum IcuCreateOpCode {
    /**
 ...
 * ```
 */
export interface IcuCreateOpCodes extends Array<number | string | ELEMENT_MARKER | ICU_MARKER | null>, I18nDebug {
 ...
 * See `I18nMutateOpCodes` documentation.
 */
export declare const ICU_MARKER: ICU_MARKER;
 ...
 */
export declare enum I18nCreateOpCode {
    /**
...
export declare const enum I18nPlaceholderType {
    ELEMENT = 0,
    SUBTEMPLATE = 1
}
export declare const enum I18nNodeKind {
    TEXT = 0,
    ELEMENT = 1,
    PLACEHOLDER = 2,
    ICU = 3
