...
import {CONTEXT, DECLARATION_LCONTAINER, FLAGS, INJECTOR, PARENT, TVIEW} from './interfaces/view';
  ...
  attachToViewContainerRef() {
    if (this._appRef) {
      throw new RuntimeError(
        902 /* RuntimeErrorCode.VIEW_ALREADY_ATTACHED */,
 ...
 */
export function isViewDirty(view) {
  return (
    requiresRefreshOrTraversal(view._lView) || !!((view._lView[FLAGS] & 64) /* LViewFlags.Dirty */)
  );
}
export function markForRefresh(view) {
