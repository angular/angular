...
export function getDependenciesFromInjectable(injector, token) {
  ...
  const dependencies = unformattedDependencies.map((dep) => {
    ...
    formattedDependency.flags = {
      optional:
        (8 /* InternalInjectFlags.Optional */ & flags) === 8 /* InternalInjectFlags.Optional */,
      ...
      skipSelf:
        (4 /* InternalInjectFlags.SkipSelf */ & flags) === 4 /* InternalInjectFlags.SkipSelf */,
    };
...
//# sourceMappingURL=injector_discovery_utils.js.map
