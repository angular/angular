...
// These are a copy of the core selector parse from packages/compiler/src/core.ts
// They are duplicated here as they cannot be directly referenced from compiler.
