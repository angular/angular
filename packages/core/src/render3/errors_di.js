...
export function cyclicDependencyError(token, path) {
...
export function cyclicDependencyErrorWithDetails(token, path) {
 ...
 */
export function prependTokenToDependencyPath(error, token) {
  error[NG_TOKEN_PATH] ?? (error[NG_TOKEN_PATH] = []);
 ...
 */
export function augmentRuntimeError(error, source) {
 ...
 */
export function createRuntimeError(message, code, path) {
...
//# sourceMappingURL=errors_di.js.map
