...
export interface DepsTrackerApi {
     ...
     */
    getComponentDependencies(cmp: ComponentType<any>, rawImports?: (Type<any> | (() => Type<any>))[]): ComponentDependencies;
    /**
     ...
     * `clearScopeCacheFor` method.
     */
    getStandaloneComponentScope(type: ComponentType<any>, rawImports: (Type<any> | (() => Type<any>))[]): StandaloneComponentScope;
    /**
