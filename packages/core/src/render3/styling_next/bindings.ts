...
let deferredBindingQueue: (TStylingContext | number | string | null)[]|null = null;
...
function updateBindingData(
  ...
  if (!isContextLocked(context)) {
    if (deferRegistration) {
      ...
      deferredBindingQueue && flushDeferredBindings();
...
function deferBindingRegistration(
  ...
  deferredBindingQueue = deferredBindingQueue || [];
