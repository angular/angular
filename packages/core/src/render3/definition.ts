...
export function ɵɵdefinePipe<T>(pipeDef: {
  ...
  return <PipeDef<T>>{
    ...
    standalone: pipeDef.standalone === undefined ? NG_STANDALONE_DEFAULT_VALUE : pipeDef.standalone,
...
function getNgDirectiveDef<T>(directiveDefinition: DirectiveDefinition<T>): DirectiveDef<T> {
  ...
  return {
    ...
    standalone:
      directiveDefinition.standalone === undefined
        ? NG_STANDALONE_DEFAULT_VALUE
        : directiveDefinition.standalone,
