...
import {PROJECTED_SIGNAL_NODE, type ProjectedSignalNode} from './internal';
...
export function structuralSignal<T>(
  ...
  // `parent` attempt to trigger this signal (subject to `PROJECTED_SIGNAL_NODE`'s short-circuiting).
  //
