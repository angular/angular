...
/**
 * The `signal` function allows creation of signals with optional initial values.
 *
 * @publicAPI
 */
...
// REPLACE the existing signal export with:
/**
 ...
 * @publicApi
 */
export const signal: SignalFunction = signalFunction as SignalFunction;
