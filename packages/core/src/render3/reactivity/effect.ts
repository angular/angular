...
import {FLAGS, LViewFlags, LView, EFFECTS, ENVIRONMENT} from '../interfaces/view';
...
import {getNodeInjectable, getNodeInjectorLView} from '../di';
...
export function effect(
  ...
  if (viewContext !== null && !options?.forceRoot) {
    ...
    node = createRootEffect(effectFn, injector.get(EffectScheduler));
  }
...
export const ROOT_EFFECT_NODE: Omit<RootEffectNode, 'fn' | 'scheduler' | 'injector'> =
  /* @__PURE__ */ (() => ({
    ...BASE_EFFECT_NODE,
