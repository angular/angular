...
import {ComponentMetadata, DirectiveMetadata, getComponent, getComponentOrDirectiveMetadata, getDirectives, getHostElement, getRenderedText} from './util/discovery_utils';
...
export {
  ...
  DirectiveType,
  getComponent,
  getComponentOrDirectiveMetadata,
  getDirectives,
  getHostElement,
  getRenderedText,
