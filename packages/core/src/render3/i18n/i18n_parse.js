    ...
    if ((i & 1) === 0) {
      ...
      if (isClosing) {
        ...
        const placeholderNode = {
          ...
          children: [],
          type:
            type === 35 /* CharCode.HASH */
              ? 0 /* I18nPlaceholderType.ELEMENT */
...
function createTNodeAndAddOpCode(
  ...
  const tNode = createTNodeAtIndex(
    tView,
    i18nNodeIdx,
    isICU ? 32 /* TNodeType.Icu */ : 1 /* TNodeType.Text */,
...
function generateBindingUpdateOpCodes(
  ...
  updateOpCodes.push(
    (destinationNode << 2) /* I18nUpdateOpCode.SHIFT_REF */ |
...
function addUpdateIcuSwitch(update, icuExpression, index) {
  update.push(
    ...
    (index << 2) /* I18nUpdateOpCode.SHIFT_REF */ | 2 /* I18nUpdateOpCode.IcuSwitch */,
  );
}
function addUpdateIcuUpdate(update, bindingMask, index) {
  update.push(
    bindingMask,
    1,
    (index << 2) /* I18nUpdateOpCode.SHIFT_REF */ | 3 /* I18nUpdateOpCode.IcuUpdate */,
  );
}
function addCreateNodeAndAppend(create, marker, text, appendToParentIdx, createAtIdx) {
  ...
  create.push(
    text,
    createAtIdx,
    icuCreateOpCode(0 /* IcuCreateOpCode.AppendChild */, appendToParentIdx, createAtIdx),
  );
}
function addCreateAttribute(create, newIndex, attr) {
  create.push(
    (newIndex << 1) /* IcuCreateOpCode.SHIFT_REF */ | 1 /* IcuCreateOpCode.Attr */,
    attr.name,
    attr.value,
  );
}
//# sourceMappingURL=i18n_parse.js.map
