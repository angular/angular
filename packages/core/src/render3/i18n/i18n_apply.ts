...
import {createCommentNode, createElementNode, createTextNode, nativeInsertBefore, nativeParentNode, nativeRemoveNode} from '../node_manipulation';
...
export function setMaskBit(hasChange: boolean) {
  if (hasChange) {
    changeMask = changeMask | (1 << changeMaskCounter);
  }
  if (changeMask < 32) {
    changeMaskCounter++;
  }
      ...
      switch (opCode & I18nMutateOpCode.MASK_INSTRUCTION) {
        case I18nMutateOpCode.AppendChild:
          ...
          if (parentRNode !== null) {
            ...
            nativeInsertBefore(renderer, parentRNode, child, insertInFrontOf);
          ...
          if (opCode < 0) {
            ...
            switch (opCode & I18nUpdateOpCode.MASK_OPCODE) {
              ...
              case I18nUpdateOpCode.Text:
                textBindingInternal(lView, nodeIndex - HEADER_OFFSET, value);
                break;
