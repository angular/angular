...
export interface DirectiveDefArgs<T> {
  type: Type<T>,
      factory: () => T,
               refresh?:
                   (this: DirectiveDef<T>, directiveIndex: number, elementIndex: number) => void,
               inputs?: {[P in keyof T]?: string}, outputs?: {[P in keyof T]?: string},
               methods?: {[P in keyof T]?: string}, features?: DirectiveDefFeature[];
}

export interface ComponentDefArgs<T> extends DirectiveDefArgs<T> {
  tag: string, template: ComponentTemplate<T>refresh?:
                   (this: ComponentDef<T>, directiveIndex: number,
