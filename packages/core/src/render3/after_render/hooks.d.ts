 ...
 */
export type ɵFirstAvailable<T extends unknown[]> = T extends [infer H, ...infer R] ? [H] extends [never] ? ɵFirstAvailable<R> : [H] : [];
/**
 ...
 * @publicApi 20.0
 */
export declare function afterEveryRender<E = never, W = never, M = never>(spec: {
    earlyRead?: () => E;
 ...
 * @publicApi 20.0
 */
export declare function afterEveryRender(callback: VoidFunction, options?: AfterRenderOptions): AfterRenderRef;
/**
...
export declare const NOOP_AFTER_RENDER_REF: AfterRenderRef;
