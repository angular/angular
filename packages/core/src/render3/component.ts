...
import {assertDefined, assertIndexInRange} from '../util/assert.js';
...
import {diPublicInInjector, getOrCreateNodeInjectorForNode} from './di.js';
import {throwProviderNotFoundError} from './errors_di.js';
import {registerPostOrderHooks} from './hooks.js';
import {addToViewTree, CLEAN_PROMISE, createLView, createTView, getOrCreateTComponentView, getOrCreateTNode, initTNodeFlags, instantiateRootComponent, invokeHostBindingsInCreationMode, locateHostElement, markAsComponentHost, refreshView, registerHostBindingOpCodes, renderView} from './instructions/shared.js';
import {ComponentDef, ComponentType, RenderFlags} from './interfaces/definition.js';
import {TElementNode, TNodeType} from './interfaces/node.js';
import {PlayerHandler} from './interfaces/player.js';
import {domRendererFactory3, Renderer3, RendererFactory3} from './interfaces/renderer.js';
import {RElement} from './interfaces/renderer_dom.js';
import {CONTEXT, HEADER_OFFSET, LView, LViewFlags, RootContext, RootContextFlags, TVIEW, TViewType} from './interfaces/view.js';
import {writeDirectClass, writeDirectStyle} from './node_manipulation.js';
import {enterView, getCurrentTNode, leaveView, setSelectedIndex} from './state.js';
import {computeStaticStyling} from './styling/static_styling.js';
import {setUpAttributes} from './util/attrs_utils.js';
import {publishDefaultGlobalUtils} from './util/global_utils.js';
import {defaultScheduler} from './util/misc_utils.js';
import {getRootContext} from './util/view_traversal_utils.js';
