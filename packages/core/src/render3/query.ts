...
class TQueryMetadata_ implements TQueryMetadata {
  constructor(
      public predicate: Token<unknown>|string[], public flags: QueryFlags,
...
export function ɵɵviewQuery<T>(
    predicate: Token<unknown>|string[], flags: QueryFlags, read?: any): void {
...
export function ɵɵcontentQuery<T>(
    directiveIndex: number, predicate: Token<unknown>|string[], flags: QueryFlags,
    read?: any): void {
  ngDevMode && assertNumber(flags, 'Expecting flags');
  const tView = getTView();
  if (tView.firstCreatePass) {
