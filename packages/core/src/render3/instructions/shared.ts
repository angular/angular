...
import {enterView, getBindingsEnabled, getCheckNoChangesMode, getIsParent, getLView, getNamespace, getPreviousOrParentTNode, incrementActiveDirectiveId as generateAndStoreNextDirectiveUniqueId, isCreationMode, leaveView, namespaceHTML, resetComponentState, setActiveHostElement, setBindingRoot, setCheckNoChangesMode, setCurrentDirectiveDef, setCurrentQueryIndex, setIsParent, setPreviousOrParentTNode, setSelectedIndex} from '../state';
    ...
    for (let i = 0; i < tView.expandoInstructions.length; i++) {
      ...
      if (typeof instruction === 'number') {
        ...
        if (instruction !== null) {
          ...
          generateAndStoreNextDirectiveUniqueId();
        }
