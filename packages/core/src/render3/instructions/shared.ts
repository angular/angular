...
import {DoCheck, OnChanges, OnInit} from '../../interface/lifecycle_hooks.js';
import {CUSTOM_ELEMENTS_SCHEMA, NO_ERRORS_SCHEMA, SchemaMetadata} from '../../metadata/schema.js';
import {ViewEncapsulation} from '../../metadata/view.js';
import {validateAgainstEventAttributes, validateAgainstEventProperties} from '../../sanitization/sanitization.js';
import {Sanitizer} from '../../sanitization/sanitizer.js';
import {assertDefined, assertDomNode, assertEqual, assertGreaterThanOrEqual, assertIndexInRange, assertNotEqual, assertNotSame, assertSame, assertString} from '../../util/assert.js';
import {escapeCommentText} from '../../util/dom.js';
import {normalizeDebugBindingName, normalizeDebugBindingValue} from '../../util/ng_reflect.js';
import {stringify} from '../../util/stringify.js';
import {assertFirstCreatePass, assertFirstUpdatePass, assertLContainer, assertLView, assertTNodeForLView, assertTNodeForTView} from '../assert.js';
import {attachPatchData, readPatchedLView} from '../context_discovery.js';
...
import {throwMultipleComponentError} from '../errors.js';
import {executeCheckHooks, executeInitAndCheckHooks, incrementInitPhaseFlags} from '../hooks.js';
import {CONTAINER_HEADER_OFFSET, HAS_TRANSPLANTED_VIEWS, LContainer, MOVED_VIEWS} from '../interfaces/container.js';
import {ComponentDef, ComponentTemplate, DirectiveDef, DirectiveDefListOrFactory, HostBindingsFunction, PipeDefListOrFactory, RenderFlags, ViewQueriesFunction} from '../interfaces/definition.js';
import {NodeInjectorFactory} from '../interfaces/injector.js';
import {getUniqueLViewId} from '../interfaces/lview_tracking.js';
import {AttributeMarker, InitialInputData, InitialInputs, LocalRefExtractor, PropertyAliases, PropertyAliasValue, TAttributes, TConstantsOrFactory, TContainerNode, TDirectiveHostNode, TElementContainerNode, TElementNode, TIcuContainerNode, TNode, TNodeFlags, TNodeType, TProjectionNode} from '../interfaces/node.js';
import {isProceduralRenderer, Renderer3, RendererFactory3} from '../interfaces/renderer.js';
import {RComment, RElement, RNode, RText} from '../interfaces/renderer_dom.js';
import {SanitizerFn} from '../interfaces/sanitization.js';
import {isComponentDef, isComponentHost, isContentQueryHost, isRootView} from '../interfaces/type_checks.js';
import {CHILD_HEAD, CHILD_TAIL, CLEANUP, CONTEXT, DECLARATION_COMPONENT_VIEW, DECLARATION_VIEW, EMBEDDED_VIEW_INJECTOR, FLAGS, HEADER_OFFSET, HOST, HostBindingOpCodes, ID, InitPhaseState, INJECTOR, LView, LViewFlags, NEXT, PARENT, RENDERER, RENDERER_FACTORY, RootContext, RootContextFlags, SANITIZER, T_HOST, TData, TRANSPLANTED_VIEWS_TO_REFRESH, TVIEW, TView, TViewType} from '../interfaces/view.js';
import {assertPureTNodeType, assertTNodeType} from '../node_assert.js';
import {updateTextNode} from '../node_manipulation.js';
import {isInlineTemplate, isNodeMatchingSelectorList} from '../node_selector_matcher.js';
import {profiler, ProfilerEvent} from '../profiler.js';
import {enterView, getBindingsEnabled, getCurrentDirectiveIndex, getCurrentParentTNode, getCurrentTNode, getCurrentTNodePlaceholderOk, getSelectedIndex, isCurrentTNodeParent, isInCheckNoChangesMode, isInI18nBlock, leaveView, setBindingIndex, setBindingRootForHostBindings, setCurrentDirectiveIndex, setCurrentQueryIndex, setCurrentTNode, setIsInCheckNoChangesMode, setSelectedIndex} from '../state.js';
import {NO_CHANGE} from '../tokens.js';
import {isAnimationProp, mergeHostAttrs} from '../util/attrs_utils.js';
import {INTERPOLATION_DELIMITER} from '../util/misc_utils.js';
import {renderStringify, stringifyForError} from '../util/stringify_utils.js';
import {getFirstLContainer, getLViewParent, getNextLContainer} from '../util/view_traversal_utils.js';
import {getComponentLViewByIndex, getNativeByIndex, getNativeByTNode, isCreationMode, resetPreOrderHookFlags, unwrapLView, updateTransplantedViewCount, viewAttachedToChangeDetector} from '../util/view_utils.js';

import {selectIndexInternal} from './advance.js';
import {attachLContainerDebug, attachLViewDebug, cloneToLViewFromTViewBlueprint, cloneToTViewData, LCleanup, LViewBlueprint, MatchesArray, TCleanup, TNodeDebug, TNodeInitialInputs, TNodeLocalNames, TViewComponents, TViewConstructor} from './lview_debug.js';
