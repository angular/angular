...
import {stylingBindingInternal} from './styling';
...
export function ɵɵstylePropInterpolate1(
  ...
  stylePropLocal(prop, interpolatedValue as string, valueSuffix);
...
function stylePropLocal(prop: string, value: string, suffix: string | null | undefined) {
