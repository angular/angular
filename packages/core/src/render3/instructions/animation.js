 ...
 */
import {MAX_ANIMATION_TIMEOUT} from '../../animation/interfaces';
 ...
 * @codeGenApi
 */
export function ɵɵanimateEnter(value) {
...
export function runEnterAnimation(lView, tNode, value) {
 ...
 * @codeGenApi
 */
export function ɵɵanimateEnterListener(value) {
  performanceMarkFeature('NgAnimateEnter');
  if ((typeof ngServerMode !== 'undefined' && ngServerMode) || !areAnimationSupported) {
 ...
 * @codeGenApi
 */
export function ɵɵanimateLeave(value) {
 ...
 * @codeGenApi
 */
export function ɵɵanimateLeaveListener(value) {
  performanceMarkFeature('NgAnimateLeave');
  if ((typeof ngServerMode !== 'undefined' && ngServerMode) || !areAnimationSupported) {
