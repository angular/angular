...
export declare const REFERENCE_NODE_HOST = "h";
/** Encodes that the node lookup should start from the document body node. */
export declare const REFERENCE_NODE_BODY = "b";
/**
...
export declare const NODE_NAVIGATION_STEP_FIRST_CHILD = "f";
export declare const NODE_NAVIGATION_STEP_NEXT_SIBLING = "n";
/**
 * Keys within serialized view data structure to represent various
 * parts. See the `SerializedView` interface below for additional information.
 */
export declare const ELEMENT_CONTAINERS = "e";
export declare const TEMPLATES = "t";
export declare const CONTAINERS = "c";
export declare const MULTIPLIER = "x";
export declare const NUM_ROOT_NODES = "r";
export declare const TEMPLATE_ID = "i";
export declare const NODES = "n";
export declare const DISCONNECTED_NODES = "d";
export declare const I18N_DATA = "l";
export declare const DEFER_BLOCK_ID = "di";
export declare const DEFER_BLOCK_STATE = "s";
export declare const DEFER_PARENT_BLOCK_ID = "p";
export declare const DEFER_HYDRATE_TRIGGERS = "t";
export declare const DEFER_PREFETCH_TRIGGERS = "pt";
/**
