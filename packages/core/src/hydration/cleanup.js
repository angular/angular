...
import {DEFER_BLOCK_ID, NUM_ROOT_NODES} from './interfaces';
...
export function removeDehydratedViewList(deferBlock) {
 ...
 */
export function cleanupLContainer(lContainer) {
 ...
 */
export function cleanupHydratedDeferBlocks(deferBlock, hydratedBlocks, registry, appRef) {
  if (deferBlock !== null) {
