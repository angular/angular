...
let ImagePerformanceWarning = class ImagePerformanceWarning {
  constructor() {
...
ImagePerformanceWarning = __decorate([Injectable({providedIn: 'root'})], ImagePerformanceWarning);
export {ImagePerformanceWarning};
function logLazyLCPWarning(src) {
  console.warn(
    formatRuntimeError(
      -913 /* RuntimeErrorCode.IMAGE_PERFORMANCE_WARNING */,
...
//# sourceMappingURL=image_performance_warning.js.map
