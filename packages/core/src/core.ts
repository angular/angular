...
export * from './di';
export {createPlatform, assertPlatform, destroyPlatform, getPlatform, platform, PlatformRef, ApplicationRef, enableProdMode, isDevMode, createPlatformFactory, NgProbeToken} from './application_ref';
