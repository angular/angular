...
export {InjectableDef as ɵInjectableDef, InjectorDef as ɵInjectorDef, getInjectableDef as ɵgetInjectableDef} from './di/interfaces/defs';
...
export {resolveComponentResources as ɵresolveComponentResources} from './render3/jit/resource_loading';
export {_sanitizeHtml as ɵ_sanitizeHtml} from './sanitization/html_sanitizer';
export {_sanitizeStyle as ɵ_sanitizeStyle} from './sanitization/style_sanitizer';
export {_sanitizeUrl as ɵ_sanitizeUrl} from './sanitization/url_sanitizer';
export {devModeEqual as ɵdevModeEqual} from './utils/WrappedValue';
export {isListLikeIterable as ɵisListLikeIterable} from './utils/WrappedValue';
export {looseIdentical as ɵlooseIdentical} from './utils/comparison';
export {makeDecorator as ɵmakeDecorator} from './utils/decorators';
export {global as ɵglobal} from './utils/global';
export {isObservable as ɵisObservable, isPromise as ɵisPromise} from './utils/lang';
