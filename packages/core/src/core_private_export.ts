...
export {createRuntimeErrorClass as ɵcreateRuntimeErrorClass, PackageErrorPrefix as ɵPackageErrorPrefix, RuntimeError as ɵRuntimeError, RuntimeErrorCode as ɵRuntimeErrorCode} from './render3/error_code';
