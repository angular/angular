...
export interface NgModule {
   ...
   * and re-exported. 
   * For example, `CommonModule` imports `BrowserModule`, and also exports
   * it, which makes the declarables from `BrowserModule` available 
   * wherever `CommonModule` is imported.
   *
   * ### Example
   *
