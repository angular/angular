...
let ApplicationRef = class ApplicationRef {
  ...
  constructor() {
    ...
    this.allTestViews = new Set();
    this.autoDetectTestViews = new Set();
     ...
     */
    this.components = [];
    this.internalPendingTask = inject(PendingTasksInternal);
...
ApplicationRef = __decorate([Injectable({providedIn: 'root'})], ApplicationRef);
