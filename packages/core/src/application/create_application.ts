...
export function internalCreateApplication(config: {
  ...
  if (typeof ngServerMode !== 'undefined' && ngServerMode && !config.platformInjector) {
    throw new RuntimeError(
      RuntimeErrorCode.PLATFORM_NOT_FOUND,
      ngDevMode &&
        `Missing Platform: This occurs when you use 'bootstrapApplication' instead of 'bootstrapServerApplication' to bootstrap the server application.`,
    );
  }
