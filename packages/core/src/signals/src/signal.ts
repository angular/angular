...
export function signal<T>(initialValue: T, options?: CreateSignalOptions<T>): WritableSignal<T> {
  ...
  const signalFn = createSignalFromFunction(
                       signalNode, signalNode.signal.bind(signalNode),
                       createWritableSignalExtraApi(signalNode)) as unknown as WritableSignal<T>;
  return signalFn;
}
...
function createWritableSignalExtraApi<T>(signalNode: WritableSignalImpl<T>):
