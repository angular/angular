 ...
 */
import {InjectionToken, makeEnvironmentProviders} from './di/index';
 ...
 */
export const NG_REFLECT_ATTRS_FLAG = new InjectionToken(
 ...
 * @publicApi
 */
export function provideNgReflectAttributes() {
  const providers =
