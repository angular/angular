...
import {assertNodeInjector} from '../render3/assert.js';
...
import {getParentInjectorLocation, NodeInjector} from '../render3/di.js';
import {addToViewTree, createLContainer} from '../render3/instructions/shared.js';
import {CONTAINER_HEADER_OFFSET, LContainer, NATIVE, VIEW_REFS} from '../render3/interfaces/container.js';
import {NodeInjectorOffset} from '../render3/interfaces/injector.js';
import {TContainerNode, TDirectiveHostNode, TElementContainerNode, TElementNode, TNodeType} from '../render3/interfaces/node.js';
import {RComment, RElement} from '../render3/interfaces/renderer_dom.js';
import {isLContainer} from '../render3/interfaces/type_checks.js';
import {LView, PARENT, RENDERER, T_HOST, TVIEW} from '../render3/interfaces/view.js';
import {assertTNodeType} from '../render3/node_assert.js';
import {addViewToContainer, destroyLView, detachView, getBeforeNodeForView, insertView, nativeInsertBefore, nativeNextSibling, nativeParentNode} from '../render3/node_manipulation.js';
import {getCurrentTNode, getLView} from '../render3/state.js';
import {getParentInjectorIndex, getParentInjectorView, hasParentInjector} from '../render3/util/injector_utils.js';
import {getNativeByTNode, unwrapRNode, viewAttachedToContainer} from '../render3/util/view_utils.js';
import {ViewRef as R3ViewRef} from '../render3/view_ref.js';
import {addToArray, removeFromArray} from '../util/array_utils.js';
import {assertDefined, assertEqual, assertGreaterThan, assertLessThan, throwError} from '../util/assert.js';

import {ComponentFactory, ComponentRef} from './component_factory.js';
import {createElementRef, ElementRef} from './element_ref.js';
import {NgModuleRef} from './ng_module_factory.js';
import {TemplateRef} from './template_ref.js';
import {EmbeddedViewRef, ViewRef} from './view_ref.js';
/**
