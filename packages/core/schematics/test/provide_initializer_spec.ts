...
describe('Provide initializer migration', () => {
  ...
  it('should transform APP_INITIALIZER + useValue async function into provideAppInitializer',
     async () => {
       const content = await migrateCode(`
      import { APP_INITIALIZER } from '@angular/core';
  ...
  it('should transform ENVIRONMENT_INITIALIZER + useValue into provideEnvironmentInitializer',
     async () => {
       const content = await migrateCode(`
  ...
  it('should transform PLATFORM_INITIALIZER + useValue into providePlatformInitializer',
     async () => {
       const content = await migrateCode(`
