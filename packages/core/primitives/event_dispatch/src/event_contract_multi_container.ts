import {
  ...
  export class EventContractMultiContainer
    implements EventContractContainerManager
  {
    ...
    private readonly eventHandlerInstallers: Array<
      (container: EventContractContainer) => void
    > = [];
