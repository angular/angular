...
export { TestBed, getTestBed, TestBedStatic, inject, InjectSetupWrapper, withModule, TestComponentOptions, } from './test_bed';
...
export { ɵDeferBlockBehavior as DeferBlockBehavior, ɵDeferBlockState as DeferBlockState, } from '../../src/core';
