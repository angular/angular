  ...
  describe(`View NgContent`, () => {
    function hostElDef(
      ...
      return [
        ...
        directiveDef(checkIndex + 1, NodeFlags.Component, null, 0, AComp, []),
        ...contentNodes,
      ];
    }
        ...
        compViewDef(
          hostElDef(
            ...
            [
              ...
              directiveDef(3, NodeFlags.None, null, 0, CreateViewService, [
                TemplateRef,
                ViewContainerRef,
              ]),
            ],
