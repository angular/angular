  ...
  describe(`View Providers`, () => {
    describe('create', () => {
      ...
      it('should create providers lazily', () => {
        ...
        createAndGetRootNodes(
          compViewDef([
            ...
            providerDef(
              NodeFlags.TypeClassProvider | NodeFlags.LazyProvider,
              null,
              LazyService,
              LazyService,
              []
      ...
      it('should create useExisting providers', () => {
        createAndGetRootNodes(
          compViewDef([
            ...
            providerDef(NodeFlags.TypeUseExistingProvider, null, 'someToken', null, [
              'someExistingToken',
            ]),
      ...
      describe('deps', () => {
        ...
        it('should not inject deps from sibling root elements', () => {
          ...
          expect(() => createAndGetRootNodes(compViewDef(rootElNodes))).toThrowError(
            `${
              ivyEnabled ? 'R3InjectorError' : 'StaticInjectorError'
            }(DynamicTestModule)[SomeService -> Dep]: \n` +
          ...
          expect(() => createAndGetRootNodes(compViewDef(nonRootElNodes))).toThrowError(
            `${
              ivyEnabled ? 'R3InjectorError' : 'StaticInjectorError'
            }(DynamicTestModule)[SomeService -> Dep]: \n` +
              '  StaticInjectorError(Platform: core)[SomeService -> Dep]: \n' +
        ...
        it('should throw for missing dependencies', () => {
          expect(() =>
            ...
            `${
              ivyEnabled ? 'R3InjectorError' : 'StaticInjectorError'
            }(DynamicTestModule)[nonExistingDep]: \n` +
        ...
        it('should skip the current element when using SkipSelf', () => {
          createAndGetRootNodes(
            compViewDef([
              ...
              providerDef(NodeFlags.TypeValueProvider, null, 'someToken', 'someValue', []),
              directiveDef(4, NodeFlags.None, null, 0, SomeService, [
                [DepFlags.SkipSelf, 'someToken'],
              ]),
            ])
          );
        ...
        describe('builtin tokens', () => {
          ...
          it('should inject Renderer2', () => {
            createAndGetRootNodes(
              compViewDef([
                elementDef(0, NodeFlags.None, null, null, 1, 'span', null, null, null, null, () =>
    ...
    describe('outputs', () => {
      it('should listen to provider events', () => {
        ...
        const {view, rootNodes} = createAndGetRootNodes(
          compViewDef([
            ...
            directiveDef(1, NodeFlags.None, null, 0, SomeService, [], null, {
              emitter: 'someEventName',
            }),
          ])
        );
      ...
      it('should report debug info on event errors', () => {
        ...
        const {view, rootNodes} = createAndGetRootNodes(
          compViewDef([
            elementDef(0, NodeFlags.None, null, null, 1, 'span', null, null, null, () => {
              throw new Error('Test');
            }),
            directiveDef(1, NodeFlags.None, null, 0, SomeService, [], null, {
              emitter: 'someEventName',
    ...
    describe('lifecycle hooks', () => {
      it('should call the lifecycle hooks in the right order', () => {
        ...
        const allFlags =
          ...
          NodeFlags.DoCheck |
          NodeFlags.OnChanges |
          NodeFlags.AfterContentInit |
          NodeFlags.AfterContentChecked |
          NodeFlags.AfterViewInit |
      ...
      it('should call ngOnChanges with the changed values and the non minified names', () => {
        ...
        const {view, rootNodes} = createAndGetRootNodes(
          compViewDef(
            [
              elementDef(0, NodeFlags.None, null, null, 1, 'span'),
              directiveDef(1, NodeFlags.OnChanges, null, 0, SomeService, [], {
                a: [0, 'nonMinifiedA'],
              }),
            ],
            (check, view) => {
