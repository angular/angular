...
@Directive({selector: 'simple', standalone: false})
class Simple {
  @Input() marker: string | undefined;
}

@Component({selector: 'view-child-type-selector', template: '', standalone: false})
class ViewChildTypeSelectorComponent {
  @ViewChild(Simple) child!: Simple;
}

@Component({selector: 'view-child-string-selector', template: '', standalone: false})
class ViewChildStringSelectorComponent {
  @ViewChild('child') child!: ElementRef;
}

@Component({selector: 'view-children-type-selector', template: '', standalone: false})
