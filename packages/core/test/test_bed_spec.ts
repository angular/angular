...
describe('TestBed', () => {
  ...
  onlyInIvy('TestBed new feature to allow declaration and import of component').it(
    'should allow both the declaration and import of a component into the testing module',
    () => {
  ...
  onlyInIvy('TestBed should handle AOT pre-compiled Components').describe(
    'AOT pre-compiled components',
    () => {
      /**
  ...
  onlyInIvy('patched ng defs should be removed after resetting TestingModule').describe(
    'resetting ng defs',
    () => {
  ...
  onlyInIvy('VE injects undefined when provider does not have useValue or useFactory').describe(
    'overrides provider',
    () => {
  ...
  onlyInIvy('uses Ivy-specific compiler output').it(
    'should handle provider overrides when module imports are provided as a function',
    () => {
