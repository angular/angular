...
@Directive({selector: '[simpleDirective]', standalone: false})
class SimpleDirective {
  @Input('simpleDirective') value: any = null;
}

@Component({selector: '[simpleComponent]', template: '', standalone: false})
class SimpleComponent {}

@Directive({selector: '[someOtherDirective]', standalone: false})
class SomeOtherDirective {}

@Directive({selector: '[cycleDirective]', standalone: false})
class CycleDirective {
  constructor(self: CycleDirective) {}
}

@Directive({selector: '[needsDirectiveFromSelf]', standalone: false})
...
@Directive({selector: '[optionallyNeedsDirective]', standalone: false})
...
@Directive({selector: '[needsComponentFromHost]', standalone: false})
...
@Directive({selector: '[needsDirectiveFromHost]', standalone: false})
...
@Directive({selector: '[needsDirective]', standalone: false})
...
@Directive({selector: '[needsService]', standalone: false})
class NeedsService {
  service: any;
...
@Directive({selector: '[needsAppService]', standalone: false})
...
@Component({selector: '[needsHostAppService]', template: '', standalone: false})
...
@Component({selector: '[needsServiceComponent]', template: '', standalone: false})
...
@Directive({selector: '[needsServiceFromHost]', standalone: false})
...
@Directive({selector: '[needsAttribute]', standalone: false})
...
@Directive({selector: '[needsAttributeNoType]', standalone: false})
class NeedsAttributeNoType {
  constructor(@Attribute('foo') public fooAttribute: any) {}
}

@Directive({selector: '[needsElementRef]', standalone: false})
class NeedsElementRef {
  constructor(public elementRef: ElementRef) {}
}

@Directive({selector: '[needsViewContainerRef]', standalone: false})
class NeedsViewContainerRef {
  constructor(public viewContainer: ViewContainerRef) {}
}

@Directive({selector: '[needsTemplateRef]', standalone: false})
class NeedsTemplateRef {
  constructor(public templateRef: TemplateRef<Object>) {}
}

@Directive({selector: '[optionallyNeedsTemplateRef]', standalone: false})
class OptionallyNeedsTemplateRef {
  constructor(@Optional() public templateRef: TemplateRef<Object>) {}
}

@Directive({selector: '[directiveNeedsChangeDetectorRef]', standalone: false})
...
@Pipe({name: 'purePipe', pure: true, standalone: false})
...
@Pipe({name: 'impurePipe', pure: false, standalone: false})
...
@Pipe({name: 'pipeNeedsChangeDetectorRef', standalone: false})
...
@Pipe({name: 'pipeNeedsService', standalone: false})
...
@Pipe({name: 'duplicatePipe', standalone: false})
...
@Component({selector: 'root', template: '', standalone: false})
class TestComp {}
...
describe('View injector', () => {
  ...
  describe('injection', () => {
    ...
    it('should support ngOnDestroy for lazy providers', () => {
      ...
      @Component({providers: [SomeInjectable], template: '', standalone: false})
      class SomeComp {}
  ...
  describe('view destruction', () => {
    @Component({selector: 'some-component', template: '', standalone: false})
    class SomeComponent {}

    @Component({selector: 'listener-and-on-destroy', template: '', standalone: false})
