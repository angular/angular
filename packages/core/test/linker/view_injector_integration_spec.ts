...
describe('View injector', () => {
  ...
  describe('injection', () => {
    ...
    obsoleteInIvy('This error is no longer generated by the compiler').it(
      'should not instantiate a directive with cyclic dependencies',
      () => {
    ...
    onlyInIvy('This error is generated by the runtime of Ivy').it(
      'should not instantiate a directive with cyclic dependencies',
      () => {
        TestBed.configureTestingModule({declarations: [CycleDirective]});
        expect(() => createComponent('<div cycleDirective></div>')).toThrowError(
          'Circular dep for CycleDirective'
        );
      }
    );
    ...
    onlyInIvy('This error is generated by the runtime of Ivy').it(
      ...
      () => {
        ...
        expect(() => createComponent('<div simpleComponent></div>')).toThrowError(
          'NodeInjector: NOT_FOUND [service]'
        );
      }
    );
    ...
    obsoleteInIvy('@Host() / @Self() no longer looks in module injector').it(
    ...
    onlyInIvy('This error is generated by the runtime of Ivy').it(
      ...
      () => {
        ...
        expect(() => createComponent('<div simpleComponent simpleDirective></div>')).toThrowError(
          'NodeInjector: NOT_FOUND [SimpleDirective]'
        );
      }
    );
  ...
  describe('pipes', () => {
    ...
    modifiedInIvy('Pure pipes are instantiated differently in view engine and ivy').it(
      'should cache pure pipes',
      () => {
