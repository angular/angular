  ...
  describe(`ChangeDetection`, () => {
    ...
    describe('expressions', () => {
      ...
      describe('pipes', () => {
        ...
        modifiedInIvy('Pure pipes are instantiated differently in view engine and ivy').it(
          'should call pure pipes that are used multiple times only when the arguments change and share state between pipe instances',
          fakeAsync(() => {
            const ctx = createCompFixture(
    ...
    describe('enforce no new changes', () => {
      ...
      it('should warn when the view has been created in a cd hook', fakeAsync(() => {
        ...
        ctx.componentInstance.a = 1;
        expect(() => ctx.detectChanges()).toThrowError(
    ...
    describe('multi directive order', () => {
      modifiedInIvy('order of bindings to directive inputs is different in ivy').it(
        'should follow the DI order for the same element',
        fakeAsync(() => {
          const ctx = createCompFixture(
    ...
    describe('nested view recursion', () => {
      ...
      describe('projected views', () => {
        ...
        modifiedInIvy(
          'Views should not be dirty checked if inserted into CD-detached view tree'
        ...
        onlyInIvy('Views should not be dirty checked if inserted into CD-detached view tree').it(
          'should not dirty check views that are inserted into a detached tree, even if the declaration place is dirty checked',
          () => {
            ctx.detectChanges(false);
            log = [];
            innerComp.cdRef.detach();
