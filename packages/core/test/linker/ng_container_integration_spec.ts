...
function declareTests(config?: {useJit: boolean}) {
  describe('<ng-container>', function () {
    ...
    modifiedInIvy('FW-678: ivy generates different DOM structure for <ng-container>').it(
      'should be rendered as comment with children as siblings',
      () => {
    ...
    modifiedInIvy("Queries with descendants: true don't descent into <ng-container>").it(
