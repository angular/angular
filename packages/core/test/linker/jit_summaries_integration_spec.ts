...
{
  obsoleteInIvy(
    'Summaries are not used/supported/able to be produced in Ivy. See FW-838.'
    ...
    it('should throw when trying to mock a type with a summary', () => {
      ...
      TestBed.resetTestingModule();
      expect(() =>
        TestBed.overrideDirective(SomeDirective, {add: {}}).compileComponents()
      ).toThrowError('SomeDirective was AOT compiled, so its metadata cannot be changed.');
      TestBed.resetTestingModule();
      expect(() =>
        TestBed.overridePipe(SomePipe, {add: {name: 'test'}}).compileComponents()
      ).toThrowError('SomePipe was AOT compiled, so its metadata cannot be changed.');
      TestBed.resetTestingModule();
      expect(() => TestBed.overrideModule(SomeModule, {add: {}}).compileComponents()).toThrowError(
        'SomeModule was AOT compiled, so its metadata cannot be changed.'
      );
    });
    ...
    it('should return stack trace and component data on resetTestingModule when error is thrown', () => {
      ...
      const fixture = TestBed.configureTestingModule({
        declarations: [TestCompErrorOnDestroy],
    ...
    it('should allow to override a provider', () => {
      ...
      const fixture = TestBed.overrideProvider(SomeDep, {
        useFactory: () => overwrittenValue,
        deps: [],
      })
