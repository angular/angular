...
@Directive({selector: '[text]', inputs: ['text'], exportAs: 'textDir', standalone: false})
class TextDirective {
  text: string | undefined;
}

@Component({selector: 'needs-content-children', template: '', standalone: false})
...
@Component({selector: 'needs-view-children', template: '<div text></div>', standalone: false})
...
@Component({selector: 'needs-content-child', template: '', standalone: false})
...
@Directive({selector: '[directive-needs-content-child]', standalone: false})
...
@Component({selector: 'needs-four-queries', template: '', standalone: false})
...
@Component({selector: 'needs-query-by-ref-binding', template: '<ng-content>', standalone: false})
...
@Component({selector: 'needs-query-by-ref-bindings', template: '<ng-content>', standalone: false})
...
@Component({selector: 'needs-content-children-read', template: '', standalone: false})
...
@Component({selector: 'needs-content-child-read', template: '', standalone: false})
...
@Component({selector: 'needs-content-children-shallow', template: '', standalone: false})
...
@Component({selector: 'needs-viewcontainer-read', template: '<div #q></div>', standalone: false})
...
@Component({selector: 'has-null-query-condition', template: '<div></div>', standalone: false})
...
@Component({selector: 'manual-projecting', template: '<div #vc></div>', standalone: false})
