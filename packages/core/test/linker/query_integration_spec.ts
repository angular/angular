...
describe('Query API', () => {
  ...
  describe('querying by directive type', () => {
    ...
    modifiedInIvy('Static queries in Ivy require an explicit {static: true} arg').it(
    ...
    it('should reflect moved directives', () => {
      ...
      // nodes of a directive that defines a content query.
      expect(asNativeElements(view.debugElement.children)).toHaveText(
        ivyEnabled ? '1d|2d|3d|' : '2|1d|2d|3d|'
      );
  ...
  describe('read a different token', () => {
    modifiedInIvy('Host nodes no longer match in ContentChild queries in Ivy').it(
      ...
      () => {
        ...
        const comp: NeedsContentChildrenWithRead = view.debugElement.children[0].injector.get(
          NeedsContentChildrenWithRead
        );
    ...
    it('should contain the first content child', () => {
      ...
      const comp: NeedsContentChildWithRead = view.debugElement.children[0].injector.get(
        NeedsContentChildWithRead
      );
    ...
    it('should contain the first view child', () => {
      ...
      const comp: NeedsViewChildWithRead = view.debugElement.children[0].injector.get(
        NeedsViewChildWithRead
      );
    ...
    it('should contain all child directives in the view', () => {
      ...
      const comp: NeedsViewChildrenWithRead = view.debugElement.children[0].injector.get(
        NeedsViewChildrenWithRead
      );
  ...
  describe('query over moved templates', () => {
    ...
    modifiedInIvy('Query results from views are reported upon view insert / detach').it(
      'should not affect queries for projected templates if views are detached or moved',
      () => {
    ...
    onlyInIvy('Query results from views are reported upon view insert / detach').it(
    ...
    modifiedInIvy('https://github.com/angular/angular/issues/15117 fixed in ivy').it(
