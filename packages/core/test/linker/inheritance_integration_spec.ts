...
@Directive({selector: '[directiveA]', standalone: false})
class DirectiveA {}

@Directive({selector: '[directiveB]', standalone: false})
class DirectiveB {
  @HostBinding('title') title = 'DirectiveB Title';
}

@Component({selector: 'component-a', template: 'ComponentA Template', standalone: false})
class ComponentA {}
...
@Directive({selector: '[directiveExtendsComponent]', standalone: false})
