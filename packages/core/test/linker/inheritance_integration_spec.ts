...
describe('Inheritance logic', () => {
  ...
  modifiedInIvy('View Engine allows Directives to extend Components').it(
    'should handle Directives that extend Components',
    () => {
  ...
  onlyInIvy('Ivy does not allow Directives to extend Components').it(
    'should throw in case a Directive tries to extend a Component',
    () => {
      TestBed.configureTestingModule({declarations: [DirectiveExtendsComponent, App]});
      const template = '<div directiveExtendsComponent>Some content</div>';
      TestBed.overrideComponent(App, {set: {template}});
