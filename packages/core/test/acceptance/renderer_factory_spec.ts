...
describe('renderer factory lifecycle', () => {
  ...
  @Component({selector: 'some-component', template: `foo`, standalone: false})
  ...
  @Component({selector: 'some-component-with-error', template: `With error`, standalone: false})
  ...
  @Component({selector: 'lol', template: `<some-component></some-component>`, standalone: false})
