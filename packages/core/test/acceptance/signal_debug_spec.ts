...
describe('getSignalGraph', () => {
  ...
  describe('debuggableFn', () => {
    it('should expose the computation of a computed', fakeAsync(() => {
      const computation = () => 1;
    ...
    it('should expose the computation of a linkedSignal', fakeAsync(() => {
      ...
      TestBed.configureTestingModule({imports: [WithLinkedSignal]});
    ...
    it('should expose the callback of an effect', fakeAsync(() => {
      const effectFn = () => {};
    ...
    it('should expose the user callback of an afterRenderEffect phase', fakeAsync(() => {
      const phaseFn = () => {};
      ...
      TestBed.configureTestingModule({imports: [WithAfterRenderEffect]});
