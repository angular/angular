...
describe('acceptance integration tests', () => {
  ...
  describe('element bindings', () => {
    ...
    describe('class-based styling', () => {
      ...
      it('should delegate initial classes to a [class] input binding if present on a directive on the same element', () => {
        ...
        expect(
          fixture.componentInstance.mockClassDirective.classesVal.split(/\s+/).sort()
      ...
      onlyInIvy('Passing an object into [style] works differently').it(
        'should update `[style]` and bindings in the provided directive if the input is matched',
        () => {
      ...
      onlyInIvy('Style binding merging works differently in Ivy').it(
        'should apply initial styling to the element that contains the directive with host styling',
        () => {
          @Directive({
      ...
      onlyInIvy('Style binding merging works differently in Ivy').it(
        "should apply single styling bindings present within a directive onto the same element and defer the element's initial styling values when missing",
        () => {
          @Directive({
      ...
      onlyInIvy('Style binding merging works differently in Ivy').it(
        'should properly prioritize single style binding collisions when they exist on multiple directives',
        () => {
  ...
  describe('tView.firstUpdatePass', () => {
    ...
    onlyInIvy('tView instances are ivy-specific').it(
