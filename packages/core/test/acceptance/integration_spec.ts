...
describe('acceptance integration tests', () => {
  ...
  describe('render', () => {
    it('should render basic template', () => {
      @Component({template: '<span title="Hello">Greetings</span>', standalone: false})
      class App {}
    ...
    it('should render and update basic "Hello, World" template', () => {
      ...
      @Component({template: '<h1>Hello, {{name}}!</h1>', standalone: false})
      class App {
        name = '';
      }
  ...
  describe('ng-container', () => {
    ...
    it('should add and remove DOM nodes when ng-container is a child of a delayed embedded view', () => {
      @Directive({selector: '[testDirective]', standalone: false})
      class TestDirective {
        constructor(
    ...
    it('should render at the component view root', () => {
      ...
      @Component({template: '<test-cmpt></test-cmpt>', standalone: false})
      class App {}
    ...
    it('should support directives and inject ElementRef', () => {
      ...
      @Component({template: '<div><ng-container dir></ng-container></div>', standalone: false})
      class App {
    ...
    it('should not set any attributes', () => {
      @Component({template: '<div><ng-container id="foo"></ng-container></div>', standalone: false})
      class App {}
  ...
  describe('text bindings', () => {
    it('should render "undefined" as ""', () => {
      @Component({template: '{{name}}', standalone: false})
      class App {
    ...
    it('should be able to render the result of a function called $any by using this', () => {
      @Component({template: '{{this.$any(1, 2)}}', standalone: false})
      class App {
  ...
  describe('ngNonBindable handling', () => {
    ...
    it('should invoke directives for host element', () => {
      ...
      @Directive({selector: '[directive]', standalone: false})
  ...
  describe('Siblings update', () => {
    it('should handle a flat list of static/bound text nodes', () => {
      @Component({template: 'Hello {{name}}!', standalone: false})
      class App {
        name = '';
      }
    ...
    it('should handle a list of static/bound text nodes as element children', () => {
      @Component({template: '<b>Hello {{name}}!</b>', standalone: false})
      class App {
        name = '';
      }
    ...
    it('should render/update text node as a child of a deep list of elements', () => {
      @Component({template: '<b><b><b><b>Hello {{name}}!</b></b></b></b>', standalone: false})
      class App {
        name = '';
      }
    ...
    it('should handle sibling text node after element with child text node', () => {
      @Component({template: '<p>hello</p>{{name}}', standalone: false})
      class App {
        name = '';
      }
  ...
  describe('basic components', () => {
    @Component({selector: 'todo', template: '<p>Todo{{value}}</p>', standalone: false})
    class TodoComponent {
      value = ' one';
    }

    it('should support a basic component template', () => {
      @Component({template: '<todo></todo>', standalone: false})
      class App {}
    ...
    it('should support a component template with sibling', () => {
      @Component({template: '<todo></todo>two', standalone: false})
      class App {}
    ...
    it('should support a component template with component sibling', () => {
      @Component({template: '<todo></todo><todo></todo>', standalone: false})
      class App {}
    ...
    it('should support a component with binding on host element', () => {
      @Component({selector: 'todo', template: '{{title}}', standalone: false})
    ...
    it('should support component with bindings in template', () => {
      @Component({selector: 'comp', template: '<p>{{ name }}</p>', standalone: false})
      class MyComp {
        name = 'Bess';
      }
    ...
    it('should support a component with sub-views', () => {
      ...
      @Component({template: '<comp [condition]="condition"></comp>', standalone: false})
      class App {
        condition = false;
      }
  ...
  describe('element bindings', () => {
    describe('elementAttribute', () => {
      it('should support attribute bindings', () => {
        @Component({template: '<button [attr.title]="title"></button>', standalone: false})
        class App {
          title: string | null = '';
        }
      ...
      it('should support host attribute bindings', () => {
        ...
        @Component({template: '<div hostBindingDir></div>', standalone: false})
        class App {
    ...
    describe('elementStyle', () => {
      it('should support binding to styles', () => {
        @Component({template: '<span [style.font-size]="size"></span>', standalone: false})
        class App {
          size: string | null = '';
        }
      ...
      it('should support binding to styles with suffix', () => {
        @Component({template: '<span [style.font-size.px]="size"></span>', standalone: false})
        class App {
    ...
    describe('class-based styling', () => {
      it('should support CSS class toggle', () => {
        @Component({template: '<span [class.active]="value"></span>', standalone: false})
        class App {
          value: any;
        }
      ...
      it('should apply classes properly when nodes are components', () => {
        @Component({selector: 'my-comp', template: 'Comp Content', standalone: false})
        class MyComp {}

        @Component({template: '<my-comp [class.active]="value"></my-comp>', standalone: false})
        class App {
          value: any;
        }
      ...
      it('should apply classes properly when nodes have containers', () => {
        @Component({selector: 'structural-comp', template: 'Comp Content', standalone: false})
      ...
      @Directive({selector: '[DirWithClass]', standalone: false})
      ...
      @Directive({selector: '[DirWithStyle]', standalone: false})
      ...
      it('should update `[class]` and bindings in the provided directive if the input is matched', () => {
        @Component({template: '<div DirWithClass [class]="value"></div>', standalone: false})
        class App {
          @ViewChild(DirWithClassDirective) mockClassDirective!: DirWithClassDirective;
          value = '';
        }
      ...
      it('should update `[style]` and bindings in the provided directive if the input is matched', () => {
        @Component({template: '<div DirWithStyle [style]="value"></div>', standalone: false})
        class App {
          @ViewChild(DirWithStyleDirective) mockStyleDirective!: DirWithStyleDirective;
    ...
    it('should properly handle and render interpolation for class attribute bindings', () => {
      @Component({template: '<div class="-{{name}}-{{age}}-"></div>', standalone: false})
      class App {
        name = '';
        age = '';
      }
  ...
  describe('self-closing tags', () => {
    it('should allow a self-closing tag for a custom tag name', () => {
      ...
      @Component({template: '<my-comp/>', standalone: false})
      class App {}
    ...
    it('should not confuse self-closing tag for an end tag', () => {
      @Component({selector: 'my-comp', template: '<ng-content/>', standalone: false})
      class MyComp {}
  ...
  it('should only call inherited host listeners once', () => {
    ...
    @Component({selector: 'button[custom-button]', template: '', standalone: false})
    class ButtonSubClass extends ButtonSuperClass {}

    @Component({template: '<button custom-button></button>', standalone: false})
    class MyApp {}
  ...
  it('should support inherited view queries', () => {
    @Directive({selector: '[someDir]', standalone: false})
    class SomeDir {}

    @Component({template: '<div someDir></div>', standalone: false})
    class SuperComp {
  ...
  it('should inherit host bindings from undecorated superclasses', () => {
    ...
    @Component({selector: '[sub-button]', template: '<ng-content></ng-content>', standalone: false})
    class SubButton extends BaseButton {}

    @Component({template: '<button sub-button>Click me</button>', standalone: false})
    class App {}
  ...
  it('should inherit host listeners from superclasses once', () => {
    ...
    @Directive({selector: '[baseButton]', standalone: false})
    class BaseButton {
      @HostListener('click')
      handleClick() {
        clicks++;
    ...
    @Component({selector: '[subButton]', template: '<ng-content></ng-content>', standalone: false})
    class SubButton extends BaseButton {}

    @Component({template: '<button subButton>Click me</button>', standalone: false})
    class App {}
  ...
  it('should inherit host listeners from grand superclasses once', () => {
    ...
    @Directive({selector: '[superBaseButton]', standalone: false})
    class SuperBaseButton {
      @HostListener('click')
      handleClick() {
        clicks++;
  ...
  it('should inherit host listeners from grand grand superclasses once', () => {
    ...
    @Directive({selector: '[superSuperBaseButton]', standalone: false})
  ...
  it('should handle nullish coalescing inside host bindings', () => {
    ...
    @Component({template: `<button some-dir>Click me</button>`, standalone: false})
    class App {}
  ...
  it('should handle shorthand property declarations in templates', () => {
    ...
    @Component({template: `<div [my-dir]="{a, b: 2, someProp}"></div>`, standalone: false})
    class App {
  ...
  it('should handle numeric separators in templates', () => {
    @Component({template: 'Balance: ${{ 1_000_000 * multiplier }}', standalone: false})
    class App {
      multiplier = 5;
    }
  ...
  it('should remove child LView from the registry when the root view is destroyed', () => {
    @Component({template: '<child></child>', standalone: false})
    class App {}

    @Component({selector: 'child', template: '<grand-child></grand-child>', standalone: false})
    class Child {}

    @Component({selector: 'grand-child', template: '', standalone: false})
    class GrandChild {}
