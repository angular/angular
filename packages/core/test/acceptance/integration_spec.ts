       ...
       fakeAsync(() => {
        ...
        `
         ...
         class Cmp {
           ...
           itemTrackFn(value: Item) { return value.id; }
         }
       ...
       fakeAsync(() => {
        ...
        `
         ...
         class Cmp {
           ...
           track(name: string, event: AnimationEvent) { this.log.push(name); }
         }
         ...
         class InnerComp {
           ...
           @HostListener('@host.start', ['$event'])
           onLeaveStart(event: AnimationEvent) { this.parent.log.push('host'); }
         }
