...
describe('acceptance integration tests', () => {
  ...
  it('should support tagged template literals with no interpolations in expressions', () => {
    ...
    expect(fixture.nativeElement.textContent).toContain(':UNCOMFORTABLY EXCITED!!!:');
    expect(fixture.nativeElement.textContent).toContain(`Hi, I'm Frodo, and I'm 50 years old`);
  });
