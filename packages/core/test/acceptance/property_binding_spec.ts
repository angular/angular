...
describe('property bindings', () => {
  it('should support bindings to properties', () => {
    @Component({template: `<span [id]="id"></span>`, standalone: false})
    class Comp {
      id: string | undefined;
    }
  ...
  it('should bind to properties whose names do not correspond to their attribute names', () => {
    @Component({template: '<label [for]="forValue"></label>', standalone: false})
    class MyComp {
      forValue?: string;
    }
  ...
  it(
    ...
    () => {
      @Component({template: '', selector: 'my-comp', standalone: false})
      class MyComp {
        @Input() for!: string;
      }

      @Component({template: '<my-comp [for]="forValue"></my-comp>', standalone: false})
      class App {
        forValue?: string;
      }
  ...
  it('should support interpolation for properties', () => {
    @Component({template: `<span id="{{'_' + id + '_'}}"></span>`, standalone: false})
    class Comp {
      id: string | undefined;
    }
  ...
  describe('input properties', () => {
    ...
    it('should check that property is not an input property before setting (component)', () => {
      ...
      @Component({template: `<comp [id]="id"></comp>`, standalone: false})
      class App {
        id = 1;
      }
  ...
  describe('attributes and input properties', () => {
    ...
    @Directive({selector: '[myDirB]', standalone: false})
    class MyDirB {
      @Input('role') roleB: string | undefined;
    }

    it('should set input property based on attribute if existing', () => {
      @Component({template: `<div role="button" myDir></div>`, standalone: false})
      class App {}
    ...
    it('should set input property and attribute if both defined', () => {
      @Component({template: `<div role="button" [role]="role" myDir></div>`, standalone: false})
      class App {
        role = 'listbox';
      }
    ...
    it('should set two directive input properties based on same attribute', () => {
      @Component({template: `<div role="button" myDir myDirB></div>`, standalone: false})
      class App {}
  ...
  it('should not throw on synthetic property bindings when a directive on the same element injects ViewContainerRef', () => {
    ...
    @Component({template: '<my-comp my-dir></my-comp>', standalone: false})
    class App {}
  ...
  it('should allow quoted binding syntax with escaped quotes inside property binding', () => {
    @Component({template: `<span [id]="'{{ \\' }}'"></span>`, standalone: false})
    class Comp {}
