...
describe('NgModule', () => {
  ...
  describe('schemas', () => {
    onlyInIvy('Unknown property warning logged instead of throwing an error').it(
      'should throw on unknown props if NO_ERRORS_SCHEMA is absent',
      () => {
        @Component({
          selector: 'my-comp',
          template: `
        ...
        expect(spy.calls.mostRecent().args[0]).toMatch(
          /Can't bind to 'unknown-prop' since it isn't a known property of 'div'/
        );
      }
    );

    modifiedInIvy('Unknown properties throw an error instead of logging a warning').it(
      'should throw on unknown props if NO_ERRORS_SCHEMA is absent',
      () => {
        @Component({
          selector: 'my-comp',
    ...
    onlyInIvy('unknown element check logs a warning rather than throwing').it(
      'should warn about unknown element without CUSTOM_ELEMENTS_SCHEMA for element with dash in tag name',
      () => {
    ...
    modifiedInIvy('unknown element error thrown instead of warning').it(
      'should throw unknown element error without CUSTOM_ELEMENTS_SCHEMA for element with dash in tag name',
      () => {
        @Component({template: `<custom-el></custom-el>`})
        class MyComp {}
    ...
    onlyInIvy('unknown element check logs a warning rather than throwing').it(
      'should warn about unknown element without CUSTOM_ELEMENTS_SCHEMA for element without dash in tag name',
      () => {
    ...
    modifiedInIvy('unknown element error thrown instead of warning').it(
      'should throw unknown element error without CUSTOM_ELEMENTS_SCHEMA for element without dash in tag name',
      () => {
        @Component({template: `<custom></custom>`})
        class MyComp {}
    ...
    onlyInIvy('test relies on Ivy-specific AOT format').it(
    ...
    onlyInIvy('unknown element check logs a warning rather than throwing').it(
      'should not warn about unknown elements with CUSTOM_ELEMENTS_SCHEMA',
      () => {
        @Component({template: `<custom-el></custom-el>`})
        class MyComp {}
    ...
    modifiedInIvy('unknown element error thrown instead of warning').it(
      'should not throw unknown element error with CUSTOM_ELEMENTS_SCHEMA',
      () => {
        @Component({template: `<custom-el></custom-el>`})
        class MyComp {}
    ...
    onlyInIvy('unknown element check logs a warning rather than throwing').it(
      'should not warn about unknown elements with NO_ERRORS_SCHEMA',
      () => {
        @Component({template: `<custom-el></custom-el>`})
        class MyComp {}
    ...
    modifiedInIvy('unknown element error thrown instead of warning').it(
      'should not throw unknown element error with NO_ERRORS_SCHEMA',
      () => {
        @Component({template: `<custom-el></custom-el>`})
        class MyComp {}
    ...
    onlyInIvy('unknown element check logs a warning rather than throwing').it(
      'should not warn about unknown elements if element matches a directive',
      () => {
        @Component({
          selector: 'custom-el',
          template: '',
    ...
    modifiedInIvy('unknown element error thrown instead of warning').it(
      'should not throw unknown element error if element matches a directive',
      () => {
        @Component({
          selector: 'custom-el',
          template: '',
    ...
    onlyInIvy('unknown element check logs a warning rather than throwing').it(
      'should not warn for HTML elements inside an SVG foreignObject',
      () => {
        @Component({
          template: `
            <svg>
    ...
    modifiedInIvy('unknown element error thrown instead of warning').it(
      'should not throw for HTML elements inside an SVG foreignObject',
      () => {
        @Component({
          template: `
            <svg>
