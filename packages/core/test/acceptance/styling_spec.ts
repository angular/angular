...
describe('styling', () => {
  ...
  describe('apply in prioritization order', () => {
    ...
    onlyInIvy('style merging is ivy only feature').it(
      'should perform interpolation bindings',
      () => {
        @Component({
    ...
    it('should support hostBindings inheritance', () => {
      ...
      const div = fixture.nativeElement.querySelector('div');
      expect(getSortedClassName(div)).toEqual(
        ivyEnabled ? 'HOST_STATIC STATIC SUPER_STATIC' : 'HOST_STATIC STATIC'
      );
      ...
      expect(getSortedStyle(div).replace('"', '').replace('"', '')).toEqual(
        ivyEnabled
          ? 'color: blue; font-family: host font; width: 1px;'
          : 'color: blue; font-family: host font;'
      );
    });

    onlyInIvy('style merging is ivy only feature').it(
      'should apply template classes in correct order',
      () => {
        @Component({
          template: `
            <div
    ...
    onlyInIvy('style merging is ivy only feature').it(
      'should apply template styles in correct order',
      () => {
        @Component({
          template: `
            <div
  ...
  describe('css variables', () => {
    onlyInIvy('css variables').it('should support css variables', () => {
      ...
      if (
        ...
        return;
      @Component({
        template: ` <div [style.--my-var]="'100px'">
  ...
  modifiedInIvy('shadow bindings include static portion').it(
    'should bind [class] as input to directive',
    () => {
  ...
  onlyInIvy('shadow bindings include static portion').it(
    'should bind [class] as input to directive',
    () => {
      // VE Behavior https://stackblitz.com/edit/angular-cycpsf
      // IVY behavior is slightly different see next test with same name.
  ...
  onlyInIvy('shadow bindings include static portion').it(
    'should bind [class] as input to directive when both static and falsy dynamic values are present',
    () => {
      @Component({
  ...
  modifiedInIvy('shadow bindings include static portion').it(
    'should bind [style] as input to directive',
    () => {
      // VE Behavior https://stackblitz.com/edit/angular-cycpsf
      @Component({
        template: `
  ...
  it('should support interpolations inside a class binding', () => {
    ...
    instance.one = instance.two = instance.three = instance.four = instance.five = instance.six = instance.seven = instance.eight = instance.nine =
      '';
    fixture.detectChanges();
  ...
  onlyInIvy('only Ivy supports style interpolation').it(
    ...
    () => {
      ...
      instance.one = instance.two = instance.three = instance.four = instance.five = instance.six = instance.seven = instance.eight = instance.nine = instance.self =
        '';
      fixture.detectChanges();
  ...
  it('should support interpolations inside a style property binding', () => {
    ...
    instance.one = instance.two = instance.three = instance.four = instance.five = instance.six = instance.seven = instance.eight = instance.nine = 1;
    fixture.detectChanges();
  ...
  onlyInIvy('only ivy combines static and dynamic class-related attr values').it(
    'should write combined class attribute and class binding to the class input',
    () => {
      @Component({
        selector: 'comp',
        template: `{{ className }}`,
  ...
  onlyInIvy('only ivy persists static class/style attrs with their binding counterparts').it(
  ...
  onlyInIvy('only ivy balances styling across directives and component host bindings').it(
    'should allow multiple directives to set dynamic and static classes independent of one another',
    () => {
      @Component({
  ...
  onlyInIvy('ivy resolves styling across directives, components and templates in unison').it(
    'should apply single property styles/classes to the element and default to any static styling values',
    () => {
      @Component({
        template: `
          <div
  ...
  onlyInIvy('ivy resolves styling across directives, components and templates in unison').it(
    'should apply single style/class across the template and directive host bindings',
    () => {
      ...
      @Component({
        template: `
          <div [style.width]="w0" [dir-that-sets-width]="w1" [another-dir-that-sets-width]="w2">
          </div>
        `,
      })
      class Cmp {
  ...
  onlyInIvy('only ivy has style debugging support').it(
  ...
  onlyInIvy('only ivy has [style.prop] support').it(
    'should sanitize style values before writing them',
    () => {
      @Component({
  ...
  onlyInIvy('only ivy has [style] support').it(
    'should sanitize style values before writing them',
    () => {
      @Component({
  ...
  onlyInIvy('only ivy has style/class bindings debugging support').it(
  ...
  onlyInIvy('only ivy has style/class bindings debugging support').it(
    'should understand multiple directives which contain initial classes',
    () => {
  ...
  onlyInIvy('only ivy has style/class bindings debugging support').it(
    "should flush bindings even if any styling hasn't changed in a previous directive",
    () => {
      @Directive({selector: '[one]'})
      class DirOne {
  ...
  onlyInIvy('only ivy allows for multiple styles/classes to be balanced across directives').it(
    'should allow various duplicate properties to be defined in various styling maps within the template and directive styling bindings',
    () => {
      @Component({
        template: `
  ...
  onlyInIvy('only ivy allows for map-based style AND class bindings').it(
    'should throw an error if a map-based style/class binding value is changed during checkNoChanges',
    () => {
      @Component({
  ...
  onlyInIvy('only ivy treats [class] in concert with other class bindings').it(
    'should retain classes added externally',
    () => {
  ...
  onlyInIvy('[style] binding is supported in Ivy only').it(
    'should allow multiple styling bindings to work alongside property/attribute bindings',
    () => {
      @Component({
        template: ` <div
  ...
  onlyInIvy('VE clobers in case of  @HostBinding("class")').it(
    'should allow host styling on the root element with external styling',
    () => {
      @Component({template: '...'})
      class MyComp {
  ...
  onlyInIvy('[style] bindings are ivy only').it(
    'should convert camelCased style property names to snake-case',
    () => {
  ...
  onlyInIvy('Prioritization works in Ivy only').it(
    'should prioritize host bindings for templates first, then directives and finally components',
    () => {
  ...
  onlyInIvy('Prioritization works in Ivy only').it(
    'should prioritize directive static bindings over components',
    () => {
  ...
  describe('regression', () => {
    ...
    onlyInIvy('styling priority resolution is Ivy only feature.').it(
      'should allow lookahead binding on second pass #35118',
      () => {
        @Component({
          selector: 'my-cmp',
          template: ``,
