...
describe('projection', () => {
  ...
  it('should match and execute attribute directives on ng-template', () => {
    let xDirectives = 0;
    ...
    @Component({
      selector: 'main',
      template: '<ng-template x="true" [ngIf]="true">Hello world!</ng-template>'
    })
    class SelectorMainComp {
    }

    TestBed.configureTestingModule({declarations: [XDirective, SelectorMainComp]});
  ...
  it('should project selected inline templates matching attributes', () => {
    let xDirectives = 0;
  ...
  it('should project selected inline templates matching classes', () => {
    let xDirectives = 0;
    @Component({selector: 'selector-proj', template: '<ng-content select=".x"></ng-content>'})
    class SelectedNgContentComp {
    }
