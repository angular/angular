...
describe('projection', () => {
  ...
  it('should project content', () => {
    ...
    @Component({selector: 'parent', template: '<child>content</child>', standalone: false})
    class Parent {}
  ...
  it('should project content with siblings', () => {
    @Component({selector: 'child', template: '<ng-content></ng-content>', standalone: false})
    class Child {}
  ...
  it('should project if <ng-content> is in a template that has different declaration/insertion points', () => {
    ...
    @Directive({selector: '[trigger]', standalone: false})
    class Trigger {
      @Input() trigger!: Comp;
  ...
  it('should handle projected containers inside other containers', () => {
    @Component({selector: 'nested-comp', template: `<div>Child content</div>`, standalone: false})
    class NestedComp {}
  ...
  it('should re-project ng-container at the content root', () => {
    @Component({selector: 'grand-child', template: `<ng-content></ng-content>`, standalone: false})
    class GrandChild {}
  ...
  describe('with selectors', () => {
    ...
    it('should match selectors against projected containers', () => {
      ...
      @Component({template: `<child><div *ngIf="value">content</div></child>`, standalone: false})
      class Parent {
        value = false;
      }
      TestBed.configureTestingModule({declarations: [Child, Parent]});
  ...
  it('should project content if the change detector has been detached', () => {
    @Component({selector: 'my-comp', template: '<ng-content></ng-content>', standalone: false})
    class MyComp {
  ...
  it('should support ngProjectAs with a various number of other bindings and attributes', () => {
    @Directive({selector: '[color],[margin]', standalone: false})
    class ElDecorator {
      @Input() color?: string;
      @Input() margin?: number;
    }
  ...
  describe('on inline templates (e.g.  *ngIf)', () => {
    it('should work when matching the element name', () => {
      ...
      @Directive({selector: 'div', standalone: false})
      class DivDirective {
        constructor() {
          divDirectives++;
        }
    ...
    it('should work when matching attributes', () => {
      ...
      @Directive({selector: '[x]', standalone: false})
      class XDirective {
        constructor() {
          xDirectives++;
        }
