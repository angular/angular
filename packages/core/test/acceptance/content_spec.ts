...
describe('projection', () => {
  ...
  it('should project nodes into the last ng-content', () => {
    @Component({
      selector: 'child',
      template: `<div><ng-content></ng-content></div> <span><ng-content></ng-content></span>`,
    })
    class Child {}
  ...
  it('should project nodes into the last ng-content unrolled by ngFor', () => {
    @Component({
      selector: 'child',
      template: `<div *ngFor="let item of [1, 2]; let i = index"
        >({{ i }}):<ng-content></ng-content
      ></div>`,
    })
    class Child {}
  ...
  describe('with selectors', () => {
    ...
    it('should not descend into re-projected content', () => {
      @Component({
        selector: 'card',
        template: `<ng-content select="[card-title]"></ng-content><hr /><ng-content
            select="[card-content]"
          ></ng-content>`,
      })
      class Card {}
    ...
    it('should not match selectors against node having ngProjectAs attribute', () => {
      ...
      @Component({
        selector: 'parent',
        template: `<child
          ><div ngProjectAs="span">should not project</div><div>should project</div></child
        >`,
      })
      class Parent {}
