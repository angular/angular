...
import {Component, ContentChild, ContentChildren, Directive, HostBinding, Input, QueryList, TemplateRef, Type, ViewChild, ViewContainerRef, ɵi18nConfigureLocalize, LOCALE_ID} from '@angular/core';
