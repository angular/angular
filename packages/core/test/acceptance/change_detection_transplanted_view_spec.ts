...
describe('change detection for transplanted views', () => {
  describe('when declaration appears before insertion', () => {
    ...
    describe('and declaration component is CheckAlways', () => {
      ...
      it('should CD during the `Targeted` change detection phase', () => {
        declareComp.name = 'Angular';
        fixture.detectChanges(false);
        // During the targeted phase, only the views with `RefreshView` flag are refreshed so the
        // insertion component will not have its lifecycle hooks run and update the log value to
        // `Insert`.
    ...
    describe('and declaration component is OnPush', () => {
      ...
      it('should CD during the `Targeted` change detection pass', () => {
