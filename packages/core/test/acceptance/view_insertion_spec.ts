...
describe('view insertion', () => {
  ...
  describe('before another view', () => {
    ...
    describe('before embedded view', () => {
      ...
      onlyInIvy('VE incorrectly inserts views before ng-container content').it(
        'should insert before a view with a ng-container where ViewContainerRef is injected',
        () => {
          expect(
            createAndInsertViews(`
