...
describe('providers', () => {
  describe('inheritance', () => {
    it('should NOT inherit providers', () => {
      ...
      @Directive({selector: '[other-dir]', standalone: false})
  ...
  describe('lifecycles', () => {
    it('should inherit ngOnDestroy hooks on providers', () => {
      ...
      @Component({template: '', providers: [SubInjectableWithDestroyHook], standalone: false})
      class App {
    ...
    it('should not call ngOnDestroy for providers that have not been requested', () => {
      ...
      @Component({template: '', providers: [InjectableWithDestroyHook], standalone: false})
      class App {}
    ...
    it('should only call ngOnDestroy once for multiple instances', () => {
      ...
      @Component({selector: 'my-cmp', template: '', standalone: false})
      class MyComponent {
    ...
    it('should invoke ngOnDestroy with the correct context when providing a type provider multiple times on the same node', () => {
      ...
      @Directive({selector: '[dir-one]', providers: [DestroyService], standalone: false})
      class DirOne {
      ...
      @Directive({selector: '[dir-two]', providers: [DestroyService], standalone: false})
      class DirTwo {
        constructor(service: DestroyService) {
          childService = service;
        }
  ...
  describe('components and directives', () => {
    ...
    it('should support providing components in tests without @Injectable', () => {
      @Component({selector: 'test-comp', template: '<my-comp></my-comp>', standalone: false})
      class TestComp {}
    ...
    it('should support providing directives in tests without @Injectable', () => {
      @Component({selector: 'test-comp', template: '<div some-dir></div>', standalone: false})
      class TestComp {}
  ...
  describe('forward refs', () => {
    ...
    it('should support forward refs in useClass when impl version is also provided', () => {
      ...
      @Component({selector: 'my-app', template: '', standalone: false})
      class App {
