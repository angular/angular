  ...
  describe('animation query tests', function () {
    ...
    describe('query()', () => {
      it('should be able to query all elements that contain animation triggers via @*', () => {
        @Component({
          ...
          animations: [
            ...
            trigger('a', [transition('* => 1', [animate(1000, style({opacity: 0}))])]),
            trigger('b', [
              transition('* => 1', [
      ...
      it('should be able to query triggers directly by name', () => {
        @Component({
          ...
          animations: [
            ...
            trigger('bar', []),
            trigger('myAnimation', [
              transition('* => foo', [query('@foo', [animate(1000, style({color: 'red'}))])]),
        ...
        @Component({
          ...
          animations: [
            trigger('myAnimation', [
              ...
              transition('* => b', [
                query('.item:animating', [style({opacity: 1}), animate(1000, style({opacity: 0}))]),
              ]),
            ]),
          ],
        })
      ...
      it('should be able to query all actively queued animation triggers via `@*:animating`', () => {
        @Component({
          ...
          animations: [
            trigger('parent', [
              transition('* => *', [
                query('@*:animating', [animate(1000, style({background: 'red'}))], {
                  optional: true,
                }),
              ]),
            ]),
          ...
          animations: [
            trigger('myAnimation', [
              transition('* => go', [
                ...
                animate(1000, style({opacity: '1'})),
                query('header, footer', [stagger(500, [animate(1000, style({opacity: '1'}))])]),
              ]),
            ]),
          ],
        })
      ...
      it('should find newly inserted items in the component via :enter', () => {
        @Component({
          ...
          animations: [
            trigger('myAnimation', [
              transition(':enter', [
                query(':enter', [style({opacity: 0}), animate(1000, style({opacity: 0.5}))]),
              ]),
            ]),
          ],
        })
        ...
        @Component({
          ...
          animations: [
            trigger('myAnimation', [
              transition('* => 0', []),
              transition('* => *', [
                query('.child:enter', [style({opacity: 0}), animate(1000, style({opacity: 1}))]),
                query('.incorrect-child:leave', [animate(1000, style({opacity: 0}))]),
              ]),
            ]),
          ],
        })
      ...
      it('should find elements that have been removed via :leave', () => {
        @Component({
          ...
          animations: [
            trigger('myAnimation', [
              transition('a => b', [
                query(':leave', [style({opacity: 1}), animate(1000, style({opacity: 0.5}))]),
              ]),
            ]),
          ],
        })
        ...
        @Component({
          ...
          animations: [
            trigger('myAnimation', [
              ...
              transition('5 => 0', [
                query(':leave', [style({opacity: '1'}), animate(1000, style({opacity: '0'}))]),
              ]),
            ]),
          ],
        })
      ...
      it('should properly cancel items that were queried into a former animation and pass in the associated styles into the follow-up players per element', () => {
        ...
        expect(p1.previousStyles).toEqual({
          opacity: AUTO_STYLE,
          width: AUTO_STYLE,
          height: AUTO_STYLE,
        });
      ...
      it('should not remove a parent container if its contents are queried into by an ancestor element', () => {
        @Component({
          ...
          animations: [
            trigger('myAnimation', [
              transition('* => go', [
                query('.child', [style({opacity: 0}), animate(1000, style({opacity: 1}))]),
              ]),
            ]),
          ],
        })
      ...
      it('should only retain a to-be-removed node if the inner queried items are apart of an animation issued by an ancestor', fakeAsync(() => {
        @Component({
          selector: 'ani-cmp',
          template: `
          ...
          animations: [
            trigger('one', [
              transition('* => go', [
                query('.child', [style({height: '100px'}), animate(1000, style({height: '0px'}))]),
              ]),
            ]),
            trigger('two', [
              transition('* => go', [
                query('header', [style({width: '100px'}), animate(1000, style({width: '0px'}))]),
              ]),
            ]),
          ],
        })
      ...
      it('should allow multiple triggers to animate on queried elements at the same time', () => {
        @Component({
          ...
          animations: [
            trigger('one', [
              transition('* => on', [
                query('.child', [style({width: '0px'}), animate(1000, style({width: '100px'}))]),
              ]),
              transition('* => off', []),
            ]),
            trigger('two', [
      ...
      it('should allow for queried items to restore their styling back to the original state via animate(time, "*")', () => {
        ...
        players.forEach((p) => {
          expect(p.keyframes).toEqual([
            ...
            {opacity: '1', width: '0px', height: '0px', offset: 0.5},
        ...
        it('should limit results when a limit value is passed into the query options', () => {
          @Component({
            ...
            animations: [
              trigger('myAnimation', [
                transition('* => go', [
                  query('.item', [style({opacity: 0}), animate('1s', style({opacity: 1}))], {
                    limit: 2,
                  }),
                ]),
              ]),
    ...
    describe('sub triggers', () => {
      ...
      it('should animate all sub triggers on the element at the same time', () => {
        @Component({
          ...
          animations: [
            ...
            trigger('h', [
              transition('* => go', [style({height: 0}), animate(1500, style({height: '100px'}))]),
            ]),
            trigger('parent', [
              transition('* => go', [
                style({opacity: 0}),
      ...
      it('should emulate a leave animation on the nearest sub host elements when a parent is removed', fakeAsync(() => {
        @Component({
          selector: 'ani-cmp',
          template: `
      ...
      it('should not cause a removal of inner @trigger DOM nodes when a parent animation occurs', fakeAsync(() => {
        @Component({
          selector: 'ani-cmp',
          template: `
            <div @parent *ngIf="exp" class="parent"> this <div @child>child</div> </div>
          `,
          animations: [
            trigger('parent', [
              transition(':leave', [style({opacity: 0}), animate('1s', style({opacity: 1}))]),
      ...
      it('should only mark outermost *directive nodes :enter and :leave when inserts and removals occur', () => {
        @Component({
          ...
          animations: [
            trigger('anim', [
              transition('* => enter', [query(':enter', [animate(1000, style({color: 'red'}))])]),
              transition('* => leave', [query(':leave', [animate(1000, style({color: 'blue'}))])]),
            ]),
          ],
          template: `
      ...
      it('should emulate leave animation callbacks for all sub elements that have leave triggers within the component', fakeAsync(() => {
        @Component({
          selector: 'ani-cmp',
          animations: [
            trigger('parent', []),
      ...
      it('should fire and synchronize the start/done callbacks on sub triggers even if they are not allowed to animate within the animation', fakeAsync(() => {
        @Component({
          selector: 'parent-cmp',
          animations: [
            trigger('parent', [
      ...
      it('should fire and synchronize the start/done callbacks on multiple blocked sub triggers', fakeAsync(() => {
        @Component({
          selector: 'cmp',
          animations: [
            trigger('parent1', [
      ...
      it('should stretch the starting keyframe of a child animation queries are issued by the parent', () => {
        ...
        @Component({
          ...
          animations: [
            trigger('child', [
              transition('* => *', [style({color: 'blue'}), animate(1000, style({color: 'red'}))]),
            ]),
          ],
        ...
        const groupPlayer = (engine
          .players[0] as TransitionAnimationPlayer).getRealPlayer() as AnimationGroupPlayer;
          ...
          animations: [
            trigger('parentAnimation', [
              transition('* => go', [
                ...
                animate(1000, style({opacity: 1})),
                query('@grandChildAnimation', [animate(1000, style({opacity: 1})), animateChild()]),
              ]),
            ]),
          ],
      ...
      it('should scope :enter queries between sub animations', () => {
        @Component({
          ...
          animations: [
            ...
            trigger('child', [
              transition(':enter', [
                query(':enter .item', [style({opacity: 0}), animate(1000, style({opacity: 1}))]),
              ]),
            ]),
          ],
          template: `
      ...
      it('should scope :leave queries between sub animations', () => {
        @Component({
          ...
          animations: [
            ...
            trigger('child', [
              transition(':leave', [
                query(':leave .item', [style({opacity: 0}), animate(1000, style({opacity: 1}))]),
              ]),
            ]),
          ],
          template: `
