...
(function () {
  ...
  describe('animation query tests', function () {
    ...
    describe('sub triggers', () => {
      ...
      it('should correctly remove a leaving element queried/animated by a parent queried via animateChild', fakeAsync(() => {
        @Component({
          selector: 'cmp',
          template: `
          ...
          `,
          animations: [
            trigger('grandParentAnimation', [
              transition('true <=> false', query('@parentAnimation', animateChild())),
            ]),
            trigger('parentAnimation', [
              transition(
                'true => false',
                query(':leave.child', animate('.2s', style({opacity: 0}))),
              ),
            ]),
          ],
          standalone: false,
            ...
            trigger('parent', [
              ...
              transition('true <=> false', [
                group([
                  ...
                  query(':enter', [style({opacity: 0}), animate(500, style({opacity: '*'}))], {
                    optional: true,
                  }),
                ]),
              ]),
