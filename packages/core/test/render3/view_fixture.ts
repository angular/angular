...
import {DirectiveDef, DirectiveDefList, DirectiveTypesOrFactory, PipeDef, PipeDefList, PipeTypesOrFactory} from '@angular/core/src/render3/interfaces/definition';
...
export class ViewFixture {
  ...
  constructor({template, decls, vars, consts, context, directives}: {
    decls?: number,
    vars?: number,
    ...
    this.tView = createTView(
        TViewType.Component, null, template || noop, decls || 0, vars || 0,
