...
import {C, D, E, NC, T, V, a, b, b1, b2, b3, b4, b5, b6, b7, b8, bV, c, defineComponent, e, k, p, r, rC, rc, s, t, v} from '../../src/render3';
...
describe('iv integration test', () => {
  ...
  describe('basic components', () => {
    ...
    it('should support component with bindings in template', () => {
      /** <p> {{ name }} </p>*/
      class MyComp{name = 'Bess'; static ngComponentDef = defineComponent({
                                    type: MyComp,
                                    tag: 'comp',
