...
import {C, D, E, NC, T, V, a, b, b1, b2, b3, b4, b5, b6, b7, b8, bV, c, defineComponent, defineDirective, e, i, k, p, r, rC, rc, s, t, v} from '../../src/render3/index';
import {NO_CHANGE, mergeInputsAndOutputs} from '../../src/render3/instructions';
  ...
  describe('element bindings', () => {
    ...
    describe('elementProperty', () => {
      ...
      class OtherDir {
        ...
        static ngDirectiveDef = defineDirective(
            {type: OtherDir, factory: () => otherDir = new OtherDir(), inputs: {id: 'id'}});
      }
      ...
      it('should support two input properties with the same name', () => {
        ...
        const ID0 =
            mergeInputsAndOutputs([0, MyButton.ngDirectiveDef, 1, OtherDisabledDir.ngDirectiveDef]);
