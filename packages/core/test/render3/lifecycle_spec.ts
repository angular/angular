...
import {defineComponent, E, e, rC, rc, C, c, V, v, i, l, L, D, T, LifeCycleGuard, ComponentTemplate,} from '../../src/render3/index';
import {renderToHtml, containerEl} from './render_util';
      ...
      function Template(ctx: any, cm: boolean) {
        ...
        rC(0);
        {
          if (ctx.condition) {
            ...
            let temp: any;
            i(temp = '1') && (D<any>(0).val = temp);
            i(temp = '2') && (D<any>(1).val = temp);
            Comp.ngComponentDef.r(0, 0);
          ...
          if (ctx.condition) {
            ...
            rC(1);
            {
              if (ctx.condition2) {
                ...
                i(temp = '2') && (D<any>(0).val = temp);
                Comp.ngComponentDef.r(0, 0);
                v();
              }
            }
            rc();
            i(temp = '3') && (D<any>(1).val = temp);
          ...
          if (ctx.condition) {
            ...
            rC(1);
            {
              for (let j = 2; j < ctx.len; j++) {
                ...
                i(temp = `${j}`) && (D<any>(0).val = temp);
                Comp.ngComponentDef.r(0, 0);
                v();
              }
            }
            rc();
            i(temp = '5') && (D<any>(1).val = temp);
            Comp.ngComponentDef.r(1, 2);
            v();
          }
        }
