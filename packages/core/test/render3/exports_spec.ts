...
import {C, D, E, T, V, a, b, c, defineComponent, defineDirective, e, i, k, p, rC, rc, t, v} from '../../src/render3/index';
...
describe('exports', () => {
  ...
  it('should support component instance fed into directive', () => {
    ...
    function Template(ctx: any, cm: boolean) {
      if (cm) {
        E(0, MyComponentDef);
        { D(0, MyComponentDef.n(), MyComponentDef); }
        e();
        E(1, 'div');
        { D(1, MyDirDef.n(), MyDirDef); }
        e();
      }
      let temp;
      i(temp = b(D<MyComponent>(0))) && (D<MyDir>(1).myDir = temp);
    }
    ...
    const MyComponentDef = defineComponent(
        {type: MyComponent, tag: 'comp', template: function() {}, factory: () => new MyComponent});

    class MyDir {
      myDir: MyComponent;
      constructor() { myDir = this; }
    }
    const MyDirDef = defineDirective({type: MyDir, factory: () => new MyDir});
  ...
  describe('forward refs', () => {
    ...
    it('should work with component refs', () => {
      ...
      function Template(ctx: any, cm: boolean) {
        ...
        let temp;
        i(temp = b(D<MyComponent>(1))) && (D<MyDir>(0).myDir = temp);
      }
      ...
      class MyDir {
        ...
        static ngDirectiveDef = defineDirective({type: MyDir, factory: () => new MyDir});
      }
