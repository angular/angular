...
describe('i18n', () => {
    ...
    class MyApp {
      static ngComponentDef = $r3$.ɵdefineComponent({
        ...
        template: function(rf: $RenderFlags$, ctx: $MyApp$) {
          if (rf & 1) {
            $r3$.ɵi18nMapping(0, $msg_1$, [{START_P: 1}]);
  ...
  it('should support expressions', () => {
    ...
    class MyApp {
      ...
      static ngComponentDef = $r3$.ɵdefineComponent({
        ...
        template: function(rf: $RenderFlags$, ctx: $MyApp$) {
          if (rf & 1) {
            $r3$.ɵi18nMapping(0, $msg_1$, null, [{EXP_1: 1}]);
            $r3$.ɵelementStart(0, 'div');
            $r3$.ɵtext(1);
            $r3$.ɵelementEnd();
            $r3$.ɵi18nApply(1, 0, 0);
  ...
  it('should support expressions in attributes', () => {
    ...
    class MyApp {
      ...
      static ngComponentDef = $r3$.ɵdefineComponent({
        ...
        template: function(rf: $RenderFlags$, ctx: $MyApp$) {
          if (rf & 1) {
            $r3$.ɵi18nAttrMapping(0, $msg_1$, ['EXP_1']);
            $r3$.ɵelementStart(0, 'div');
            $r3$.ɵelementStart(1, 'p');
            $r3$.ɵelementEnd();
            $r3$.ɵelementEnd();
          ...
          if (rf & 2) {
            $r3$.ɵelementProperty(0, 'title', $r3$.ɵi18nInterpolation1(0, ctx.exp1));
          }
        }
      });
    }
  ...
  it('should support embedded templates', () => {
    ...
    function liTemplate(rf1: $RenderFlags$, row: NgForOfContext<string>) {
      if (rf1 & 1) {
        $r3$.ɵi18nMapping(
            0, $msg_1$, [{START_LI: 1}, {START_LI: 0}], [null, {EXP_1: 1}], ['START_LI']);
