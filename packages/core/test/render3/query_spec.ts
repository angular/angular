...
import {bind, container, containerRefreshEnd, containerRefreshStart, directiveInject, viewQuery, loadViewQuery, element, elementContainerEnd, elementContainerStart, elementEnd, elementProperty, elementStart, embeddedViewEnd, embeddedViewStart, load, loadQueryList, reference, registerContentQuery, template, text} from '../../src/render3/instructions';
