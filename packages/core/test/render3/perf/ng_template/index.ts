...
} from '../../../../src/render3/view_engine_compatibility';
...
class NgIfLike {
  static ɵfac() {
    return new NgIfLike(
      ɵɵdirectiveInject(TemplateRefToken),
      ɵɵdirectiveInject(ViewContainerRefToken)
    );
  }
...
const rootLView = createLView(
  null,
  createTView(TViewType.Root, -1, null, 0, 0, null, null, null, null, null),
  {},
  LViewFlags.IsRoot,
  null,
  null
