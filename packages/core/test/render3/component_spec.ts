...
import {T, b, defineComponent, markDirty, renderComponent, t} from '../../src/render3/index';

import {containerEl, document, requestAnimationFrame} from './render_util';
...
describe('component', () => {
  ...
  describe('renderComponent', () => {
    ...
    it('should re-render on input change or method invocation', () => {
      const component = renderComponent(CounterComponent, {renderer: document, host: containerEl});
      expect(containerEl.innerHTML).toEqual('0');
      component.count = 123;
