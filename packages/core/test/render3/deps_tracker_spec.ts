...
describe('runtime dependency tracker', () => {
  ...
  describe('getNgModuleScope method', () => {
    ...
    describe('exports specs', () => {
      ...
      it('should include the exported scope of an exported module in both the compilation and exported scopes',
         () => {
           @Directive({})
           class Directive1 {
           }
    ...
    describe('import specs', () => {
      ...
      it('should contain the exported scope of an imported module with providers in compilation scope',
         () => {
           @Directive({})
           class Directive1 {
           }
      ...
      it('should poison compilation scope if an import is neither a NgModule nor a NgModule with providers nor a standalone component',
         () => {
           class RandomClass {}
    ...
    describe('declarations specs', () => {
      ...
      it('should poison compilation scope if declare a standalone component', () => {
        @Component({standalone: true})
        class Component1 {
        }
    ...
    describe('forward ref specs', () => {
      ...
      it('should include the exported scope of an exported forward ref module in both exported and compilation scope when compiling in JIT mode',
         () => {
      ...
      it('should include the exported scope of an exported forward ref module in both exported and compilation scope when compiling in AOT mode',
         () => {
           class MainModule {}
  ...
  describe('getComponentDependencies method', () => {
    describe('for non-standalone component', () => {
      ...
      it('should include the compilation scope of the declaring module when it is forward refed',
         () => {
           @Component({})
           class Component1 {
           }
    ...
    describe('for standalone component', () => {
      it('should return only self if component has empty imports', () => {
        @Component({standalone: true})
        class MainComponent {
        }
