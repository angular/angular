...
describe('AppRef', () => {
  ...
  it('should not instantiate the ErrorHandler while creating the ApplicationRef', () => {
    ...
    @Component({
      template: '{{throwPlease}}',
    })
    class ThrowingComponent {
      get throwPlease() {
        throw new Error('Please throw');
      }
    }
    ...
    const fixture = TestBed.createComponent(ThrowingComponent);
