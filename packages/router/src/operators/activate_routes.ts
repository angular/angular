...
import {Event, ChildActivationEnd, ActivationEnd} from '../events';
import {RouteReuseStrategy, DetachedRouteHandleInternal} from '../route_reuse_strategy';
import {NavigationTransition} from '../router';
import {ChildrenOutletContexts} from '../router_outlet_context';
import { RouterState, ActivatedRouteSnapshot, ActivatedRoute, advanceActivatedRoute } from '../router_state';
