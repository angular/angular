 ...
 * to this `EmptyOutletComponent`. This component acts as a passthrough wrapper for the child outlet.
 */
@Component({
...
export class EmptyOutletComponent {
  ...
  /**
   * Child outlet is instantiated and assigned in create mode so this should always be defined.
   *
   * Note that `RouterOutlet` is a directive, not a component, so we have to do this in a bit
   * of a roundabout way instead of creating it in the constructor of this component.
   */
  outlet!: RouterOutlet;
