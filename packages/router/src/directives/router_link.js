...
let RouterLink = class RouterLink {
  ...
  constructor(router, route, tabIndexAttribute, renderer, el, locationStrategy) {
    ...
    /** @nodoc */
    this.reactiveHref = signal(null);
    /** @internal */
    this.onChanges = new Subject();
    this.applicationErrorHandler = inject(ɵINTERNAL_APPLICATION_ERROR_HANDLER);
...
__decorate([HostBinding('attr.target'), Input()], RouterLink.prototype, 'target', void 0);
__decorate([Input()], RouterLink.prototype, 'queryParams', void 0);
__decorate([Input()], RouterLink.prototype, 'fragment', void 0);
__decorate([Input()], RouterLink.prototype, 'queryParamsHandling', void 0);
__decorate([Input()], RouterLink.prototype, 'state', void 0);
__decorate([Input()], RouterLink.prototype, 'info', void 0);
__decorate([Input()], RouterLink.prototype, 'relativeTo', void 0);
__decorate(
...
__decorate([Input({transform: booleanAttribute})], RouterLink.prototype, 'replaceUrl', void 0);
__decorate([Input()], RouterLink.prototype, 'routerLink', null);
__decorate(
  [
    HostListener('click', [
      '$event.button',
