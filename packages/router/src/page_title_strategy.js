 ...
 */
let TitleStrategy = class TitleStrategy {
  /**
 ...
 */
let DefaultTitleStrategy = class DefaultTitleStrategy extends TitleStrategy {
  constructor(title) {
    super();
    this.title = title;
  }
...
DefaultTitleStrategy = __decorate([Injectable({providedIn: 'root'})], DefaultTitleStrategy);
