...
class Recognizer {
  ...
  recognize(): Observable<RouterStateSnapshot> {
    try {
      ...
      return new Observable<RouterStateSnapshot>((obs: Observer<RouterStateSnapshot>) =>
        obs.error(e)
      );
    }
  }
  ...
  processChildren(
    ...
    const children = mapChildrenIntoArray(segmentGroup, (child, childOutlet) =>
