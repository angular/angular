...
export {Data, LoadChildren, LoadChildrenCallback, QueryParamsHandling, QueryParamsHandlingStrategy, ResolveData, Route, Routes, RunGuardsAndResolvers} from './config';
