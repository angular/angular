    ...
    if (typeof ngDevMode === 'undefined' || ngDevMode) {
      if (root.segments.length > 0) {
        throw new RuntimeError(
          4015 /* RuntimeErrorCode.INVALID_ROOT_URL_SEGMENT */,
 ...
 * @publicApi
 */
let UrlSerializer = class UrlSerializer {};
UrlSerializer = __decorate(
...
class UrlParser {
  ...
  parseSegment() {
    ...
    if (path === '' && this.peekStartsWith(';')) {
      throw new RuntimeError(
        4009 /* RuntimeErrorCode.EMPTY_PATH_WITH_PARAMS */,
  ...
  parseParens(allowPrimary) {
    ...
    while (!this.consumeOptional(')') && this.remaining.length > 0) {
      ...
      if (next !== '/' && next !== ')' && next !== ';') {
        throw new RuntimeError(
          4010 /* RuntimeErrorCode.UNPARSABLE_URL */,
  ...
  capture(str) {
    if (!this.consumeOptional(str)) {
      throw new RuntimeError(
        4011 /* RuntimeErrorCode.UNEXPECTED_VALUE_IN_URL */,
