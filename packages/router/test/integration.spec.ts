  ...
  describe(`${browserAPI}-based routing`, () => {
    ...
    describe('router links', () => {
      ...
      describe('should support history and state', () => {
        ...
        afterEach(fakeAsync(inject([Router, Location], (router: Router, location: Location) => {
          const fixture = createRoot(router, RootCmp);
    ...
    describe('lazy loading', () => {
      ...
      describe('should use the injector of the lazily-loaded configuration', () => {
        ...
        class LazyChildComponent {
          constructor(
              ...
              lazyService:
                  LazyLoadedServiceDefinedInModule,  // should be able to inject lazy service
      ...
      describe('preloading', () => {
        ...
        it('should not preload when canLoad is present and does not execute guard',
           fakeAsync(() => {
             const router = TestBed.inject(Router);
             const fixture = createRoot(router, RootCmp);
    ...
    describe('Custom Route Reuse Strategy', () => {
      ...
      it('should emit an event when an outlet gets attached/detached', fakeAsync(() => {
           ...
           router.resetConfig(
               [{path: 'a', component: BlankCmp}, {path: 'b', component: SimpleCmp}]);
