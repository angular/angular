...
describe('Integration', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{path: 'simple', component: SimpleCmp}]),
        TestModule,
      ],
  ...
  describe('navigation', function () {
    ...
    describe('relativeLinkResolution', () => {
      ...
      it('should not ignore empty paths in legacy mode', fakeAsync(
        inject([Router], (router: Router) => {
      ...
      it('should ignore empty paths in corrected mode', fakeAsync(
        inject([Router], (router: Router) => {
  ...
  describe('get/setTransition', () => {
    it('should provide the most recent NavigationTransition', fakeAsync(
      inject([Router, Location], (router: Router, location: SpyLocation) => {
        router.resetConfig([
          {path: '', component: SimpleCmp},
          {path: 'a', component: SimpleCmp},
  ...
  describe('"eager" urlUpdateStrategy', () => {
    ...
    it('should eagerly update the URL with urlUpdateStrategy="eagar"', fakeAsync(
      inject([Router, Location], (router: Router, location: Location) => {
        const fixture = TestBed.createComponent(RootCmp);
        advance(fixture);
    ...
    it('should set browserUrlTree with urlUpdateStrategy="eagar" and false `shouldProcessUrl`', fakeAsync(
      inject([Router, Location], (router: Router, location: Location) => {
        const fixture = TestBed.createComponent(RootCmp);
        advance(fixture);
    ...
    it('should eagerly update URL after redirects are applied with urlUpdateStrategy="eagar"', fakeAsync(
      inject([Router, Location], (router: Router, location: Location) => {
        const fixture = TestBed.createComponent(RootCmp);
        advance(fixture);
    ...
    it('should should set `state` with urlUpdateStrategy="eagar"', fakeAsync(
      inject([Router, Location], (router: Router, location: SpyLocation) => {
        router.urlUpdateStrategy = 'eager';
        router.resetConfig([
          {path: '', component: SimpleCmp},
  ...
  it('should dispatch NavigationCancel after the url has been reset back', fakeAsync(() => {
    TestBed.configureTestingModule({providers: [{provide: 'returnsFalse', useValue: () => false}]});
  ...
  it('should support custom malformed uri error handler', fakeAsync(
    inject([Router, Location], (router: Router, location: Location) => {
  ...
  describe('router links', () => {
    ...
    it('should update hrefs when query params or fragment change', fakeAsync(() => {
      @Component({
        selector: 'someRoot',
        template: `<router-outlet></router-outlet
          ><a routerLink="/home" preserveQueryParams preserveFragment>Link</a>`,
      })
      class RootCmpWithLink {}
      TestBed.configureTestingModule({declarations: [RootCmpWithLink]});
      const router: Router = TestBed.inject(Router);
  ...
  describe('guards', () => {
    ...
    describe('CanDeactivate', () => {
      ...
      describe('should not deactivate a route when CanDeactivate returns false', () => {
        ...
        it('should call canDeactivate handler with each deactivated component', fakeAsync(
          inject([Router, Location], (router: Router, location: Location) => {
            const fixture = createRoot(router, TwoOutletsCmp);
  ...
  describe('lazy loading', () => {
              ...
              RouterModule.forChild([
                {
                  path: 'parent',
                  component: Parent,
                  children: [{path: 'child', loadChildren: 'child'}],
                },
              ]),
            ],
            providers: [
    ...
    it('throws an error when forRoot() is used in a lazy context', fakeAsync(
      inject(
        ...
        (router: Router, location: Location, loader: SpyNgModuleFactoryLoader) => {
          ...
          advance(fixture);
          expect(recordedError.message).toEqual(
    ...
    describe('should use the injector of the lazily-loaded configuration', () => {
      ...
      class LazyChildComponent {
        constructor(
          ...
          eager: EagerParentComponent // should use the injector of the location to create a parent
        ) {}
      }
    ...
    describe('relativeLinkResolution', () => {
      ...
      it('should not ignore empty path when in legacy mode', fakeAsync(
        inject(
          [Router, NgModuleFactoryLoader],
          (router: Router, loader: SpyNgModuleFactoryLoader) => {
            router.relativeLinkResolution = 'legacy';
      ...
      it('should ignore empty path when in corrected mode', fakeAsync(
        inject(
          [Router, NgModuleFactoryLoader],
          (router: Router, loader: SpyNgModuleFactoryLoader) => {
            router.relativeLinkResolution = 'corrected';
      ...
      class RootCmpWithCondOutlet implements OnDestroy {
        ...
        constructor(router: Router) {
          this.subscription = router.events
            ...
            .subscribe(
              () =>
                (this.isToolpanelShowing = !!router.parseUrl(router.url).root.children['toolpanel'])
            );
        }
...
describe('Testing router options', () => {
  describe('paramsInheritanceStrategy', () => {
    ...
    it('should configure the router', fakeAsync(
      inject([Router], (router: Router) => {
...
@Component({
  selector: 'link-cmp',
  template: `<router-outlet></router-outlet
    ><a routerLinkActive="active" [routerLinkActiveOptions]="{exact: exact}" [routerLink]="['./']"
      >link</a
    >
    <button
