    ...
    it('should work', fakeAsync(
      inject(
        ...
        (
          ...
          const loadedConfig2: LoadedRouterConfig = (loadedConfig.routes[0] as any)._loadedConfig!;
    ...
    it('should work', fakeAsync(
      inject(
        ...
        (
          ...
          const loadedConfig2: LoadedRouterConfig = (loadedConfig.routes[0] as any)._loadedConfig!;
          const loadedConfig3: LoadedRouterConfig = (loadedConfig2.routes[0] as any)._loadedConfig!;
