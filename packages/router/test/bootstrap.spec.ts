...
describe('bootstrap', () => {
  ...
  it('should NOT wait for resolvers to complete when initialNavigation = legacy_enabled', (done) => {
    @Component({selector: 'test', template: 'test'})
  ...
  it('should not init router navigation listeners if a non root component is bootstrapped', (done) => {
    @NgModule({
  ...
  it('should reinit router navigation listeners if a previously bootstrapped root component is destroyed', (done) => {
    @NgModule({
      imports: [BrowserModule, RouterModule.forRoot([], {useHash: true})],
      declarations: [SecondRootCmp, RootCmp],
      entryComponents: [SecondRootCmp],
