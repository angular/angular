  ...
  describe('guards', () => {
    describe('CanActivate', () => {
      describe('guard completes before emitting a value', () => {
        ...
        it('should not thrown an unhandled promise rejection', () =>
          fakeAsync(async () => {
      ...
      describe('should redirect when guard returns UrlTree', () => {
        ...
        it('can redirect to 404 without changing the URL', () =>
          fakeAsync(() => {
            TestBed.configureTestingModule({
              providers: [provideRouter([], withRouterConfig({urlUpdateStrategy: 'eager'}))],
            });
        ...
        it('can redirect while changing state object', () =>
          fakeAsync(() => {
            TestBed.configureTestingModule({
              providers: [provideRouter([], withRouterConfig({urlUpdateStrategy: 'eager'}))],
            });
    ...
    describe('CanLoad', () => {
      ...
      it('cancels guard execution when a new navigation happens', () =>
        fakeAsync(() => {
          @Injectable({providedIn: 'root'})
          class DelayedGuard {
    ...
    describe('should run CanLoad guards concurrently', () => {
      ...
      it('should only execute canLoad guards of routes being activated', () =>
        fakeAsync(() => {
          const router = TestBed.inject(Router);
    ...
    describe('canMatch', () => {
      ...
      it('falls back to second route when canMatch returns false', () =>
        fakeAsync(() => {
          const router = TestBed.inject(Router);
          router.resetConfig([
            {
      ...
      it('uses route when canMatch returns true', () =>
        fakeAsync(() => {
          const router = TestBed.inject(Router);
      ...
      it('can return UrlTree from canMatch guard', () =>
        fakeAsync(() => {
          const router = TestBed.inject(Router);
      ...
      it('can return UrlTree from CanMatchFn guard', () =>
        fakeAsync(() => {
      ...
      it('runs canMatch guards provided in lazy module', () =>
        fakeAsync(() => {
          const router = TestBed.inject(Router);
          @Component({
            selector: 'lazy',
    ...
    it('should allow guards as functions', () =>
      fakeAsync(() => {
        @Component({
          template: '',
        })
    ...
    it('should allow DI in plain function guards', () =>
      fakeAsync(() => {
        @Component({
          template: '',
        })
    ...
    it('can run functional guards serially', () =>
      fakeAsync(() => {
