...
export function routerLinkIntegrationSpec() {
  describe('router links', () => {
    ...
    it('should not throw when commands is null or undefined', () =>
      fakeAsync(() => {
        @Component({
          selector: 'someCmp',
    ...
    it('should not throw when some command is null', () =>
      fakeAsync(() => {
        @Component({
          selector: 'someCmp',
    ...
    it('should not throw when some command is undefined', () =>
      fakeAsync(() => {
        @Component({
          selector: 'someCmp',
    ...
    it('should correctly use the preserve strategy', () =>
      fakeAsync(() => {
        @Component({
          selector: 'someRoot',
    ...
    it('should correctly use the merge strategy', () =>
      fakeAsync(() => {
        @Component({
          selector: 'someRoot',
    ...
    it('should set href on area elements', () =>
      fakeAsync(() => {
        @Component({
          selector: 'someRoot',
