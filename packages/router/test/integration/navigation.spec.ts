...
export function navigationIntegrationTestSuite() {
  ...
  describe('should execute navigations serially', () => {
    ...
    describe('route activation', () => {
      ...
      it('should advance the parent route after deactivating its children', () =>
        fakeAsync(() => {
      ...
      it('should deactivate outlet children with componentless parent', () =>
        fakeAsync(() => {
          TestBed.configureTestingModule({imports: [TestModule]});
          const router = TestBed.inject(Router);
          const fixture = createRoot(router, RootCmp);
      ...
      it('should work between aux outlets under two levels of empty path parents', () =>
        fakeAsync(() => {
          TestBed.configureTestingModule({imports: [TestModule]});
          const router = TestBed.inject(Router);
          router.resetConfig([
