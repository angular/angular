...
export function routeReuseIntegrationSuite() {
  describe('Custom Route Reuse Strategy', () => {
    ...
    it('should emit an event when an outlet gets attached/detached', () =>
      fakeAsync(() => {
        @Component({
          selector: 'container',
    ...
    it('should not remount a destroyed component', () =>
      fakeAsync(() => {
        @Component({
          selector: 'root-cmp',
    ...
    it('should allow to attach parent route with fresh child route', () =>
      fakeAsync(() => {
