...
describe('recognize', () => {
  ...
  it('should match routes in the depth first order', () => {
    ...
    checkRecognize(
      ...
      (s: RouterStateSnapshot) => {
        checkActivatedRoute(s.root, '', {}, RootComponent);
        checkActivatedRoute((s as any).firstChild(s.root)!, 'a/paramA', {id: 'paramA'}, ComponentC);
      }
    );
  });
  ...
  describe('data', () => {
    it('should set static data', () => {
      checkRecognize(
        [{path: 'a', data: {one: 1}, component: ComponentA}],
        'a',
        (s: RouterStateSnapshot) => {
    ...
    it("should inherit componentless route's data", () => {
      checkRecognize(
        ...
        'a/b',
        (s: RouterStateSnapshot) => {
          const r: ActivatedRouteSnapshot = (s as any).firstChild(
            <any>(s as any).firstChild(s.root)
          )!;
      ...
      it('should inherit params', () => {
        checkRecognize(
          ...
          (s: RouterStateSnapshot) => {
            ...
            checkActivatedRoute(
              (s as any).firstChild((s as any).firstChild(s.root)!)!,
              '',
              {p: '1'},
              ComponentB
            );
  ...
  describe('query parameters', () => {
    ...
    it('should not freeze UrlTree query params', () => {
      ...
      recognize(RootComponent, [{path: 'a', component: ComponentA}], url, 'a?q=11').subscribe(
        (s: RouterStateSnapshot) => {
...
function checkRecognize(
  ...
  recognize(RootComponent, config, tree(url), url, paramsInheritanceStrategy).subscribe(
    callback,
    (e) => {
      throw e;
    }
