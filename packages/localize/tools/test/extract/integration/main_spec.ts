        ...
        it('should extract translations from source code, and write as xmb format', () => {
          ...
          expect(fs.readFile(outputPath)).toEqual(
            [
              ...
              `  <msg id="${
                useLegacyIds ? '12345678901234567890' : '273296103957933077'
              }"><source>test_files/test.js:4</source>Legacy id message</msg>`,
          ...
          it(`should extract translations from source code, and write as XLIFF 1.2 format${
            ...
            expect(fs.readFile(outputPath)).toEqual(
              [
                ...
                `  <file source-language="en-CA" datatype="plaintext" original="ng2.template"${toAttributes(
                  formatOptions,
                )}>`,
                `    <body>`,
                ...
                `      </trans-unit>`,
                `      <trans-unit id="${
                  useLegacyIds ? '1234567890123456789012345678901234567890' : '273296103957933077'
                }" datatype="html">`,
