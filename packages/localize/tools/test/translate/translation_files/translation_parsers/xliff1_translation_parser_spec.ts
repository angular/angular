...
describe('Xliff1TranslationParser', () => {
  ...
  describe('analyze()', () => {
    it('should return a success object if the file contains an <xliff> element with version="1.2" attribute', () => {
      ...
      expect(parser.analyze('/some/file.json', '<xliff version="1.2">')).toEqual(
        jasmine.objectContaining({canParse: true, hint: jasmine.any(Object)}),
      );
      expect(parser.analyze('/some/file.xliff', '<xliff version="1.2">')).toEqual(
        jasmine.objectContaining({canParse: true, hint: jasmine.any(Object)}),
      );
      expect(parser.analyze('/some/file.json', '<xliff version="1.2">')).toEqual(
        jasmine.objectContaining({canParse: true, hint: jasmine.any(Object)}),
    ...
    it('should return a failure object if the file cannot be parsed as XLIFF 1.2', () => {
      const parser = new Xliff1TranslationParser();
      expect(parser.analyze('/some/file.xlf', '<xliff>')).toEqual(
        jasmine.objectContaining({
          canParse: false,
        }),
      );
      expect(parser.analyze('/some/file.xlf', '<xliff version="2.0">')).toEqual(
