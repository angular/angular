...
export class StyleCompiler {
  ...
  private _compileStyles(
    ...
    const styleExpressions: o.Expression[] = stylesheet.styles.map(
      (plainStyle) => o.literal(this._shimIfNeeded(plainStyle, shim))
    );
    ...
    stylesheet.styleUrls.forEach((styleUrl) => {
      ...
      dependencies.push(
        new StylesCompileDependency(
          getStylesVarName(null),
          styleUrl,
