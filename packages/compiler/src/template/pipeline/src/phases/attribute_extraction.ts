 ...
 */
export function phaseAttributeExtraction(
    cpl: ComponentCompilationJob, compatibility: boolean): void {
 ...
 */
function populateElementAttributes(view: ViewCompilationUnit, compatibility: boolean) {
