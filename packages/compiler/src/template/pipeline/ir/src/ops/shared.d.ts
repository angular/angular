 ...
 * Create a `VariableOp`.
 */
export declare function createVariableOp<OpT extends Op<OpT>>(xref: XrefId, variable: SemanticVariable, initializer: o.Expression, flags: VariableFlags): VariableOp<OpT>;
/**
