...
import { AnimationKind, BindingKind, DeferOpModifierKind, DeferTriggerKind, I18nContextKind, I18nParamValueFlags, Namespace, OpKind, TDeferDetailsFlags, TemplateKind } from '../enums';
import { SlotHandle } from '../handle';
import { Op, OpList, XrefId } from '../operations';
import { ConsumesSlotOpTrait, ConsumesVarsTrait } from '../traits';
import { ListEndOp, StatementOp, VariableOp } from './shared';
import type { Interpolation, UpdateOp } from './update';
/**
 * An operation usable on the creation side of the IR.
 */
export type CreateOp = ListEndOp<CreateOp> | StatementOp<CreateOp> | ElementOp | ElementStartOp | ElementEndOp | ContainerOp | ContainerStartOp | ContainerEndOp | TemplateOp | EnableBindingsOp | DisableBindingsOp | TextOp | ListenerOp | TwoWayListenerOp | PipeOp | VariableOp<CreateOp> | NamespaceOp | ProjectionDefOp | ProjectionOp | ExtractedAttributeOp | DeferOp | DeferOnOp | ConditionalCreateOp | ConditionalBranchCreateOp | RepeaterCreateOp | I18nMessageOp | I18nOp | I18nStartOp | I18nEndOp | IcuStartOp | IcuEndOp | IcuPlaceholderOp | I18nContextOp | I18nAttributesOp | DeclareLetOp | AnimationListenerOp | AnimationStringOp | AnimationOp | SourceLocationOp;
/**
 * An operation representing the creation of an element or container.
 */
export type ElementOrContainerOps = ElementOp | ElementStartOp | ContainerOp | ContainerStartOp | TemplateOp | RepeaterCreateOp | ConditionalCreateOp | ConditionalBranchCreateOp;
/**
...
export interface ElementOpBase extends ElementOrContainerOpBase {
    kind: OpKind.Element | OpKind.ElementStart | OpKind.Template | OpKind.RepeaterCreate | OpKind.ConditionalCreate | OpKind.ConditionalBranchCreate;
    /**
 ...
 */
export declare function createElementStartOp(tag: string, xref: XrefId, namespace: Namespace, i18nPlaceholder: i18n.TagPlaceholder | undefined, startSourceSpan: ParseSourceSpan, wholeSourceSpan: ParseSourceSpan): ElementStartOp;
/**
 ...
 * Create a `TemplateOp`.
 */
export declare function createTemplateOp(xref: XrefId, templateKind: TemplateKind, tag: string | null, functionNameSuffix: string, namespace: Namespace, i18nPlaceholder: i18n.TagPlaceholder | i18n.BlockPlaceholder | undefined, startSourceSpan: ParseSourceSpan, wholeSourceSpan: ParseSourceSpan): TemplateOp;
/**
...
export declare function createConditionalBranchCreateOp(xref: XrefId, templateKind: TemplateKind, tag: string | null, functionNameSuffix: string, namespace: Namespace, i18nPlaceholder: i18n.TagPlaceholder | i18n.BlockPlaceholder | undefined, startSourceSpan: ParseSourceSpan, wholeSourceSpan: ParseSourceSpan): ConditionalBranchCreateOp;
/**
...
export declare function createRepeaterCreateOp(primaryView: XrefId, emptyView: XrefId | null, tag: string | null, track: o.Expression, varNames: RepeaterVarNames, emptyTag: string | null, i18nPlaceholder: i18n.BlockPlaceholder | undefined, emptyI18nPlaceholder: i18n.BlockPlaceholder | undefined, startSourceSpan: ParseSourceSpan, wholeSourceSpan: ParseSourceSpan): RepeaterCreateOp;
/**
 ...
 * Create a `TextOp`.
 */
export declare function createTextOp(xref: XrefId, initialValue: string, icuPlaceholder: string | null, sourceSpan: ParseSourceSpan | null): TextOp;
/**
 ...
 */
export declare function createAnimationStringOp(name: string, target: XrefId, animationKind: AnimationKind, expression: o.Expression | Interpolation, securityContext: SecurityContext | SecurityContext[], sourceSpan: ParseSourceSpan): AnimationStringOp;
/**
 * A logical operation representing binding to an animation in the create IR.
 */
 ...
 * Create an `AnimationOp`.
 */
export declare function createAnimationOp(name: string, target: XrefId, animationKind: AnimationKind, callbackOps: Array<UpdateOp>, securityContext: SecurityContext | SecurityContext[], sourceSpan: ParseSourceSpan): AnimationOp;
/**
 ...
 */
export declare function createListenerOp(target: XrefId, targetSlot: SlotHandle, name: string, tag: string | null, handlerOps: Array<UpdateOp>, legacyAnimationPhase: string | null, eventTarget: string | null, hostListener: boolean, sourceSpan: ParseSourceSpan): ListenerOp;
 ...
 * Create a `ListenerOp`. Host bindings reuse all the listener logic.
 */
export declare function createAnimationListenerOp(target: XrefId, targetSlot: SlotHandle, name: string, tag: string | null, handlerOps: Array<UpdateOp>, animationKind: AnimationKind, eventTarget: string | null, hostListener: boolean, sourceSpan: ParseSourceSpan): AnimationListenerOp;
/**
 ...
 */
export declare function createTwoWayListenerOp(target: XrefId, targetSlot: SlotHandle, name: string, tag: string | null, handlerOps: Array<UpdateOp>, sourceSpan: ParseSourceSpan): TwoWayListenerOp;
export interface PipeOp extends Op<CreateOp>, ConsumesSlotOpTrait {
    kind: OpKind.Pipe;
    xref: XrefId;
    name: string;
}
export declare function createPipeOp(xref: XrefId, slot: SlotHandle, name: string): PipeOp;
/**
...
export declare function createProjectionDefOp(def: o.Expression | null): ProjectionDefOp;
/**
 * An op that creates a content projection slot.
 */
...
export declare function createProjectionOp(xref: XrefId, selector: string, i18nPlaceholder: i18n.TagPlaceholder | undefined, fallbackView: XrefId | null, sourceSpan: ParseSourceSpan): ProjectionOp;
/**
 ...
 */
export declare function createExtractedAttributeOp(target: XrefId, bindingKind: BindingKind, namespace: string | null, name: string, expression: o.Expression | null, i18nContext: XrefId | null, i18nMessage: i18n.Message | null, securityContext: SecurityContext | SecurityContext[]): ExtractedAttributeOp;
...
export declare function createDeferOp(xref: XrefId, main: XrefId, mainSlot: SlotHandle, ownResolverFn: o.Expression | null, resolverFn: o.Expression | null, sourceSpan: ParseSourceSpan): DeferOp;
 ...
 */
export type DeferTrigger = DeferIdleTrigger | DeferImmediateTrigger | DeferTimerTrigger | DeferHoverTrigger | DeferInteractionTrigger | DeferViewportTrigger | DeferNeverTrigger;
...
export declare function createDeferOnOp(defer: XrefId, trigger: DeferTrigger, modifier: DeferOpModifierKind, sourceSpan: ParseSourceSpan): DeferOnOp;
/**
 ...
 */
export declare function createDeclareLetOp(xref: XrefId, declaredName: string, sourceSpan: ParseSourceSpan): DeclareLetOp;
/**
 ...
 */
export declare function createI18nMessageOp(xref: XrefId, i18nContext: XrefId, i18nBlock: XrefId | null, message: i18n.Message, messagePlaceholder: string | null, params: Map<string, o.Expression>, postprocessingParams: Map<string, o.Expression>, needsPostprocessing: boolean): I18nMessageOp;
 ...
 */
export declare function createI18nStartOp(xref: XrefId, message: i18n.Message, root: XrefId | undefined, sourceSpan: ParseSourceSpan | null): I18nStartOp;
/**
 ...
 * Create an `I18nEndOp`.
 */
export declare function createI18nEndOp(xref: XrefId, sourceSpan: ParseSourceSpan | null): I18nEndOp;
/**
 ...
 */
export declare function createIcuStartOp(xref: XrefId, message: i18n.Message, messagePlaceholder: string, sourceSpan: ParseSourceSpan): IcuStartOp;
/**
 ...
 */
export declare function createIcuEndOp(xref: XrefId): IcuEndOp;
/**
 ...
 */
export declare function createIcuPlaceholderOp(xref: XrefId, name: string, strings: string[]): IcuPlaceholderOp;
/**
...
export declare function createI18nContextOp(contextKind: I18nContextKind, xref: XrefId, i18nBlock: XrefId | null, message: i18n.Message, sourceSpan: ParseSourceSpan): I18nContextOp;
...
export declare function createI18nAttributesOp(xref: XrefId, handle: SlotHandle, target: XrefId): I18nAttributesOp;
...
export declare function createSourceLocationOp(templatePath: string, locations: ElementSourceLocation[]): SourceLocationOp;
/**
