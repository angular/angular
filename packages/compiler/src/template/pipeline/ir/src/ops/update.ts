...
/**
 * A logical operation to bind an attribute to an element-like structure in the update IR.
 */
export interface AttributeOp extends Op<UpdateOp>, DependsOnSlotContextOpTrait {
