...
/** ASCII-lowercases `value`, the case insensitivity HTML applies to tag and attribute syntax. */
...
export interface CustomElementsManifestEvent {
   ...
   *
   * SECURITY: see `CustomElementsManifestProperty.checkType`.
   */
  checkType?: string;
