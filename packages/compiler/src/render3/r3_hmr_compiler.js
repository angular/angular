 ...
 */
export function compileHmrInitializer(meta) {
  const moduleName = 'm';
  const dataName = 'd';
 ...
 * @param meta HMR metadata extracted from the class.
 */
export function compileHmrUpdateCallback(definitions, constantStatements, meta) {
...
//# sourceMappingURL=r3_hmr_compiler.js.map
