...
function createHostBindingsFunction(
  ...
  const eventBindings =
      bindingParser.createDirectiveHostEventAsts(hostBindingsMetadata, hostBindingSourceSpan);
  ...
  const bindings =
      bindingParser.createBoundHostProperties(hostBindingsMetadata, hostBindingSourceSpan);
...
export function verifyHostBindings(
  ...
  bindingParser.createDirectiveHostEventAsts(bindings, sourceSpan);
  bindingParser.createBoundHostProperties(bindings, sourceSpan);
