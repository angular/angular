...
export function compileComponentFromMetadata(meta, constantPool, bindingParser) {
  ...
  if (
    meta.defer.mode === 1 /* DeferBlockDepsEmitMode.PerComponent */ &&
  ...
  if (
    meta.declarationListEmitMode !== 3 /* DeclarationListEmitMode.RuntimeResolved */ &&
 ...
 */
export function encapsulateStyle(style, componentIdentifier) {
  const shadowCss = new ShadowCss();
