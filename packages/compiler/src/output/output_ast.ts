...
export class BuiltinType extends Type {
  constructor(public name: BuiltinTypeName, modifiers: TypeModifier[]|null = null) { super(modifiers); }
...
export abstract class Expression {
  ...
  conditional(trueCase: Expression, falseCase: Expression|null = null, sourceSpan?: ParseSourceSpan|null):
      ConditionalExpr {
...
export class ExternalExpr extends Expression {
  constructor(
      public value: CompileIdentifierMetadata, type?: Type|null, public typeParams: Type[]|null = null,
      sourceSpan?: ParseSourceSpan|null) {
    super(type, sourceSpan);
  }
  visitExpression(visitor: ExpressionVisitor, context: any): any {
...
export class ExpressionStatement extends Statement {
  constructor(public expr: Expression, sourceSpan?: ParseSourceSpan|null) { super(null, sourceSpan); }
...
export class ReturnStatement extends Statement {
  constructor(public value: Expression, sourceSpan?: ParseSourceSpan|null) { super(null, sourceSpan); }
  visitStatement(visitor: StatementVisitor, context: any): any {
...
export class ClassMethod extends AbstractClassPart {
  constructor(
      public name: string|null, public params: FnParam[], public body: Statement[], type?: Type|null,
...
export class CommentStmt extends Statement {
  constructor(public comment: string, sourceSpan?: ParseSourceSpan|null) { super(null, sourceSpan); }
  visitStatement(visitor: StatementVisitor, context: any): any {
...
export class TryCatchStmt extends Statement {
  constructor(
      public bodyStmts: Statement[], public catchStmts: Statement[], sourceSpan?: ParseSourceSpan|null) {
    super(null, sourceSpan);
  }
  visitStatement(visitor: StatementVisitor, context: any): any {
...
export class ThrowStmt extends Statement {
  constructor(public error: Expression, sourceSpan?: ParseSourceSpan|null) { super(null, sourceSpan); }
  visitStatement(visitor: StatementVisitor, context: any): any {
...
export function literalMap(
    values: [string, Expression][], type: MapType|null = null, quoted: boolean = false): LiteralMapExpr {
