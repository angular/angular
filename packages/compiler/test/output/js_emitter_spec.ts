  ...
  describe('JavaScriptEmitter', () => {
    ...
    it('should support external identifiers', () => {
      ...
      expect(emitStmt(o.importExpr(externalModuleIdentifier).toStmt())).toEqual(
        [`var i0 = re` + `quire('somePackage/someOtherPath');`, `i0.someExternalId;`].join('\n')
      );
    });
    ...
    it('should support ES5 localized strings', () => {
      expect(
        ...
        String.raw`$localize((this&&this.__makeTemplateObject||function(e,t){return Object.defineProperty?Object.defineProperty(e,"raw",{value:t}):e.raw=t,e})(['ab\\:c', ':ph1:d"e\'f'], ['ab\\\\:c', ':ph1:d"e\'f']), (7 + 8));`
      );
    });
