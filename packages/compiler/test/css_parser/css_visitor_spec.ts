...
(function() {
  ...
  describe('CSS parsing and visiting', () => {
    ...
    it('should parse and visit each of the stylesheet selectors', () => {
      ...
      expect(rule1).toEqual(ast.rules[0] as any);
      ...
      expect(rule2).toEqual(ast.rules[1] as any);
      ...
      expect(rule3).toEqual((<CssMediaQueryRuleAst>ast.rules[2]).block.entries[0] as any);
