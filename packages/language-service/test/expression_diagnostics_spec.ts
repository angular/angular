...
describe('expression diagnostics', () => {
  ...
  it('should reject an async misspelled field', () =>
    reject('{{(promised_person | async)?.nume.first || ""}}', "Identifier 'nume' is not defined"));
  it('should accept an async *ngFor', () =>
    accept(`
  ...
  it('should accept an async *ngIf', () =>
    accept(`
  ...
  it('should reject an uncalled event handler', () =>
    reject('<div (click)="click">{{person.name.first}}</div>', 'Unexpected callable expression'));
