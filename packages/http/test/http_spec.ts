...

{
  describe('injectables', () => {
    ...
    it('should allow using jsonpInjectables and httpInjectables in same injector', inject(
      [AsyncTestCompleter],
  ...
  describe('http', () => {
    ...
    beforeEach(() => {
      injector = Injector.create([
        {provide: BaseRequestOptions, deps: []},
    ...
    describe('Http', () => {
      describe('.request()', () => {
        ...
        it('should accept a fully-qualified request as its only parameter', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            ...
            http
              .request(new Request(new RequestOptions({url: 'https://google.com'})))
        ...
        it('should accept a fully-qualified request as its only parameter', inject(
          ...
          (async: AsyncTestCompleter) => {
            ...
            http
              .request(
                new Request(
                  new RequestOptions({url: 'https://google.com', method: RequestMethod.Post})
                )
              )
              .subscribe((res: Response) => {});
          }
        ...
        it('should perform a get request for given url if only passed a string', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
        ...
        it('should perform a post request for given url if options include a method', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            backend.connections.subscribe((c: MockConnection) => {
        ...
        it('should perform a get request and complete the response', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            backend.connections.subscribe((c: MockConnection) => c.mockRespond(baseResponse));
            http.request('http://basic.connection').subscribe(
              (res: Response) => {
                expect(res.text()).toBe('base response');
              },
              null!,
        ...
        it('should perform multiple get requests and complete the responses', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            backend.connections.subscribe((c: MockConnection) => c.mockRespond(baseResponse));
        ...
        it('should throw if url is not a string or Request', () => {
          const req = <Request>{};
          expect(() => http.request(req)).toThrowError(
      ...
      describe('.options()', () => {
        it('should perform an options request for given url', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            backend.connections.subscribe((c: MockConnection) => {
      ...
      describe('searchParams', () => {
        it('should append search params to url', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            ...
            http
              .get('https://www.google.com', new RequestOptions({search: params}))
              .subscribe((res: Response) => {});
          }
        ));

        it('should append string search params to url', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            backend.connections.subscribe((c: MockConnection) => {
            ...
            http
              .get('https://www.google.com', new RequestOptions({search: 'q=piggies'}))
              .subscribe((res: Response) => {});
          }
        ));

        it('should produce valid url when url already contains a query', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            backend.connections.subscribe((c: MockConnection) => {
            ...
            http
              .get('https://www.google.com?q=angular', new RequestOptions({search: 'as_eq=1.x'}))
              .subscribe((res: Response) => {});
          }
        ));
      });
      ...
      describe('params', () => {
        it('should append params to url', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            backend.connections.subscribe((c: MockConnection) => {
              expect(c.request.url).toEqual('https://www.google.com?q=puppies');
            ...
            http
              .get('https://www.google.com', {params: {q: 'puppies'}})
              .subscribe((res: Response) => {});
          }
        ));
      });
      ...
      describe('string method names', () => {
        it('should allow case insensitive strings for method names', () => {
          inject([AsyncTestCompleter], (async: AsyncTestCompleter) => {
            ...
            http
              .request(new Request(new RequestOptions({url: 'https://google.com', method: 'PosT'})))
              .subscribe((res: Response) => {});
          });
        });
    ...
    describe('Jsonp', () => {
      describe('.request()', () => {
        it('should throw if url is not a string or Request', () => {
          const req = <Request>{};
          expect(() => jsonp.request(req)).toThrowError(
            'First argument must be a url string or Request instance.'
          );
        });
      });
    ...
    describe('response buffer', () => {
      it('should attach the provided buffer to the response', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          backend.connections.subscribe((c: MockConnection) => {
      ...
      it('should be able to consume a buffer containing a String as any response type', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          backend.connections.subscribe((c: MockConnection) => c.mockRespond(baseResponse));
      ...
      it('should be able to consume a buffer containing an ArrayBuffer as any response type', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
      ...
      it('should be able to consume a buffer containing an Object as any response type', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
      ...
      it('should preserve encoding of ArrayBuffer response', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const message = 'é@θЂ';
      ...
      it('should preserve encoding of String response', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const message = 'é@θЂ';
          backend.connections.subscribe((c: MockConnection) =>
      ...
      it('should have an equivalent response independently of the buffer used', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
