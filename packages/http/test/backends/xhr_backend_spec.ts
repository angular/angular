...
import {
  ...
  XHRBackend,
  XHRConnection,
} from '@angular/http/src/backends/xhr_backend';
  ...
  describe('XHRBackend', () => {
    ...
    beforeEach(inject([XHRBackend], (be: XHRBackend) => {
      ...
      sampleRequest = new Request(
        base.merge(new RequestOptions({url: 'https://google.com'})) as any
      );
    }));
    ...
    describe('XHRConnection', () => {
      it('should use the injected BaseResponseOptions to create the response', inject(
        [AsyncTestCompleter],
      ...
      it('should create an error Response on error', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const connection = new XHRConnection(
            sampleRequest,
      ...
      it('should set the status text and status code on error', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const connection = new XHRConnection(
            sampleRequest,
      ...
      it('should attach default Accept header', () => {
        ...
        const base = new BaseRequestOptions();
        const connection = new XHRConnection(
          new Request(base.merge(new RequestOptions({headers})) as any),
          new MockBrowserXHR()
        );
        connection.response.subscribe();
      ...
      if ((global as any) /** TODO #9100 */['Blob']) {
        ...
        const createBlob = (data: Array<string>, datatype: string) => {
          ...
          try {
            ...
            const BlobBuilder =
              (<any>global).BlobBuilder ||
              (<any>global).WebKitBlobBuilder ||
              (<any>global).MozBlobBuilder ||
              (<any>global).MSBlobBuilder;
      ...
      it('should return the correct status code', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
      ...
      it('should call next and complete on 200 codes', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
      ...
      it('should set ok to true on 200 return', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const statusCode = 200;
          const connection = new XHRConnection(
      ...
      it('should set ok to false on 300 return', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
      ...
      it('should call error and not complete on 300+ codes', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          let nextCalled = false;
      ...
      it("should normalize IE's 1223 status code into 204", inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
      ...
      it('should ignore response body for 204 status code', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
      ...
      it('should normalize responseText and response', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const responseBody = 'Doge';

          const connection1 = new XHRConnection(
            sampleRequest,
            new MockBrowserXHR(),
            new ResponseOptions()
          );

          const connection2 = new XHRConnection(
            sampleRequest,
            new MockBrowserXHR(),
            new ResponseOptions()
          );
      ...
      it('should strip XSSI prefixes', inject([AsyncTestCompleter], (async: AsyncTestCompleter) => {
        const conn = new XHRConnection(sampleRequest, new MockBrowserXHR(), new ResponseOptions());
      ...
      it('should strip XSSI prefix from errors', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const conn = new XHRConnection(
            sampleRequest,
            new MockBrowserXHR(),
            new ResponseOptions()
          );
      ...
      it('should parse response headers and add them to the response', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const statusCode = 200;
          const connection = new XHRConnection(
...
Connection: keep-alive`;
      ...
      it('should add the responseURL to the response', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const statusCode = 200;
          const connection = new XHRConnection(
      ...
      it('should add use the X-Request-URL in CORS situations', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const statusCode = 200;
          const connection = new XHRConnection(
      ...
      it('should return request url if it cannot be retrieved from response', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const statusCode = 200;
          const connection = new XHRConnection(
      ...
      it('should set the status text property from the XMLHttpRequest instance if present', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
      ...
      it('should set status text to "OK" if it is not present in XMLHttpRequest instance', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const connection = new XHRConnection(sampleRequest, new MockBrowserXHR());
      ...
      it('should set withCredentials to true when defined in request options for CORS situations', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const statusCode = 200;
      ...
      it('should set the responseType attribute to blob when the corresponding response content type is present', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const statusCode = 200;
          const base = new BaseRequestOptions();
          const connection = new XHRConnection(
            new Request(base.merge(new RequestOptions({responseType: ResponseContentType.Blob}))),
            new MockBrowserXHR()
          );
      ...
      it('should not throw invalidStateError if response without body and responseType not equal to text', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const base = new BaseRequestOptions();
          const connection = new XHRConnection(
            new Request(base.merge(new RequestOptions({responseType: ResponseContentType.Json}))),
            new MockBrowserXHR()
          );
