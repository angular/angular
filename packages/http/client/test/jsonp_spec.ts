...
import {JSONP_ERR_NO_CALLBACK, JSONP_ERR_WRONG_METHOD, JSONP_ERR_WRONG_RESPONSE_TYPE, JsonpCallbackMap, JsonpClientBackend} from '../src/jsonp';
import {HttpRequest} from '../src/request';
import {HttpErrorResponse, HttpEventType} from '../src/response';

import {MockDocument} from './jsonp_mock';

function runOnlyCallback(home: JsonpCallbackMap, data: Object) {
...
const SAMPLE_REQ = new HttpRequest<never>('/test', 'JSONP');

export function main() {
  describe('JsonpClientBackend', () => {
    let home: JsonpCallbackMap = {};
