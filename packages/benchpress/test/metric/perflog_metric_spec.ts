...
(function () {
  ...
  describe('perflog metric', () => {
    ...
    describe('beginMeasure', () => {
      it('should not force gc and mark the timeline', inject(
        [AsyncTestCompleter],
      ...
      it('should force gc and mark the timeline', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
    ...
    describe('endMeasure', () => {
      it('should mark and aggregate events in between the marks', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const events = [
            [
      ...
      it('should mark and aggregate events since navigationStart', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const events = [
            [
      ...
      it('should ignore navigationStart if ignoreNavigation is set', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const events = [
            [
      ...
      it('should loop and aggregate until the end mark is present', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const events = [
      ...
      it('should store events after the end mark for the next call', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const events = [
            [
      ...
      describe('with forced gc', () => {
        ...
        it('should restart after the forced gc if needed', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            const metric = createMetric(events, null!, {forceGc: true});
            metric
    ...
    describe('aggregation', () => {
      ...
      describe('frame metrics', () => {
        it('should calculate mean frame time', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            aggregate(
              [
        ...
        it('should throw if no start event', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
        ...
        it('should throw if no end event', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            aggregate(
        ...
        it('should throw if trying to capture twice', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            aggregate(
              [
        ...
        it('should throw if trying to capture when frame capture is disabled', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
        ...
        it('should throw if frame capture is enabled, but nothing is captured', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
        ...
        it('should calculate best and worst frame time', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            aggregate(
              [
        ...
        it('should calculate percentage of smoothness to be good', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            aggregate(
              [
        ...
        it('should calculate percentage of smoothness to be bad', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            aggregate(
              [
      ...
      it('should report a single interval', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          aggregate([eventFactory.start('script', 0), eventFactory.end('script', 5)]).then(
            (data) => {
      ...
      it('should sum up multiple intervals', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          aggregate([
      ...
      it('should ignore not started intervals', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
      ...
      it('should ignore not ended intervals', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
      ...
      it('should ignore nested intervals', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          aggregate([
            eventFactory.start('script', 0),
      ...
      it('should ignore events from different processed as the start mark', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
      ...
      it('should mark a run as invalid if the start and end marks are different', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          const otherProcessEventFactory = new TraceEventFactory('timeline', 'pid1');
          const metric = createMetric(
      ...
      it('should support scriptTime metric', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          aggregate([eventFactory.start('script', 0), eventFactory.end('script', 5)]).then(
            (data) => {
      ...
      it('should support renderTime metric', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          aggregate([eventFactory.start('render', 0), eventFactory.end('render', 5)]).then(
            (data) => {
      ...
      it('should support gcTime/gcAmount metric', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          aggregate([
      ...
      it('should support majorGcTime metric', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          aggregate([
            eventFactory.start('gc', 0, {'usedHeapSize': 2500}),
      ...
      it('should support pureScriptTime = scriptTime-gcTime-renderTime', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          aggregate([
            eventFactory.start('script', 0),
      ...
      describe('receivedData', () => {
        it('should report received data since last navigationStart', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            aggregate(
              [
      ...
      describe('requestCount', () => {
        it('should report count of requests sent since last navigationStart', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
            aggregate(
              [
      ...
      describe('microMetrics', () => {
        it('should report micro metrics', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
        ...
        it('should ignore micro metrics that were not specified', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
        ...
        it('should report micro metric averages', inject(
          [AsyncTestCompleter],
          (async: AsyncTestCompleter) => {
