...

{
  ...
  describe('sampler', () => {
    ...
    it('should call the prepare and execute callbacks using WebDriverAdapter.waitFor', inject(
      [AsyncTestCompleter],
    ...
    it('should call prepare, beginMeasure, execute, endMeasure for every iteration', inject(
      [AsyncTestCompleter],
      (async: AsyncTestCompleter) => {
        let workCount = 0;
        const log: any[] = [];
    ...
    it('should call execute, endMeasure for every iteration if there is no prepare callback', inject(
      [AsyncTestCompleter],
      (async: AsyncTestCompleter) => {
        const log: any[] = [];
        let workCount = 0;
    ...
    it('should only collect metrics for execute and ignore metrics from prepare', inject(
      [AsyncTestCompleter],
      (async: AsyncTestCompleter) => {
        let scriptTime = 0;
    ...
    it('should call the validator for every execution and store the valid sample', inject(
      [AsyncTestCompleter],
      (async: AsyncTestCompleter) => {
        const log: any[] = [];
    ...
    it('should report the metric values', inject(
      [AsyncTestCompleter],
      (async: AsyncTestCompleter) => {
        const log: any[] = [];
        const validSample = [mv(null!, null!, {})];
