...

{
  describe('runner', () => {
    ...
    it('should set SampleDescription.id', inject(
      [AsyncTestCompleter],
    ...
    it('should provide Options.EXECUTE', inject(
      [AsyncTestCompleter],
      (async: AsyncTestCompleter) => {
        const execute = () => {};
        createRunner()
    ...
    it('should provide Options.PREPARE', inject(
      [AsyncTestCompleter],
      (async: AsyncTestCompleter) => {
        const prepare = () => {};
        createRunner()
    ...
    it('should provide Options.MICRO_METRICS', inject(
      [AsyncTestCompleter],
      (async: AsyncTestCompleter) => {
        createRunner()
    ...
    it('should overwrite providers per sample call', inject(
      [AsyncTestCompleter],
      (async: AsyncTestCompleter) => {
        createRunner([{provide: Options.DEFAULT_DESCRIPTION, useValue: {'a': 1}}])
          .sample({
