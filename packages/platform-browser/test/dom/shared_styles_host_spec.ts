...
import {APP_ID, CSP_NONCE, DOCUMENT, Injector, runInInjectionContext} from '@angular/core';
...
describe('SharedStylesHost', () => {
  ...
  describe('without nonce set', () => {
    beforeEach(() => {
      ...
      ssh = runInInjectionContext(TestBed.inject(Injector), () => new SharedStylesHost());
