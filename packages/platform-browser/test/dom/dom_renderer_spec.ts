...
describe('DefaultDomRendererV2', () => {
  ...
  it('should encapsulate isolated shadow DOM components, with child components using their own styles', async () => {
  ...
  it('child components of isolated shadow components should use their own background styles inherit browser defaults rather than their component styles', async () => {
    const fixture = TestBed.createComponent(IsolatedShadowComponentParentApp);
    await fixture.whenStable();
  ...
  describe('should not cleanup styles of destroyed components when `REMOVE_STYLES_ON_COMPONENT_DESTROY` is `false`', () => {
    beforeEach(() => {
      ...
      TestBed.configureTestingModule({
        imports: [SomeAppForCleanUp, CmpEncapsulationEmulated, CmpEncapsulationNone],
        providers: [
          {
...
@Component({
  ...
  imports: [CmpEncapsulationEmulated, CmpEncapsulationIsolatedShadowWithConditionalChild],
  encapsulation: ViewEncapsulation.ExperimentalIsolatedShadowDom,
})
...
@Component({
  ...
  `,
  changeDetection: ChangeDetectionStrategy.Eager,
  imports: [CmpEncapsulationIsolatedShadowWithConditionalChild, CmpEncapsulationEmulated],
})
...
@Component({
  ...
  `,
  imports: [CmpEncapsulationIsolatedShadowWithSlot, CmpEncapsulationEmulated],
})
