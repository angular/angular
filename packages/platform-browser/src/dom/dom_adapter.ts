...
export abstract class DomAdapter {
  ...
  abstract createMouseEvent(eventType: any, doc: Document): any;
  abstract createEvent(eventType: string, doc: Document): any;
  ...
  abstract createComment(text: string, doc: Document): any;
  abstract createTemplate(html: any, doc: Document): HTMLElement;
