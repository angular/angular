...
import {Inject, Injectable, Renderer2, RendererFactory2, RendererStyleFlags2, RendererType2, SecurityContext, ViewEncapsulation} from '@angular/core';
    ...
    switch (type.encapsulation) {
      case ViewEncapsulation.Emulated: {
        ...
        if (!renderer) {
          renderer = new EmulatedEncapsulationDomRenderer2(
              this.eventManager, this.sharedStylesHost, type, this.policyAdapter);
      ...
      case ViewEncapsulation.ShadowDom:
        return new ShadowDomRenderer(
            this.eventManager, this.sharedStylesHost, element, type, this.policyAdapter);
      default: {
...
class EmulatedEncapsulationDomRenderer2 extends DefaultDomRenderer2 {
  ...
  constructor(
      ...
      private component: RendererType2, policyAdapter: TrustedTypePolicyAdapter) {
...
class ShadowDomRenderer extends DefaultDomRenderer2 {
  ...
  constructor(
      ...
      policyAdapter: TrustedTypePolicyAdapter) {
    super(eventManager, policyAdapter);
