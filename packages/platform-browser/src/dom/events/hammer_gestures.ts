...
export class HammerGestureConfig {
  ...
  /**
   * @description Creates a {@link http://hammerjs.github.io/api/#hammer.manager HammerJS Manager}
...
export class HammerGesturesPlugin extends EventManagerPlugin {
  /**
   * Initializes an instance of the Hammer gestures-manager service.
   * @param doc The document in which to detect Hammer gestures.
   * @param _config The supported-gestures configuration.
   * @param console The logging console.
   */
  constructor(
