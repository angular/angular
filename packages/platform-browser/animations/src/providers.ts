...
import {ANIMATION_MODULE_TYPE, inject, Inject, Injectable, InjectionToken, NgZone, OnDestroy, Provider, RendererFactory2, ɵChangeDetectionScheduler as ChangeDetectionScheduler,} from '@angular/core';
import {ɵDomRendererFactory2 as DomRendererFactory2} from '@angular/platform-browser';

/**
 * Token to provide to check whether show animatable dev warnings.
 */
export const ANIMATABLE_DEV_WARNINGS_ENABLED = new InjectionToken(
    ngDevMode ? 'AnimatableDevWarningsEnabled' : '',
    {factory: () => true},
);
...
export class InjectableAnimationEngine extends AnimationEngine implements OnDestroy {
  ...
  constructor(
      ...
      @Inject(ANIMATABLE_DEV_WARNINGS_ENABLED) animatableDevWarningsEnabled: boolean,
  ) {
    super(
        doc,
        driver,
