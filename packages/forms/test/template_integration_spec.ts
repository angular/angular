    ...
    describe('updateOn', () => {
      describe('blur', () => {
        ...
        it('should always set value and validity on init', fakeAsync(() => {
          ...
          expect(form.value).toEqual(
            {name: 'Nancy Drew'},
            'Expected initial control value be set.'
          );
        ...
        it('should always set value programmatically right away', fakeAsync(() => {
          ...
          expect(input.value).toEqual(
            'Carson',
            'Expected view value to update on programmatic change.'
          );
          expect(form.value).toEqual(
            {name: 'Carson'},
            'Expected form value to update on programmatic change.'
          );
          expect(form.valid).toBe(
            false,
            'Expected validation to run immediately on programmatic change.'
          );
        }));
        ...
        it('should update value/validity on blur', fakeAsync(() => {
          ...
          expect(fixture.componentInstance.name).toEqual(
            'Carson',
            'Expected value not to update on input.'
          );
          ...
          expect(fixture.componentInstance.name).toEqual(
            'Nancy Drew',
            'Expected value to update on blur.'
          );
        ...
        it('should wait for second blur to update value/validity again', fakeAsync(() => {
          ...
          expect(fixture.componentInstance.name).toEqual(
            'Nancy Drew',
            'Expected value not to update until another blur.'
          );
          ...
          expect(fixture.componentInstance.name).toEqual(
            'Carson',
            'Expected value to update on second blur.'
          );
        ...
        it('should not fire ngModelChange event on blur unless value has changed', fakeAsync(() => {
          ...
          expect(fixture.componentInstance.events).toEqual(
            [],
            'Expected ngModelChanges not to fire.'
          );
          ...
          expect(fixture.componentInstance.events).toEqual(
            [],
            'Expected ngModelChanges not to fire if value unchanged.'
          );
          ...
          expect(fixture.componentInstance.events).toEqual(
            [],
            'Expected ngModelChanges not to fire on input.'
          );
          ...
          expect(fixture.componentInstance.events).toEqual(
            ['fired'],
            'Expected ngModelChanges to fire once blurred if value changed.'
          );
          ...
          expect(fixture.componentInstance.events).toEqual(
            ['fired'],
            'Expected ngModelChanges not to fire on input after blur.'
          );
      ...
      describe('submit', () => {
        ...
        it('should update on submit', fakeAsync(() => {
          ...
          expect(fixture.componentInstance.name).toEqual(
            'Carson',
            'Expected value not to update on blur.'
          );
          ...
          expect(fixture.componentInstance.name).toEqual(
            'Nancy Drew',
            'Expected value to update on submit.'
          );
        ...
        it('should wait until second submit to update again', fakeAsync(() => {
          ...
          expect(fixture.componentInstance.name).toEqual(
            'Nancy Drew',
            'Expected value not to update until second submit.'
          );
          ...
          expect(fixture.componentInstance.name).toEqual(
            'Carson',
            'Expected value to update on second submit.'
          );
        ...
        it('should reset properly', fakeAsync(() => {
          ...
          expect(fixture.componentInstance.name).toEqual(null, 'Expected ngModel value to reset.');
          ...
          expect(form.value).toEqual({name: null}, 'Expected form value to stay empty on submit');
          expect(fixture.componentInstance.name).toEqual(
            null,
            'Expected ngModel value to stay empty on submit.'
          );
        ...
        it('should not fire ngModelChange event on submit unless value has changed', fakeAsync(() => {
          ...
          expect(fixture.componentInstance.events).toEqual(
            ['fired'],
            'Expected ngModelChanges to fire once submitted if value changed.'
          );
          ...
          expect(fixture.componentInstance.events).toEqual(
            ['fired'],
            'Expected ngModelChanges not to fire on input after submit.'
          );
      ...
      describe('ngFormOptions', () => {
        it('should use ngFormOptions value when ngModelOptions are not set', fakeAsync(() => {
          ...
          expect(controlOne.updateOn).toEqual(
            'blur',
            'Expected first control to inherit updateOn from parent form.'
          );

          const controlTwo = form.control.get('two')! as FormControl;
          expect((controlTwo as any)._updateOn).toBeUndefined();
          expect(controlTwo.updateOn).toEqual(
            'blur',
            'Expected last control to inherit updateOn from parent form.'
          );
        }));
        ...
        it('should allow ngModelOptions updateOn to override ngFormOptions', fakeAsync(() => {
          ...
          expect(controlOne.updateOn).toEqual(
            'change',
            'Expected control updateOn to inherit form updateOn.'
          );

          const controlTwo = form.control.get('two')! as FormControl;
          expect((controlTwo as any)._updateOn).toEqual(
            'blur',
            'Expected control to set blur override.'
          );
          expect(controlTwo.updateOn).toEqual(
            'blur',
            'Expected control updateOn to override form updateOn.'
          );
        }));
        ...
        it('should update using ngModelOptions override', fakeAsync(() => {
          ...
          expect(form.value).toEqual(
            {one: 'Nancy Drew', two: ''},
            'Expected first value to update on input.'
          );
          ...
          expect(form.value).toEqual(
            {one: 'Nancy Drew', two: ''},
            'Expected second value not to update on input.'
          );
        ...
        it('should not use ngFormOptions for standalone ngModels', fakeAsync(() => {
          ...
          expect(fixture.componentInstance.two).toEqual(
            'Nancy Drew',
            'Expected standalone ngModel not to inherit blur update.'
          );
        }));
      });
    });
