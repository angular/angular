...
import {AbstractControl, FormArray, FormControl, FormGroup, UntypedFormArray, UntypedFormControl, UntypedFormGroup} from '../src/forms';
...
describe('Typed Class', () => {
  describe('FormControl', () => {
    ...
    it('supports explicit boolean controls', () => {
      let fc: FormControl<boolean> = new FormControl(false, {initialValueIsDefault: true});
    });
  ...
  describe('FormGroup', () => {
    ...
    it('supports explicit groups with boolean types', () => {
      let fg: FormGroup<{a: FormControl<number>}> =
          new FormGroup({a: new FormControl(45, {initialValueIsDefault: true})});
    });
...
describe('Untyped Class', () => {
  ...
  describe('UntypedFormGroup', () => {
    ...
    it('should allow removeControl', () => {
      const ufc = new UntypedFormGroup({foo: new FormControl('bar')});
      ufc.removeControl('foo');
    });
