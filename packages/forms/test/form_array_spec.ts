...
(function () {
  ...
  describe('FormArray', () => {
    ...
    describe('setValue', () => {
      ...
      it('should throw if a value is not provided for a disabled control', () => {
        ...
        expect(() => a.setValue(['one'])).toThrowError(
          new RegExp(`Must supply a value for form control at index: 1`)
        );
      });
    ...
    describe('valueChanges', () => {
      ...
      it("should fire an event after the control's observable fired an event", inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
      ...
      it('should fire an event when a control is removed', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          a.valueChanges.subscribe({
            next: (value: any) => {
      ...
      it('should fire an event when a control is added', inject(
        [AsyncTestCompleter],
        (async: AsyncTestCompleter) => {
          a.removeAt(1);
