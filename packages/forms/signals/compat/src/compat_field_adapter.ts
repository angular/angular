...
import {isAbstractControl} from '../../src/field/context';
...
export class CompatFieldAdapter implements FieldAdapter {
  ...
  /**
   * Create regular of compat node state based on whether the control is present.
   * @param node
   * @param options
   */
  ...
  /**
   * Create regular of compat structure based on whether the control is present.
   * @param node
   * @param options
   */
  ...
  /**
   * Create regular of compat validation state based on whether the control is present.
   * @param node
   * @param options
   */
  ...
  /**
   * Create regular of compat node based on whether the control is present.
   * @param options
   */
