 ...
 */
export interface UntypedFormControl extends FormControl {}
...
export type FormGroupValue<T extends {[K in keyof T]?: AbstractControl}> =
    TypedOrUntyped<T, Partial<{[K in keyof T]: Value<T[K]>}>, {[key: string]: AbstractControl}>;
...
export type FormGroupRawValue<T extends {[K in keyof T]?: AbstractControl}> =
    TypedOrUntyped<T, {[K in keyof T]: RawValue<T[K]>}, {[key: string]: AbstractControl}>;
...
export class FormGroup<ControlT extends {
   ...
   */
  override reset(
      value: FormGroupValue<ControlT> = {} as unknown as FormGroupValue<ControlT>,
      options: {onlySelf?: boolean, emitEvent?: boolean} = {}): void {
 ...
 */
export interface UntypedFormGroup extends FormGroup {
  value: any;
...
export class FormArray<ControlT extends AbstractControl<Value<ControlT>, RawValue<ControlT>> =
    ...
    AbstractControl<Array<Value<ControlT>>, Array<RawValue<ControlT>>> {
  /**
   ...
   * updateValueAndValidity} method.
   */
  override reset(value: Array<Value<ControlT>> = [], options: {
    onlySelf?: boolean,
    emitEvent?: boolean
  } = {}): void {
 ...
 */
export interface UntypedFormArray extends FormArray {
  value: any;
  valueChanges: Observable<any>;
  getRawValue(): any;
}
