 ...
 */
import { booleanAttribute, OnChanges, Provider, SimpleChanges } from '@angular/core';
...
export declare class MaxValidator extends AbstractValidatorDirective {
    ...
    /** @internal */
    createValidator: (max: number) => ValidatorFn;
}
/**
 * @description
...
export declare class MinValidator extends AbstractValidatorDirective {
    ...
    normalizeInput: (input: string | number) => number;
    /** @internal */
    createValidator: (min: number) => ValidatorFn;
}
/**
 * @description
...
export declare class RequiredValidator extends AbstractValidatorDirective {
    ...
    inputName: string;
    /** @internal */
    normalizeInput: typeof booleanAttribute;
    /** @internal */
    createValidator: (input: boolean) => ValidatorFn;
    /** @docs-private */
...
export declare class CheckboxRequiredValidator extends RequiredValidator {
    /** @internal */
    createValidator: (input: unknown) => ValidatorFn;
}
/**
 * @description
...
export declare class EmailValidator extends AbstractValidatorDirective {
    ...
    normalizeInput: typeof booleanAttribute;
    /** @internal */
    createValidator: (input: number) => ValidatorFn;
    /** @docs-private */
    enabled(input: boolean): boolean;
}
/**
...
export declare class MinLengthValidator extends AbstractValidatorDirective {
    ...
    normalizeInput: (input: string | number) => number;
    /** @internal */
    createValidator: (minlength: number) => ValidatorFn;
}
/**
 * @description
...
export declare class MaxLengthValidator extends AbstractValidatorDirective {
    ...
    normalizeInput: (input: string | number) => number;
    /** @internal */
    createValidator: (maxlength: number) => ValidatorFn;
}
/**
 * @description
...
export declare class PatternValidator extends AbstractValidatorDirective {
    ...
    inputName: string;
    /** @internal */
    normalizeInput: (input: string | RegExp) => string | RegExp;
    /** @internal */
    createValidator: (input: string | RegExp) => ValidatorFn;
}
export {};
