 ...
 * @publicApi
 */
let SelectControlValueAccessor = class SelectControlValueAccessor extends BuiltInControlValueAccessor {
  constructor() {
    super(...arguments);
    /** @internal */
    ...
    this.appRefInjector = inject(ApplicationRef).injector;
...
__decorate([Input()], SelectControlValueAccessor.prototype, 'compareWith', null);
...
__decorate([Input('ngValue')], NgSelectOption.prototype, 'ngValue', null);
__decorate([Input('value')], NgSelectOption.prototype, 'value', null);
