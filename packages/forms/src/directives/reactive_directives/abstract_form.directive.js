...
import {Directive, Inject, Optional, Self, computed, signal, untracked} from '@angular/core';
import {FormSubmittedEvent} from '../../model/abstract_model';
 ...
 * @publicApi
 */
let AbstractFormDirective = class AbstractFormDirective extends ControlContainer {
  /**
   * @description
...
AbstractFormDirective = __decorate(
  [
    Directive(),
    __param(0, Optional()),
    __param(0, Self()),
    ...
    __param(2, Optional()),
    __param(2, Inject(CALL_SET_DISABLED_STATE)),
  ],
  AbstractFormDirective,
);
export {AbstractFormDirective};
//# sourceMappingURL=abstract_form.directive.js.map
