...
export function assertControlPresent(parent: FormGroup|FormArray, key: string|number): void {
...
export function assertAllValuesPresent(control: FormGroup|FormArray, value: any): void {
