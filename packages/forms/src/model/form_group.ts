...
export class FormGroup<TControl extends {
  ...
  /**
   * Remove a control from this group. In a strongly-typed group, controls cannot be
   * removed.
   *
  ...
  removeControl(this: FormGroup<{[key: string]: AbstractControl<any>}>, name: string, options: {
    ...
    if ((this.controls as any)[name]) this.controls[name]._registerOnCollectionChange(() => {});
