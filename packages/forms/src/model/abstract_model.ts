...
*/
type ɵTokenize<S extends string, D extends string> =
...
*/
type ɵCoerceStrArrToNumArr<S> =                                           
    S extends [infer Head, ...infer Tail] ?                              
    Head extends `${number}` ? [number, ...ɵCoerceStrArrToNumArr<Tail>] :
...
*/
type ɵNavigate<T, K extends(Array<string|number>)> = 
...
export type ɵGetProperty<T, K> =                                                  /*\n*/
    K extends string ? ɵGetProperty<T, ɵCoerceStrArrToNumArr<ɵTokenize<K, '.'>>>: /*\n*/
                       Writeable<K> extends Array<string|number>? ɵNavigate<T, Writeable<K>>:        /*\n*/
                                               any                                                                           /*\n*/
    ;
