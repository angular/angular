...
import { AbstractControl, AbstractControlOptions, ɵRawValue, ɵTypedOrUntyped, ɵValue } from './abstract_model';
 ...
 */
export type ɵFormGroupArgumentValue<T extends {
...
export type ɵFormGroupValue<T extends {
    [K in keyof T]?: AbstractControl<any>;
}> = ɵTypedOrUntyped<T, Partial<{
 ...
 * For internal use only.
 */
export type ɵFormGroupRawValue<T extends {
    [K in keyof T]?: AbstractControl<any>;
}> = ɵTypedOrUntyped<T, {
...
export declare class FormGroup<TControl extends {
    ...
    /** @internal */
    _reduceChildren<T, K extends keyof TControl>(initValue: T, fn: (acc: T, control: TControl[K], name: K) => T): T;
    /** @internal */
