...
(function () {
  ...
  describe('platform-server integration', () => {
    ...
    describe('render', () => {
      ...
      it('using long form should work', async(() => {
        ...
        platform
          ...
          .then((moduleRef) => {
            ...
            return applicationRef.isStable.pipe(first((isStable: boolean) => isStable)).toPromise();
          })
          .then((b) => {
      ...
      modifiedInIvy('Will not support binding to innerText in Ivy since domino does not').it(
