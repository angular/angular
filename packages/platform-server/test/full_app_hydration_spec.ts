      ...
      describe('support is enabled', () => {
        ...
        it('should support disjoint nodes', async () => {
          ...
          expect(content.innerHTML).toBe(
            'Start  Inner Start  Hello <span>World</span>! <!--ICU 30:0--> Inner End  Middle <span>Span</span> End',
          );
        });
        ...
        it('should support nested content projection', async () => {
          ...
          expect(content.innerHTML).toBe(
            '<app-content-inner>Start  Outer Start <span>Span</span> Hello <span>World</span>! <!--ICU 30:0--> Outer End  Middle  End</app-content-inner>',
          );
        });
        ...
        it('should support translations that include additional elements', async () => {
          ...
          const div = clientRootNode.querySelector('div');
          expect(div.innerHTML).toMatch(/Some <strong>strong<\/strong><!--ICU 30:0--> content/);
        });
