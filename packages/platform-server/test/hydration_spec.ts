...
import {afterRender, ApplicationRef, Component, ComponentRef, ContentChildren, createComponent, destroyPlatform, Directive, ElementRef, EnvironmentInjector, ErrorHandler, getPlatform, inject, Injectable, Input, NgZone, PLATFORM_ID, Provider, QueryList, TemplateRef, Type, ViewChild, viewChild, ViewContainerRef, ViewEncapsulation, ɵwhenStable as whenStable} from '@angular/core';
    ...
    describe('hydration', () => {
      ...
      describe('basic scenarios', () => {
        ...
        it('should support text and HTML elements in nested components', async () => {
          ...
          const appRef = await renderAndHydrate(
              doc, html, SimpleComponent, {envProviders: [withDebugConsole()]});
          const compRef = getComponentRef<SimpleComponent>(appRef);
          appRef.tick();
