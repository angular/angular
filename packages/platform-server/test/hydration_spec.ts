            ...
            @Component({
              ...
              template: `
                <ng-template #template>
                  ...
                  @if (true) {
<div>With more nested views!</div>
}
                </ng-template>
...
<i>This is a CLIENT-ONLY content</i>
      ...
      it('should trigger change detection after cleanup (immediate)', async () => {
        ...
        @Component({
          ...
          template: `
            @if (isServer) {
<span>This is a SERVER-ONLY content</span>
}
            @if (!isServer) {
<span>This is a CLIENT-ONLY content</span>
}
          `,
        })
        class SimpleComponent {
      ...
      it('should project contents with *ngIf\'s', async () => {
        ...
        @Component({
          ...
          template: `
            <projector-cmp>
              @if (visible) {
<h1>Header with an ngIf condition.</h1>
}
            </projector-cmp>
          `,
        })
