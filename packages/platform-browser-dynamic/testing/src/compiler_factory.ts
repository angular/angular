...
export class TestingCompilerFactoryImpl implements TestingCompilerFactory {
  ...
  createTestingCompiler(options: CompilerOptions[]): TestingCompiler {
    ...
    return new TestingCompilerImpl(
      compiler,
      compiler.injector.get(MockDirectiveResolver),
      compiler.injector.get(MockPipeResolver),
      compiler.injector.get(MockNgModuleResolver)
    );
  }
}
...
export class TestingCompilerImpl implements TestingCompiler {
  ...
  constructor(
    private _compiler: CompilerImpl,
  ...
  overrideModule(ngModule: Type<any>, override: MetadataOverride<NgModule>): void {
    ...
    this._moduleResolver.setNgModule(
      ngModule,
      this._overrider.overrideMetadata(NgModule, oldMetadata, override)
    );
  ...
  overrideDirective(directive: Type<any>, override: MetadataOverride<Directive>): void {
    ...
    this._directiveResolver.setDirective(
      directive,
      this._overrider.overrideMetadata(Directive, oldMetadata!, override)
    );
  ...
  overrideComponent(component: Type<any>, override: MetadataOverride<Component>): void {
    ...
    this._directiveResolver.setDirective(
      component,
      this._overrider.overrideMetadata(Component, oldMetadata!, override)
    );
