...
exports.MruTracker = exports.isDebugMode = void 0;
exports.uriToFilePath = uriToFilePath;
exports.filePathToUri = filePathToUri;
exports.tsFileTextChangesToLspWorkspaceEdit = tsFileTextChangesToLspWorkspaceEdit;
...
exports.tsRelatedInformationToLspRelatedInformation = tsRelatedInformationToLspRelatedInformation;
exports.isConfiguredProject = isConfiguredProject;
exports.tsDisplayPartsToText = tsDisplayPartsToText;
exports.getMappedDefinitionInfo = getMappedDefinitionInfo;
 ...
 * @param relatedInfo
 */
function tsRelatedInformationToLspRelatedInformation(projectService, relatedInfo) {
...
function getMappedLocation(location, project) {
  ...
  return mapsTo && project.projectService.fileExists(ts.server.toNormalizedPath(mapsTo.fileName))
    ? mapsTo
    : undefined;
}
