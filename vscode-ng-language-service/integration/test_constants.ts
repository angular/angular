...
export const HOST_STYLE_SCOPES = join(PROJECT_PATH, 'app', 'host-bindings.component.ts');
export const CSS_SCOPES_COMPONENT = join(PROJECT_PATH, 'app', 'css-scopes.component.ts');
export const CSS_SCOPES_TEMPLATE = join(PROJECT_PATH, 'app', 'css-scopes.component.html');
export const CSS_SCOPES_REFERENCE_CSS = join(PROJECT_PATH, 'app', 'css-scopes-reference.css');
