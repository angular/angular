...
const foo_component_1 = require('./foo.component');
let AppModule = (() => {
  let _classDecorators = [
    (0, core_1.NgModule)({
      imports: [common_1.CommonModule, post_1.PostModule],
      declarations: [app_component_1.AppComponent, foo_component_1.FooComponent],
