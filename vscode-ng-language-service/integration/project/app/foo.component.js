...
let FooComponent = (() => {
  ...
  let _classThis;
  var FooComponent = (_classThis = class {
    constructor() {
      this.title = 'Foo Component';
      this.sig = (0, core_1.signal)(1);
      this.x = {
        sig: (0, core_1.signal)(1),
      };
    }
    /** returns 1 */
    method() {
  ...
  __setFunctionName(_classThis, 'FooComponent');
  (() => {
    const _metadata =
    ...
    FooComponent = _classThis = _classDescriptor.value;
    if (_metadata)
  ...
  return (FooComponent = _classThis);
})();
