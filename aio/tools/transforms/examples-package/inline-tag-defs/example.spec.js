...
describe('example inline-tag-def', function() {
  ...
  describe('handler', () => {
    ...
    it('should add a title if specified', () => {
      expect(handler({}, 'example', 'test/url region-1 \'Some Title\'')).toEqual('<code-example header="Some Title">\nregion 1 contents\n</code-example>');
      expect(handler({}, 'example', 'test/url region-1 Some Title')).toEqual('<code-example header="Some Title">\nregion 1 contents\n</code-example>');
    });

    it('should contain the whole contents from the example file if an empty ("") region is specified', () => {
      expect(handler({}, 'example', 'test/url \'\'')).toEqual('<code-example>\nwhole file\n</code-example>');
      expect(handler({}, 'example', 'test/url \'\' Some Title')).toEqual('<code-example header="Some Title">\nwhole file\n</code-example>');
    });
