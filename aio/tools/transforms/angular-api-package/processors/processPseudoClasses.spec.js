...
describe('processPseudoClasses processor', () => {
  ...
  it('should grab the content from the first additional declaration if there is not content already',
     () => {
       ...
       const docs = [
         ...
         {docType: 'interface', id: 'b', additionalDeclarations: [additionalDeclaration2]},
       ];
       processor.$process(docs);
