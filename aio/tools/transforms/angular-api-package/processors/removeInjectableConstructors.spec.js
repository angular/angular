...
describe('removeInjectableConstructors processor', () => {
  ...
  it('should remove undocumented constructors from docs that have an "Injectable" decorator on them', () => {
    ...
    const docs = [
      ...
      { constructorDoc: { description: 'Blah' } },
      { constructorDoc: { description: 'Blah' }, decorators: [] },
      { constructorDoc: { description: 'Blah' }, decorators: [ { name: 'Injectable' }] },
      { constructorDoc: { description: 'Blah' }, decorators: [ { name: 'Component' }] },
      { constructorDoc: { description: 'Blah' }, decorators: [ { name: 'Directive' }] },
      { constructorDoc: { description: 'Blah' }, decorators: [ { name: 'Pipe' }] },
      { constructorDoc: { description: 'Blah' }, decorators: [ { name: 'Other' }, { name: 'Injectable' }] },
      { constructorDoc: { description: 'Blah' }, decorators: [ { name: 'Other' }] },
    ];
