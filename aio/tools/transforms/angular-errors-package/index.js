...
errorPackage.factory(require('./readers/error'))
    ...
    // We split the description given in the .md file into a pair of properties:
    // * `shortDescription` this is the first paragraph of the original description.
    // * `description` this is the rest of the original description, after the `shortDescription` is
    // removed.
    .config(function(splitDescription) {
      splitDescription.docTypes = splitDescription.docTypes.concat(['error']);
    })
