...
&lt;hero-details&gt;
  ...
  &lt;/hero-team&gt;
&lt;/hero-details&gt;`;
const oneLineHtml = '&lt;h1&gt;Heading&lt;/h1&gt;';
const oneLineJson = '{ \"key\": \"value\" }';
...
describe('CodeTabsComponent', () => {
  ...
  it('should pass content to CodeComponent (<aio-code>)', () => {
    createComponent(HostComponent.oneLineCode);
    expect(codeComponent.code).toBe(HostComponent.oneLineCode);
  });
...
class HostComponent {
  ...
  static oneLineCode = `const foo = "bar";`;

  static multiLineCode = `
&lt;hero-details&gt;
  &lt;h2&gt;Bah Dah Bing&lt;/h2&gt;
  &lt;hero-team&gt;
    &lt;h3&gt;NYC Team&lt;/h3&gt;
