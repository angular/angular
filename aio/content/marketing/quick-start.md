...
1.  In the code editor, in the `template` value, add this line after the line that starts with `<button (click)=`.
...
1.  The buttons in your new Angular app should now have the bold text and rounded corners.
