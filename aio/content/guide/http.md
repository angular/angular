...
If your backend service uses different names for the XSRF token cookie or header, use `HttpClientXsrfModule.withOptions()` from `@angular/common/http` to override the defaults.
