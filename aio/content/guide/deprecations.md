...
| [`ComponentFactoryResolver`](api/core/ComponentFactoryResolver)                          | n/a                                                                                | v13                    | No replacement needed, use FW APIs that allow passing Component type instead of a factory function.                                                                                                                                                                                                                  |
| [`NgModuleRef.componentFactoryResolver`](api/core/NgModuleRef#componentFactoryResolver)                          | n/a                                                                                | v13                    |  No replacement needed, use FW APIs that allow passing Component type instead of a factory function.                                                                                                                                                                                                                  |
