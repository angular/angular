...
In any component file that plan to use animations, import specific animation functions from '@angular/animations'.
...
NOTE: The use of the special aliases `:enter`, `:leave`, `:increment`, and `:decrement` are described on the 
[Animation Basics Deep Dive](guide/animation-basics-deep-dive).
</div>
