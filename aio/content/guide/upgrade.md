...
Angular application.
The setup for a hybrid application is mostly the same as described in
...
an AngularJS application anymore, but instead it should find *Angular applications* from
the page.
