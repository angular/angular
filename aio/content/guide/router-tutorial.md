...
In an SPA, all of your applications functions exist in a single HTML page.
As users access your applications features, the browser needs to render only the parts that matter to the user, instead of loading a new page. This pattern can significantly improve your application's user experience.
...
* Organize a sample applications features into modules.
