...
Use the <a href="https://cli.angular.io/" target="_blanks">Angular CLI</a> to automatically set up your project with the correct polyfill: <code>ng add @angular/elements --name=*your_project_name*</code>.
