...
For example, you can use schematics to fix breaking changes in a dependency, or to add a new configuration option or framework to an existing project.
...
To specify a particular schematic or collection of schematic to generate, using the long form:
