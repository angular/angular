...
<table class="is-full-width is-fixed-layout">
  ...
  <thead>
    <tr>
      ...
      <th><p><code>import { Routes, RouterModule, ... } from '@angular/router';</code></p></th>
    </tr>
  </thead>
  ...
  <tr>
    ...
    <td>An interface for defining a class that the router should call first to determine if it should activate this component. Should return a boolean or an Observable/Promise that resolves to a boolean.</td>
  </tr>
  ...
  <tr>
    ...
    <td>An interface for defining a class that the router should call first to determine if it should deactivate this component after a navigation. Should return a boolean or an Observable/Promise that resolves to a boolean.</td>
  </tr>
