...
For the sample application that this page describes, see the <live-example name="component-overview"></live-example>.
...
1.  [Create an Angular workspace][AioGuideSetupLocalCreateAWorkspaceAndInitialApplication] with initial application.
    If you don't have a project, you may create one using `ng new <project-name>`, where `<project-name>` is the name of your Angular application.

## Creating a component

The best way to create a component is with the Angular CLI.
You may also create a component manually.
...
You may change how `ng generate component` creates new components.
For more information, see [ng generate component][AioCliGenerateComponentCommand] in the Angular CLI documentation.

</div>

### Creating a component manually

Although the Angular CLI is the best way to create an Angular component, you may also create a component manually.
...
1.  Choose a CSS selector for the component.
    ...
    For more information on choosing a selector, see [Specifying a component's selector][AioGuideComponentOverviewSpecifyingAComponentsCssSelector].
...
1.  Define the HTML template that the component uses to display information.
    ...
    For more information on defining a component's template, see [Defining a component's template][AioGuideComponentOverviewDefiningAComponentsTemplate].
...
If you want your template to span multiple lines, you may use backticks (<code>`</code>).
For example:
...
You may not have both statements in a component.
...
*   For an architectural overview of components, see [Introduction to components and templates][AioGuideArchitectureComponents].
*   For additional options you may use when creating a component, see [Component][AioApiCoreComponent] in the API Reference.
*   For more information on styling components, see [Component styles][AioGuideComponentStyles].
*   For more information on templates, see [Template syntax][AioGuideTemplateSyntax].
...
[AioGuideArchitectureComponents]: guide/architecture-components "Introduction to components and templates | Angular"

[AioGuideComponentOverviewDefiningAComponentsTemplate]: guide/component-overview#defining-a-components-template "Defining a component's template - Angular Components Overview | Angular"
[AioGuideComponentOverviewSpecifyingAComponentsCssSelector]: guide/component-overview#specifying-a-components-css-selector "Specifying a component's CSS selector - Angular Components Overview | Angular"

[AioGuideComponentStyles]: guide/component-styles "Component styles | Angular"
