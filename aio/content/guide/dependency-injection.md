...
Dependency injection, or DI, is wired into the Angular framework and used everywhere to provide new components with the services or other things they need.
...
## Creating Dependency injection (DI)
