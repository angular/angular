...
Angular Universal works by compiling the app to make it capable of running on the server, a form of _Ahead of Time_ compilation ([AOT](guide/aot-compiler)).  It's different from regular AOT because the app is compiled using `platform-server` instead of `platform-browser`.  This changes the app behavior to make it capable of rendering to an HTML string on the server instead of the browser DOM.
...
With Angular Universal, you can generate landing pages for the app that look like the complete app.  The pages are pure HTML, and can display even if JavaScript is disabled.  The pages do not handle browser events, but they _do_ support navigation through the site use [routerLink](guide/router#router-link).
...
<table class="perf">
  ...
  <tr>
    <td>JIT</td>
    <td>1.01s</td>
    <td><img src="generated/images/guide/universal/toh-jit-local-pie.png" alt="JIT local time allocation"></td>
  </tr>
  <tr>
    <td>AOT</td>
    <td>0.29s</td>
    <td><img src="generated/images/guide/universal/toh-aot-local-pie.png" alt="AOT local time allocation"></td>
  </tr>
  <tr>
    <td>Universal</td>
    <td>0.04s</td>
    <td><img src="generated/images/guide/universal/toh-uni-local-pie.png" alt="Universal local time allocation"></td>
  </tr>
</table>
...
<table class="perf">
  ...
  <tr>
    <td>JIT</td>
    <td>37.3s</td>
    <td><img src="generated/images/guide/universal/toh-jit-throttled-pie.png" alt="JIT 3G time allocation"></td>
  </tr>
  <tr>
    <td>AOT</td>
    <td>5.5s</td>
    <td><img src="generated/images/guide/universal/toh-aot-throttled-pie.png" alt="AOT 3G time allocation"></td>
  </tr>
  <tr>
    <td>Universal</td>
    <td>0.4s</td>
    <td><img src="generated/images/guide/universal/toh-uni-throttled-pie.png" alt="Universal 3G time allocation"></td>
  </tr>
</table>
...
Using Webpack for AOT is similar, but uses different [loaders](guide/webpack#loaders) and [plugins](guide/webpack#plugins).  
...
If you create [multiple bundles](guide/webpack#multiple-bundles), 
...
The [lite-server](https://github.com/johnpapa/lite-server) is used in the [Quickstart](guide/quickstart) and
...
> You can share code between webpack configurations.  See the [Webpack Introduction](guide/webpack#configure-webpack) for more information.
