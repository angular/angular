...
src/
  index.html                 <i>application web page</i>
...
With Angular Universal, you can generate landing pages for the application that look like the complete app.
...
The web server must distinguish _application page requests_ from other kinds of requests.
