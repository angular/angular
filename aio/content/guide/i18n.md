...
You can also create a custom build configuration to specify additional locale-specific options. Use the `localize` option to specify a single defined locale.
