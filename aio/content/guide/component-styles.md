...
<code-example format="">
  &lt;hero-details x-pmm-5>
    &lt;h2 _c-pmm-5>Mister Fantastic&lt;/h2>
    &lt;hero-team _c-pmm-5 x-pmm-6>
      &lt;h3 _c-pmm-6>Team&lt;/h3>
    &lt;/hero-team>
  &lt;/hero-detail>
...
* An element that would be a shadow DOM host in native encapsulation has a
  generated `x` attribute. This is typically the case for component host elements.
* An element within a component's view has a `_c` attribute
...
with `x` or `_c` attribute selectors.
