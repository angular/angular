...
The Angular compiler can create index ES module files. Tools like Rollup can use these files to create flattened modules in a *Flattened ES Module* (FESM) file format.
