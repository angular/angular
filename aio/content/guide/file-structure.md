...
When you run this command, the CLI installs the necessary Angular npm packages and other dependencies a new workspace, with a root folder named *project_name*. 
...
| `package-lock.json`    | Provides version information for all of packages installed into node_modules by the npm client. [More info](https://docs.npmjs.com/files/package-lock.json). If you use the yarn client instead, you'll see the [yarn.lock](https://yarnpkg.com/lang/en/docs/yarn-lock/) file created instead of `package-lock.json`. |

All of the projects within a workspace share this configuration context. 
Project-specific TypeScript configuration files inherit from the workspace-wide `tsconfig.*.json`, and app-specific [TSLint](https://palantir.github.io/tslint/) configuration files inherit from the workspace-wide `tslint.json`.
...
| `tsconfig.app.json`   | Inherits from the workspace-wide `tsconfig.app.json` file. |
| `tsconfig.spec.json`  | Inherits from the workspace-wide `tsconfig.spec.json` file. |
