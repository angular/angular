...
You can also find the most current version of Angular by using the [CLI command `ng update`](cli/update "Angular CLI update documentation"). By default, `ng update` (without additional arguments) lists the updates that are available to you.  
...
For simple updates, the [CLI command `ng update`](cli/update "Angular CLI update documentation") is all you need. Without additional arguments, `ng update` lists the updates that are available to you and provides recommended steps to update your application to the most current version. 
...
* Update command reference: [Angular CLI update documentation](cli/update "Angular CLI update documentation")
