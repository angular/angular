...
Angular sanitizes untrusted values for HTML and URLs, and modern web browsers sanitize untrusted values for styles. Sanitizing resource URLs isn't possible because they contain arbitrary code.
