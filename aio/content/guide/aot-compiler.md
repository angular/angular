...
in the final bundle. Using it is straigthforward. We added the following 
to the `plugins` array in `rollup-config.js`:
...
We activated it by adding the following to the `plugins` array:
