...
Angular doesn't have a `FilterPipe` or an `OrderByPipe`. For more 
...
<!-- KW--I don't understand the following sentence. Where is the 
component's format property? -->
...
<!-- KW--Where does the inheriting take place? -->
...
By using `AsyncPipe`, the component doesn't have to do 
any of the followng: 
