...
Impure pipes are called whenever change detection runs for a component, which could be every few milliseconds with the default `ChangeDetectionStrategy` setting.
