...
The `output()` function is currently in [developer preview](/guide/releases#developer-preview).
...
Most of the time, using `output()` is sufficient and you can emit values imperatively.
