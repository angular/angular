...
<h3 class="no-toc">Template reference variable notes</h3>

A template _reference_ variable; for example, `#phone`, is _not_ the same as a template _input_ variable, that is, `let phone`,
such as you might see in an [`*ngFor`](guide/template-syntax#template-input-variable).
Read about the difference in the [_Structural Directives_](guide/structural-directives#template-input-variable) guide.

Since the scope of a reference variable is the _entire template_, only
define the a variable name once within the template. If you define it more than 
