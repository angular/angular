...
describe('HeroListComponent', () => {
  ...
  // optional to define prams defined in constructor
  it('should define properties on instance initialization', () => {
    expect(component.hasSpecificProperyOrMethod).toBeUndefined();
  });
