...
It also creates the following workspace and starter project files:
  ...
  * An initial skeleton application project, also called `angular-tour-of-heroes` (in the `src` subfolder).
  * An end-to-end test project (in the e2e subfolder).
  * Related configuration files.

The initial application project contains a simple Welcome app, ready to run.
