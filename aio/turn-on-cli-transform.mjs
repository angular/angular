...
code = code.replace(/\/\/ (plugins.push\(require\('@babel\/plugin-transform-async-to-generator'\)\.default, require\('@babel\/plugin-proposal-async-generator-functions'\)\.default\);)/m, '$1');
