...
export declare class AbstractFormGroupDirective extends ControlContainer implements OnInit,
                                                                                    OnDestroy {
...
export declare class CheckboxControlValueAccessor extends ɵangular_packages_forms_forms_f implements
...
export declare class FormArrayName extends ControlContainer implements OnInit, OnDestroy {
  ...
  get path(): string[];
  constructor(
      parent: ControlContainer, validators: (Validator|ValidatorFn)[],
...
export declare class FormControlDirective extends NgControl implements OnChanges {
  ...
  constructor(
      ...
      valueAccessors: ControlValueAccessor[], _ngModelWarningConfig: string|null);
...
export declare class FormControlName extends NgControl implements OnChanges, OnDestroy {
  ...
  constructor(
      parent: ControlContainer, validators: (Validator|ValidatorFn)[],
      asyncValidators: (AsyncValidator|AsyncValidatorFn)[], valueAccessors: ControlValueAccessor[],
...
export declare class NumberValueAccessor extends ɵangular_packages_forms_forms_f implements
    ControlValueAccessor {
  onChange: (_: any) => void;
  onTouched: () => void;
  constructor(_renderer: Renderer2, _elementRef: ElementRef);
...
export declare class RadioControlValueAccessor extends ɵangular_packages_forms_forms_f implements
  ...
  value: any;
  constructor(
      _renderer: Renderer2, _elementRef: ElementRef, _registry: ɵangular_packages_forms_forms_p,
      _injector: Injector);
...
export declare class RangeValueAccessor extends ɵangular_packages_forms_forms_f implements
    ControlValueAccessor {
  onChange: (_: any) => void;
  onTouched: () => void;
  constructor(_renderer: Renderer2, _elementRef: ElementRef);
...
export declare class SelectControlValueAccessor extends ɵangular_packages_forms_forms_f implements
    ControlValueAccessor {
...
export declare class SelectMultipleControlValueAccessor extends ɵangular_packages_forms_forms_f
