...
export abstract class AbstractControl<TValue = any, TRawValue extends TValue = TValue> {
    ...
    get<P extends string | (readonly (string | number)[])>(path: P): AbstractControl<Get<TRawValue, P>> | null;
...
// @public
export class FormArray<TControl extends AbstractControl<Value<TControl>, RawValue<TControl>> = AbstractControl> extends AbstractControl<FormArrayTypedOrUntyped<TControl, Array<Value<TControl>>, any>, FormArrayTypedOrUntyped<TControl, Array<RawValue<TControl>>, any>> {
    ...
    getRawValue(): Array<RawValue<TControl>>;
    insert(index: number, control: TControl, options?: {
        emitEvent?: boolean;
    }): void;
    get length(): number;
    patchValue(value: Array<Value<TControl>>, options?: {
        onlySelf?: boolean;
        emitEvent?: boolean;
    }): void;
    ...
    setValue(value: Array<RawValue<TControl>>, options?: {
        onlySelf?: boolean;
        emitEvent?: boolean;
    }): void;
}
...
export class FormBuilder {
    array<T = AbstractControl<any>>(controls: Array<T | FormState<T> | ControlConfig<T> | AbstractControl<T> | FormControl<T>>, validatorOrOpts?: ValidatorFn | ValidatorFn[] | AbstractControlOptions | null, asyncValidator?: AsyncValidatorFn | AsyncValidatorFn[] | null): FormArray<AbstractControl<T | null>>;
    // (undocumented)
    control<T = any>(formState: T | FormState<T>, opts: FormControlOptions & {
        initialValueIsDefault: true;
    }): FormControl<T>;
    // (undocumented)
    control<T = any>(formState: T | FormState<T>, validatorOrOpts?: ValidatorFn | ValidatorFn[] | FormControlOptions | null, asyncValidator?: AsyncValidatorFn | AsyncValidatorFn[] | null): FormControl<T | null>;
    group<T extends {
        [key: string]: any;
    } = {
        [key: string]: any;
...
export interface FormControl<TValue = any> extends AbstractControl<TValue> {
    ...
    reset(formState?: TValue | FormState<TValue>, options?: {
        onlySelf?: boolean;
        emitEvent?: boolean;
    }): void;
...
export class FormGroup<TControl extends {
    [K in keyof TControl]: AbstractControl<Value<TControl[K]>, RawValue<TControl[K]>>;
} = any> extends AbstractControl<TypedOrUntyped<TControl, FormGroupValue<TControl>, any>, TypedOrUntyped<TControl, FormGroupRawValue<TControl>, any>> {
    constructor(controls: TypedOrUntyped<TControl, TControl, {
    ...
    // (undocumented)
    controls: TypedOrUntyped<TControl, TControl, {
        [key: string]: AbstractControl;
    }>;
    getRawValue(): TypedOrUntyped<TControl, FormGroupRawValue<TControl>, any>;
    patchValue(value: FormGroupValue<TControl>, options?: {
        onlySelf?: boolean;
        emitEvent?: boolean;
    }): void;
    ...
    removeControl<S extends string>(name: KeyIsRemovable<TControl, S>, options?: {
        emitEvent?: boolean;
    }): void;
    reset(value?: TypedOrUntyped<TControl, FormGroupValue<TControl>, any>, options?: {
        onlySelf?: boolean;
        emitEvent?: boolean;
    }): void;
    ...
    setValue(value: FormGroupRawValue<TControl>, options?: {
        onlySelf?: boolean;
        emitEvent?: boolean;
    }): void;
}
