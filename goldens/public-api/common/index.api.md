...
export class NgOptimizedImage implements OnInit, OnChanges, OnDestroy {
    ...
    // (undocumented)
    static ngAcceptInputType_ngLocalSrc: string | i0.ɵSafeValue;
    // (undocumented)
