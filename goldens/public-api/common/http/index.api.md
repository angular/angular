...
export interface HttpResourceFn<TRaw> {
    <TResult = TRaw>(url: string | (() => string | undefined), options: HttpResourceOptions<TResult, TRaw> & {
        defaultValue: NoInfer<TResult>;
    }): HttpResource<TResult>;
    <TResult = TRaw>(url: string | (() => string | undefined), options?: HttpResourceOptions<TResult, TRaw>): HttpResource<TResult | undefined>;
    <TResult = TRaw>(request: HttpResourceRequest | (() => HttpResourceRequest | undefined), options: HttpResourceOptions<TResult, TRaw> & {
        defaultValue: NoInfer<TResult>;
    }): HttpResource<TResult>;
    <TResult = TRaw>(request: HttpResourceRequest | (() => HttpResourceRequest | undefined), options?: HttpResourceOptions<TResult, TRaw>): HttpResource<TResult | undefined>;
}
