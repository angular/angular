...
export declare interface ContentChildDecorator {
    ...
    new (selector: Token<unknown> | Function | string, opts?: {
        read?: any;
        static?: boolean;
    }): ContentChild;
}
...
/** @codeGenApi */
export declare function ɵɵinject<T>(token: Token<T>): T;
export declare function ɵɵinject<T>(token: Token<T>, flags?: InjectFlags): T | null;
...
export declare type Token<T> = Type<T> | AbstractType<T> | InjectionToken<T>;
