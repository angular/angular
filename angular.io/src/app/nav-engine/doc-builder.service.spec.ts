...
fdescribe('DocBuilderService', () => {
  ...
  fit(('should NOT include Bar within Baz'), () => {
    const content = `
      <p>Top</p>
      <aio-bar>
        <div style="margin-left: 2em">
