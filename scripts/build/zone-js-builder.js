...
const {chmod, cp, mkdir, rm, test, mv} = require('shelljs');
...
function buildZoneJsPackage(destPath) {
  ...
  // now npm_package.pack rule not work on windows, so run the `npm pack`
  // command directly.
  ...
  // the the archive generated by `npm_package.pack` rule
