...
import {MatLegacySlider, MatLegacySliderModule} from './index';

describe('MatSlider', () => {
  function createComponent<T>(component: Type<T>): ComponentFixture<T> {
    TestBed.configureTestingModule({
      imports: [MatLegacySliderModule, ReactiveFormsModule, FormsModule, BidiModule],
  ...
  describe('standard slider', () => {
    ...
    let sliderInstance: MatLegacySlider;
    ...
    beforeEach(() => {
      ...
      sliderDebugElement = fixture.debugElement.query(By.directive(MatLegacySlider))!;
  ...
  describe('slider with set min and max', () => {
    ...
    beforeEach(() => {
      ...
      sliderNativeElement = sliderDebugElement.nativeElement;
      sliderInstance = sliderDebugElement.injector.get<MatLegacySlider>(MatLegacySlider);
      trackFillElement = <HTMLElement>sliderNativeElement.querySelector('.mat-slider-track-fill');
  ...
  describe('slider with custom thumb label formatting', () => {
    ...
    beforeEach(() => {
      ...
      const sliderDebugElement = fixture.debugElement.query(By.directive(MatLegacySlider))!;
  ...
  describe('tabindex', () => {
    it('should allow setting the tabIndex through binding', () => {
      ...
      const slider = fixture.debugElement.query(By.directive(MatLegacySlider))!.componentInstance;
  ...
  describe('slider with a two-way binding', () => {
    ...
    beforeEach(() => {
      ...
      let sliderDebugElement = fixture.debugElement.query(By.directive(MatLegacySlider))!;
      sliderNativeElement = sliderDebugElement.nativeElement;
    });
...
class SliderWithNgModel {
  @ViewChild(MatLegacySlider) slider: MatLegacySlider;
