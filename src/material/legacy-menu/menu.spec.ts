...
import {MatLegacyMenu, MatLegacyMenuItem, MatLegacyMenuModule, MatLegacyMenuTrigger} from './index';
...
describe('MatMenu', () => {
  ...
  it('should not change focus origin if origin not specified for menu items', fakeAsync(() => {
    ...
    const firstMenuItemInstance = firstMenuItemDebugEl.componentInstance as MatLegacyMenuItem;
    const secondMenuItemInstance = secondMenuItemDebugEl.componentInstance as MatLegacyMenuItem;
  ...
  describe('nested menu', () => {
    ...
    it('should close submenu when hovering over disabled sibling item', fakeAsync(() => {
      ...
      const items = fixture.debugElement.queryAll(By.directive(MatLegacyMenuItem));
    ...
    it('should not open submenu when hovering over disabled trigger', fakeAsync(() => {
      ...
      const item = fixture.debugElement.query(By.directive(MatLegacyMenuItem))!;
...
class SimpleMenu {
  ...
  @ViewChildren(MatLegacyMenuItem) items: QueryList<MatLegacyMenuItem>;
  extraItems: string[] = [];
...
class NestedMenu {
  @ViewChild('root') rootMenu: MatLegacyMenu;
  @ViewChild('rootTrigger') rootTrigger: MatLegacyMenuTrigger;
  @ViewChild('rootTriggerEl') rootTriggerEl: ElementRef<HTMLElement>;
  @ViewChild('alternateTrigger') alternateTrigger: MatLegacyMenuTrigger;
  readonly rootCloseCallback = jasmine.createSpy('root menu closed callback');

  @ViewChild('levelOne') levelOneMenu: MatLegacyMenu;
  @ViewChild('levelOneTrigger') levelOneTrigger: MatLegacyMenuTrigger;
  readonly levelOneCloseCallback = jasmine.createSpy('level one menu closed callback');

  @ViewChild('levelTwo') levelTwoMenu: MatLegacyMenu;
  @ViewChild('levelTwoTrigger') levelTwoTrigger: MatLegacyMenuTrigger;
  readonly levelTwoCloseCallback = jasmine.createSpy('level one menu closed callback');

  @ViewChild('lazy') lazyMenu: MatLegacyMenu;
  @ViewChild('lazyTrigger') lazyTrigger: MatLegacyMenuTrigger;
  showLazy = false;
}
...
class LazyMenuWithContext {
  @ViewChild('triggerOne') triggerOne: MatLegacyMenuTrigger;
  @ViewChild('triggerTwo') triggerTwo: MatLegacyMenuTrigger;
}
...
class DynamicPanelMenu {
  @ViewChild(MatLegacyMenuTrigger) trigger: MatLegacyMenuTrigger;
  @ViewChild('one') firstMenu: MatLegacyMenu;
  @ViewChild('two') secondMenu: MatLegacyMenu;
}
...
class SimpleMenuWithRepeater {
  @ViewChild(MatLegacyMenuTrigger) trigger: MatLegacyMenuTrigger;
  @ViewChild(MatLegacyMenu) menu: MatLegacyMenu;
  @ViewChildren(MatLegacyMenuItem) itemInstances: QueryList<MatLegacyMenuItem>;
  items = [
...
class MenuWithRepeatedItems {
  @ViewChild(MatLegacyMenuTrigger, {static: false}) trigger: MatLegacyMenuTrigger;
  @ViewChild('triggerEl', {static: false}) triggerEl: ElementRef<HTMLElement>;
  @ViewChild(MatLegacyMenu, {static: false}) menu: MatLegacyMenu;
  items = ['One', 'Two', 'Three'];
}
