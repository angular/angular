...
import {LegacyTooltipHarnessExample} from './legacy-tooltip-harness-example';
import {NoopAnimationsModule} from '@angular/platform-browser/animations';

describe('LegacyTooltipHarnessExample', () => {
  let fixture: ComponentFixture<LegacyTooltipHarnessExample>;
  let loader: HarnessLoader;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [MatLegacyTooltipModule, NoopAnimationsModule],
      declarations: [LegacyTooltipHarnessExample],
    }).compileComponents();
    fixture = TestBed.createComponent(LegacyTooltipHarnessExample);
