 ...
 */
@Component({
  selector: 'legacy-table-text-column-advanced-example',
  styleUrls: ['legacy-table-text-column-advanced-example.css'],
  templateUrl: 'legacy-table-text-column-advanced-example.html',
})
export class LegacyTableTextColumnAdvancedExample {
