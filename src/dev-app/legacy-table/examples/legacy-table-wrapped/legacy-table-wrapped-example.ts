 ...
 */
@Component({
  selector: 'legacy-table-wrapped-example',
  styleUrls: ['legacy-table-wrapped-example.css'],
  templateUrl: 'legacy-table-wrapped-example.html',
})
export class LegacyTableWrappedExample implements AfterViewInit {
