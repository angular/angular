...
export const DEV_APP_ROUTES: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('./cdk-experimental-combobox/cdk-combobox-demo-module')
                            .then(m => m.CdkComboboxDemoModule)
  },
  {
    path: 'cdk-experimental-listbox',
    loadChildren: () => import('./cdk-experimental-listbox/cdk-listbox-demo-module')
                            .then(m => m.CdkListboxDemoModule)
  },
  {
  ...
  {
    path: 'input-modality',
    loadChildren: () => import('./input-modality/input-modality-detector-demo-module')
                            .then(m => m.InputModalityDetectorDemoModule),
  },
  {
    path: 'list',
  ...
  },
  {
    ...
    loadChildren: () => import('./mdc-autocomplete/mdc-autocomplete-demo-module')
                            .then(m => m.MdcAutocompleteDemoModule)
  },
  {
    path: 'mdc-button',
    loadChildren: () =>
  ...
  },
  {
    ...
    loadChildren: () => import('./mdc-progress-bar/mdc-progress-bar-demo-module')
                            .then(m => m.MdcProgressBarDemoModule)
  },
  {
    path: 'mdc-chips',
  ...
  },
  {
    ...
    loadChildren: () => import('./mdc-progress-spinner/mdc-progress-spinner-demo-module')
                            .then(m => m.MdcProgressSpinnerDemoModule)
  },
  {
    path: 'mdc-radio',
  ...
  },
  {
    ...
    loadChildren: () => import('./mdc-slide-toggle/mdc-slide-toggle-demo-module')
                            .then(m => m.MdcSlideToggleDemoModule)
  },
  {
    path: 'mdc-slider',
    loadChildren: () =>
  ...
  },
  {
    ...
    loadChildren: () => import('./progress-spinner/progress-spinner-demo-module')
  ...
  },
  {
    ...
    loadChildren: () => import('./table-scroll-container/table-scroll-container-demo-module')
                            .then(m => m.TableScrollContainerDemoModule),
  },
  {
    path: 'tabs',
  ...
  },
  {
    ...
    loadChildren: () => import('./connected-overlay/connected-overlay-demo-module')
                            .then(m => m.ConnectedOverlayDemoModule)
  },
  {
    path: 'virtual-scroll',
    loadChildren: () =>
