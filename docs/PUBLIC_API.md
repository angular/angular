...
- any class members or symbols marked as `private`, or prefixed with underscore (`_`), [barred latin o](https://en.wikipedia.org/wiki/%C6%9F) (`ɵ`), and  [greek delta](https://en.wikipedia.org/wiki/Delta_(letter)) (`ɵɵ`).
