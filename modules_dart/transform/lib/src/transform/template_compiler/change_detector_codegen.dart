...
class _CodegenState {
  ...
  String _maybeGenDehydrateDirectives() {
    ...
    var destroyDirectivesCode = _logic.genDirectivesOnDestroy(this._directiveRecords);
    if (destroyPipesCode.isEmpty && dehydrateFieldsCode.isEmpty && destroyDirectivesCode.isEmpty) return '';
