...
//    }
  ...
  group('directives', () {
    ...
    test('should populate `providers` using useFactory.', () async {
      ...
      expect(useFactoryDeps[0].token.name, equals("ServiceDep"));
      expect(useFactoryDeps[1].token, equals("Str"));
      expect(useFactoryDeps[2].token.name, equals("ServiceDep"));
      expect(useFactoryDeps[3].token.name, equals("ServiceDep"));
      expect(useFactoryDeps[3].isSelf, equals(true));
      expect(useFactoryDeps[4].token.name, equals("ServiceDep"));
      expect(useFactoryDeps[4].isSkipSelf, equals(true));
      expect(useFactoryDeps[5].token.name, equals("ServiceDep"));
