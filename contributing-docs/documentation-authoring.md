...
| **Nested treatments**             | angular.dev supports several custom treatments like callouts, alerts, pills, etc. Do not nest these treatments. Do not use these treatment inside table cells.                                                                                            |                                                                             |                                                                                                                 |
...
* Use descriptive examples grounded in realistic scenarios
    * **Avoid** generic or abstract names like "Comp", "Example", "Hello world", "prop1", etc.
    * **Prefer** examples that reflect realistic scenarios for
