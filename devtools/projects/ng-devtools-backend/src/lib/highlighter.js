...
export function findComponentAndHost(el) {
...
export function getDirectiveName(dir) {
  return dir ? dir.constructor.name : 'unknown';
}
export function highlightSelectedElement(el) {
...
export function highlightHydrationElement(el, status) {
  let overlay = null;
