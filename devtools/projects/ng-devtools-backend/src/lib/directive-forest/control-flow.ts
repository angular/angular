...
export function mapToDevtoolsControlFlowModel(
  ...
  iterator: ControlFlowBlocksIterator,
  rootId: number,
): ControlFlowBlock {
  switch (block.type) {
...
export function createControlFlowTreeNode(
  ...
  return {
    ...
    hydration: null,
    controlFlowBlock: mapToDevtoolsControlFlowModel(controlFlowBlock, iterator, rootId),
  };
}
