...
describe('getInjectorIdsToRootFromNode', () => {
  it('should be able to get ids from a node', () => {
    ...
    expect(getInjectorIdsToRootFromNode(root)).toEqual(['1']);
    expect(getInjectorIdsToRootFromNode(child)).toEqual(['2', '1']);
    expect(getInjectorIdsToRootFromNode(grandChild)).toEqual(['3', '2', '1']);
  });
});
...
//# sourceMappingURL=injector-tree-fns.spec.js.map
