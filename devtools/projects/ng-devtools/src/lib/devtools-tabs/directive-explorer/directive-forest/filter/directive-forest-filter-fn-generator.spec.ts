...
describe('directive-forest-filter-fn-generator', () => {
  describe('directiveForestFilterLexer', () => {
    it('should tokenize an empty string', () => {
      const tokens = directiveForestFilterLexer('');
      expect(tokens).toEqual([]);
    });

    it('should tokenize a component', () => {
      const tokens = directiveForestFilterLexer('app-component');
      expect(tokens).toEqual([{type: 'text', value: 'app-component', idx: 0}]);
    });

    it('should tokenize a directive', () => {
      const tokens = directiveForestFilterLexer('[FooDirective]');
      expect(tokens).toEqual([
    ...
    it('should tokenize multiple directives', () => {
      const tokens = directiveForestFilterLexer('[Foo][Bar]');
      expect(tokens).toEqual([
        {type: 'opening_bracket', value: '[', idx: 0},
    ...
    it('should tokenize a component multiple directives', () => {
      const tokens = directiveForestFilterLexer('app-cmp[Foo][Bar]');
      expect(tokens).toEqual([
  ...
  describe('directiveForestFilterParser', () => {
    ...
    it('should parse a standard string', () => {
      const tokens = directiveForestFilterLexer('app-random-component');
      const parsed = directiveForestFilterParser(tokens);
    ...
    it('should parse a directive', () => {
      const tokens = directiveForestFilterLexer('[AppDirective]');
      const parsed = directiveForestFilterParser(tokens);
    ...
    it('should parse multiple directives ([b][c] format)', () => {
      const tokens = directiveForestFilterLexer('[FooDir][BarDir]');
      const parsed = directiveForestFilterParser(tokens);
    ...
    it('should parse a component + directive', () => {
      const tokens = directiveForestFilterLexer('app-component[AppDirective]');
      const parsed = directiveForestFilterParser(tokens);
    ...
    it('should parse a component + multiple directives (a[b][c] format)', () => {
      const tokens = directiveForestFilterLexer('app-foo[BarDir][BazDir]');
      const parsed = directiveForestFilterParser(tokens);
    ...
    it('should parse a component with empty directive brackets (app-foo[)', () => {
      const tokens = directiveForestFilterLexer('app-foo[');
      const parsed = directiveForestFilterParser(tokens);
    ...
    it('should parse a component and a directive without closing bracket (app-foo[Foo)', () => {
      const tokens = directiveForestFilterLexer('app-foo[Foo');
      const parsed = directiveForestFilterParser(tokens);
    ...
    it('should parse an incomplete element', () => {
      const tokens = directiveForestFilterLexer('<app-ele');
      const parsed = directiveForestFilterParser(tokens);
