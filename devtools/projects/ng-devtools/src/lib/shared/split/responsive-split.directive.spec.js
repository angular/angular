...
import {RESIZE_DEBOUNCE, ResponsiveSplitDirective} from './responsive-split.directive';
...
let TestComponent = class TestComponent {
  constructor() {
    this.split = viewChild.required(SplitComponent);
...
function initTestComponent(width, height) {
...
//# sourceMappingURL=responsive-split.directive.spec.js.map
