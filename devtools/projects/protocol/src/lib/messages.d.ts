 ...
 */
import { ɵFramework as Framework, ɵAcxViewEncapsulation as AcxViewEncapsulation, InjectionToken, InjectOptions, Injector, Type, ViewEncapsulation as AngularViewEncapsulation } from '@angular/core';
...
export type HydrationStatus = null | {
...
export type DirectiveMetadata = AngularDirectiveMetadata | AcxDirectiveMetadata | WizComponentMetadata;
...
export type TransferStateValue = string | number | boolean | null | undefined | Record<string, unknown> | unknown[];
export interface Events {
    ...
    latestInjectorProviders: (injector: SerializedInjector, providers: SerializedProviderRecord[]) => void;
