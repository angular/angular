 ...
 */
const additionBazelReleaseArgs = ['--color=yes', '--curses=yes', '--show_progress_rate_limit=5'];
 ...
 */
async function getLastReleaseSha(version = '') {
 ...
 */
async function getNewVersion(commits) {
  console.log('');
 ...
 */
async function updateManifests(newVersion) {
  console.log('');
 ...
 */
async function prepareReleasePullRequest(newVersion) {
  console.log('');
 ...
 */
async function getMergedCommitSha(newVersion) {
  console.log('');
 ...
 */
async function checkoutMergedCommitAndInstallDependencies(mergedCommitSha) {
  console.log('');
  console.log(
 ...
 */
async function publishChromeExtension(chromeZipPath) {
  console.log('');
 ...
 */
async function publishFirefoxExtension(mergedCommitSha, firefoxZipPath, sourceZipPath, commits) {
  console.log('');
 ...
 */
function getFirefoxReviewerNote(commitSha) {
  return `
 ...
 */
function execAndStream(command, args, options = {}) {
