...
http_archive(
    ...
    sha256 = "7912f9cf030aca7cd67b26f140804e37c719fda315e25a06fe3616aeb74750d9",
    strip_prefix = "rules_sass-1.49.7",
    urls = [
        "https://github.com/bazelbuild/rules_sass/archive/1.49.7.zip",
    ],
)
