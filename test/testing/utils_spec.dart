library angular2.test.testing.utils_spec;

import "package:angular2/testing_internal.dart"
    show describe, it, iit, ddescribe, expect, BrowserDetection;
...
main() {
  describe("BrowserDetection", () {
    var browsers = [
      {
        "name": "Chrome",
        "ua":
            "Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0.2403.125 Safari/537.36",
        "isFirefox": false,
        "isAndroid": false,
        "isEdge": false,
        "isIE": false,
      ...
      },
      {
        "name": "Android4.2",
        "ua":
            "Mozilla/5.0 (Linux; U; Android 4.2; en-us; Android SDK built for x86 Build/JOP40C) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30",
        "isFirefox": false,
        "isAndroid": true,
        "isEdge": false,
        "isIE": false,
    ...
    browsers.forEach((Map<String, dynamic> browser) {
      it('''should detect ${ StringMapWrapper . get ( browser , "name" )}''',
          () {
        var bd = new BrowserDetection(
            (StringMapWrapper.get(browser, "ua") as String));
        ...
        expect(bd.supportsIntlApi)
            .toBe(StringMapWrapper.get(browser, "supportsIntlApi"));
      });
    });
  });
}
