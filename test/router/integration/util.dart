...
export "package:angular2/core.dart" show Provider;
...
import "package:angular2/router.dart" show Router, ROUTER_DIRECTIVES;
...
var TEST_ROUTER_PROVIDERS = [
  ...
  provide(Router, useFactory: (registry, location) {
    return new RootRouter(registry, location, RootCmp);
