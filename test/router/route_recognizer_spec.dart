...
main() {
  describe("RouteRecognizer", () {
    ...
    it("should generate URLs with params", () {
      recognizer.config(new Route(
          path: "/app/user/:name", component: DummyCmpA, name: "User"));
    ...
    it("should generate URLs with numeric params", () {
      recognizer.config(new Route(
          path: "/app/page/:number", component: DummyCmpA, name: "Page"));
      expect(recognizer.generate("Page", {"number": 42}).urlPath)
          .toEqual("app/page/42");
    });
    ...
    describe("params", () {
      it("should recognize parameters within the URL path", () {
        recognizer.config(new Route(
            path: "profile/:name", component: DummyCmpA, name: "User"));
      ...
      it("should generate and populate the given static-based route with querystring params",
          () {
        recognizer.config(new Route(
            path: "forum/featured", component: DummyCmpA, name: "ForumPage"));
      ...
      it("should ignore matrix params for the top-level component", () {
        recognizer.config(new Route(
            path: "/home/:subject", component: DummyCmpA, name: "User"));
...
ComponentInstruction recognize(RouteRecognizer recognizer, String url) {
  return recognizer.recognize(parser.parse(url))[0].instruction;
}

dynamic getComponentType(ComponentInstruction routeMatch) {
