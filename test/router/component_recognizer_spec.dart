...
import "package:angular2/src/router/component_recognizer.dart"
    show ComponentRecognizer;
...
main() {
  describe("ComponentRecognizer", () {
    ComponentRecognizer recognizer;
    beforeEach(() {
...
Future<List<RouteMatch>> recognize(ComponentRecognizer recognizer, String url) {
