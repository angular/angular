library angular2.test.animate.animation_builder_spec;
...
main() {
  describe("AnimationBuilder", () {
    ...
    it(
        "should allow you to add classes",
        inject([AnimationBuilder], (animate) {
          var animateCss = animate.css();
          ...
          expect(animateCss.data.classesToAdd)
              .toEqual(["some-class", "another-class"]);
        }));
    it(
        "should allow you to add temporary classes",
        inject([AnimationBuilder], (animate) {
          var animateCss = animate.css();
          ...
          expect(animateCss.data.animationClasses)
              .toEqual(["some-class", "another-class"]);
        }));
    it(
        "should allow you to remove classes",
        inject([AnimationBuilder], (animate) {
          var animateCss = animate.css();
          ...
          expect(animateCss.data.classesToRemove)
              .toEqual(["some-class", "another-class"]);
        }));
    it(
    ...
    it(
        ...
        inject([AnimationBuilder], (animate) {
          ...
          expect(element.style.getPropertyValue("background-color"))
              .toEqual("blue");
        }));
    it(
        "should support duration and delay defined in CSS",
        inject([AnimationBuilder], (animate) {
          var animateCss = animate.css();
          var element = el(
    ...
    it(
        "should call `onComplete` method after animations have finished",
        inject([AnimationBuilder], (animate) {
