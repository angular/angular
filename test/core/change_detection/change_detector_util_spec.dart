  ...
  describe("ChangeDetectionUtil", () {
    describe("devModeEqual", () {
      it("should do the deep comparison of iterables", () {
        expect(ChangeDetectionUtil.devModeEqual([
          ["one"]
        ], [
          ["one"]
        ])).toBe(true);
        expect(ChangeDetectionUtil.devModeEqual(["one"], ["one", "two"]))
            .toBe(false);
        expect(ChangeDetectionUtil.devModeEqual(["one", "two"], ["one"]))
            .toBe(false);
        expect(ChangeDetectionUtil.devModeEqual(["one"], "one")).toBe(false);
        expect(ChangeDetectionUtil.devModeEqual(["one"], new Object()))
            .toBe(false);
        expect(ChangeDetectionUtil.devModeEqual("one", ["one"])).toBe(false);
        expect(ChangeDetectionUtil.devModeEqual(new Object(), ["one"]))
            .toBe(false);
      });
      ...
      it("should compare primitive booleans", () {
        ...
        expect(ChangeDetectionUtil.devModeEqual(new Object(), true))
            .toBe(false);
        expect(ChangeDetectionUtil.devModeEqual(true, new Object()))
            .toBe(false);
      });
      it("should compare null", () {
        ...
        expect(ChangeDetectionUtil.devModeEqual(new Object(), null))
            .toBe(false);
        expect(ChangeDetectionUtil.devModeEqual(null, new Object()))
            .toBe(false);
      });
      it("should return true for other objects", () {
        expect(ChangeDetectionUtil.devModeEqual(new Object(), new Object()))
            .toBe(true);
      });
    });
  });
