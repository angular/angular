...
main() {
  describe("KeyEvents", () {
    it("should ignore unrecognized events", () {
      ...
      expect(KeyEventsPlugin.parseEventName("keydown.unknownmodifier.enter"))
          .toEqual(null);
      expect(KeyEventsPlugin.parseEventName("keyup.unknownmodifier.enter"))
          .toEqual(null);
      expect(KeyEventsPlugin.parseEventName("unknownevent.control.shift.enter"))
          .toEqual(null);
      expect(KeyEventsPlugin.parseEventName("unknownevent.enter"))
          .toEqual(null);
    });
    it("should correctly parse event names", () {
      ...
      expect(KeyEventsPlugin.parseEventName("keydown.control.shift.enter"))
          .toEqual(
              {"domEventName": "keydown", "fullKey": "control.shift.enter"});
