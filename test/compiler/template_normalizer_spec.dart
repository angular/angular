library angular2.test.compiler.template_normalizer_spec;
  ...
  describe("TemplateNormalizer", () {
    ...
    describe("loadTemplate", () {
      describe("inline template", () {
        it(
            ...
            inject([AsyncTestCompleter, TemplateNormalizer],
                (async, TemplateNormalizer normalizer) {
              normalizer
                  .normalizeTemplate(
                      dirType,
      ...
      describe("templateUrl", () {
        it(
            ...
            inject([AsyncTestCompleter, TemplateNormalizer, XHR],
                (async, TemplateNormalizer normalizer, MockXHR xhr) {
      ...
      it(
          ...
          inject([TemplateNormalizer], (TemplateNormalizer normalizer) {
    ...
    describe("normalizeLoadedTemplate", () {
      ...
      it(
          "should normalize ViewEncapsulation.Emulated to ViewEncapsulation.None if there are no stlyes nor stylesheets",
          inject([TemplateNormalizer], (TemplateNormalizer normalizer) {
            var template = normalizer.normalizeLoadedTemplate(
                dirType,
                new CompileTemplateMetadata(
      ...
      it(
          "should ignore ng-content in elements with ng-non-bindable",
          inject([TemplateNormalizer], (TemplateNormalizer normalizer) {
            var template = normalizer.normalizeLoadedTemplate(
                dirType,
                new CompileTemplateMetadata(
      ...
      it(
          "should still collect <style> in elements with ng-non-bindable",
          inject([TemplateNormalizer], (TemplateNormalizer normalizer) {
            var template = normalizer.normalizeLoadedTemplate(
                dirType,
                new CompileTemplateMetadata(
                    encapsulation: null, styles: [], styleUrls: []),
                "<div ng-non-bindable><style>div {color:red}</style></div>",
                "package:some/module/");
