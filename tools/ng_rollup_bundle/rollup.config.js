...
const buildOptimizer = require('npm/node_modules/@angular-devkit/build-optimizer/src/build-optimizer/rollup-plugin.js');
...
function resolveBazel(
  ...
  function resolveInRootDir(importee) {
    ...
    return (
      tryImportee(`${importee}.mjs`) ||
      tryImportee(`${importee}/index.mjs`) ||
      tryImportee(importee) ||
      tryImportee(`${importee}.js`) ||
...
if (bannerFile) {
  ...
  if (stampData) {
    const versionTag = fs
      .readFileSync(stampData, {encoding: 'utf-8'})
      .split('\n')
