...
module.exports = function makeNodeTree(projects, destinationPath, internalDeclTree) {
  ...
  testTree = mergeTrees([testTree, srcPrivateDeclarations, internalDeclTree]);
  ...
  var license = new Funnel('.', {files: ['LICENSE'], destDir: 'benchpress'});
  // merge the test tree
