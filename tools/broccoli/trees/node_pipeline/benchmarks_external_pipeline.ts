...
module.exports = function makeNodeTree(projects, destinationPath, testingInternalDeclTree, internalDeclTree) {
  // list of npm packages that this build will create
  var outputPackages = ['angular2', 'benchpress'];

  let srcTree = new Funnel('modules', {
    // TODO: the cross-dep on angular2/src/* is bad
    include: [
      'benchmarks_external/**',
      'angular2/typings/**',
  ...
  let compiledSrcTreeWithInternals = compileTree(srcTree, true, [
  ...
  testTree = mergeTrees([testTree, srcPrivateDeclarations, testingInternalDeclTree, internalDeclTree]);
