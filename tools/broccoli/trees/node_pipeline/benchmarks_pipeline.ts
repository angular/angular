...
module.exports = function makeNodeTree(destinationPath, typeDeclsTree, testingInternalDeclTree) {
  ...
  srcTree = mergeTrees([srcTree, typeDeclsTree]);
  ...
  testTree = mergeTrees([testTree, srcPrivateDeclarations, typeDeclsTree, testingInternalDeclTree]);
