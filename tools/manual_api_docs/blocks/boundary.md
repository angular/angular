...
IMPORTANT: Wrapping `<ng-content>` in a `@boundary` does not catch errors from projected content. See [Content projection with error boundaries](guide/templates/error-boundaries#content-projection).
