...
export declare class CurrencyPipe implements PipeTransform {
  ...
  transform(
      value: any, currencyCode?: string, display?: 'code'|'symbol'|'symbol-narrow'|string|boolean,
...
export declare function formatCurrency(
    ...
    export declare function formatNumber(value: number, locale: string, digitsInfo?: string):
        string;

    export declare function formatPercent(value: number, locale: string, digitsInfo?: string):
        string;

    export declare enum FormatWidth {
      Short = 0, Medium = 1, Long = 2, Full = 3
    }
...
export declare function getCurrencySymbol(code: string, format: 'wide' | 'narrow', locale?: string):
    string;
    ...
    export declare function getLocaleMonthNames(
        locale: string, formStyle: FormStyle, width: TranslationWidth): string[];
    ...
    export declare function getNumberOfCurrencyDigits(code: string):
        number;
...
export declare function isPlatformBrowser(platformId: Object): boolean;
    ...
    export declare function isPlatformWorkerUi(platformId: Object):
        boolean;
...
export declare class NgForOf<T, U extends NgIterable<T> = NgIterable<T>> implements DoCheck {
  ...
  constructor(
      _viewContainer: ViewContainerRef, _template: TemplateRef<NgForOfContext<T, U>>,
...
export declare class NgStyle implements DoCheck {
  ngStyle: {[klass: string]: any;}|null;
  constructor(_ngEl: ElementRef, _differs: KeyValueDiffers, _renderer: Renderer2);
  ngDoCheck(): void;
}

export declare class NgSwitch { set ngSwitch(newValue: any); }
...
export declare enum NumberFormatStyle {Decimal = 0, Percent = 1, Currency = 2, Scientific = 3}
...
export declare enum Plural {Zero = 0, One = 1, Two = 2, Few = 3, Many = 4, Other = 5}
...
export declare function registerLocaleData(data: any, localeId?: string | any, extraData?: any):
    void;
...
export declare class TitleCasePipe implements PipeTransform { transform(value: string): string; }

export declare enum TranslationWidth {Narrow = 0, Abbreviated = 1, Wide = 2, Short = 3}
