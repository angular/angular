...
export declare class CheckboxControlValueAccessor implements ControlValueAccessor {
    onChange: (_: any) => void;
    onTouched: () => void;
    constructor(_renderer: RendererV2, _elementRef: ElementRef);
...
export declare class NgSelectOption implements OnDestroy {
    ...
    ngValue: any;
    value: any;
    constructor(_element: ElementRef, _renderer: RendererV2, _select: SelectControlValueAccessor);
    ngOnDestroy(): void;
}
...
export declare class RadioControlValueAccessor implements ControlValueAccessor, OnDestroy, OnInit {
    ...
    onTouched: () => void;
    value: any;
    constructor(_renderer: RendererV2, _elementRef: ElementRef, _registry: RadioControlRegistry, _injector: Injector);
