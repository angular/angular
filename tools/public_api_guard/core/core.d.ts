...
export declare function createInjector(
    defType: any, parent?: Injector | null, additionalProviders?: StaticProvider[] | null):
    Injector;
...
/** @experimental */
export declare function defineInjectable<T>(
    opts: {providedIn?: Type<any>| 'root' | 'any' | null; factory: () => T;}): never;

/** @experimental */
export declare function defineInjector(
...
export declare function getDebugNode(nativeNode: any): DebugNode |
    ...
    /** @experimental */
    export declare function getModuleFactory(id: string):
        NgModuleFactory<any>;
...
export declare const enum InjectFlags {Default = 0, Host = 1, Self = 2, SkipSelf = 4, Optional = 8}
...
export declare class NgZone {
  ...
  constructor({enableLongStackTrace}: {enableLongStackTrace?: boolean;});
...
export declare class PlatformRef {
  ...
  /** @experimental */ bootstrapModuleFactory<M>(
      moduleFactory: NgModuleFactory<M>, options?: BootstrapOptions): Promise<NgModuleRef<M>>;
  destroy(): void;
...
export declare type Provider = TypeProvider | ValueProvider | ClassProvider | ConstructorProvider |
...
export declare abstract class ReflectiveInjector implements Injector {
  ...
  /** @experimental */ static fromResolvedProviders(
...
export declare class RenderComponentType {
  ...
  templateUrl: string;
  constructor(
      id: string, templateUrl: string, slotCount: number, encapsulation: ViewEncapsulation,
      styles: Array<string|any[]>, animations: any);
}
...
/** @experimental */
export declare enum RendererStyleFlags2 {Important = 1, DashCase = 2}
...
/** @experimental */
export declare function resolveForwardRef(type: any):
    any;
...
/** @experimental */
export declare function setTestabilityGetter(getter: GetTestability):
    void;
...
export declare type StaticProvider = ValueProvider | ExistingProvider | StaticClassProvider |
