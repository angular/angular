...
/** @experimental */
export declare function createPlatformFactory(parentPlatformFactory: ((extraProviders?: Provider[]) => PlatformRef) | null | undefined, name: string, providers?: Provider[]): (extraProviders?: Provider[]) => PlatformRef;
...
export declare class DebugNode {
    ...
    readonly providerTokens: any[] | null;
    readonly references: {
        [key: string]: any;
    } | null;
...
export declare class DefaultIterableDiffer<V> implements IterableDiffer<V>, IterableChanges<V> {
    ...
    forEachOperation(fn: (item: IterableChangeRecord<V>, previousIndex: number, currentIndex: number) => void): void;
