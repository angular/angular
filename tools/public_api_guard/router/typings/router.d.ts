...
export declare class RouterLink {
    ...
    constructor(router: Router, route: ActivatedRoute, tabIndex: string, renderer: RendererV2, el: ElementRef);
    onClick(): boolean;
}
...
export declare class RouterLinkActive implements OnChanges, OnDestroy, AfterContentInit {
    ...
    constructor(router: Router, element: ElementRef, renderer: RendererV2, cdr: ChangeDetectorRef);
