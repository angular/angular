...
const CORE =
    [
      ...
      'ComponentResolver.createInjectorFactory(injectorModule:Type, extraProviders:any[]):InjectorFactory<any>',
      'ComponentDecorator',
      ...
      'InjectorFactory.constructor(_injectorFactory:(parent: Injector, mainModule: MODULE) => Injector)',
      'InjectorFactory.create(parent:Injector, mainModule:MODULE):Injector',
      'InjectorFactory<MODULE>',
      ...
      'MapInjector',
      'MapInjector.constructor(_parent:Injector, _values:Map<any, any>)',
...
const COMPILER = [
  ...
  'CompileInjectorModuleMetadata.constructor({runtime,name,moduleUrl,prefix,value,diDeps,providers}:{runtime?:Type, name?:string, moduleUrl?:string, prefix?:string, value?:any, diDeps?:CompileDiDependencyMetadata[], providers?:Array<CompileProviderMetadata|CompileTypeMetadata|CompileIdentifierMetadata|any[]>})',
