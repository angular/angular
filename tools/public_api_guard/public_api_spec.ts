...
const CORE = [
  ...
  'Injector.getOptional(token:any, notFoundResult:any):any',
...
const COMPILER =
    [
      ...
      'CompileDiDependencyMetadata.constructor({isAttribute,isSelf,isHost,isSkipSelf,isOptional,query,viewQuery,token}:{isAttribute?:boolean, isSelf?:boolean, isHost?:boolean, isSkipSelf?:boolean, isOptional?:boolean, query?:CompileQueryMetadata, viewQuery?:CompileQueryMetadata, token?:CompileTokenMetadata})',
      ...
      'CompileIdentifierMetadata.constructor({runtime,name,moduleUrl,prefix,constConstructor,value}:{runtime?:any, name?:string, moduleUrl?:string, prefix?:string, constConstructor?:boolean, value?:any})',
      ...
      'ProviderAst',
      'ProviderAst.constructor(token:CompileTokenMetadata, multiProvider:boolean, providers:CompileProviderMetadata[], providerType:ProviderAstType, sourceSpan:ParseSourceSpan)',
