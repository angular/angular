...
const CORE_TESTING = [
  ...
  'TestInjector',
  'TestInjector.addProviders(providers:Array<Type|Provider|any[]>):any',
  'TestInjector.applicationProviders:Array<Type|Provider|any[]>',
  'TestInjector.createInjector():any',
  'TestInjector.execute(tokens:any[], fn:Function):any',
  'TestInjector.get(token:any):any',
  'TestInjector.platformProviders:Array<Type|Provider|any[]>',
...
const COMPILER = [
  ...
  'CompilerConfig',
  'CompilerConfig.constructor(genDebugInfo:boolean, logBindingUpdate:boolean, useJit:boolean, renderTypes:RenderTypes=null, interpolation:InterpolationConfig=null, defaultEncapsulation:ViewEncapsulation=null)',
  'CompilerConfig.defaultEncapsulation:ViewEncapsulation',
  'CompilerConfig.genDebugInfo:boolean',
  'CompilerConfig.interpolation:InterpolationConfig',
  ...
  'InterpolationConfig',
  'InterpolationConfig.constructor(startSymbol:string, endSymbol:string)',
  'InterpolationConfig.endSymbol:string',
  'InterpolationConfig.startSymbol:string',
  'NgContentAst',
