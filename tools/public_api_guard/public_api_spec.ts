...
const CORE = [
  ...
  'ComponentResolver.createInjectorFactory(config:Type, extraProviders?:any[]):InjectorFactory<any>',
  'ComponentResolver.loadInjectorFactory(configTypeModule:string):Promise<InjectorFactory<any>>',
  ...
  'InjectorDecorator',
  'InjectorFactory.constructor(_injectorFactory:(parent: Injector, config: CONFIG) => Injector)',
  'InjectorFactory.create(parent:Injector=null, config:CONFIG=null):Injector',
  'InjectorFactory<CONFIG>',
  'InjectorMetadata',
  'InjectorMetadata.constructor({providers=[]}:{providers?:any[]}={})',
  'InjectorMetadata.providers:any[]',
  'InjectorMetadataFactory',
  'InputMetadata',
  ...
  'ProviderPropertyMetadata.token:any',
  ...
  'SystemJsComponentResolver.createInjectorFactory(config:Type, extraProviders?:any[]):InjectorFactory<any>',
  'SystemJsComponentResolver.loadInjectorFactory(configTypeModule:string):Promise<InjectorFactory<any>>',
  ...
  'var InjectorConfig:InjectorMetadataFactory',
...
const COMPILER = [
  ...
  'CompileInjectorMetadata.constructor({type,providers}:{type?:CompileTypeMetadata, providers?:Array<CompileProviderMetadata|CompileTypeMetadata|CompileIdentifierMetadata|any[]>}={})',
  'CompileInjectorMetadata.fromJson(data:{[key:string]:any}):CompileInjectorMetadata',
  'CompileInjectorMetadata.identifier:CompileIdentifierMetadata',
  'CompileInjectorMetadata.providers:Array<CompileProviderMetadata|CompileTypeMetadata|CompileIdentifierMetadata|any[]>',
  'CompileInjectorMetadata.toJson():{[key:string]:any}',
  'CompileInjectorMetadata.type:CompileTypeMetadata',
  ...
  'InjectorResolver',
  'InjectorResolver.constructor(_reflector?:ReflectorReader)',
  'InjectorResolver.resolve(type:Type):InjectorMetadata',
  'NgContentAst',
  ...
  'OfflineCompiler',
  'OfflineCompiler.compile(components:NormalizedComponentWithViewDirectives[], injectors:CompileInjectorMetadata[]):SourceModule',
  'OfflineCompiler.constructor(_directiveNormalizer:DirectiveNormalizer, _templateParser:TemplateParser, _styleCompiler:StyleCompiler, _viewCompiler:ViewCompiler, _injectorCompiler:InjectorCompiler, _outputEmitter:OutputEmitter, _xhr:XHR)',
  ...
  'RuntimeCompiler.constructor(_metadataResolver:CompileMetadataResolver, _templateNormalizer:DirectiveNormalizer, _templateParser:TemplateParser, _styleCompiler:StyleCompiler, _viewCompiler:ViewCompiler, _xhr:XHR, _injectorCompiler:InjectorCompiler, _genConfig:CompilerConfig)',
  'RuntimeCompiler.createInjectorFactory(config:Type, extraProviders:any[]=[]):InjectorFactory<any>',
  'RuntimeCompiler.loadInjectorFactory(configTypeModule:string):Promise<InjectorFactory<any>>',
...
const COMPILER_TESTING = [
  ...
  'MockInjectorResolver.resolve(type:Type):InjectorMetadata',
  'MockInjectorResolver.setProvidersOverride(type:Type, providers:any[]):void',
  'MockSchemaRegistry',
