...
const CORE = [
  ...
  'ApplicationRef.componentFactories:ComponentFactory[]',
  ...
  'ComponentResolver.createInjectorFactory(injectorModule:Type, extraProviders:any[]):CodegenInjectorFactory<any>',
  'ComponentDecorator',
  ...
  'ComponentFactory.cloneWithMetadata(original:ComponentFactory, metadata:any[]):ComponentFactory',
  'ComponentFactory.constructor(selector:string, _viewFactory:Function, _componentType:Type, _metadataPairs:Array<Type|any[]>)',
  ...
  'InjectorModuleMetadata.constructor({providers=CONST_EXPR([])}:{providers?:any[]})',
  'InjectorModuleMetadata.providers:any[]',
  'InjectorModuleMetadataFactory',
  'MapInjector',
  'MapInjector.get(token:any, notFoundValue:any):any',
  'MapInjector.constructor(_parent:Injector, values:Map<any, any>)',
  'MapInjector.createFactory(values:Map<any, any>):InjectorFactory<any>',
  'MapInjectorFactory.constructor(_values:Map<any, any>)',
  'MapInjectorFactory',
  'MapInjectorFactory.create(parent:Injector, context:any):Injector',
  'ReflectiveInjector',
  ...
  'Provider',
  'Provider.constructor(token:any, {useClass,useValue,useExisting,useFactory,useProperty,deps,multi}:{useClass?:Type, useValue?:any, useExisting?:any, useFactory?:Function, useProperty?:string, deps?:Object[], multi?:boolean})',
  ...
  'ProviderPropertyMetadata.constructor(token:any, {multi=false}:{multi?:boolean})',
  'ProviderPropertyMetadata.multi:boolean',
  'ProviderPropertyMetadataFactory',
  ...
  'ResolvedReflectiveFactory.constructor(factory:Function, dependencies:ReflectiveDependency[], postProcess:Function)',
  ...
  'TestabilityRegistry',
  'TestabilityRegistry.setTestabilityGetter(getter:GetTestability):void',
  ...
  'var InjectorModule:InjectorModuleMetadataFactory',
  ...
  'var Provides:ProviderPropertyMetadataFactory',
...
const COMPILER = [
  ...
  'ElementAst',
  'ElementAst.constructor(name:string, attrs:AttrAst[], inputs:BoundElementPropertyAst[], outputs:BoundEventAst[], references:VariableAst[], directives:DirectiveAst[], providers:ProviderAst[], hasViewContainer:boolean, children:TemplateAst[], ngContentIndex:number, sourceSpan:ParseSourceSpan)',
  ...
  'CompileProviderMetadata.constructor({token,useClass,useValue,useExisting,useFactory,useProperty,deps,multi}:{token?:CompileTokenMetadata, useClass?:CompileTypeMetadata, useValue?:any, useExisting?:CompileTokenMetadata, useFactory?:CompileFactoryMetadata, useProperty?:string, deps?:CompileDiDependencyMetadata[], multi?:boolean})',
  ...
  'CompileProviderMetadata.useProperty:string',
  'CompileProviderMetadata.useValue:any',
  'CompileInjectorModuleMetadata',
  'CompileInjectorModuleMetadata.constructor({runtime,name,moduleUrl,prefix,value,diDeps,providers,injectable}:{runtime?:Type, name?:string, moduleUrl?:string, prefix?:string, value?:any, diDeps?:CompileDiDependencyMetadata[], injectable?:boolean, providers?:Array<CompileProviderMetadata|CompileTypeMetadata|CompileIdentifierMetadata|any[]>})',
  'CompileInjectorModuleMetadata.injectable:boolean',
  'CompileInjectorModuleMetadata.diDeps:CompileDiDependencyMetadata[]',
  'CompileInjectorModuleMetadata.fromJson(data:{[key:string]:any}):CompileInjectorModuleMetadata',
  'CompileInjectorModuleMetadata.identifier:CompileIdentifierMetadata',
  'CompileInjectorModuleMetadata.isHost:any',
  'CompileInjectorModuleMetadata.moduleUrl:string',
  'CompileInjectorModuleMetadata.name:string',
  'CompileInjectorModuleMetadata.prefix:string',
  'CompileInjectorModuleMetadata.providers:Array<CompileProviderMetadata|CompileTypeMetadata|CompileIdentifierMetadata|any[]>',
  'CompileInjectorModuleMetadata.runtime:Type',
  'CompileInjectorModuleMetadata.toJson():{[key:string]:any}',
  'CompileInjectorModuleMetadata.type:CompileInjectorModuleMetadata',
  'CompileInjectorModuleMetadata.value:any',
  ...
  'OfflineCompiler.compile(components:NormalizedComponentWithViewDirectives[], injectorModules:CompileInjectorModuleMetadata[]):SourceModule',
  'OfflineCompiler.constructor(_directiveNormalizer:DirectiveNormalizer, _templateParser:TemplateParser, _styleCompiler:StyleCompiler, _viewCompiler:ViewCompiler, _injectorCompiler:InjectorCompiler, _outputEmitter:OutputEmitter)',
