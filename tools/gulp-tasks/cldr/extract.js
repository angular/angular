...
module.exports = (gulp, done) => {
  ...
  console.log(`Writing file ${I18N_CORE_FOLDER}/currencies.ts`);
  fs.writeFileSync(`${RELATIVE_I18N_CORE_FOLDER}/currencies.ts`, generateCurrenciesFile());
  ...
  return gulp
    .src([
      `${I18N_DATA_FOLDER}/**/*.ts`,
      `${I18N_CORE_FOLDER}/currencies.ts`,
