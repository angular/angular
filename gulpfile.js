...
gulp.task('!test.unit.dart/run/angular2', pubtest(gulp, gulpPlugins, {
...
gulp.task('!test.unit.dart/run/angular2_testing', pubtest(gulp, gulpPlugins, {
...
gulp.task('!test.unit.dart/run/benchpress', pubtest(gulp, gulpPlugins, {
