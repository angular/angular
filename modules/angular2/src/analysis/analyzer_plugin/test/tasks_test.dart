...
main() {
  groupSep = ' | ';
  runReflectiveTests(BuildUnitDirectivesTaskTest);
}
...
@Decorator(selector: 'deco-a')
class ComponentA {
}

@Decorator(selector: 'deco-b')
class ComponentB {
}
''');
    LibrarySpecificUnit target = new LibrarySpecificUnit(source, source);
...
class Decorator extends Directive {
  ...
  const Decorator({selector, properties, events, hostListeners,
      lifecycle, compileChildren: true})
