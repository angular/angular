 ...
 * # Example
 *
 * This example creates a {@link ControlGroup} that consists of a `login` {@link Control}, and a nested {@link ControlGroup} that defines
 * a `password` and a `passwordConfirmation` {@link Control}.
 *
 * ```
