...
/// in {@link reflectionEntryPoint} and replaces it with a call to
/// `setupReflection` in {@link newEntryPoint}.
///
/// This only searches the code in {@link reflectionEntryPoint}, not `part`s,
