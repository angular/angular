import {Type, TypeClass, isBlank, isPresent} from 'angular2/src/facade/lang';
...
export class BindingBuilder {
  ...
  _constructDependencies(factoryFunction:Function, dependencies:List<any>): List<Dependency> {
...
function _extractToken(typeOrFunc, annotations): Dependency {
  var depProps = [];
  var token = null;
  var optional = false;
  var lazy = false;
  ...
  for (var i = 0; i < annotations.length; ++i) {
    ...
    if (paramAnnotation instanceof TypeClass) {
