...
export class ProtoInjectorInlineStrategy implements ProtoInjectorStrategy {
  ...
  constructor(protoEI: ProtoInjector, bd: List<any>) {
...
export class ProtoInjectorDynamicStrategy implements ProtoInjectorStrategy {
  ...
  keyIds: List<number>;
  visibilities: List<number>;

  constructor(protoInj: ProtoInjector, bd: List<any>) {
    var len = bd.length;
...
export class ProtoInjector {
  ...
  constructor(public parent: ProtoInjector, rb: List<any>, public distanceToParent: number) {
  ...
  */
  ...
  _new(binding: ResolvedBinding): any {
    ...
    try {
      ...
      throw new InstantiationError(e, binding.key);
    }
    return obj;
  }
