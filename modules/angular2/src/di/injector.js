...
export class Injector {
   ...
   * list of [ResolvedBinding] objects. The resolution can be cached by [Injector.resolve] for performance-sensitive
   * code.
   *
   ...
   *
   * @param [bindings] A sparse list of [ResolvedBinding] objects. See [Injector.resolve].
   * @param [defaultBindings] Setting to true will auto-create bindings.
   */
   ...
   * Used to retrieve an instance from the injector.
   *
   * @param [token] usually the [Type] of object. (Same as the token used while setting up a binding).
  ...
  /**
   * Creates a child injector and loads a new set of [ResolvedBinding] objects into it.
   *
   * @param [bindings] A sparse list of [ResolvedBinding] objects. See [Injector.resolve].
   * @returns a new child `Injector`.
   */
