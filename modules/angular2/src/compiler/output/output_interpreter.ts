...
class _ExecutionContext {
  ...
  createChildWihtLocalVars() {
    return new _ExecutionContext(this, this.superClass, this.superInstance, this.className,
                                 MapWrapper.clone(this.vars), this.props, this.getters,
                                 this.methods, this.instanceFactory);
  }
}
...
class StatementInterpreter implements o.StatementVisitor, o.ExpressionVisitor {
  ...
  visitAllExpressions(expressions: o.Expression[], ctx: _ExecutionContext) {
