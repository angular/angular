...
import {TemplateAst, templateVisitAll} from '../template_ast';
import {
  getViewFactoryName,
...
export class CompileView implements NameResolver {
  ...
  public constructorMethod: CompileMethod;
  public injectorGetMethod: CompileMethod;
  public injectorPrivateGetMethod: CompileMethod;
  ...
  public checkNoChangesMethod: CompileMethod;
  ...
  constructor(public component: CompileDirectiveMetadata, public genConfig: CompilerConfig,
    ...
    this.injectorPrivateGetMethod = new CompileMethod(this, 'injectorPrivateGet');
    ...
    this.detectChangesHostPropertiesMethod = new CompileMethod(this, 'detectChanges');
    this.checkNoChangesMethod = new CompileMethod(this, 'checkNoChanges');

    this.afterContentLifecycleCallbacksMethod = new CompileMethod(this, 'detectChanges');
    this.afterViewLifecycleCallbacksMethod = new CompileMethod(this, 'detectChanges');
