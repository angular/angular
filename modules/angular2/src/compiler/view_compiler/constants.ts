...
import {RenderComponentType, RenderDebugInfo} from 'angular2/src/core/render/api';
...
export class ViewConstructorVars {
  static renderer = o.variable('renderer');
  static viewManager = o.variable('viewManager');
  static projectableNodes = o.variable(`projectableNodes`);
