...
var EVENT_RESULT_VAR = o.variable('$eventResult');
...
export class CompileEventListener {
    ...
    if (lastIndex >= 0) {
      ...
      if (isPresent(returnExpr)) {
        ...
        actionStmts[lastIndex] =
            EVENT_RESULT_VAR.set(EVENT_RESULT_VAR.and(returnExpr.cast(o.DYNAMIC_TYPE)
  ...
  finishMethod() {
    var markPathToRootStart =
        this._hasComponentHostListener ?
            ...
            o.THIS_EXPR;
    var stmts =
        (<o.Statement[]>[EVENT_RESULT_VAR.set(o.literal(true)).toDeclStmt(o.BOOL_TYPE),
                         markPathToRootStart.callMethod('markPathToRootAsCheckOnce', []).toStmt()])
            .concat(this._method.finish())
            .concat([new o.ReturnStatement(EVENT_RESULT_VAR)]);
  ...
  listenToRenderer() {
    var listenExpr;
    var eventListener = o.THIS_EXPR.callMethod('eventHandler', [o.fn([this._eventParam], [
