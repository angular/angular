...
export class Identifiers {
  ...
  static ensureSlotCount = new CompileIdentifierMetadata(
      {name: 'ensureSlotCount', moduleUrl: VIEW_UTILS_MODULE_URL, runtime: impEnsureSlotCount});
  static flattenNestedViewRenderNodes = new CompileIdentifierMetadata({
    name: 'flattenNestedViewRenderNodes',
    moduleUrl: VIEW_UTILS_MODULE_URL,
    runtime: impFlattenNestedViewRenderNodes
  });
  static looseIdentical = new CompileIdentifierMetadata(
      {name: 'looseIdentical', moduleUrl: CD_MODULE_URL, runtime: impLooseIdentical});
