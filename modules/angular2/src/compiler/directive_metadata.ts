...
export class CompileIdentifierMetadata implements CompileMetadataWithIdentifier {
  ...
  constructor({runtime, name, moduleUrl,
               prefix, constConstructor}: {runtime?: any, name?: string, moduleUrl?: string, prefix?: string, constConstructor?: boolean} = {}) {
  ...
  static fromJson(data: {[key: string]: any}): CompileIdentifierMetadata {
    return new CompileIdentifierMetadata(
        {name: data['name'], prefix: data['prefix'], moduleUrl: data['moduleUrl'], constConstructor: data['constConstructor']});
  }
