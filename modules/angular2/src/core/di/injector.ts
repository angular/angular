...
interface Bindables {
  /* type Bindables = List<ResolvedBinding | Binding | Type | List<any>>; */
}
...
export class Injector {
   ...
   */
  static resolve(bindings: Bindables): List<ResolvedBinding> {
   ...
   */
  static resolveAndCreate(bindings: Bindables, {defaultBindings = false}: any = {}): Injector {
   ...
   *
   */
  resolveAndCreateChild(bindings: Bindables): Injector {
