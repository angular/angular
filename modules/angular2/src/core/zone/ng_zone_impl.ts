...
export class NgZoneImpl extends NgZone {
  ...
  _onTurnStart: () => void = null;
  _onTurnDone: () => void = null;
  _onEventDone: () => void = null;
  _onErrorHandler: (error, stack) => void = null;
  ...
  constructor({enableLongStackTrace}) {
    ...
    if (!global.zone) {
      throw new Error('Zone.js must be loaded before angular');
    }
   ...
   * ```
   */
  runOutsideAngular(fn: () => any): any { return this._mountZone.run(fn); }
