...
export class ViewContainer {
  ...
  constructor(parentView: View, templateElement: Element, defaultProtoView: ProtoView, elementInjector: ElementInjector,
              eventManager: EventManager, lightDom = null) {
  ...
  get(index: number): View { return this._views[index]; }

  get length() { return this._views.length; }
  ...
  hydrated() { return isPresent(this.appInjector); }
  ...
  contentTagContainers() { return this._views; }
