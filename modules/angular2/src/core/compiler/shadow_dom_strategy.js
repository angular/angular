...
export class EmulatedShadowDomStrategy extends ShadowDomStrategy {
  ...
  polyfillDirectives(): List<Type> { return [Content]; }

  shim(): boolean { return true; }

  extractStyles(): boolean { return true; }
}

export class NativeShadowDomStrategy extends ShadowDomStrategy {
  constructor() { super(); }

  attachTemplate(el: Element, view: View) { moveViewNodesIntoParent(el.createShadowRoot(), view); }

  constructLightDom(lightDomView: View, shadowDomView: View, el: Element) { return null; }
