...
export abstract class ComponentRef {
  ...
  /**
   * The {@link HostViewRef} of the Host View of this Component instance.
   */
  get hostView(): HostViewRef { return unimplemented(); };
...
export class ComponentRef_ extends ComponentRef {
  constructor(private _location: AppElement) { super(); }
  get location(): ElementRef { return this._location.ref; }
  get injector(): Injector { return this._location.ref.injector; }
  get instance(): any { return this._location.component; };
  get hostView(): HostViewRef { return this._location.parentView.ref; };

  destroy(): void { this.hostView.destroy(); }
...
export class ComponentFactory {
  ...
  create(injector: Injector, projectableNodes: any[][] = null,
         rootSelectorOrNode: string | any = null): ComponentRef_ {
    var vm: AppViewManager = injector.get(AppViewManager);
    if (isBlank(projectableNodes)) {
      projectableNodes = [];
    }
    // Note: Host views don't need a declarationAppElement!
    var view: AppView<any> = this._viewFactory(vm, injector, null);
    view.create(projectableNodes, rootSelectorOrNode);
    return new ComponentRef_(view.getHostViewElement());
  }
}
