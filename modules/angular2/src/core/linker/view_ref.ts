...
export class ViewRef_ implements EmbeddedViewRef, HostViewRef {
  ...
  detach(): void { this._view.mode = ChangeDetectionStrategy.Detached; }
  detectChanges(): void { this._view.detectChanges(); }
  checkNoChanges(): void { this._view.checkNoChanges(); }
  reattach(): void {
    this._view.mode = ChangeDetectionStrategy.CheckAlways;
    this.markForCheck();
  }
}
