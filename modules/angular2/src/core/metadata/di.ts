...
/**
 * Declares an injectable parameter to be a live list of directives or bindings from
 * the content children of a directive.
 *
 ...
 * ```
 *
 * In this case the object that is queried depends on what is the var binding
 * bound to. It can be an ElementRef, a directive or a component.
 *
 * Passing in a comma separated list of bindings will query for all of them.
 *
 * ```html
 * <seeker>
 *   <div #find-me>...</div>
...
export class QueryMetadata extends DependencyMetadata {
  ...
  /**
   * whether this is querying for a var-* binding or a directive.
   */
  get isVarBindingQuery(): boolean { return isString(this.selector); }

  /**
   * returns a list of var-* bindings this is querying for.
   * Only applicable if this is a var bindings query.
   */
