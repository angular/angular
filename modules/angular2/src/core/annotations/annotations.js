 ...
 * - `@Children query:Query<DirectiveType>`: A live collection of direct child directives (will be implemented for 1.0).
 * - `@Descendants query:Query<DirectiveType>`: A live collection of any child directives (will be implemented for 1.0).
 *
 ...
 *
 * Note: This is not yet supported pre-1.0.
 *
 ...
 * injects a {@link Query}, which updates as children are added, removed, or moved by any {@link Viewport} directive such as a
 ...
 * ```
 *
 * This directive would be instantiated with a {@link Query} which contains `Dependency` 4 and 6. Here, `Dependency` 5 would
 * not be included, because it is not a direct child.
 *
 * ### Injecting a live collection of direct descendant directives
 *
 * Note: This is not yet supported pre-1.0.
 *
