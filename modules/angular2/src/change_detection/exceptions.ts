import {BaseError} from 'angular2/di';
import {ProtoRecord} from './proto_record';

export class ExpressionChangedAfterItHasBeenChecked extends BaseError {
  message:string;
...
export class ChangeDetectionError extends BaseError {
  message:string;
