...
export class AST {
  eval(context) { throw new BaseException("Not supported"); }

  get isAssignable() { return false; }

  assign(context, value) { throw new BaseException("Not supported"); }
...
export class Structural extends AST {
  ...
  eval(context) { return value.eval(context); }

  visit(visitor) { return visitor.visitStructural(this); }
}

export class ImplicitReceiver extends AST {
  eval(context) { return context; }
...
export class Formatter extends AST {
  ...
  visit(visitor) { return visitor.visitFormatter(this); }
}
...
export class LiteralPrimitive extends AST {
  ...
  eval(context) { return this.value; }
...
export class LiteralArray extends AST {
  ...
  eval(context) { return ListWrapper.map(this.expressions, (e) => e.eval(context)); }
...
export class Interpolation extends AST {
  ...
  eval(context) { throw new BaseException("evaluating an Interpolation is not supported"); }
...
export class PrefixNot extends AST {
  ...
  eval(context) { return !this.expression.eval(context); }
...
export class Assignment extends AST {
  ...
  eval(context) { return this.target.assign(context, this.value.eval(context)); }
...
export class ASTWithSource extends AST {
  ...
  eval(context) { return this.ast.eval(context); }

  get isAssignable() { return this.ast.isAssignable; }

  assign(context, value) { return this.ast.assign(context, value); }
