...
export class ProtoRecord {
  ...
  constructor(mode: number, name: string, funcOrValue, args: List, fixedArgs: List, contextIndex: number,
              selfIndex: number, bindingMemento: any, directiveMemento: any, expressionAsString: string,
              lastInBinding: boolean, lastInDirective: boolean) {
    this.mode = mode;
    this.name = name;
  ...
  isPureFunction(): boolean {
    return this.mode === RECORD_TYPE_INTERPOLATE || this.mode === RECORD_TYPE_INVOKE_FORMATTER ||
...
export class ProtoChangeDetector {
  ...
  instantiate(dispatcher: any, formatters: Map): ChangeDetector { return null; }
}
...
class _ConvertAstIntoProtoRecords {
  ...
  visitImplicitReceiver(ast: ImplicitReceiver) { return 0; }
  ...
  visitLiteralMap(ast: LiteralMap) {
    return this._addRecord(RECORD_TYPE_PRIMITIVE_OP, _mapPrimitiveName(ast.keys), ChangeDetectionUtil.mapFn(ast.keys),
  ...
  visitPrefixNot(ast: PrefixNot) {
    var exp = ast.expression.visit(this) return this._addRecord(RECORD_TYPE_PRIMITIVE_OP, "operation_negate",
  ...
  _addRecord(type, name, funcOrValue, args, fixedArgs, context) {
    ...
    ListWrapper.push(this.protoRecords,
                     new ProtoRecord(type, name, funcOrValue, args, fixedArgs, context, selfIndex, this.bindingMemento,
                                     this.directiveMemento, this.expressionAsString, false, false));
    return selfIndex;
  }
}
  ...
  switch (length - 1) {
    ...
    case 7:
      return (a1, a2, a3, a4, a5, a6, a7) =>
                 c0 + s(a1) + c1 + s(a2) + c2 + s(a3) + c3 + s(a4) + c4 + s(a5) + c5 + s(a6) + c6 + s(a7) + c7;
    case 8:
      return (a1, a2, a3, a4, a5, a6, a7, a8) => c0 + s(a1) + c1 + s(a2) + c2 + s(a3) + c3 + s(a4) + c4 + s(a5) + c5 +
                                                 s(a6) + c6 + s(a7) + c7 + s(a8) + c8;
    case 9:
      return (a1, a2, a3, a4, a5, a6, a7, a8, a9) => c0 + s(a1) + c1 + s(a2) + c2 + s(a3) + c3 + s(a4) + c4 + s(a5) +
                                                     c5 + s(a6) + c6 + s(a7) + c7 + s(a8) + c8 + s(a9) + c9;
    default:
