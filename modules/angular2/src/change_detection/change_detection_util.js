...
export class ChangeDetectionUtil {
  ...
  static noChangeMarker(value): boolean { return value === NO_CHANGE; }

  static throwOnChange(proto: ProtoRecord, change) { throw new ExpressionChangedAfterItHasBeenChecked(proto, change); }

  static simpleChange(previousValue: any, currentValue: any): SimpleChange {
    return _simpleChange(previousValue, currentValue);
  }

  static changeRecord(memento: any, change: any): ChangeRecord { return _changeRecord(memento, change); }
