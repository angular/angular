...
const _CASE_DEFAULT = CONST_EXPR(new Object());
...
export class NgSwitch {
  ...
  /** @internal */
  _onWhenValueChanged(oldCase: any, newCase: any, view: SwitchView): void {
  ...
  _deregisterView(value: any, view: SwitchView): void {
    // `_CASE_DEFAULT` is used a marker for non-registered whens
 ...
 */
@Directive({selector: '[ngSwitchCase]', inputs: ['ngSwitchCase']})
