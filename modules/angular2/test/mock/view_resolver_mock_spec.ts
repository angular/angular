...
import * as viewImpl from 'angular2/src/core/annotations_impl/base_view';
...
export function main() {
  describe('MockViewResolver', () => {
    ...
    describe('View overriding', () => {
      ...
      it('should allow overriding the @BaseView', () => {
        viewResolver.setView(SomeComponent,
                             new viewImpl.BaseView({template: 'overridden template'}));
        var view = viewResolver.resolve(SomeComponent);
    ...
    describe('inline template definition overriding', () => {
      ...
      it('should allow overriding an overridden @BaseView', () => {
        viewResolver.setView(SomeComponent,
                             new viewImpl.BaseView({template: 'overridden template'}));
    ...
    describe('Directive overriding', () => {
      ...
      it('should allow overriding a directive from an overridden @BaseView', () => {
        viewResolver.setView(SomeComponent,
                             new viewImpl.BaseView({directives: [SomeOtherDirective]}));
