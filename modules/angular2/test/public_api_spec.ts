...
var NG_PLATFORM_COMMON_DOM = [
  ...
  'DebugElementViewListener.onViewCreated()',
  'DebugElementViewListener.onViewDestroyed()',
  'DomAdapter',
  'DomEventsPlugin',
  'DomEventsPlugin.addEventListener()',
  'DomEventsPlugin.addGlobalEventListener()',
  'DomEventsPlugin.supports()',
  'DomRenderer',
  'DomRenderer.animateNodesEnter()',
  'DomRenderer.appendChild()',
  'DomRenderer.attachFragmentAfterElement()',
  'DomRenderer.attachFragmentAfterFragment()',
  'DomRenderer.createTemplateAnchor()',
  'DomRenderer.createText()',
  ...
  'DomRenderer.setBindingDebugInfo()',
  ...
  'DomRenderer.setText()',
  'DomSharedStylesHost',
  'DomSharedStylesHost.addHost()',
  'DomSharedStylesHost.addStyles()',
  'DomSharedStylesHost.getAllStyles()',
  'DomSharedStylesHost.onStylesAdded()',
  'DomSharedStylesHost.removeHost()',
  ...
  'SharedStylesHost',
  'SharedStylesHost.addStyles()',
  'SharedStylesHost.getAllStyles()',
  'SharedStylesHost.onStylesAdded()',
  'inspectNativeElement()',
  'setRootDomAdapter()'
];

// TODO(#5906): currently not compatible with our test setup
var NG_PLATFORM_SERVER = [];

// TODO(#5906): currently not compatible with our test setup
var NG_PLATFORM_WORKER_APP = [];

var NG_PLATFORM_WORKER_RENDER = [
  'ClientMessageBroker',
...
var NG_ROUTER = [
  ...
  'Instruction.toLinkUrl()',
  'Instruction.toRootUrl()',
  'Instruction.toUrlPath()',
  'Instruction.toUrlQuery()',
  'Instruction.urlParams',
  'Instruction.urlPath',
  'Location',
  'Location.back()',
  'Location.forward()',
  ...
  'RouteRegistry.generateDefault()',
  'RouteRegistry.hasRoute()',
  ...
  'RouterOutlet.reuse()',
  'RouterOutlet.routerCanDeactivate()',
  'RouterOutlet.routerCanReuse()'
];

var NG_ROUTER_LINK_DSL = [
  'RouterLinkTransform',
  'RouterLinkTransform.visitAttr()',
  'RouterLinkTransform.visitBoundText()',
  'RouterLinkTransform.visitDirective()',
  'RouterLinkTransform.visitDirectiveProperty()',
  'RouterLinkTransform.visitElement()',
  'RouterLinkTransform.visitElementProperty()',
  'RouterLinkTransform.visitEmbeddedTemplate()',
  'RouterLinkTransform.visitEvent()',
  'RouterLinkTransform.visitNgContent()',
  'RouterLinkTransform.visitText()',
  'RouterLinkTransform.visitVariable()',
  'RouterLinkTransform.astTransformer:dart',
  'RouterLinkTransform.astTransformer=:dart',
  'ROUTER_LINK_DSL_PROVIDER'
];

var NG_ROUTER_TESTING = [
  ...
  'MockLocationStrategy.internalBaseHref:dart',
  'MockLocationStrategy.internalBaseHref=:dart',
  'MockLocationStrategy.internalPath:dart',
  'MockLocationStrategy.internalPath=:dart',
  'MockLocationStrategy.internalTitle:dart',
  'MockLocationStrategy.internalTitle=:dart',
  'MockLocationStrategy.urlChanges:dart',
  'MockLocationStrategy.urlChanges=:dart',
  'SpyLocation',
  'SpyLocation.back()',
  'SpyLocation.forward()',
  ...
  'SpyLocation.platformStrategy:dart',
  'SpyLocation.platformStrategy=:dart',
  'SpyLocation.urlChanges:dart',
  'SpyLocation.urlChanges=:dart'
];
...
var NG_TESTING = [
  ...
  'ComponentFixture.componentInstance:dart',
  'ComponentFixture.componentInstance=:dart',
  'ComponentFixture.debugElement:dart',
  'ComponentFixture.debugElement=:dart',
  'ComponentFixture.nativeElement:dart',
  'ComponentFixture.nativeElement=:dart',
  'FunctionWithParamTokens.isAsync:dart',
  'FunctionWithParamTokens.isAsync=:dart',
  'MockDirectiveResolver.viewProviderOverrides:dart',
  'MockDirectiveResolver.viewProviderOverrides=:dart',
  'FunctionWithParamTokens',
  'FunctionWithParamTokens.execute()',
  'FunctionWithParamTokens.hasToken()',
  'MockApplicationRef',
  'MockApplicationRef.bootstrap()',
  'MockApplicationRef.componentTypes',
  'MockApplicationRef.dispose()',
  'MockApplicationRef.injector',
  'MockApplicationRef.registerBootstrapListener()',
  'MockApplicationRef.registerDisposeListener()',
  'MockApplicationRef.tick()',
  'MockApplicationRef.zone',
  'MockDirectiveResolver',
  'MockDirectiveResolver.resolve()',
  'MockDirectiveResolver.setBindingsOverride()',
  'MockDirectiveResolver.setProvidersOverride()',
  'MockDirectiveResolver.setViewBindingsOverride()',
  'MockDirectiveResolver.setViewProvidersOverride()',
  'MockNgZone',
  'MockNgZone.hasPendingAsyncTasks',
  'MockNgZone.hasPendingMicrotasks',
  'MockNgZone.hasPendingTimers',
  'MockNgZone.onError',
  'MockNgZone.onEventDone',
  'MockNgZone.onTurnDone',
  'MockNgZone.onTurnStart',
  'MockNgZone.overrideOnErrorHandler()',
  'MockNgZone.overrideOnEventDone()',
  'MockNgZone.overrideOnTurnDone()',
  'MockNgZone.overrideOnTurnStart()',
  'MockNgZone.run()',
  'MockNgZone.runOutsideAngular()',
  'MockNgZone.simulateZoneExit()',
  'MockViewResolver',
  'MockViewResolver.overrideViewDirective()',
  'MockViewResolver.resolve()',
  'MockViewResolver.setInlineTemplate()',
  'MockViewResolver.setView()',
  'MockXHR',
  'MockXHR.expect()',
  'MockXHR.flush()',
  'MockXHR.get()',
  'MockXHR.verifyNoOutstandingExpectations()',
  'MockXHR.when()',
  'TestComponentBuilder',
  'TestComponentBuilder.createAsync()',
  'TestComponentBuilder.overrideBindings()',
  'TestComponentBuilder.overrideDirective()',
  'TestComponentBuilder.overrideProviders()',
  'TestComponentBuilder.overrideTemplate()',
  'TestComponentBuilder.overrideView()',
  'TestComponentBuilder.overrideViewBindings()',
  'TestComponentBuilder.overrideViewProviders()',
  'afterEach():js',
  'beforeEach():js',
  'beforeEachProviders():js',
  'clearPendingTimers()',
  'createTestInjector()',
...
var NG_API = {
  ngAnimate: NG_ANIMATE,
  ngCommon: NG_COMMON,
  ngCompiler: NG_COMPILER,
  ngCore: NG_CORE,
  ngHttp: NG_HTTP,
  ngHttpTesting: NG_HTTP_TESTING,
  ngInstrumentation: NG_INSTRUMENTATION,
  ngPlatformBrowser: NG_PLATFORM_BROWSER,
  ngPlatformCommonDom: NG_PLATFORM_COMMON_DOM,
  // TODO(#5906): currently not compatible with our test setup
  // ngPlatformServer: NG_PLATFORM_SERVER,
  // ngPlatformWorkerApp: NG_PLATFORM_WORKER_APP,
  ngPlatformWorkerRender: NG_PLATFORM_WORKER_RENDER,
  ngUpgrade: NG_UPGRADE,
  ngRouter: NG_ROUTER,
  ngRouterLinkDsl: NG_ROUTER_LINK_DSL,
  ngRouterTesting: NG_ROUTER_TESTING,
  ngTesting: NG_TESTING
};
...
export function main() {
  ...
  describe('public API', () => {
    ...
    if (IS_DART) {
      barrelList =
          barrelList.filter(b => b !== 'ngUpgrade' && b !== 'ngHttp' && b !== 'ngHttpTesting');
    }

    barrelList.forEach(
        // TODO(i): remove iit
        barrel => {iit(`should fail if public API for ${barrel} has changed`, () => {

          expect(new SymbolsDiff(getSymbolsFromLibrary(barrel), NG_API[barrel]).errors).toEqual([]);
        })});
