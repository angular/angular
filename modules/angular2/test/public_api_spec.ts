...
var NG_COMMON = [
  ...
  'ControlArray.markAllAsDirty()',
  'ControlArray.markAsPristine()',
  'ControlArray.markAllAsPristine()',
  'ControlArray.markAsPending()',
  'ControlArray.markAllAsPending()',
  'ControlArray.markAsTouched()',
  'ControlArray.markAllAsTouched()',
  'ControlArray.markAsUntouched()',
  'ControlArray.markAllAsUntouched()',
  ...
  'ControlGroup.markAllAsDirty()',
  'ControlGroup.markAsPristine()',
  'ControlGroup.markAllAsPristine()',
  'ControlGroup.markAsPending()',
  'ControlGroup.markAllAsPending()',
  'ControlGroup.markAsTouched()',
  'ControlGroup.markAllAsTouched()',
  'ControlGroup.markAsUntouched()',
  'ControlGroup.markAllAsUntouched()',
