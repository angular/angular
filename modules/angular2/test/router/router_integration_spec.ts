...
@BaseView({template: "outer { <router-outlet></router-outlet> }", directives: ROUTER_DIRECTIVES})
...
@Component({selector: 'app-cmp'})
@BaseView({template: `<router-outlet></router-outlet>`, directives: ROUTER_DIRECTIVES})
