...
@BaseView({template: `root { <router-outlet></router-outlet> }`, directives: ROUTER_DIRECTIVES})
...
@BaseView({template: `parent { <router-outlet></router-outlet> }`, directives: ROUTER_DIRECTIVES})
