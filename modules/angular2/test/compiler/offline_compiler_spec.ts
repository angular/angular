...
export function main() {
  var outputDefs = [];
  var typedHostViewFactory = typed.CompANg2Factory;
  var untypedHostViewFactory = untyped.CompANg2Factory;
  ...
  describe('OfflineCompiler', () => {
    ...
    beforeEach(
        inject([Injector, SharedStylesHost], (_viewManager, _injector, _sharedStylesHost) => {
          injector = _injector;
