...
//   if (IS_DART) return;
//   const noContext = {moduleId: '', filePath: ''};
//
...
//           reflector.getStaticType(host.resolveModule('/src/app/hero-detail.component.ts'), 'HeroDetailComponent');
...
//       let UnknownClass = reflector.getStaticType(host.resolveModule('/src/app/app.component.ts'), 'UnknownClass');
...
//                                   ({__symbolic: "reference", module: "./extern", name: "s"})))
//           .toEqual(reflector.getStaticType({moduleId: '', filePath: '/src/extern.d.ts'}, 's'));
//     });
//   });
// }
//
...
//       return new StaticType('FIXME', pathTo(containingFile, modulePath) + '.d.ts', symbolName);
//     }
//     return new StaticType('FIXME', '/tmp/' + modulePath + '.d.ts', symbolName);
//   }
//
