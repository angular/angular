...
export function main() {
  describe('DomRenderer integration', () => {
    ...
    iit('should update any element property/attributes/class/style independent of the compilation on the root element and other elements',
       inject([DomTestbed], (tb: DomTestbed) => {
               ...
               tb.renderer.addComponentTemplate('comp1', [bbe('input'),
                 ee()], []);
    ...
    it('should add and remove fragments',
       inject([DomTestbed], (tb: DomTestbed) => {
          tb.renderer.addComponentTemplate('comp1', [tpl('tpl1', true, null, [
            tt('hello')
          ])], []);
         var rootView = tb.createRootHostView([
            bc('comp1', 'root'),
