...
export function main() {
  ...
  function injector(bindings, appInjector = null, isComponent: boolean = false,
    ...
    inj.hydrate(appInjector, null, preBuilt);
    return inj;
  }
    ...
    [{ strategy: 'inline', bindings: [] }, { strategy: 'dynamic',
      ...
      describe(`${context['strategy']} strategy`, () => {
        ...
        describe("hydrate", () => {
          ...
          it("should instantiate directives that depend on app injector bindings", () => {
