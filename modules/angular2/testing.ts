...
export {MockViewResolver} from 'mock/mock/view_resolver_mock';
export {MockXHR} from 'angular2/src/compiler/xhr_mock';
export {MockNgZone} from 'mock/mock/ng_zone_mock';
export {MockApplicationRef} from 'mock/mock/mock_application_ref';
export {MockDirectiveResolver} from 'mock/mock/directive_resolver_mock';
