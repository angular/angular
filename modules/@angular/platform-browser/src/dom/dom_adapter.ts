...
export abstract class DomAdapter {
  ...
  abstract createMouseEvent(doc: Document, eventType: any): any;
  abstract createEvent(doc: Document, eventType: string): any;
  ...
  abstract createComment(doc: Document, text: string): any;
  abstract createTemplate(doc: Document, html: any): HTMLElement;
  abstract createElement(doc: Document, tagName: any): HTMLElement;
  abstract createElementNS(doc: Document, ns: string, tagName: string): Element;
  abstract createTextNode(tdoc: Document, ext: string): Text;
  abstract createScriptTag(doc: Document, attrName: string, attrValue: string): HTMLElement;
  abstract createStyleElement(doc: Document, css: string): HTMLStyleElement;
  abstract createShadowRoot(doc: Document, el: any): any;
