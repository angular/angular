import {describe, it, expect, beforeEach, ddescribe, iit, xit} from '@angular/testing/testing_internal';

import {ListWrapper, StringMapWrapper, MapWrapper} from '../collection';
