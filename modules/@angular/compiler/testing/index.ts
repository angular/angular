...
import {createPlatformFactory, Pipe, NgModule, ModuleWithComponentFactories, Injectable, Directive, Component, CompilerOptions, COMPILER_OPTIONS, CompilerFactory, ComponentFactory, NgModuleFactory, Injector, NgModuleMetadata, ComponentMetadata, DirectiveMetadata, PipeMetadata, Type, PlatformRef} from '@angular/core';
