...
export class DecimalPipe implements PipeTransform {
  ...
  transform(value: any, digits: string = null): string {
    return formatNumber(DecimalPipe, this.locale, value, NumberFormatStyle.Decimal, digits);
  }
}
...
export class PercentPipe implements PipeTransform {
  ...
  transform(value: any, digits: string = null): string {
    return formatNumber(PercentPipe, this.locale, value, NumberFormatStyle.Percent, digits);
  }
}
...
export class CurrencyPipe implements PipeTransform {
  ...
  transform(
    ...
    return formatNumber(
        CurrencyPipe, this.locale, value, NumberFormatStyle.Currency, digits, currencyCode,
        symbolDisplay);
  }
}
