...
import {
  ...
  ɵand as anchorDef,
  ɵccf as createComponentFactory,
  ɵdid as directiveDef,
  ɵeld as elementDef,
  ɵinitServicesIfNeeded as initServicesIfNeeded,
  ɵted as textDef,
  ɵvid as viewDef,
} from '@angular/core';
import {
...
function TreeComponent_0(): ViewDefinition {
  return viewDef(
    viewFlags,
    [
      elementDef(0, NodeFlags.None, null, null, 1, 'span', null, [
        [BindingFlags.TypeElementStyle, 'backgroundColor', null],
      ]),
      textDef(1, null, [' ', ' ']),
      anchorDef(NodeFlags.EmbeddedViews, null, null, 1, null, TreeComponent_1),
      directiveDef(3, NodeFlags.None, null, 0, NgIf, [ViewContainerRef, TemplateRef], {
        ngIf: [0, 'ngIf'],
      }),
      anchorDef(NodeFlags.EmbeddedViews, null, null, 1, null, TreeComponent_2),
      directiveDef(5, NodeFlags.None, null, 0, NgIf, [ViewContainerRef, TemplateRef], {
        ngIf: [0, 'ngIf'],
      }),
    ],
    (check, view) => {
...
export class AppModule implements Injector, NgModuleRef<any> {
  ...
  bootstrap() {
    this.componentRef = this.componentFactory.create(
      Injector.NULL,
      [],
      this.componentFactory.selector,
      this
    );
  }
